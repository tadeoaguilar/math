...
class Serializer:
    ...
    last_anchor_id: int
    closed: Incomplete
    def __init__(self, encoding: Any = None, explicit_start: bool | None = None, explicit_end: bool | None = None, version: VersionType | None = None, tags: Any = None, dumper: Any = None) -> None: ...
    @property
