...
class VectorLIME(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(self, java_obj: Incomplete | None = None, backgroundData: Incomplete | None = None, inputCol: Incomplete | None = None, kernelWidth: float = 0.75, metricsCol: str = 'r2', model: Incomplete | None = None, numSamples: int = 1000, outputCol: str = 'VectorLIME_f2bcc27c8185__output', regularization: float = 0.0, targetClasses=[], targetClassesCol: Incomplete | None = None, targetCol: str = 'probability') -> None: ...
    def setParams(self, backgroundData: Incomplete | None = None, inputCol: Incomplete | None = None, kernelWidth: float = 0.75, metricsCol: str = 'r2', model: Incomplete | None = None, numSamples: int = 1000, outputCol: str = 'VectorLIME_f2bcc27c8185__output', regularization: float = 0.0, targetClasses=[], targetClassesCol: Incomplete | None = None, targetCol: str = 'probability'):
        """
