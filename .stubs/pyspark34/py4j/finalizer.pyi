...
from py4j.compat import items as items
...
class ThreadSafeFinalizer:
    ...
    operation."""
    finalizers: Incomplete
    lock: Incomplete
    @classmethod
    def add_finalizer(cls, id, weak_ref) -> None:
        ...
        """
    @classmethod
    def remove_finalizer(cls, id) -> None:
...
def clear_finalizers(clear_all: bool = False) -> None:
