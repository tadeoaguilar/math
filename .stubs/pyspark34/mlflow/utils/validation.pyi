...
from mlflow.entities import Dataset as Dataset, DatasetInput as DatasetInput, InputTag as InputTag
...
MAX_DATASET_NAME_SIZE: int
MAX_DATASET_DIGEST_SIZE: int
MAX_DATASET_SCHEMA_SIZE: int
MAX_DATASET_SOURCE_SIZE: int
MAX_DATASET_PROFILE_SIZE: int
MAX_INPUT_TAG_KEY_SIZE: int
MAX_INPUT_TAG_VALUE_SIZE: int
MAX_REGISTERED_MODEL_ALIAS_LENGTH: int
