...
def get_default_conda_env():
    ...
    """
def save_model(h2o_model, path, conda_env: Incomplete | None = None, code_paths: Incomplete | None = None, mlflow_model: Incomplete | None = None, settings: Incomplete | None = None, signature: ModelSignature = None, input_example: ModelInputExample = None, pip_requirements: Incomplete | None = None, extra_pip_requirements: Incomplete | None = None, metadata: Incomplete | None = None):
    """
...
class _H2OModelWrapper:
    h2o_model: Incomplete
    def __init__(self, h2o_model) -> None: ...
