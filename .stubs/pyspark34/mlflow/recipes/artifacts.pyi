...
from mlflow.utils.file_utils import chdir as chdir
...
class DataframeArtifact(Artifact):
    def __init__(self, name, recipe_root, step_name, rel_path: str = '') -> None: ...
    def name(self): ...
    def path(self): ...
    def load(self): ...

class ModelArtifact(Artifact):
    def __init__(self, name, recipe_root, step_name, tracking_uri) -> None: ...
    def name(self): ...
    def path(self): ...
    def load(self): ...
...
class HyperParametersArtifact(Artifact):
    def __init__(self, name, recipe_root, step_name) -> None: ...
    def name(self): ...
    def path(self): ...
    def load(self): ...
