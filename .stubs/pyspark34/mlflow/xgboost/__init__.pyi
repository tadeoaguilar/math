...
def get_default_conda_env():
    ...
    """
def save_model(xgb_model, path, conda_env: Incomplete | None = None, code_paths: Incomplete | None = None, mlflow_model: Incomplete | None = None, signature: ModelSignature = None, input_example: ModelInputExample = None, pip_requirements: Incomplete | None = None, extra_pip_requirements: Incomplete | None = None, model_format: str = 'xgb', metadata: Incomplete | None = None):
    """
...
def autolog(importance_types: Incomplete | None = None, log_input_examples: bool = False, log_model_signatures: bool = True, log_models: bool = True, log_datasets: bool = True, disable: bool = False, exclusive: bool = False, disable_for_unsupported_versions: bool = False, silent: bool = False, registered_model_name: Incomplete | None = None, model_format: str = 'xgb', extra_tags: Incomplete | None = None):
    '''
