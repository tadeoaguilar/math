...
from mlflow.protos.databricks_pb2 import ALREADY_EXISTS as ALREADY_EXISTS, ErrorCode as ErrorCode, RESOURCE_ALREADY_EXISTS as RESOURCE_ALREADY_EXISTS
...
def register_model(model_uri, name, await_registration_for=..., *, tags: Dict[str, Any] | None = None) -> ModelVersion:
    ...
    .. code-block:: text
        ...
        Version: 1
    '''
def search_registered_models(max_results: int | None = None, filter_string: str | None = None, order_by: List[str] | None = None) -> List[RegisteredModel]:
    '''
    ...
    '''
def search_model_versions(max_results: int | None = None, filter_string: str | None = None, order_by: List[str] | None = None) -> List[ModelVersion]:
    '''
