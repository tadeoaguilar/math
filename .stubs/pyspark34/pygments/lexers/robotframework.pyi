...
class VariableTokenizer:
    def tokenize(self, string, token) -> Generator[Incomplete, None, None]: ...

class RowTokenizer:
    def __init__(self) -> None: ...
    def tokenize(self, row) -> Generator[Incomplete, Incomplete, None]: ...

class RowSplitter:
    def split(self, row) -> Generator[Incomplete, Incomplete, None]: ...
...
class _Table:
    ...
    def tokenize(self, value, index) -> Generator[Incomplete, Incomplete, None]: ...
