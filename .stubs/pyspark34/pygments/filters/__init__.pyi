...
def get_filter_by_name(filtername, **options):
    ...
    """
def get_all_filters() -> Generator[Incomplete, Incomplete, None]:
...
class SymbolFilter(Filter):
    ...
    symbols: Incomplete
    def __init__(self, **options) -> None: ...
    def filter(self, lexer, stream) -> Generator[Incomplete, None, None]: ...
...
class VisibleWhitespaceFilter(Filter):
    ...
    wstt: Incomplete
    def __init__(self, **options) -> None: ...
    def filter(self, lexer, stream) -> Generator[Incomplete, Incomplete, Incomplete]: ...
