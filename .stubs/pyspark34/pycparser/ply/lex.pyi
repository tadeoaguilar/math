...
class Lexer:
    ...
    def clone(self, object: Incomplete | None = None): ...
...
class LexerReflect:
    ...
    error: bool
    log: Incomplete
    def __init__(self, ldict, log: Incomplete | None = None, reflags: int = 0) -> None: ...
...
def lex(module: Incomplete | None = None, object: Incomplete | None = None, debug: bool = False, optimize: bool = False, lextab: str = 'lextab', reflags=..., nowarn: bool = False, outputdir: Incomplete | None = None, debuglog: Incomplete | None = None, errorlog: Incomplete | None = None): ...
def runmain(lexer: Incomplete | None = None, data: Incomplete | None = None) -> None: ...
def TOKEN(r): ...
Token = TOKEN
