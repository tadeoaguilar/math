...
def parse(source, filename: str = '<unknown>', mode: str = 'exec', feature_version=...):
    """
...
def literal_eval(node_or_string):
    ...
    """
def dump(node, annotate_fields: bool = True, include_attributes: bool = False):
    """
...
def iter_fields(node) -> Generator[Incomplete, None, None]:
    ...
    """
def iter_child_nodes(node) -> Generator[Incomplete, None, None]:
    """
...
def get_docstring(node, clean: bool = True):
    ...
    will be raised.
    """
def walk(node) -> Generator[Incomplete, None, None]:
    """
