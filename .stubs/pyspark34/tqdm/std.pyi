...
class tqdm(Comparable):
    ...
    @classmethod
    def external_write_mode(cls, file: Incomplete | None = None, nolock: bool = False) -> Generator[None, None, None]:
        """
    ...
    def display(self, msg: Incomplete | None = None, pos: Incomplete | None = None):
        ...
        """
    @classmethod
    def wrapattr(cls, stream, method, total: Incomplete | None = None, bytes: bool = True, **tqdm_kwargs) -> Generator[Incomplete, None, None]:
        '''
