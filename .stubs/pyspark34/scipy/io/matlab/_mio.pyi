...
def mat_reader_factory(file_name, appendmat: bool = True, **kwargs):
    ...
    """
def loadmat(file_name, mdict: Incomplete | None = None, appendmat: bool = True, **kwargs):
    """
    Load MATLAB file.
    ...
    """
def savemat(file_name, mdict, appendmat: bool = True, format: str = '5', long_field_names: bool = False, do_compression: bool = False, oned_as: str = 'row') -> None:
    '''
