...
def find_active_events(g, g_new, direction):
    ...
    '''
def solve_ivp(fun, t_span, y0, method: str = 'RK45', t_eval: Incomplete | None = None, dense_output: bool = False, events: Incomplete | None = None, vectorized: bool = False, args: Incomplete | None = None, **options):
