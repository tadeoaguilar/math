...
def quad_vec(f, a, b, epsabs: float = 1e-200, epsrel: float = 1e-08, norm: str = '2', cache_size: float = 100000000.0, limit: int = 10000, workers: int = 1, points: Incomplete | None = None, quadrature: Incomplete | None = None, full_output: bool = False, *, args=()):
