...
def solve_bvp(fun, bc, x, y, p: Incomplete | None = None, S: Incomplete | None = None, fun_jac: Incomplete | None = None, bc_jac: Incomplete | None = None, tol: float = 0.001, max_nodes: int = 1000, verbose: int = 0, bc_tol: Incomplete | None = None):
