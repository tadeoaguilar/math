...
def shgo(func, bounds, args=(), constraints: Incomplete | None = None, n: Incomplete | None = None, iters: int = 1, callback: Incomplete | None = None, minimizer_kwargs: Incomplete | None = None, options: Incomplete | None = None, sampling_method: str = 'simplicial'):
    '''
...
class SHGO:
    ...
    LMC: Incomplete
    res: Incomplete
    def __init__(self, func, bounds, args=(), constraints: Incomplete | None = None, n: Incomplete | None = None, iters: Incomplete | None = None, callback: Incomplete | None = None, minimizer_kwargs: Incomplete | None = None, options: Incomplete | None = None, sampling_method: str = 'sobol') -> None: ...
    init: Incomplete
    f_tol: Incomplete
    ...
    def surface_topo_ref(self) -> None:
        ...
        """
    Xi_ind_pos: Incomplete
    Xi_ind_topo_i: Incomplete
    Xi_ind_topo: bool
    ...
    def minimizers_1D(self):
        ...
        """
    Tri: Incomplete
    def delaunay_triangulation(self, grow: bool = False, n_prc: int = 0): ...
    @staticmethod
