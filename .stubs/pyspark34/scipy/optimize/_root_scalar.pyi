...
def root_scalar(f, args=(), method: Incomplete | None = None, bracket: Incomplete | None = None, fprime: Incomplete | None = None, fprime2: Incomplete | None = None, x0: Incomplete | None = None, x1: Incomplete | None = None, xtol: Incomplete | None = None, rtol: Incomplete | None = None, maxiter: Incomplete | None = None, options: Incomplete | None = None):
    """
