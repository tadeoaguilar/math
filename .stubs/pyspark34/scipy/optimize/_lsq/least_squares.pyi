...
def least_squares(fun, x0, jac: str = '2-point', bounds=..., method: str = 'trf', ftol: float = 1e-08, xtol: float = 1e-08, gtol: float = 1e-08, x_scale: float = 1.0, loss: str = 'linear', f_scale: float = 1.0, diff_step: Incomplete | None = None, tr_solver: Incomplete | None = None, tr_options={}, jac_sparsity: Incomplete | None = None, max_nfev: Incomplete | None = None, verbose: int = 0, args=(), kwargs={}):
