...
def intersect_trust_region(x, s, Delta):
    ...
    """
def solve_lsq_trust_region(n, m, uf, s, V, Delta, initial_alpha: Incomplete | None = None, rtol: float = 0.01, max_iter: int = 10):
...
def update_tr_radius(Delta, actual_reduction, predicted_reduction, step_norm, bound_hit):
    ...
    """
def build_quadratic_1d(J, g, s, diag: Incomplete | None = None, s0: Incomplete | None = None):
