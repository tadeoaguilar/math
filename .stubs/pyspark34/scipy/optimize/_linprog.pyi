...
def linprog_terse_callback(res) -> None:
    ...
    res : A `scipy.optimize.OptimizeResult` consisting of the following fields:
        ...
        message : str
            A string descriptor of the exit status of the optimization.
    """
def linprog(c, A_ub: Incomplete | None = None, b_ub: Incomplete | None = None, A_eq: Incomplete | None = None, b_eq: Incomplete | None = None, bounds: Incomplete | None = None, method: str = 'highs', callback: Incomplete | None = None, options: Incomplete | None = None, x0: Incomplete | None = None, integrality: Incomplete | None = None):
    '''
