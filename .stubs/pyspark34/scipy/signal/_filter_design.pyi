...
def freqs_zpk(z, p, k, worN: int = 200):
    ...
    """
def freqz(b, a: int = 1, worN: int = 512, whole: bool = False, plot: Incomplete | None = None, fs=..., include_nyquist: bool = False):
    """
...
def bilinear(b, a, fs: float = 1.0):
    ...
    >>> plt.grid(True)
    """
def iirdesign(wp, ws, gpass, gstop, analog: bool = False, ftype: str = 'ellip', output: str = 'ba', fs: Incomplete | None = None):
    ...
    """
def iirfilter(N, Wn, rp: Incomplete | None = None, rs: Incomplete | None = None, btype: str = 'band', analog: bool = False, ftype: str = 'butter', output: str = 'ba', fs: Incomplete | None = None):
    """
...
def lp2bs_zpk(z, p, k, wo: float = 1.0, bw: float = 1.0):
    ...
    '''
def butter(N, Wn, btype: str = 'low', analog: bool = False, output: str = 'ba', fs: Incomplete | None = None):
    '''
    ...
    >>> plt.show()
    '''
def cheby1(N, rp, Wn, btype: str = 'low', analog: bool = False, output: str = 'ba', fs: Incomplete | None = None):
    """
    ...
    >>> plt.show()
    """
def cheby2(N, rs, Wn, btype: str = 'low', analog: bool = False, output: str = 'ba', fs: Incomplete | None = None):
    """
    ...
    >>> plt.show()
    """
def ellip(N, rp, rs, Wn, btype: str = 'low', analog: bool = False, output: str = 'ba', fs: Incomplete | None = None):
    """
    ...
    >>> plt.show()
    """
def bessel(N, Wn, btype: str = 'low', analog: bool = False, output: str = 'ba', norm: str = 'phase', fs: Incomplete | None = None):
    '''
...
def band_stop_obj(wp, ind, passb, stopb, gpass, gstop, type):
    ...
    """
def buttord(wp, ws, gpass, gstop, analog: bool = False, fs: Incomplete | None = None):
    ...
    '''
def cheb1ord(wp, ws, gpass, gstop, analog: bool = False, fs: Incomplete | None = None):
    ...
    '''
def cheb2ord(wp, ws, gpass, gstop, analog: bool = False, fs: Incomplete | None = None):
    ...
    '''
def ellipord(wp, ws, gpass, gstop, analog: bool = False, fs: Incomplete | None = None):
...
def iirpeak(w0, Q, fs: float = 2.0):
    ...
    >>> plt.show()
    '''
def iircomb(w0, Q, ftype: str = 'notch', fs: float = 2.0, *, pass_zero: bool = False):
    '''
    ...
    >>> plt.show()
    '''
def gammatone(freq, ftype, order: Incomplete | None = None, numtaps: Incomplete | None = None, fs: Incomplete | None = None):
    '''
