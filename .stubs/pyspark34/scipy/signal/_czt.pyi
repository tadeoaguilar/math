...
class CZT:
    ...
    >>> plt.show()
    '''
    def __init__(self, n, m: Incomplete | None = None, w: Incomplete | None = None, a: complex = ...) -> None: ...
...
class ZoomFFT(CZT):
    ...
    w: Incomplete
    a: Incomplete
    def __init__(self, n, fn, m: Incomplete | None = None, *, fs: int = 2, endpoint: bool = False) -> None: ...

def czt(x, m: Incomplete | None = None, w: Incomplete | None = None, a: complex = ..., *, axis: int = -1):
    '''
    ...
    >>> plt.show()
    '''
def zoom_fft(x, fn, m: Incomplete | None = None, *, fs: int = 2, endpoint: bool = False, axis: int = -1):
    """
