...
def lsim2(system, U: Incomplete | None = None, T: Incomplete | None = None, X0: Incomplete | None = None, **kwargs):
    """
...
def impulse(system, X0: Incomplete | None = None, T: Incomplete | None = None, N: Incomplete | None = None):
    ...
    """
def impulse2(system, X0: Incomplete | None = None, T: Incomplete | None = None, N: Incomplete | None = None, **kwargs):
    """
...
def step(system, X0: Incomplete | None = None, T: Incomplete | None = None, N: Incomplete | None = None):
    ...
    """
def step2(system, X0: Incomplete | None = None, T: Incomplete | None = None, N: Incomplete | None = None, **kwargs):
    """Step response of continuous-time system.
