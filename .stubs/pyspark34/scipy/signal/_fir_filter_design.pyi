...
def kaiserord(ripple, width):
    ...
    '''
def firwin(numtaps, cutoff, width: Incomplete | None = None, window: str = 'hamming', pass_zero: bool = True, scale: bool = True, nyq: Incomplete | None = None, fs: Incomplete | None = None):
    '''
    ...
    '''
def firwin2(numtaps, freq, gain, nfreqs: Incomplete | None = None, window: str = 'hamming', nyq: Incomplete | None = None, antisymmetric: bool = False, fs: Incomplete | None = None):
    '''
    FIR filter design using the window method.
    ...
    '''
def remez(numtaps, bands, desired, weight: Incomplete | None = None, Hz: Incomplete | None = None, type: str = 'bandpass', maxiter: int = 25, grid_density: int = 16, fs: Incomplete | None = None):
    '''
    ...
    '''
def firls(numtaps, bands, desired, weight: Incomplete | None = None, nyq: Incomplete | None = None, fs: Incomplete | None = None):
    """
