...
def solve_discrete_lyapunov(a, q, method: Incomplete | None = None):
    ...
    """
def solve_continuous_are(a, b, q, r, e: Incomplete | None = None, s: Incomplete | None = None, balanced: bool = True):
    '''
    ...
    '''
def solve_discrete_are(a, b, q, r, e: Incomplete | None = None, s: Incomplete | None = None, balanced: bool = True):
    '''
