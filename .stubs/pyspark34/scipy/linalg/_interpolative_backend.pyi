...
def idd_id2svd(B, idx, proj):
    ...
    :rtype: :class:`numpy.ndarray`
    """
def idd_snorm(m, n, matvect, matvec, its: int = 20):
    """
    ...
    :rtype: float
    """
def idd_diffsnorm(m, n, matvect, matvect2, matvec, matvec2, its: int = 20):
    """
...
def idz_id2svd(B, idx, proj):
    ...
    :rtype: :class:`numpy.ndarray`
    """
def idz_snorm(m, n, matveca, matvec, its: int = 20):
    """
    ...
    :rtype: float
    """
def idz_diffsnorm(m, n, matveca, matveca2, matvec, matvec2, its: int = 20):
    """
