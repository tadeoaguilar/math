...
def eig(a, b: Incomplete | None = None, left: bool = False, right: bool = True, overwrite_a: bool = False, overwrite_b: bool = False, check_finite: bool = True, homogeneous_eigvals: bool = False):
    """
    ...
    """
def eigh(a, b: Incomplete | None = None, lower: bool = True, eigvals_only: bool = False, overwrite_a: bool = False, overwrite_b: bool = False, turbo: bool = False, eigvals: Incomplete | None = None, type: int = 1, check_finite: bool = True, subset_by_index: Incomplete | None = None, subset_by_value: Incomplete | None = None, driver: Incomplete | None = None):
    '''
    ...
    '''
def eig_banded(a_band, lower: bool = False, eigvals_only: bool = False, overwrite_a_band: bool = False, select: str = 'a', select_range: Incomplete | None = None, max_ev: int = 0, check_finite: bool = True):
    """
    ...
    """
def eigvals(a, b: Incomplete | None = None, overwrite_a: bool = False, check_finite: bool = True, homogeneous_eigvals: bool = False):
    """
    ...
    """
def eigvalsh(a, b: Incomplete | None = None, lower: bool = True, overwrite_a: bool = False, overwrite_b: bool = False, turbo: bool = False, eigvals: Incomplete | None = None, type: int = 1, check_finite: bool = True, subset_by_index: Incomplete | None = None, subset_by_value: Incomplete | None = None, driver: Incomplete | None = None):
    '''
    ...
    '''
def eigvals_banded(a_band, lower: bool = False, overwrite_a_band: bool = False, select: str = 'a', select_range: Incomplete | None = None, check_finite: bool = True):
    """
    Solve real symmetric or complex Hermitian band matrix eigenvalue problem.
    ...
    array([-4.26200532, -2.22987175,  3.95222349, 12.53965359])
    """
def eigvalsh_tridiagonal(d, e, select: str = 'a', select_range: Incomplete | None = None, check_finite: bool = True, tol: float = 0.0, lapack_driver: str = 'auto'):
    """
    ...
    True
    """
def eigh_tridiagonal(d, e, eigvals_only: bool = False, select: str = 'a', select_range: Incomplete | None = None, check_finite: bool = True, tol: float = 0.0, lapack_driver: str = 'auto'):
    """
    Solve eigenvalue problem for a real symmetric tridiagonal matrix.
    ...
    True
    """
def hessenberg(a, calc_q: bool = False, overwrite_a: bool = False, check_finite: bool = True):
    """
