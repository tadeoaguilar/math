...
class RBFInterpolator:
    ...
    epsilon: Incomplete
    powers: Incomplete
    def __init__(self, y, d, neighbors: Incomplete | None = None, smoothing: float = 0.0, kernel: str = 'thin_plate_spline', epsilon: Incomplete | None = None, degree: Incomplete | None = None) -> None: ...
    def __call__(self, x):
