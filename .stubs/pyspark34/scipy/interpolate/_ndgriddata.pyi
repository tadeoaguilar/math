...
class NearestNDInterpolator(NDInterpolatorBase):
    ...
    tree: Incomplete
    values: Incomplete
    def __init__(self, x, y, rescale: bool = False, tree_options: Incomplete | None = None) -> None: ...
...
def griddata(points, values, xi, method: str = 'linear', fill_value=..., rescale: bool = False):
    """
    Interpolate unstructured D-D data.
