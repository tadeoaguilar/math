...
class _Interpolator1D:
    ...
    """
    dtype: Incomplete
    def __init__(self, xi: Incomplete | None = None, yi: Incomplete | None = None, axis: Incomplete | None = None) -> None: ...
    def __call__(self, x):
        """
...
def krogh_interpolate(xi, yi, x, der: int = 0, axis: int = 0):
    ...
    '''
def approximate_taylor_polynomial(f, x, degree, scale, order: Incomplete | None = None):
    '''
...
class BarycentricInterpolator(_Interpolator1D):
    ...
    n: Incomplete
    wi: Incomplete
    def __init__(self, xi, yi: Incomplete | None = None, axis: int = 0) -> None: ...
    yi: Incomplete
...
def barycentric_interpolate(xi, yi, x, axis: int = 0):
    '''
    Convenience function for polynomial interpolation.
