...
def splprep(x, w: Incomplete | None = None, u: Incomplete | None = None, ub: Incomplete | None = None, ue: Incomplete | None = None, k: int = 3, task: int = 0, s: Incomplete | None = None, t: Incomplete | None = None, full_output: int = 0, nest: Incomplete | None = None, per: int = 0, quiet: int = 1):
    '''
    ...
    '''
def splrep(x, y, w: Incomplete | None = None, xb: Incomplete | None = None, xe: Incomplete | None = None, k: int = 3, task: int = 0, s: Incomplete | None = None, t: Incomplete | None = None, full_output: int = 0, per: int = 0, quiet: int = 1):
    '''
...
def spalde(x, tck):
    ...
    """
def bisplrep(x, y, z, w: Incomplete | None = None, xb: Incomplete | None = None, xe: Incomplete | None = None, yb: Incomplete | None = None, ye: Incomplete | None = None, kx: int = 3, ky: int = 3, task: int = 0, s: Incomplete | None = None, eps: float = 1e-16, tx: Incomplete | None = None, ty: Incomplete | None = None, full_output: int = 0, nxest: Incomplete | None = None, nyest: Incomplete | None = None, quiet: int = 1):
    """
