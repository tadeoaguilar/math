...
def gmean(a, axis: int = 0, dtype: Incomplete | None = None, weights: Incomplete | None = None):
    ...
    '''
def hmean(a, axis: int = 0, dtype: Incomplete | None = None, *, weights: Incomplete | None = None):
    ...
    '''
def pmean(a, p, *, axis: int = 0, dtype: Incomplete | None = None, weights: Incomplete | None = None):
...
def mode(a, axis: int = 0, nan_policy: str = 'propagate', keepdims: Incomplete | None = None):
...
def tvar(a, limits: Incomplete | None = None, inclusive=(True, True), axis: int = 0, ddof: int = 1):
    ...
    """
def tmin(a, lowerlimit: Incomplete | None = None, axis: int = 0, inclusive: bool = True, nan_policy: str = 'propagate'):
    ...
    """
def tmax(a, upperlimit: Incomplete | None = None, axis: int = 0, inclusive: bool = True, nan_policy: str = 'propagate'):
    ...
    """
def tstd(a, limits: Incomplete | None = None, inclusive=(True, True), axis: int = 0, ddof: int = 1):
...
def tsem(a, limits: Incomplete | None = None, inclusive=(True, True), axis: int = 0, ddof: int = 1):
    ...
    """
def moment(a, moment: int = 1, axis: int = 0, nan_policy: str = 'propagate'):
...
def skew(a, axis: int = 0, bias: bool = True, nan_policy: str = 'propagate'):
    ...
    """
def kurtosis(a, axis: int = 0, fisher: bool = True, bias: bool = True, nan_policy: str = 'propagate'):
...
def describe(a, axis: int = 0, ddof: int = 1, bias: bool = True, nan_policy: str = 'propagate'):
...
def skewtest(a, axis: int = 0, nan_policy: str = 'propagate', alternative: str = 'two-sided'):
...
def kurtosistest(a, axis: int = 0, nan_policy: str = 'propagate', alternative: str = 'two-sided'):
...
def jarque_bera(x, *, axis: Incomplete | None = None):
    ...
    '''
def scoreatpercentile(a, per, limit=(), interpolation_method: str = 'fraction', axis: Incomplete | None = None):
...
def cumfreq(a, numbins: int = 10, defaultreallimits: Incomplete | None = None, weights: Incomplete | None = None):
...
def relfreq(a, numbins: int = 10, defaultreallimits: Incomplete | None = None, weights: Incomplete | None = None):
...
def gzscore(a, *, axis: int = 0, ddof: int = 0, nan_policy: str = 'propagate'):
    ...
    """
def zmap(scores, compare, axis: int = 0, ddof: int = 0, nan_policy: str = 'propagate'):
    """
...
def gstd(a, axis: int = 0, ddof: int = 1):
    ...
    '''
def iqr(x, axis: Incomplete | None = None, rng=(25, 75), scale: float = 1.0, nan_policy: str = 'propagate', interpolation: str = 'linear', keepdims: bool = False):
    '''
    ...
    '''
def median_abs_deviation(x, axis: int = 0, center=..., scale: float = 1.0, nan_policy: str = 'propagate'):
    '''
...
class PearsonRResult(PearsonRResultBase):
    ...
    def __init__(self, statistic, pvalue, alternative, n) -> None: ...
...
def pearsonr(x, y, *, alternative: str = 'two-sided'):
    '''
...
def fisher_exact(table, alternative: str = 'two-sided'):
    ...
    *Odds ratio*
    ...
    '''
def spearmanr(a, b: Incomplete | None = None, axis: int = 0, nan_policy: str = 'propagate', alternative: str = 'two-sided'):
...
def pointbiserialr(x, y):
    ...
    '''
def kendalltau(x, y, initial_lexsort: Incomplete | None = None, nan_policy: str = 'propagate', method: str = 'auto', variant: str = 'b', alternative: str = 'two-sided'):
    ...
    '''
def weightedtau(x, y, rank: bool = True, weigher: Incomplete | None = None, additive: bool = True):
...
def multiscale_graphcorr(x, y, compute_distance=..., reps: int = 1000, workers: int = 1, is_twosamp: bool = False, random_state: Incomplete | None = None):
...
def ttest_1samp(a, popmean, axis: int = 0, nan_policy: str = 'propagate', alternative: str = 'two-sided'):
...
def ttest_ind_from_stats(mean1, std1, nobs1, mean2, std2, nobs2, equal_var: bool = True, alternative: str = 'two-sided'):
    """
    ...
    """
def ttest_ind(a, b, axis: int = 0, equal_var: bool = True, nan_policy: str = 'propagate', permutations: Incomplete | None = None, random_state: Incomplete | None = None, alternative: str = 'two-sided', trim: int = 0):
    '''
    ...
    * ``binom(n, k)`` is the binomial coefficient (``n`` choose ``k``),
    ...
    '''
def ttest_rel(a, b, axis: int = 0, nan_policy: str = 'propagate', alternative: str = 'two-sided'):
...
def power_divergence(f_obs, f_exp: Incomplete | None = None, ddof: int = 0, axis: int = 0, lambda_: Incomplete | None = None):
...
def ks_2samp(data1, data2, alternative: str = 'two-sided', method: str = 'auto'):
    ...
    '''
def kstest(rvs, cdf, args=(), N: int = 20, alternative: str = 'two-sided', method: str = 'auto'):
    '''
...
def brunnermunzel(x, y, alternative: str = 'two-sided', distribution: str = 't', nan_policy: str = 'propagate'):
    ...
    '''
def combine_pvalues(pvalues, method: str = 'fisher', weights: Incomplete | None = None):
    '''
    ...
    * Tippett\'s method uses the smallest p-value as a statistic.
    ...
    '''
def wasserstein_distance(u_values, v_values, u_weights: Incomplete | None = None, v_weights: Incomplete | None = None):
    '''
    ...
    '''
def energy_distance(u_values, v_values, u_weights: Incomplete | None = None, v_weights: Incomplete | None = None):
...
def find_repeats(arr):
    ...
    """
def rankdata(a, method: str = 'average', *, axis: Incomplete | None = None, nan_policy: str = 'propagate'):
