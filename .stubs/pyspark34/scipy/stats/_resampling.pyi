...
def bootstrap(data, statistic, *, n_resamples: int = 9999, batch: Incomplete | None = None, vectorized: Incomplete | None = None, paired: bool = False, axis: int = 0, confidence_level: float = 0.95, method: str = 'BCa', bootstrap_result: Incomplete | None = None, random_state: Incomplete | None = None):
    '''
    ...
    '''
def monte_carlo_test(sample, rvs, statistic, *, vectorized: Incomplete | None = None, n_resamples: int = 9999, batch: Incomplete | None = None, alternative: str = 'two-sided', axis: int = 0):
    '''
    ...
    '''
def permutation_test(data, statistic, *, permutation_type: str = 'independent', vectorized: Incomplete | None = None, n_resamples: int = 9999, batch: Incomplete | None = None, alternative: str = 'two-sided', axis: int = 0, random_state: Incomplete | None = None):
    '''
