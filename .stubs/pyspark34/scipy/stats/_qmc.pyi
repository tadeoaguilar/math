...
class QMCEngine(ABC, metaclass=abc.ABCMeta):
    ...
    * ``fast_forward``: If the sequence is deterministic (like Halton
    ...
    @abstractmethod
    def __init__(self, d: IntNumber, *, optimization: Literal['random-cd', 'lloyd'] | None = None, seed: SeedType = None): ...
...
class LatinHypercube(QMCEngine):
    ...
    def __init__(self, d: IntNumber, *, centered: bool = False, scramble: bool = True, strength: int = 1, optimization: Literal['random-cd', 'lloyd'] | None = None, seed: SeedType = None) -> None: ...
...
class MultinomialQMC:
    ...
    n_trials: Incomplete
    engine: Incomplete
    def __init__(self, pvals: npt.ArrayLike, n_trials: IntNumber, *, engine: QMCEngine | None = None, seed: SeedType = None) -> None: ...
    def random(self, n: IntNumber = 1) -> np.ndarray:
