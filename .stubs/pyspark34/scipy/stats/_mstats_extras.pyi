...
def hdquantiles_sd(data, prob=..., axis: Incomplete | None = None):
    ...
    """
def trimmed_mean_ci(data, limits=(0.2, 0.2), inclusive=(True, True), alpha: float = 0.05, axis: Incomplete | None = None):
    """
...
def mjci(data, prob=[0.25, 0.5, 0.75], axis: Incomplete | None = None):
    ...
    """
def mquantiles_cimj(data, prob=[0.25, 0.5, 0.75], alpha: float = 0.05, axis: Incomplete | None = None):
    """
