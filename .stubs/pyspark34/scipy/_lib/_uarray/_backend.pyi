...
def create_multimethod(*args, **kwargs):
    ...
    """
def generate_multimethod(argument_extractor: ArgumentExtractorType, argument_replacer: ArgumentReplacerType, domain: str, default: typing.Callable | None = None):
    '''
    Generates a multimethod.
...
def wrap_single_convertor_instance(convert_single):
    ...
    Accepts a signature of (value, type, coerce).
    """
def determine_backend(value, dispatch_type, *, domain, only: bool = True, coerce: bool = False):
    ...
    '''
def determine_backend_multi(dispatchables, *, domain, only: bool = True, coerce: bool = False, **kwargs):
