...
def tfqmr(A, b, x0: Incomplete | None = None, tol: float = 1e-05, maxiter: Incomplete | None = None, M: Incomplete | None = None, callback: Incomplete | None = None, atol: Incomplete | None = None, show: bool = False):
    '''
