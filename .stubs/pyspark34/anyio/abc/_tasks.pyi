...
from anyio._core._tasks import CancelScope as CancelScope
...
class TaskGroup(metaclass=ABCMeta):
    ...
    async def spawn(self, func: Callable[..., Awaitable[Any]], *args: object, name: object = None) -> None:
        """
    ...
    def start_soon(self, func: Callable[..., Awaitable[Any]], *args: object, name: object = None) -> None:
        ...
        """
    @abstractmethod
    async def start(self, func: Callable[..., Awaitable[Any]], *args: object, name: object = None) -> Any:
        """
