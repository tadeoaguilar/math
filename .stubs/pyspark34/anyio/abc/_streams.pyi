...
class UnreliableObjectReceiveStream(AsyncResource, TypedAttributeProvider, Generic[T_co], metaclass=abc.ABCMeta):
    """
...
class UnreliableObjectSendStream(AsyncResource, TypedAttributeProvider, Generic[T_contra], metaclass=abc.ABCMeta):
    """
...
class UnreliableObjectStream(UnreliableObjectReceiveStream[T_Item], UnreliableObjectSendStream[T_Item], metaclass=abc.ABCMeta):
    """
    A bidirectional message stream which does not guarantee the order or reliability of message
    delivery.
    """
class ObjectReceiveStream(UnreliableObjectReceiveStream[T_co], metaclass=abc.ABCMeta):
    """
    ...
    """
class ObjectSendStream(UnreliableObjectSendStream[T_contra], metaclass=abc.ABCMeta):
    """
...
class ObjectStream(ObjectReceiveStream[T_Item], ObjectSendStream[T_Item], UnreliableObjectStream[T_Item], metaclass=abc.ABCMeta):
    """
...
class ByteReceiveStream(AsyncResource, TypedAttributeProvider, metaclass=abc.ABCMeta):
    """
...
class ByteSendStream(AsyncResource, TypedAttributeProvider, metaclass=abc.ABCMeta):
...
class ByteStream(ByteReceiveStream, ByteSendStream, metaclass=abc.ABCMeta):
    ...
    async def send_eof(self) -> None:
        ...
        This method is idempotent (does nothing on successive calls).
        """
AnyUnreliableByteReceiveStream = UnreliableObjectReceiveStream[bytes] | ByteReceiveStream
AnyUnreliableByteSendStream = UnreliableObjectSendStream[bytes] | ByteSendStream
AnyUnreliableByteStream = UnreliableObjectStream[bytes] | ByteStream
AnyByteReceiveStream = ObjectReceiveStream[bytes] | ByteReceiveStream
AnyByteSendStream = ObjectSendStream[bytes] | ByteSendStream
AnyByteStream = ObjectStream[bytes] | ByteStream

class Listener(AsyncResource, TypedAttributeProvider, Generic[T_co], metaclass=abc.ABCMeta):
