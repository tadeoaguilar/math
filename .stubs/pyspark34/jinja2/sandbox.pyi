...
def inspect_format_method(callable: t.Callable) -> str | None: ...
...
class SandboxedEnvironment(Environment):
    ...
    def format_string(self, s: str, args: t.Tuple[t.Any, ...], kwargs: t.Dict[str, t.Any], format_func: t.Callable | None = None) -> str:
