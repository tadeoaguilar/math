...
def is_port_open(port):
    ...
    """
def find_open_port(start: int = 8080, stop: Incomplete | None = None):
    ...
    Optional[int]
        ...
        open port.
    """
def get_user_credentials(scopes, client_id, client_secret, minimum_port: int = 8080, maximum_port: Incomplete | None = None):
