...
class IElement(Interface):
    ...
    def getTaggedValue(tag) -> None:
        ...
        """
    def queryTaggedValue(tag, default: Incomplete | None = None) -> None:
        """
    ...
    def getDirectTaggedValue(tag) -> None:
        ...
        .. versionadded:: 5.0.0
        """
    def queryDirectTaggedValue(tag, default: Incomplete | None = None) -> None:
        """
...
class ISpecification(Interface):
    ...
    def isOrExtends(other) -> None:
        ...
        """
    def extends(other, strict: bool = True) -> None:
        ...
        """
    def weakref(callback: Incomplete | None = None) -> None:
    ...
    __sro__: Incomplete
    __iro__: Incomplete
    def get(name, default: Incomplete | None = None) -> None:
...
class IInterface(ISpecification, IElement):
    ...
    def names(all: bool = False) -> None:
        ...
        """
    def namesAndDescriptions(all: bool = False) -> None:
    ...
    def direct(name) -> None:
        ...
        """
    def validateInvariants(obj, errors: Incomplete | None = None) -> None:
        '''Validate invariants
...
class IAdapterRegistry(Interface):
    ...
    def registered(required, provided, name: str = '') -> None:
        ...
        """
    def lookup(required, provided, name: str = '', default: Incomplete | None = None) -> None:
        """Lookup a value
        ...
        text.
        """
    def queryMultiAdapter(objects, provided, name: str = '', default: Incomplete | None = None) -> None:
        """Adapt a sequence of objects to a named, provided, interface
        """
    def lookup1(required, provided, name: str = '', default: Incomplete | None = None) -> None:
        ...
        text.
        """
    def queryAdapter(object, provided, name: str = '', default: Incomplete | None = None) -> None:
        """Adapt an object using a registered adapter factory.
        """
    def adapter_hook(provided, object, name: str = '', default: Incomplete | None = None) -> None:
        """Adapt an object using a registered adapter factory.
...
class IComponentLookup(Interface):
    ...
    def queryAdapter(object, interface, name: str = '', default: Incomplete | None = None) -> None:
    ...
    def getAdapter(object, interface, name: str = '') -> None:
        ...
        is raised.
        """
    def queryMultiAdapter(objects, interface, name: str = '', default: Incomplete | None = None) -> None:
    ...
    def handle(*objects) -> None:
        ...
        """
    def queryUtility(interface, name: str = '', default: Incomplete | None = None) -> None:
...
class IComponentRegistry(Interface):
    """Register components
    """
    def registerUtility(component: Incomplete | None = None, provided: Incomplete | None = None, name: str = '', info: str = '', factory: Incomplete | None = None) -> None:
        """Register a utility
        ...
        """
    def unregisterUtility(component: Incomplete | None = None, provided: Incomplete | None = None, name: str = '', factory: Incomplete | None = None) -> None:
    ...
    def registeredUtilities() -> None:
        ...
        in the object.
        """
    def registerAdapter(factory, required: Incomplete | None = None, provided: Incomplete | None = None, name: str = '', info: str = '') -> None:
        ...
        """
    def unregisterAdapter(factory: Incomplete | None = None, required: Incomplete | None = None, provided: Incomplete | None = None, name: str = '') -> None:
    ...
    def registeredAdapters() -> None:
        ...
        in the object.
        """
    def registerSubscriptionAdapter(factory, required: Incomplete | None = None, provides: Incomplete | None = None, name: str = '', info: str = '') -> None:
        ...
        """
    def unregisterSubscriptionAdapter(factory: Incomplete | None = None, required: Incomplete | None = None, provides: Incomplete | None = None, name: str = '') -> None:
    ...
    def registeredSubscriptionAdapters() -> None:
        ...
        """
    def registerHandler(handler, required: Incomplete | None = None, name: str = '', info: str = '') -> None:
        """Register a handler.
        ...
        """
    def unregisterHandler(handler: Incomplete | None = None, required: Incomplete | None = None, name: str = '') -> None:
