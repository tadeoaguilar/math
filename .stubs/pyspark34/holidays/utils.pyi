...
__all__ = ['country_holidays', 'CountryHoliday', 'financial_holidays', 'list_localized_countries', 'list_localized_financial', 'list_supported_countries', 'list_supported_financial']

def country_holidays(country: str, subdiv: str | None = None, years: int | Iterable[int] | None = None, expand: bool = True, observed: bool = True, prov: str | None = None, state: str | None = None, language: str | None = None, categories: Tuple[str] | None = None) -> HolidayBase:
    '''
    ...
    * or a single date item (of one of the types above); ``\'Holiday\'`` will be
    ...
    '''
def financial_holidays(market: str, subdiv: str | None = None, years: int | Iterable[int] | None = None, expand: bool = True, observed: bool = True, language: str | None = None) -> HolidayBase:
    """
    Returns a new dictionary-like :py:class:`HolidayBase` object for the public
    ...
    examples.
    """
def CountryHoliday(country: str, subdiv: str | None = None, years: int | Iterable[int] | None = None, expand: bool = True, observed: bool = True, prov: str | None = None, state: str | None = None) -> HolidayBase:
    """
