...
class SparkFrameMethods:
    ...
    def print_schema(self, index_col: str | List[str] | None = None) -> None:
        ...
        root
         ...
         |-- f: timestamp (nullable = false)
        """
    def frame(self, index_col: str | List[str] | None = None) -> SparkDataFrame:
        '''
    ...
    def explain(self, extended: bool | None = None, mode: str | None = None) -> None:
        ...
        ...
        '''
    def apply(self, func: Callable[[SparkDataFrame], SparkDataFrame], index_col: str | List[str] | None = None) -> ps.DataFrame:
        '''
