...
from pyspark.sql._typing import ColumnOrName as ColumnOrName, ColumnOrName_ as ColumnOrName_, DataTypeOrString as DataTypeOrString, UserDefinedFunctionLike as UserDefinedFunctionLike
...
@overload
def struct(__cols: List['ColumnOrName_'] | Tuple['ColumnOrName_', ...]) -> Column: ...
...
@overload
def create_map(__cols: List['ColumnOrName_'] | Tuple['ColumnOrName_', ...]) -> Column: ...
...
@overload
def array(__cols: List['ColumnOrName_'] | Tuple['ColumnOrName_', ...]) -> Column: ...
...
def arrays_overlap(a1: ColumnOrName, a2: ColumnOrName) -> Column:
    ...
    '''
def slice(x: ColumnOrName, start: ColumnOrName | int, length: ColumnOrName | int) -> Column:
    '''
...
@overload
def map_concat(__cols: List['ColumnOrName_'] | Tuple['ColumnOrName_', ...]) -> Column: ...
...
@overload
def udf(f: DataTypeOrString | None = None) -> Callable[[Callable[..., Any]], 'UserDefinedFunctionLike']: ...
@overload
def udf(*, returnType: DataTypeOrString = ...) -> Callable[[Callable[..., Any]], 'UserDefinedFunctionLike']: ...
