...
from ...operations._service_operations import build_list_file_systems_request as build_list_file_systems_request
from _typeshed import Incomplete
from azure.core.pipeline import PipelineResponse
from azure.core.pipeline.transport import AsyncHttpResponse
from azure.core.rest import HttpRequest
from typing import Any, AsyncIterable, Callable, Dict, TypeVar
...
class ServiceOperations:
    ...
    def list_file_systems(self, prefix: str | None = None, continuation: str | None = None, max_results: int | None = None, request_id_parameter: str | None = None, timeout: int | None = None, **kwargs: Any) -> AsyncIterable['_models.FileSystem']:
        '''List FileSystems.
