...
def build_create_request(url: str, *, request_id_parameter: str | None = None, timeout: int | None = None, properties: str | None = None, **kwargs: Any) -> HttpRequest: ...
def build_set_properties_request(url: str, *, request_id_parameter: str | None = None, timeout: int | None = None, properties: str | None = None, if_modified_since: datetime.datetime | None = None, if_unmodified_since: datetime.datetime | None = None, **kwargs: Any) -> HttpRequest: ...
def build_get_properties_request(url: str, *, request_id_parameter: str | None = None, timeout: int | None = None, **kwargs: Any) -> HttpRequest: ...
def build_delete_request(url: str, *, request_id_parameter: str | None = None, timeout: int | None = None, if_modified_since: datetime.datetime | None = None, if_unmodified_since: datetime.datetime | None = None, **kwargs: Any) -> HttpRequest: ...
def build_list_paths_request(url: str, *, recursive: bool, request_id_parameter: str | None = None, timeout: int | None = None, continuation: str | None = None, path: str | None = None, max_results: int | None = None, upn: bool | None = None, **kwargs: Any) -> HttpRequest: ...
def build_list_blob_hierarchy_segment_request(url: str, *, prefix: str | None = None, delimiter: str | None = None, marker: str | None = None, max_results: int | None = None, include: List[str | _models.ListBlobsIncludeItem] | None = None, showonly: Literal['deleted'] = 'deleted', timeout: int | None = None, request_id_parameter: str | None = None, **kwargs: Any) -> HttpRequest: ...
...
class FileSystemOperations:
    ...
    def create(self, request_id_parameter: str | None = None, timeout: int | None = None, properties: str | None = None, **kwargs: Any) -> None:
        '''Create FileSystem.
        ...
        '''
    def set_properties(self, request_id_parameter: str | None = None, timeout: int | None = None, properties: str | None = None, modified_access_conditions: _models.ModifiedAccessConditions | None = None, **kwargs: Any) -> None:
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        '''
    def get_properties(self, request_id_parameter: str | None = None, timeout: int | None = None, **kwargs: Any) -> None:
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        '''
    def delete(self, request_id_parameter: str | None = None, timeout: int | None = None, modified_access_conditions: _models.ModifiedAccessConditions | None = None, **kwargs: Any) -> None:
        '''Delete FileSystem.
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        '''
    def list_paths(self, recursive: bool, request_id_parameter: str | None = None, timeout: int | None = None, continuation: str | None = None, path: str | None = None, max_results: int | None = None, upn: bool | None = None, **kwargs: Any) -> _models.PathList:
        '''List Paths.
