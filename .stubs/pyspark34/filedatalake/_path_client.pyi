...
from ._models import AccessControlChangeCounters as AccessControlChangeCounters, AccessControlChangeFailure as AccessControlChangeFailure, AccessControlChangeResult as AccessControlChangeResult, AccessControlChanges as AccessControlChanges, ContentSettings as ContentSettings, DirectoryProperties as DirectoryProperties, FileProperties as FileProperties, LocationMode as LocationMode
from ._serialize import add_metadata_headers as add_metadata_headers, convert_datetime_to_rfc1123 as convert_datetime_to_rfc1123, convert_dfs_url_to_blob_url as convert_dfs_url_to_blob_url, get_access_conditions as get_access_conditions, get_api_version as get_api_version, get_cpk_info as get_cpk_info, get_lease_id as get_lease_id, get_mod_conditions as get_mod_conditions, get_path_http_headers as get_path_http_headers, get_source_mod_conditions as get_source_mod_conditions
from ._shared.base_client import StorageAccountHostsMixin as StorageAccountHostsMixin, parse_query as parse_query
from ._shared.response_handlers import return_headers_and_deserialized as return_headers_and_deserialized, return_response_headers as return_response_headers
...
class PathClient(StorageAccountHostsMixin):
    ...
    def __init__(self, account_url: str, file_system_name: str, path_name: str, credential: str | Dict[str, str] | AzureNamedKeyCredential | AzureSasCredential | TokenCredential | None = None, **kwargs: Any) -> None: ...
    def __exit__(self, *args) -> None: ...
    def close(self) -> None:
        """ This method is to close the sockets opened by the client.
        It need not be used when using with a context manager.
        """
    def set_access_control(self, owner: str | None = None, group: str | None = None, permissions: str | None = None, acl: str | None = None, **kwargs) -> Dict[str, str | datetime]:
        '''
        ...
        '''
    def get_access_control(self, upn: bool | None = None, **kwargs) -> Dict[str, Any]:
        '''
        :param upn: Optional.
    ...
    def remove_access_control_recursive(self, acl: str, **kwargs: Any) -> AccessControlChangeResult:
        ...
        :raises ~azure.core.exceptions.AzureError:
            User can restart the operation using continuation_token field of AzureError if the token is available.
        '''
    def set_metadata(self, metadata: Dict[str, str], **kwargs) -> Dict[str, str | datetime]:
        ...
        """
    def set_http_headers(self, content_settings: ContentSettings | None = None, **kwargs) -> Dict[str, Any]:
        ...
        :rtype: Dict[str, Any]
        """
    def acquire_lease(self, lease_duration: int | None = -1, lease_id: str | None = None, **kwargs) -> DataLakeLeaseClient:
        """
