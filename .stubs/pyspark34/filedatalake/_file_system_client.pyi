...
from ._generated import AzureDataLakeStorageRESTAPI as AzureDataLakeStorageRESTAPI
...
from ._models import DeletedPathProperties as DeletedPathProperties, DirectoryProperties as DirectoryProperties, FileProperties as FileProperties, FileSystemProperties as FileSystemProperties, LocationMode as LocationMode, PublicAccess as PublicAccess
from ._serialize import convert_dfs_url_to_blob_url as convert_dfs_url_to_blob_url, get_api_version as get_api_version
...
class FileSystemClient(StorageAccountHostsMixin):
    ...
    '''
    file_system_name: Incomplete
    def __init__(self, account_url: str, file_system_name: str, credential: str | Dict[str, str] | AzureNamedKeyCredential | AzureSasCredential | TokenCredential | None = None, **kwargs: Any) -> None: ...
    ...
    def close(self) -> None:
        ...
        """
    @classmethod
    def from_connection_string(cls, conn_str: str, file_system_name: str, credential: str | Dict[str, str] | AzureNamedKeyCredential | AzureSasCredential | TokenCredential | None = None, **kwargs: Any) -> Self:
        '''
        ...
        '''
    def acquire_lease(self, lease_duration: int = -1, lease_id: str | None = None, **kwargs) -> DataLakeLeaseClient:
        """
        ...
        """
    def create_file_system(self, metadata: Dict[str, str] | None = None, public_access: PublicAccess | None = None, **kwargs) -> Dict[str, str | datetime]:
    ...
    def get_file_system_properties(self, **kwargs: Any) -> FileSystemProperties:
        ...
        """
    def set_file_system_metadata(self, metadata: Dict[str, str], **kwargs) -> Dict[str, str | datetime]:
        ...
        """
    def set_file_system_access_policy(self, signed_identifiers: Dict[str, AccessPolicy], public_access: str | PublicAccess | None = None, **kwargs) -> Dict[str, str | datetime]:
    ...
    def get_file_system_access_policy(self, **kwargs: Any) -> Dict[str, Any]:
        ...
        :rtype: dict[str, Any]
        """
    def get_paths(self, path: str | None = None, recursive: bool | None = True, max_results: int | None = None, **kwargs) -> ItemPaged[PathProperties]:
        ...
        '''
    def create_directory(self, directory: DirectoryProperties | str, metadata: Dict[str, str] | None = None, **kwargs) -> DataLakeDirectoryClient:
        '''
        Create directory
        ...
        '''
    def delete_directory(self, directory: DirectoryProperties | str, **kwargs) -> DataLakeDirectoryClient:
        """
        ...
        """
    def create_file(self, file: FileProperties | str, **kwargs) -> DataLakeFileClient:
        '''
        Create file
        ...
        '''
    def delete_file(self, file: FileProperties | str, **kwargs) -> DataLakeFileClient:
        """
