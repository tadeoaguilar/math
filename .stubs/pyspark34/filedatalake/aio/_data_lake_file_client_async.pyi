...
from .._models import ContentSettings as ContentSettings, FileProperties as FileProperties
from .._serialize import convert_datetime_to_rfc1123 as convert_datetime_to_rfc1123
from ..aio._upload_helper import upload_datalake_file as upload_datalake_file
from ._download_async import StorageStreamDownloader as StorageStreamDownloader
from ._path_client_async import PathClient as PathClient
...
from typing import Any, AnyStr, AsyncIterable, Dict, IO, Iterable
...
class DataLakeFileClient(PathClient, DataLakeFileClientBase):
    ...
    '''
    def __init__(self, account_url: str, file_system_name: str, file_path: str, credential: str | Dict[str, str] | AzureNamedKeyCredential | AzureSasCredential | AsyncTokenCredential | None = None, **kwargs: Any) -> None: ...
    async def create_file(self, content_settings: ContentSettings | None = None, metadata: Dict[str, str] | None = None, **kwargs) -> Dict[str, str | datetime]:
        '''
        Create a new file.
    ...
    async def get_file_properties(self, **kwargs: Any) -> FileProperties:
        ...
        """
    async def set_file_expiry(self, expiry_options: str, expires_on: datetime | int | None = None, **kwargs) -> None:
        ...
        :rtype: None
        """
    async def upload_data(self, data: bytes | str | Iterable[AnyStr] | AsyncIterable[AnyStr] | IO[AnyStr], length: int | None = None, overwrite: bool | None = False, **kwargs) -> Dict[str, Any]:
        """
        ...
        :return: response dict (Etag and last modified).
        """
    async def append_data(self, data: bytes | str | Iterable[AnyStr] | IO[AnyStr], offset: int, length: int | None = None, **kwargs) -> Dict[str, str | datetime | int]:
        ...
        '''
    async def flush_data(self, offset: int, retain_uncommitted_data: bool | None = False, **kwargs) -> Dict[str, str | datetime]:
        ...
        '''
    async def download_file(self, offset: int | None = None, length: int | None = None, **kwargs: Any) -> StorageStreamDownloader:
