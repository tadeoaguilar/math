...
from .._shared.base_client_async import AsyncTransportWrapper as AsyncTransportWrapper
...
class DataLakeDirectoryClient(PathClient, DataLakeDirectoryClientBase):
    ...
    '''
    def __init__(self, account_url: str, file_system_name: str, directory_name: str, credential: str | Dict[str, str] | AzureNamedKeyCredential | AzureSasCredential | AsyncTokenCredential | None = None, **kwargs: Any) -> None: ...
    async def create_directory(self, metadata: Dict[str, str] | None = None, **kwargs) -> Dict[str, str | datetime]:
        '''
    ...
    async def exists(self, **kwargs: Any) -> bool:
        ...
        :returns: boolean
        """
    async def delete_directory(self, **kwargs) -> None:
        """
    ...
    async def get_directory_properties(self, **kwargs: Any) -> DirectoryProperties:
        ...
        """
    async def rename_directory(self, new_name: str, **kwargs) -> DataLakeDirectoryClient:
        '''
        ...
        '''
    async def create_sub_directory(self, sub_directory: DirectoryProperties | str, metadata: Dict[str, str] | None = None, **kwargs) -> DataLakeDirectoryClient:
        '''
        ...
        '''
    async def delete_sub_directory(self, sub_directory: DirectoryProperties | str, **kwargs) -> DataLakeDirectoryClient:
        """
