...
from ._models import FileSystemPropertiesPaged as FileSystemPropertiesPaged, LocationMode as LocationMode, UserDelegationKey as UserDelegationKey
...
class DataLakeServiceClient(StorageAccountHostsMixin):
    ...
    def list_file_systems(self, name_starts_with: str | None = None, include_metadata: bool | None = None, **kwargs) -> ItemPaged[FileSystemProperties]:
        ...
        """
    def create_file_system(self, file_system: FileSystemProperties | str, metadata: Dict[str, str] | None = None, public_access: PublicAccess | None = None, **kwargs) -> FileSystemClient:
    ...
    def undelete_file_system(self, name: str, deleted_version: str, **kwargs: Any) -> FileSystemClient:
        ...
        :rtype: ~azure.storage.filedatalake.FileSystemClient
        """
    def delete_file_system(self, file_system: FileSystemProperties | str, **kwargs) -> FileSystemClient:
