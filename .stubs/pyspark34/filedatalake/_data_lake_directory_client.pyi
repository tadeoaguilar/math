...
from ._deserialize import deserialize_dir_properties as deserialize_dir_properties
from ._models import DirectoryProperties as DirectoryProperties, FileProperties as FileProperties
from ._path_client import PathClient as PathClient
from ._shared.base_client import TransportWrapper as TransportWrapper, parse_connection_str as parse_connection_str
...
class DataLakeDirectoryClient(PathClient):
    ...
    '''
    def __init__(self, account_url: str, file_system_name: str, directory_name: str, credential: str | Dict[str, str] | AzureNamedKeyCredential | AzureSasCredential | TokenCredential | None = None, **kwargs: Any) -> None: ...
    @classmethod
    def from_connection_string(cls, conn_str: str, file_system_name: str, directory_name: str, credential: str | Dict[str, str] | AzureNamedKeyCredential | AzureSasCredential | TokenCredential | None = None, **kwargs: Any) -> Self:
        '''
        ...
        '''
    def create_directory(self, metadata: Dict[str, str] | None = None, **kwargs) -> Dict[str, str | datetime]:
        '''
    ...
    def rename_directory(self, new_name: str, **kwargs: Any) -> DataLakeDirectoryClient:
        ...
        '''
    def create_sub_directory(self, sub_directory: DirectoryProperties | str, metadata: Dict[str, str] | None = None, **kwargs) -> DataLakeDirectoryClient:
        '''
        ...
        '''
    def delete_sub_directory(self, sub_directory: DirectoryProperties | str, **kwargs) -> DataLakeDirectoryClient:
        """
    ...
    def create_file(self, file: FileProperties | str, **kwargs) -> DataLakeFileClient:
        ...
        '''
    def get_file_client(self, file: FileProperties | str) -> DataLakeFileClient:
        ...
        """
    def get_sub_directory_client(self, sub_directory: DirectoryProperties | str) -> DataLakeDirectoryClient:
