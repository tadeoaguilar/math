from ._deserialize import deserialize_file_properties as deserialize_file_properties, process_storage_error as process_storage_error
from ._download import StorageStreamDownloader as StorageStreamDownloader
from ._models import ContentSettings as ContentSettings, DataLakeFileQueryError as DataLakeFileQueryError, FileProperties as FileProperties
from ._path_client import PathClient as PathClient
from ._quick_query_helper import DataLakeFileQueryReader as DataLakeFileQueryReader
from ._serialize import add_metadata_headers as add_metadata_headers, convert_datetime_to_rfc1123 as convert_datetime_to_rfc1123, get_access_conditions as get_access_conditions, get_cpk_info as get_cpk_info, get_lease_action_properties as get_lease_action_properties, get_mod_conditions as get_mod_conditions, get_path_http_headers as get_path_http_headers
from ._shared.base_client import parse_connection_str as parse_connection_str
from ._shared.request_handlers import get_length as get_length, read_length as read_length
...
from ._upload_helper import upload_datalake_file as upload_datalake_file
...
class DataLakeFileClient(PathClient):
    ...
    '''
    def __init__(self, account_url: str, file_system_name: str, file_path: str, credential: str | Dict[str, str] | AzureNamedKeyCredential | AzureSasCredential | TokenCredential | None = None, **kwargs: Any) -> None: ...
    @classmethod
    def from_connection_string(cls, conn_str: str, file_system_name: str, file_path: str, credential: str | Dict[str, str] | AzureNamedKeyCredential | AzureSasCredential | TokenCredential | None = None, **kwargs: Any) -> Self:
        '''
        ...
        '''
    def create_file(self, content_settings: ContentSettings | None = None, metadata: Dict[str, str] | None = None, **kwargs) -> Dict[str, str | datetime]:
        '''
        Create a new file.
    ...
    def get_file_properties(self, **kwargs: Any) -> FileProperties:
        ...
        """
    def set_file_expiry(self, expiry_options: str, expires_on: datetime | int | None = None, **kwargs) -> None:
        ...
        :rtype: None
        """
    def upload_data(self, data: bytes | str | Iterable[AnyStr] | IO[AnyStr], length: int | None = None, overwrite: bool | None = False, **kwargs) -> Dict[str, Any]:
        """
        ...
        :return: response dict (Etag and last modified).
        """
    def append_data(self, data: bytes | str | Iterable[AnyStr] | IO[AnyStr], offset: int, length: int | None = None, **kwargs) -> Dict[str, str | datetime | int]:
        ...
        '''
    def flush_data(self, offset: int, retain_uncommitted_data: bool | None = False, **kwargs) -> Dict[str, str | datetime]:
        ...
        '''
    def download_file(self, offset: int | None = None, length: int | None = None, **kwargs: Any) -> StorageStreamDownloader:
