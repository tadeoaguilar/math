...
class Config(dict):
    ...
    def from_envvar(self, variable_name: str, silent: bool = False) -> bool:
        ...
        """
    def from_prefixed_env(self, prefix: str = 'FLASK', *, loads: t.Callable[[str], t.Any] = ...) -> bool:
    ...
    def from_object(self, obj: object | str) -> None:
        ...
        """
    def from_file(self, filename: str | os.PathLike, load: t.Callable[[t.IO[t.Any]], t.Mapping], silent: bool = False, text: bool = True) -> bool:
