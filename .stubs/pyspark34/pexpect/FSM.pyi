...
class FSM:
    ...
    def reset(self) -> None:
        ...
        __init__(). """
    def add_transition(self, input_symbol, state, action: Incomplete | None = None, next_state: Incomplete | None = None) -> None:
        ...
        add_transition_list(). """
    def add_transition_list(self, list_input_symbols, state, action: Incomplete | None = None, next_state: Incomplete | None = None) -> None:
