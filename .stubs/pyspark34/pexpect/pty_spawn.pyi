...
from .utils import poll_ignore_interrupts as poll_ignore_interrupts, select_ignore_interrupts as select_ignore_interrupts, split_command_line as split_command_line, which as which
...
class spawn(SpawnBase):
    ...
    name: str
    use_poll: Incomplete
    def __init__(self, command, args=[], timeout: int = 30, maxread: int = 2000, searchwindowsize: Incomplete | None = None, logfile: Incomplete | None = None, cwd: Incomplete | None = None, env: Incomplete | None = None, ignore_sighup: bool = False, echo: bool = True, preexec_fn: Incomplete | None = None, encoding: Incomplete | None = None, codec_errors: str = 'strict', dimensions: Incomplete | None = None, use_poll: bool = False) -> None:
    ...
    def setwinsize(self, rows, cols):
        ...
        SIGWINCH signal. """
    def interact(self, escape_character=..., input_filter: Incomplete | None = None, output_filter: Incomplete | None = None) -> None:
