...
from .expect import Expecter as Expecter, searcher_re as searcher_re, searcher_string as searcher_string
...
class SpawnBase:
    ...
    def __init__(self, timeout: int = 30, maxread: int = 2000, searchwindowsize: Incomplete | None = None, logfile: Incomplete | None = None, encoding: Incomplete | None = None, codec_errors: str = 'strict') -> None: ...
    buffer: Incomplete
