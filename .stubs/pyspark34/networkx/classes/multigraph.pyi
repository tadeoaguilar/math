...
class MultiGraph(Graph):
    ...
    **Subclassing Example**
    ...
    def to_undirected_class(self):
        ...
        what directed class to use for `to_directed()` copies.
        """
    def __init__(self, incoming_graph_data: Incomplete | None = None, multigraph_input: Incomplete | None = None, **attr) -> None:
    ...
    def add_edges_from(self, ebunch_to_add, **attr):
        ...
        '''
    def remove_edge(self, u, v, key: Incomplete | None = None) -> None:
    ...
    def edges(self):
        ...
        '''
    def get_edge_data(self, u, v, key: Incomplete | None = None, default: Incomplete | None = None):
    ...
    def to_undirected(self, as_view: bool = False):
        ...
        [(0, 1, 0), (0, 1, 1), (1, 2, 0)]
        '''
    def number_of_edges(self, u: Incomplete | None = None, v: Incomplete | None = None):
