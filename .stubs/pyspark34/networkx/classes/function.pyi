...
def create_empty_copy(G, with_data: bool = True):
    ...
    """
def set_node_attributes(G, values, name: Incomplete | None = None) -> None:
    ...
    '''
def get_node_attributes(G, name, default: Incomplete | None = None):
    ...
    \'yellow\'
    '''
def set_edge_attributes(G, values, name: Incomplete | None = None) -> None:
    ...
    '''
def get_edge_attributes(G, name, default: Incomplete | None = None):
...
def common_neighbors(G, u, v):
    ...
    [2, 3, 4]
    """
def is_weighted(G, edge: Incomplete | None = None, weight: str = 'weight'):
    ...
    """
def is_negatively_weighted(G, edge: Incomplete | None = None, weight: str = 'weight'):
...
def nodes_with_selfloops(G):
    ...
    """
def selfloop_edges(G, data: bool = False, keys: bool = False, default: Incomplete | None = None):
