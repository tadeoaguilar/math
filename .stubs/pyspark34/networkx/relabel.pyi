...
def relabel_nodes(G, mapping, copy: bool = True):
    ...
    '''
def convert_node_labels_to_integers(G, first_label: int = 0, ordering: str = 'default', label_attribute: Incomplete | None = None):
