...
def incidence_matrix(G, nodelist: Incomplete | None = None, edgelist: Incomplete | None = None, oriented: bool = False, weight: Incomplete | None = None, *, dtype: Incomplete | None = None):
