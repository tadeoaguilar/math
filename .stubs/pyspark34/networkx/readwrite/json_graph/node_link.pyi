...
def node_link_data(G, *, source: str = 'source', target: str = 'target', name: str = 'id', key: str = 'key', link: str = 'links'):
    ...
    '''
def node_link_graph(data, directed: bool = False, multigraph: bool = True, *, source: str = 'source', target: str = 'target', name: str = 'id', key: str = 'key', link: str = 'links'):
