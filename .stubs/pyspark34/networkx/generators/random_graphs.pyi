...
def random_shell_graph(constructor, seed: Incomplete | None = None):
    ...
    """
def random_powerlaw_tree(n, gamma: int = 3, seed: Incomplete | None = None, tries: int = 100):
    ...
    """
def random_powerlaw_tree_sequence(n, gamma: int = 3, seed: Incomplete | None = None, tries: int = 100):
