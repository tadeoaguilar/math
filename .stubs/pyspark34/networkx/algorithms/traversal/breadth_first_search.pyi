...
__all__ = ['bfs_edges', 'bfs_tree', 'bfs_predecessors', 'bfs_successors', 'descendants_at_distance', 'bfs_layers', 'bfs_labeled_edges', 'generic_bfs_edges']

def generic_bfs_edges(G, source, neighbors: Incomplete | None = None, depth_limit: Incomplete | None = None, sort_neighbors: Incomplete | None = None) -> Generator[Incomplete, None, Incomplete]:
    ...
    '''
def bfs_edges(G, source, reverse: bool = False, depth_limit: Incomplete | None = None, sort_neighbors: Incomplete | None = None) -> Generator[Incomplete, Incomplete, Incomplete]:
    ...
    """
def bfs_tree(G, source, reverse: bool = False, depth_limit: Incomplete | None = None, sort_neighbors: Incomplete | None = None):
    ...
    edge_bfs
    '''
def bfs_predecessors(G, source, depth_limit: Incomplete | None = None, sort_neighbors: Incomplete | None = None) -> Generator[Incomplete, None, None]:
    ...
    edge_bfs
    '''
def bfs_successors(G, source, depth_limit: Incomplete | None = None, sort_neighbors: Incomplete | None = None) -> Generator[Incomplete, None, None]:
...
def bfs_layers(G, sources) -> Generator[Incomplete, None, None]:
    ...
    {0: [1, 6], 1: [0, 3, 4, 2], 2: [5]}
    """
def bfs_labeled_edges(G, sources) -> Generator[Incomplete, None, None]:
