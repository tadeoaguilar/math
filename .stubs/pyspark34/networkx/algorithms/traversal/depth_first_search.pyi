...
__all__ = ['dfs_edges', 'dfs_tree', 'dfs_predecessors', 'dfs_successors', 'dfs_preorder_nodes', 'dfs_postorder_nodes', 'dfs_labeled_edges']

def dfs_edges(G, source: Incomplete | None = None, depth_limit: Incomplete | None = None) -> Generator[Incomplete, None, None]:
...
def dfs_preorder_nodes(G, source: Incomplete | None = None, depth_limit: Incomplete | None = None):
    ...
    bfs_edges
    '''
def dfs_labeled_edges(G, source: Incomplete | None = None, depth_limit: Incomplete | None = None) -> Generator[Incomplete, None, None]:
