...
def equivalence_classes(iterable, relation):
    ...
    """
def quotient_graph(G, partition, edge_relation: Incomplete | None = None, node_data: Incomplete | None = None, edge_data: Incomplete | None = None, weight: str = 'weight', relabel: bool = False, create_using: Incomplete | None = None):
