...
def greedy_modularity_communities(G, weight: Incomplete | None = None, resolution: int = 1, cutoff: int = 1, best_n: Incomplete | None = None):
    ...
    '''
def naive_greedy_modularity_communities(G, resolution: int = 1, weight: Incomplete | None = None):
    """Find communities in G using greedy modularity maximization.
