...
def eigenvector_centrality(G, max_iter: int = 100, tol: float = 1e-06, nstart: Incomplete | None = None, weight: Incomplete | None = None):
    ...
    * tol`` or after ``max_iter`` iterations, but in the second case it
    ...
    '''
def eigenvector_centrality_numpy(G, weight: Incomplete | None = None, max_iter: int = 50, tol: int = 0):
    '''Compute the eigenvector centrality for the graph G.
