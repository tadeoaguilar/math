...
def single_source_dijkstra_path_length(G, source, cutoff: Incomplete | None = None, weight: str = 'weight'):
    ...
    '''
def single_source_dijkstra(G, source, target: Incomplete | None = None, cutoff: Incomplete | None = None, weight: str = 'weight'):
...
def multi_source_dijkstra_path_length(G, sources, cutoff: Incomplete | None = None, weight: str = 'weight'):
    ...
    '''
def multi_source_dijkstra(G, sources, target: Incomplete | None = None, cutoff: Incomplete | None = None, weight: str = 'weight'):
...
def all_pairs_dijkstra(G, cutoff: Incomplete | None = None, weight: str = 'weight') -> Generator[Incomplete, None, None]:
    ...
    '''
def all_pairs_dijkstra_path_length(G, cutoff: Incomplete | None = None, weight: str = 'weight') -> Generator[Incomplete, None, None]:
...
def all_pairs_dijkstra_path(G, cutoff: Incomplete | None = None, weight: str = 'weight') -> Generator[Incomplete, None, None]:
    ...
    """
def bellman_ford_predecessor_and_distance(G, source, target: Incomplete | None = None, weight: str = 'weight', heuristic: bool = False):
