...
def all_shortest_paths(G, source, target, weight: Incomplete | None = None, method: str = 'dijkstra'):
    ...
    all_pairs_shortest_path
    """
def single_source_all_shortest_paths(G, source, weight: Incomplete | None = None, method: str = 'dijkstra') -> Generator[Incomplete, None, None]:
    ...
    """
def all_pairs_all_shortest_paths(G, weight: Incomplete | None = None, method: str = 'dijkstra') -> Generator[Incomplete, None, None]:
