...
def strongly_connected_components(G) -> Generator[Incomplete, None, None]:
    ...
    """
def kosaraju_strongly_connected_components(G, source: Incomplete | None = None) -> Generator[Incomplete, None, None]:
    """Generate nodes in strongly connected components of graph.
    ...
    """
def strongly_connected_components_recursive(G) -> Generator[Incomplete, Incomplete, None]:
    """Generate nodes in strongly connected components of graph.
...
def is_strongly_connected(G):
    ...
    For directed graphs only.
    """
def condensation(G, scc: Incomplete | None = None):
