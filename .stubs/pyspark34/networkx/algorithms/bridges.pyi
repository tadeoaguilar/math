...
def bridges(G, root: Incomplete | None = None) -> Generator[Incomplete, None, None]:
    ...
    """
def has_bridges(G, root: Incomplete | None = None):
    ...
    """
def local_bridges(G, with_span: bool = True, weight: Incomplete | None = None) -> Generator[Incomplete, None, Incomplete]:
