...
__all__ = ['find_cliques', 'find_cliques_recursive', 'make_max_clique_graph', 'make_clique_bipartite', 'node_clique_number', 'number_of_cliques', 'enumerate_all_cliques', 'max_weight_clique']
...
def enumerate_all_cliques(G) -> Generator[Incomplete, None, None]:
    ...
    '''
def find_cliques(G, nodes: Incomplete | None = None) -> Generator[Incomplete, None, Incomplete]:
    ...
    '''
def find_cliques_recursive(G, nodes: Incomplete | None = None):
    ...
    '''
def make_max_clique_graph(G, create_using: Incomplete | None = None):
    ...
    """
def make_clique_bipartite(G, fpos: Incomplete | None = None, create_using: Incomplete | None = None, name: Incomplete | None = None):
    ...
    '''
def node_clique_number(G, nodes: Incomplete | None = None, cliques: Incomplete | None = None, separate_nodes: bool = False):
    ...
    """
def number_of_cliques(G, nodes: Incomplete | None = None, cliques: Incomplete | None = None):
...
def max_weight_clique(G, weight: str = 'weight'):
