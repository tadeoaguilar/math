...
def degree_assortativity_coefficient(G, x: str = 'out', y: str = 'in', weight: Incomplete | None = None, nodes: Incomplete | None = None):
    ...
    '''
def degree_pearson_correlation_coefficient(G, x: str = 'out', y: str = 'in', weight: Incomplete | None = None, nodes: Incomplete | None = None):
    '''Compute degree assortativity of graph.
