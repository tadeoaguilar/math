...
def topological_generations(G) -> Generator[Incomplete, None, None]:
    ...
    topological_sort
    """
def topological_sort(G) -> Generator[Incomplete, Incomplete, None]:
    ...
    '''
def lexicographical_topological_sort(G, key: Incomplete | None = None) -> Generator[Incomplete, None, Incomplete]:
...
def transitive_closure(G, reflexive: bool = False):
    ...
    """
def transitive_closure_dag(G, topo_order: Incomplete | None = None):
...
def transitive_reduction(G):
    ...
    """
def antichains(G, topo_order: Incomplete | None = None) -> Generator[Incomplete, None, None]:
...
def dag_to_branching(G):
    ...
    *arborescences*. For this function, each node of in-degree zero in
    ...
    '''
def compute_v_structures(G) -> Generator[Incomplete, None, None]:
