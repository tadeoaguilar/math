...
class Z(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg: Incomplete | None = None, fill: Incomplete | None = None, locations: Incomplete | None = None, locationssrc: Incomplete | None = None, show: Incomplete | None = None, **kwargs) -> None:
        """
