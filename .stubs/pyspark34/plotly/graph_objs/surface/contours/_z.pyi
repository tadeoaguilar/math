...
class Z(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg: Incomplete | None = None, color: Incomplete | None = None, end: Incomplete | None = None, highlight: Incomplete | None = None, highlightcolor: Incomplete | None = None, highlightwidth: Incomplete | None = None, project: Incomplete | None = None, show: Incomplete | None = None, size: Incomplete | None = None, start: Incomplete | None = None, usecolormap: Incomplete | None = None, width: Incomplete | None = None, **kwargs) -> None:
        '''
