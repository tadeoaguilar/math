...
class Lighting(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg: Incomplete | None = None, ambient: Incomplete | None = None, diffuse: Incomplete | None = None, fresnel: Incomplete | None = None, roughness: Incomplete | None = None, specular: Incomplete | None = None, **kwargs) -> None:
        """
