...
class Header(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg: Incomplete | None = None, align: Incomplete | None = None, alignsrc: Incomplete | None = None, fill: Incomplete | None = None, font: Incomplete | None = None, format: Incomplete | None = None, formatsrc: Incomplete | None = None, height: Incomplete | None = None, line: Incomplete | None = None, prefix: Incomplete | None = None, prefixsrc: Incomplete | None = None, suffix: Incomplete | None = None, suffixsrc: Incomplete | None = None, values: Incomplete | None = None, valuessrc: Incomplete | None = None, **kwargs) -> None:
        """
