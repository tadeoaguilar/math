...
class Sankey(_BaseTraceType):
    ...
    @property
    def type(self): ...
    def __init__(self, arg: Incomplete | None = None, arrangement: Incomplete | None = None, customdata: Incomplete | None = None, customdatasrc: Incomplete | None = None, domain: Incomplete | None = None, hoverinfo: Incomplete | None = None, hoverlabel: Incomplete | None = None, ids: Incomplete | None = None, idssrc: Incomplete | None = None, legend: Incomplete | None = None, legendgrouptitle: Incomplete | None = None, legendrank: Incomplete | None = None, legendwidth: Incomplete | None = None, link: Incomplete | None = None, meta: Incomplete | None = None, metasrc: Incomplete | None = None, name: Incomplete | None = None, node: Incomplete | None = None, orientation: Incomplete | None = None, selectedpoints: Incomplete | None = None, stream: Incomplete | None = None, textfont: Incomplete | None = None, uid: Incomplete | None = None, uirevision: Incomplete | None = None, valueformat: Incomplete | None = None, valuesuffix: Incomplete | None = None, visible: Incomplete | None = None, **kwargs) -> None:
        '''
