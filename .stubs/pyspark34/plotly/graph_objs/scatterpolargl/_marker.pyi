...
class Marker(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg: Incomplete | None = None, angle: Incomplete | None = None, anglesrc: Incomplete | None = None, autocolorscale: Incomplete | None = None, cauto: Incomplete | None = None, cmax: Incomplete | None = None, cmid: Incomplete | None = None, cmin: Incomplete | None = None, color: Incomplete | None = None, coloraxis: Incomplete | None = None, colorbar: Incomplete | None = None, colorscale: Incomplete | None = None, colorsrc: Incomplete | None = None, line: Incomplete | None = None, opacity: Incomplete | None = None, opacitysrc: Incomplete | None = None, reversescale: Incomplete | None = None, showscale: Incomplete | None = None, size: Incomplete | None = None, sizemin: Incomplete | None = None, sizemode: Incomplete | None = None, sizeref: Incomplete | None = None, sizesrc: Incomplete | None = None, symbol: Incomplete | None = None, symbolsrc: Incomplete | None = None, **kwargs) -> None:
        '''
