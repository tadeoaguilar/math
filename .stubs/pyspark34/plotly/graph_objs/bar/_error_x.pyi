...
class ErrorX(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg: Incomplete | None = None, array: Incomplete | None = None, arrayminus: Incomplete | None = None, arrayminussrc: Incomplete | None = None, arraysrc: Incomplete | None = None, color: Incomplete | None = None, copy_ystyle: Incomplete | None = None, symmetric: Incomplete | None = None, thickness: Incomplete | None = None, traceref: Incomplete | None = None, tracerefminus: Incomplete | None = None, type: Incomplete | None = None, value: Incomplete | None = None, valueminus: Incomplete | None = None, visible: Incomplete | None = None, width: Incomplete | None = None, **kwargs) -> None:
        '''
