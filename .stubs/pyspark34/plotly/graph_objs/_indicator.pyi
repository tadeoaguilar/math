...
class Indicator(_BaseTraceType):
    ...
    @property
    def type(self): ...
    def __init__(self, arg: Incomplete | None = None, align: Incomplete | None = None, customdata: Incomplete | None = None, customdatasrc: Incomplete | None = None, delta: Incomplete | None = None, domain: Incomplete | None = None, gauge: Incomplete | None = None, ids: Incomplete | None = None, idssrc: Incomplete | None = None, legend: Incomplete | None = None, legendgrouptitle: Incomplete | None = None, legendrank: Incomplete | None = None, legendwidth: Incomplete | None = None, meta: Incomplete | None = None, metasrc: Incomplete | None = None, mode: Incomplete | None = None, name: Incomplete | None = None, number: Incomplete | None = None, stream: Incomplete | None = None, title: Incomplete | None = None, uid: Incomplete | None = None, uirevision: Incomplete | None = None, value: Incomplete | None = None, visible: Incomplete | None = None, **kwargs) -> None:
        '''
