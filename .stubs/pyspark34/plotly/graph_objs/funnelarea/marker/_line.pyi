...
class Line(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg: Incomplete | None = None, color: Incomplete | None = None, colorsrc: Incomplete | None = None, width: Incomplete | None = None, widthsrc: Incomplete | None = None, **kwargs) -> None:
        """
