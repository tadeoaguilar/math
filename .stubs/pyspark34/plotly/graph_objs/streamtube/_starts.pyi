...
class Starts(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg: Incomplete | None = None, x: Incomplete | None = None, xsrc: Incomplete | None = None, y: Incomplete | None = None, ysrc: Incomplete | None = None, z: Incomplete | None = None, zsrc: Incomplete | None = None, **kwargs) -> None:
        """
