...
class Line(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg: Incomplete | None = None, backoff: Incomplete | None = None, backoffsrc: Incomplete | None = None, color: Incomplete | None = None, dash: Incomplete | None = None, shape: Incomplete | None = None, simplify: Incomplete | None = None, smoothing: Incomplete | None = None, width: Incomplete | None = None, **kwargs) -> None:
        '''
