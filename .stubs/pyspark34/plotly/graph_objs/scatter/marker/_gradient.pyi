...
class Gradient(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg: Incomplete | None = None, color: Incomplete | None = None, colorsrc: Incomplete | None = None, type: Incomplete | None = None, typesrc: Incomplete | None = None, **kwargs) -> None:
        """
