...
class Parcoords(_BaseTraceType):
    ...
    @property
    def type(self): ...
    def __init__(self, arg: Incomplete | None = None, customdata: Incomplete | None = None, customdatasrc: Incomplete | None = None, dimensions: Incomplete | None = None, dimensiondefaults: Incomplete | None = None, domain: Incomplete | None = None, ids: Incomplete | None = None, idssrc: Incomplete | None = None, labelangle: Incomplete | None = None, labelfont: Incomplete | None = None, labelside: Incomplete | None = None, legend: Incomplete | None = None, legendgrouptitle: Incomplete | None = None, legendrank: Incomplete | None = None, legendwidth: Incomplete | None = None, line: Incomplete | None = None, meta: Incomplete | None = None, metasrc: Incomplete | None = None, name: Incomplete | None = None, rangefont: Incomplete | None = None, stream: Incomplete | None = None, tickfont: Incomplete | None = None, uid: Incomplete | None = None, uirevision: Incomplete | None = None, unselected: Incomplete | None = None, visible: Incomplete | None = None, **kwargs) -> None:
        '''
