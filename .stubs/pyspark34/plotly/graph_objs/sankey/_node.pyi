...
class Node(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg: Incomplete | None = None, color: Incomplete | None = None, colorsrc: Incomplete | None = None, customdata: Incomplete | None = None, customdatasrc: Incomplete | None = None, groups: Incomplete | None = None, hoverinfo: Incomplete | None = None, hoverlabel: Incomplete | None = None, hovertemplate: Incomplete | None = None, hovertemplatesrc: Incomplete | None = None, label: Incomplete | None = None, labelsrc: Incomplete | None = None, line: Incomplete | None = None, pad: Incomplete | None = None, thickness: Incomplete | None = None, x: Incomplete | None = None, xsrc: Incomplete | None = None, y: Incomplete | None = None, ysrc: Incomplete | None = None, **kwargs) -> None:
        '''
