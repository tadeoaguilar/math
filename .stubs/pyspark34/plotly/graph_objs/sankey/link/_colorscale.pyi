...
class Colorscale(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg: Incomplete | None = None, cmax: Incomplete | None = None, cmin: Incomplete | None = None, colorscale: Incomplete | None = None, label: Incomplete | None = None, name: Incomplete | None = None, templateitemname: Incomplete | None = None, **kwargs) -> None:
        """
