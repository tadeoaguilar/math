...
class Link(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg: Incomplete | None = None, arrowlen: Incomplete | None = None, color: Incomplete | None = None, colorscales: Incomplete | None = None, colorscaledefaults: Incomplete | None = None, colorsrc: Incomplete | None = None, customdata: Incomplete | None = None, customdatasrc: Incomplete | None = None, hoverinfo: Incomplete | None = None, hoverlabel: Incomplete | None = None, hovertemplate: Incomplete | None = None, hovertemplatesrc: Incomplete | None = None, label: Incomplete | None = None, labelsrc: Incomplete | None = None, line: Incomplete | None = None, source: Incomplete | None = None, sourcesrc: Incomplete | None = None, target: Incomplete | None = None, targetsrc: Incomplete | None = None, value: Incomplete | None = None, valuesrc: Incomplete | None = None, **kwargs) -> None:
        '''
