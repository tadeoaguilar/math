...
class Cluster(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg: Incomplete | None = None, color: Incomplete | None = None, colorsrc: Incomplete | None = None, enabled: Incomplete | None = None, maxzoom: Incomplete | None = None, opacity: Incomplete | None = None, opacitysrc: Incomplete | None = None, size: Incomplete | None = None, sizesrc: Incomplete | None = None, step: Incomplete | None = None, stepsrc: Incomplete | None = None, **kwargs) -> None:
        """
