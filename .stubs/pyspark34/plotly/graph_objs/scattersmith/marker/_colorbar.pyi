...
class ColorBar(_BaseTraceHierarchyType):
    ...
    def titlefont(self):
        '''
        Deprecated: Please use scattersmith.marker.colorbar.title.font
    ...
    def titleside(self):
        '''
        Deprecated: Please use scattersmith.marker.colorbar.title.side
