...
class AngularAxis(_BaseLayoutHierarchyType):
    ...
    def __init__(self, arg: Incomplete | None = None, autotypenumbers: Incomplete | None = None, categoryarray: Incomplete | None = None, categoryarraysrc: Incomplete | None = None, categoryorder: Incomplete | None = None, color: Incomplete | None = None, direction: Incomplete | None = None, dtick: Incomplete | None = None, exponentformat: Incomplete | None = None, gridcolor: Incomplete | None = None, griddash: Incomplete | None = None, gridwidth: Incomplete | None = None, hoverformat: Incomplete | None = None, labelalias: Incomplete | None = None, layer: Incomplete | None = None, linecolor: Incomplete | None = None, linewidth: Incomplete | None = None, minexponent: Incomplete | None = None, nticks: Incomplete | None = None, period: Incomplete | None = None, rotation: Incomplete | None = None, separatethousands: Incomplete | None = None, showexponent: Incomplete | None = None, showgrid: Incomplete | None = None, showline: Incomplete | None = None, showticklabels: Incomplete | None = None, showtickprefix: Incomplete | None = None, showticksuffix: Incomplete | None = None, thetaunit: Incomplete | None = None, tick0: Incomplete | None = None, tickangle: Incomplete | None = None, tickcolor: Incomplete | None = None, tickfont: Incomplete | None = None, tickformat: Incomplete | None = None, tickformatstops: Incomplete | None = None, tickformatstopdefaults: Incomplete | None = None, ticklabelstep: Incomplete | None = None, ticklen: Incomplete | None = None, tickmode: Incomplete | None = None, tickprefix: Incomplete | None = None, ticks: Incomplete | None = None, ticksuffix: Incomplete | None = None, ticktext: Incomplete | None = None, ticktextsrc: Incomplete | None = None, tickvals: Incomplete | None = None, tickvalssrc: Incomplete | None = None, tickwidth: Incomplete | None = None, type: Incomplete | None = None, uirevision: Incomplete | None = None, visible: Incomplete | None = None, **kwargs) -> None:
        '''
