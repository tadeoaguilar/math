...
class Newshape(_BaseLayoutHierarchyType):
    ...
    def __init__(self, arg: Incomplete | None = None, drawdirection: Incomplete | None = None, fillcolor: Incomplete | None = None, fillrule: Incomplete | None = None, label: Incomplete | None = None, layer: Incomplete | None = None, legend: Incomplete | None = None, legendgroup: Incomplete | None = None, legendgrouptitle: Incomplete | None = None, legendrank: Incomplete | None = None, legendwidth: Incomplete | None = None, line: Incomplete | None = None, name: Incomplete | None = None, opacity: Incomplete | None = None, showlegend: Incomplete | None = None, visible: Incomplete | None = None, **kwargs) -> None:
        '''
