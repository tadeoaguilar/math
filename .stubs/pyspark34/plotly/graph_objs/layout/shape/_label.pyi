...
class Label(_BaseLayoutHierarchyType):
    ...
    def __init__(self, arg: Incomplete | None = None, font: Incomplete | None = None, padding: Incomplete | None = None, text: Incomplete | None = None, textangle: Incomplete | None = None, textposition: Incomplete | None = None, texttemplate: Incomplete | None = None, xanchor: Incomplete | None = None, yanchor: Incomplete | None = None, **kwargs) -> None:
        '''
