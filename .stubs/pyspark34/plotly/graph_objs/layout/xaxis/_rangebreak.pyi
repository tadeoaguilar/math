...
class Rangebreak(_BaseLayoutHierarchyType):
    ...
    def __init__(self, arg: Incomplete | None = None, bounds: Incomplete | None = None, dvalue: Incomplete | None = None, enabled: Incomplete | None = None, name: Incomplete | None = None, pattern: Incomplete | None = None, templateitemname: Incomplete | None = None, values: Incomplete | None = None, **kwargs) -> None:
        '''
