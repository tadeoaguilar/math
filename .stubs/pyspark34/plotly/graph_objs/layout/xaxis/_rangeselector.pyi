...
class Rangeselector(_BaseLayoutHierarchyType):
    ...
    def __init__(self, arg: Incomplete | None = None, activecolor: Incomplete | None = None, bgcolor: Incomplete | None = None, bordercolor: Incomplete | None = None, borderwidth: Incomplete | None = None, buttons: Incomplete | None = None, buttondefaults: Incomplete | None = None, font: Incomplete | None = None, visible: Incomplete | None = None, x: Incomplete | None = None, xanchor: Incomplete | None = None, y: Incomplete | None = None, yanchor: Incomplete | None = None, **kwargs) -> None:
        '''
