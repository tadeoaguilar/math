...
class Button(_BaseLayoutHierarchyType):
    ...
    def __init__(self, arg: Incomplete | None = None, count: Incomplete | None = None, label: Incomplete | None = None, name: Incomplete | None = None, step: Incomplete | None = None, stepmode: Incomplete | None = None, templateitemname: Incomplete | None = None, visible: Incomplete | None = None, **kwargs) -> None:
        '''
