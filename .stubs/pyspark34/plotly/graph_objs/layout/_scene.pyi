...
class Scene(_BaseLayoutHierarchyType):
    ...
    def __init__(self, arg: Incomplete | None = None, annotations: Incomplete | None = None, annotationdefaults: Incomplete | None = None, aspectmode: Incomplete | None = None, aspectratio: Incomplete | None = None, bgcolor: Incomplete | None = None, camera: Incomplete | None = None, domain: Incomplete | None = None, dragmode: Incomplete | None = None, hovermode: Incomplete | None = None, uirevision: Incomplete | None = None, xaxis: Incomplete | None = None, yaxis: Incomplete | None = None, zaxis: Incomplete | None = None, **kwargs) -> None:
        '''
