...
class Ternary(_BaseLayoutHierarchyType):
    ...
    def __init__(self, arg: Incomplete | None = None, aaxis: Incomplete | None = None, baxis: Incomplete | None = None, bgcolor: Incomplete | None = None, caxis: Incomplete | None = None, domain: Incomplete | None = None, sum: Incomplete | None = None, uirevision: Incomplete | None = None, **kwargs) -> None:
        """
