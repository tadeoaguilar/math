...
class Minor(_BaseLayoutHierarchyType):
    ...
    def __init__(self, arg: Incomplete | None = None, dtick: Incomplete | None = None, gridcolor: Incomplete | None = None, griddash: Incomplete | None = None, gridwidth: Incomplete | None = None, nticks: Incomplete | None = None, showgrid: Incomplete | None = None, tick0: Incomplete | None = None, tickcolor: Incomplete | None = None, ticklen: Incomplete | None = None, tickmode: Incomplete | None = None, ticks: Incomplete | None = None, tickvals: Incomplete | None = None, tickvalssrc: Incomplete | None = None, tickwidth: Incomplete | None = None, **kwargs) -> None:
        '''
