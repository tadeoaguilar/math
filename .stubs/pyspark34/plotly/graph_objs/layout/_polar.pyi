...
class Polar(_BaseLayoutHierarchyType):
    ...
    def __init__(self, arg: Incomplete | None = None, angularaxis: Incomplete | None = None, bargap: Incomplete | None = None, barmode: Incomplete | None = None, bgcolor: Incomplete | None = None, domain: Incomplete | None = None, gridshape: Incomplete | None = None, hole: Incomplete | None = None, radialaxis: Incomplete | None = None, sector: Incomplete | None = None, uirevision: Incomplete | None = None, **kwargs) -> None:
        '''
