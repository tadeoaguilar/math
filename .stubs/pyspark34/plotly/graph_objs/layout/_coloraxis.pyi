...
class Coloraxis(_BaseLayoutHierarchyType):
    ...
    def __init__(self, arg: Incomplete | None = None, autocolorscale: Incomplete | None = None, cauto: Incomplete | None = None, cmax: Incomplete | None = None, cmid: Incomplete | None = None, cmin: Incomplete | None = None, colorbar: Incomplete | None = None, colorscale: Incomplete | None = None, reversescale: Incomplete | None = None, showscale: Incomplete | None = None, **kwargs) -> None:
        """
