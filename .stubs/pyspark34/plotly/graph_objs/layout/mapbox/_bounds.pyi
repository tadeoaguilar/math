...
class Bounds(_BaseLayoutHierarchyType):
    ...
    def __init__(self, arg: Incomplete | None = None, east: Incomplete | None = None, north: Incomplete | None = None, south: Incomplete | None = None, west: Incomplete | None = None, **kwargs) -> None:
        """
