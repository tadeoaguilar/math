...
class Symbol(_BaseLayoutHierarchyType):
    ...
    def __init__(self, arg: Incomplete | None = None, icon: Incomplete | None = None, iconsize: Incomplete | None = None, placement: Incomplete | None = None, text: Incomplete | None = None, textfont: Incomplete | None = None, textposition: Incomplete | None = None, **kwargs) -> None:
        '''
