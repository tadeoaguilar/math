...
class Layer(_BaseLayoutHierarchyType):
    ...
    def __init__(self, arg: Incomplete | None = None, below: Incomplete | None = None, circle: Incomplete | None = None, color: Incomplete | None = None, coordinates: Incomplete | None = None, fill: Incomplete | None = None, line: Incomplete | None = None, maxzoom: Incomplete | None = None, minzoom: Incomplete | None = None, name: Incomplete | None = None, opacity: Incomplete | None = None, source: Incomplete | None = None, sourceattribution: Incomplete | None = None, sourcelayer: Incomplete | None = None, sourcetype: Incomplete | None = None, symbol: Incomplete | None = None, templateitemname: Incomplete | None = None, type: Incomplete | None = None, visible: Incomplete | None = None, **kwargs) -> None:
        '''
