...
class Smith(_BaseLayoutHierarchyType):
    ...
    def __init__(self, arg: Incomplete | None = None, bgcolor: Incomplete | None = None, domain: Incomplete | None = None, imaginaryaxis: Incomplete | None = None, realaxis: Incomplete | None = None, **kwargs) -> None:
        """
