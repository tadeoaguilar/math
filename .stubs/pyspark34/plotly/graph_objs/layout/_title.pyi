...
class Title(_BaseLayoutHierarchyType):
    ...
    def __init__(self, arg: Incomplete | None = None, automargin: Incomplete | None = None, font: Incomplete | None = None, pad: Incomplete | None = None, text: Incomplete | None = None, x: Incomplete | None = None, xanchor: Incomplete | None = None, xref: Incomplete | None = None, y: Incomplete | None = None, yanchor: Incomplete | None = None, yref: Incomplete | None = None, **kwargs) -> None:
        '''
