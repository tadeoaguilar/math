...
class Domain(_BaseLayoutHierarchyType):
    ...
    @y.setter
    def y(self, val) -> None: ...
    def __init__(self, arg: Incomplete | None = None, column: Incomplete | None = None, row: Incomplete | None = None, x: Incomplete | None = None, y: Incomplete | None = None, **kwargs) -> None:
        """
