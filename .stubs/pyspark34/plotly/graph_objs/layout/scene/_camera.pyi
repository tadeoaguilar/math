...
class Camera(_BaseLayoutHierarchyType):
    ...
    def __init__(self, arg: Incomplete | None = None, center: Incomplete | None = None, eye: Incomplete | None = None, projection: Incomplete | None = None, up: Incomplete | None = None, **kwargs) -> None:
        """
