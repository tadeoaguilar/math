...
class Legend(_BaseLayoutHierarchyType):
    ...
    def __init__(self, arg: Incomplete | None = None, bgcolor: Incomplete | None = None, bordercolor: Incomplete | None = None, borderwidth: Incomplete | None = None, entrywidth: Incomplete | None = None, entrywidthmode: Incomplete | None = None, font: Incomplete | None = None, groupclick: Incomplete | None = None, grouptitlefont: Incomplete | None = None, itemclick: Incomplete | None = None, itemdoubleclick: Incomplete | None = None, itemsizing: Incomplete | None = None, itemwidth: Incomplete | None = None, orientation: Incomplete | None = None, title: Incomplete | None = None, tracegroupgap: Incomplete | None = None, traceorder: Incomplete | None = None, uirevision: Incomplete | None = None, valign: Incomplete | None = None, visible: Incomplete | None = None, x: Incomplete | None = None, xanchor: Incomplete | None = None, xref: Incomplete | None = None, y: Incomplete | None = None, yanchor: Incomplete | None = None, yref: Incomplete | None = None, **kwargs) -> None:
        '''
