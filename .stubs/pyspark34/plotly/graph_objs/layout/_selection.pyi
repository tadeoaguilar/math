...
class Selection(_BaseLayoutHierarchyType):
    ...
    def __init__(self, arg: Incomplete | None = None, line: Incomplete | None = None, name: Incomplete | None = None, opacity: Incomplete | None = None, path: Incomplete | None = None, templateitemname: Incomplete | None = None, type: Incomplete | None = None, x0: Incomplete | None = None, x1: Incomplete | None = None, xref: Incomplete | None = None, y0: Incomplete | None = None, y1: Incomplete | None = None, yref: Incomplete | None = None, **kwargs) -> None:
        '''
