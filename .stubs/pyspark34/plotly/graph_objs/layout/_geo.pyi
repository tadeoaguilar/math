...
class Geo(_BaseLayoutHierarchyType):
    ...
    def __init__(self, arg: Incomplete | None = None, bgcolor: Incomplete | None = None, center: Incomplete | None = None, coastlinecolor: Incomplete | None = None, coastlinewidth: Incomplete | None = None, countrycolor: Incomplete | None = None, countrywidth: Incomplete | None = None, domain: Incomplete | None = None, fitbounds: Incomplete | None = None, framecolor: Incomplete | None = None, framewidth: Incomplete | None = None, lakecolor: Incomplete | None = None, landcolor: Incomplete | None = None, lataxis: Incomplete | None = None, lonaxis: Incomplete | None = None, oceancolor: Incomplete | None = None, projection: Incomplete | None = None, resolution: Incomplete | None = None, rivercolor: Incomplete | None = None, riverwidth: Incomplete | None = None, scope: Incomplete | None = None, showcoastlines: Incomplete | None = None, showcountries: Incomplete | None = None, showframe: Incomplete | None = None, showlakes: Incomplete | None = None, showland: Incomplete | None = None, showocean: Incomplete | None = None, showrivers: Incomplete | None = None, showsubunits: Incomplete | None = None, subunitcolor: Incomplete | None = None, subunitwidth: Incomplete | None = None, uirevision: Incomplete | None = None, visible: Incomplete | None = None, **kwargs) -> None:
        '''
