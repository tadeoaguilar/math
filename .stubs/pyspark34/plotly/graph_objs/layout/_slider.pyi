...
class Slider(_BaseLayoutHierarchyType):
    ...
    def __init__(self, arg: Incomplete | None = None, active: Incomplete | None = None, activebgcolor: Incomplete | None = None, bgcolor: Incomplete | None = None, bordercolor: Incomplete | None = None, borderwidth: Incomplete | None = None, currentvalue: Incomplete | None = None, font: Incomplete | None = None, len: Incomplete | None = None, lenmode: Incomplete | None = None, minorticklen: Incomplete | None = None, name: Incomplete | None = None, pad: Incomplete | None = None, steps: Incomplete | None = None, stepdefaults: Incomplete | None = None, templateitemname: Incomplete | None = None, tickcolor: Incomplete | None = None, ticklen: Incomplete | None = None, tickwidth: Incomplete | None = None, transition: Incomplete | None = None, visible: Incomplete | None = None, x: Incomplete | None = None, xanchor: Incomplete | None = None, y: Incomplete | None = None, yanchor: Incomplete | None = None, **kwargs) -> None:
        '''
