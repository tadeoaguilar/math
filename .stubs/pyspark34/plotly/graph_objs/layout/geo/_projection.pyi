...
class Projection(_BaseLayoutHierarchyType):
    ...
    def __init__(self, arg: Incomplete | None = None, distance: Incomplete | None = None, parallels: Incomplete | None = None, rotation: Incomplete | None = None, scale: Incomplete | None = None, tilt: Incomplete | None = None, type: Incomplete | None = None, **kwargs) -> None:
        """
