...
class Mapbox(_BaseLayoutHierarchyType):
    ...
    def __init__(self, arg: Incomplete | None = None, accesstoken: Incomplete | None = None, bearing: Incomplete | None = None, bounds: Incomplete | None = None, center: Incomplete | None = None, domain: Incomplete | None = None, layers: Incomplete | None = None, layerdefaults: Incomplete | None = None, pitch: Incomplete | None = None, style: Incomplete | None = None, uirevision: Incomplete | None = None, zoom: Incomplete | None = None, **kwargs) -> None:
        """
