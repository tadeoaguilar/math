...
class Box(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg: Incomplete | None = None, fillcolor: Incomplete | None = None, line: Incomplete | None = None, visible: Incomplete | None = None, width: Incomplete | None = None, **kwargs) -> None:
        """
