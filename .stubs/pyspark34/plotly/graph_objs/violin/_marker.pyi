...
class Marker(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg: Incomplete | None = None, angle: Incomplete | None = None, color: Incomplete | None = None, line: Incomplete | None = None, opacity: Incomplete | None = None, outliercolor: Incomplete | None = None, size: Incomplete | None = None, symbol: Incomplete | None = None, **kwargs) -> None:
        '''
