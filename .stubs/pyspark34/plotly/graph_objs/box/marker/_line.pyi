...
class Line(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg: Incomplete | None = None, color: Incomplete | None = None, outliercolor: Incomplete | None = None, outlierwidth: Incomplete | None = None, width: Incomplete | None = None, **kwargs) -> None:
        """
