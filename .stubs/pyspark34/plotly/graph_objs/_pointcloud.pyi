...
class Pointcloud(_BaseTraceType):
    ...
    @property
    def type(self): ...
    def __init__(self, arg: Incomplete | None = None, customdata: Incomplete | None = None, customdatasrc: Incomplete | None = None, hoverinfo: Incomplete | None = None, hoverinfosrc: Incomplete | None = None, hoverlabel: Incomplete | None = None, ids: Incomplete | None = None, idssrc: Incomplete | None = None, indices: Incomplete | None = None, indicessrc: Incomplete | None = None, legend: Incomplete | None = None, legendgroup: Incomplete | None = None, legendgrouptitle: Incomplete | None = None, legendrank: Incomplete | None = None, legendwidth: Incomplete | None = None, marker: Incomplete | None = None, meta: Incomplete | None = None, metasrc: Incomplete | None = None, name: Incomplete | None = None, opacity: Incomplete | None = None, showlegend: Incomplete | None = None, stream: Incomplete | None = None, text: Incomplete | None = None, textsrc: Incomplete | None = None, uid: Incomplete | None = None, uirevision: Incomplete | None = None, visible: Incomplete | None = None, x: Incomplete | None = None, xaxis: Incomplete | None = None, xbounds: Incomplete | None = None, xboundssrc: Incomplete | None = None, xsrc: Incomplete | None = None, xy: Incomplete | None = None, xysrc: Incomplete | None = None, y: Incomplete | None = None, yaxis: Incomplete | None = None, ybounds: Incomplete | None = None, yboundssrc: Incomplete | None = None, ysrc: Incomplete | None = None, **kwargs) -> None:
        '''
