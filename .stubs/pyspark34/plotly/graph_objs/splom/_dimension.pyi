...
class Dimension(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg: Incomplete | None = None, axis: Incomplete | None = None, label: Incomplete | None = None, name: Incomplete | None = None, templateitemname: Incomplete | None = None, values: Incomplete | None = None, valuessrc: Incomplete | None = None, visible: Incomplete | None = None, **kwargs) -> None:
        """
