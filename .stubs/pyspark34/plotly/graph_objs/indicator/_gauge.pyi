...
class Gauge(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg: Incomplete | None = None, axis: Incomplete | None = None, bar: Incomplete | None = None, bgcolor: Incomplete | None = None, bordercolor: Incomplete | None = None, borderwidth: Incomplete | None = None, shape: Incomplete | None = None, steps: Incomplete | None = None, stepdefaults: Incomplete | None = None, threshold: Incomplete | None = None, **kwargs) -> None:
        """
