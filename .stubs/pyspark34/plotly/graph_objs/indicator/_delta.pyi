...
class Delta(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg: Incomplete | None = None, decreasing: Incomplete | None = None, font: Incomplete | None = None, increasing: Incomplete | None = None, position: Incomplete | None = None, prefix: Incomplete | None = None, reference: Incomplete | None = None, relative: Incomplete | None = None, suffix: Incomplete | None = None, valueformat: Incomplete | None = None, **kwargs) -> None:
        """
