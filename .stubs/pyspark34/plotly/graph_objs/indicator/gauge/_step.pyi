...
class Step(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg: Incomplete | None = None, color: Incomplete | None = None, line: Incomplete | None = None, name: Incomplete | None = None, range: Incomplete | None = None, templateitemname: Incomplete | None = None, thickness: Incomplete | None = None, **kwargs) -> None:
        """
