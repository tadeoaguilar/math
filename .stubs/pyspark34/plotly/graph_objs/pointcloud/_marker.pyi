...
class Marker(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg: Incomplete | None = None, blend: Incomplete | None = None, border: Incomplete | None = None, color: Incomplete | None = None, opacity: Incomplete | None = None, sizemax: Incomplete | None = None, sizemin: Incomplete | None = None, **kwargs) -> None:
        """
