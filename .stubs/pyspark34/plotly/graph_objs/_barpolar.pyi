...
class Barpolar(_BaseTraceType):
    ...
    @property
    def type(self): ...
    def __init__(self, arg: Incomplete | None = None, base: Incomplete | None = None, basesrc: Incomplete | None = None, customdata: Incomplete | None = None, customdatasrc: Incomplete | None = None, dr: Incomplete | None = None, dtheta: Incomplete | None = None, hoverinfo: Incomplete | None = None, hoverinfosrc: Incomplete | None = None, hoverlabel: Incomplete | None = None, hovertemplate: Incomplete | None = None, hovertemplatesrc: Incomplete | None = None, hovertext: Incomplete | None = None, hovertextsrc: Incomplete | None = None, ids: Incomplete | None = None, idssrc: Incomplete | None = None, legend: Incomplete | None = None, legendgroup: Incomplete | None = None, legendgrouptitle: Incomplete | None = None, legendrank: Incomplete | None = None, legendwidth: Incomplete | None = None, marker: Incomplete | None = None, meta: Incomplete | None = None, metasrc: Incomplete | None = None, name: Incomplete | None = None, offset: Incomplete | None = None, offsetsrc: Incomplete | None = None, opacity: Incomplete | None = None, r: Incomplete | None = None, r0: Incomplete | None = None, rsrc: Incomplete | None = None, selected: Incomplete | None = None, selectedpoints: Incomplete | None = None, showlegend: Incomplete | None = None, stream: Incomplete | None = None, subplot: Incomplete | None = None, text: Incomplete | None = None, textsrc: Incomplete | None = None, theta: Incomplete | None = None, theta0: Incomplete | None = None, thetasrc: Incomplete | None = None, thetaunit: Incomplete | None = None, uid: Incomplete | None = None, uirevision: Incomplete | None = None, unselected: Incomplete | None = None, visible: Incomplete | None = None, width: Incomplete | None = None, widthsrc: Incomplete | None = None, **kwargs) -> None:
        '''
