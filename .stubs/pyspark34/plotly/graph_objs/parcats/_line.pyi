...
class Line(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg: Incomplete | None = None, autocolorscale: Incomplete | None = None, cauto: Incomplete | None = None, cmax: Incomplete | None = None, cmid: Incomplete | None = None, cmin: Incomplete | None = None, color: Incomplete | None = None, coloraxis: Incomplete | None = None, colorbar: Incomplete | None = None, colorscale: Incomplete | None = None, colorsrc: Incomplete | None = None, hovertemplate: Incomplete | None = None, reversescale: Incomplete | None = None, shape: Incomplete | None = None, showscale: Incomplete | None = None, **kwargs) -> None:
        '''
