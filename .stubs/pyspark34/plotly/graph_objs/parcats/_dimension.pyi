...
class Dimension(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg: Incomplete | None = None, categoryarray: Incomplete | None = None, categoryarraysrc: Incomplete | None = None, categoryorder: Incomplete | None = None, displayindex: Incomplete | None = None, label: Incomplete | None = None, ticktext: Incomplete | None = None, ticktextsrc: Incomplete | None = None, values: Incomplete | None = None, valuessrc: Incomplete | None = None, visible: Incomplete | None = None, **kwargs) -> None:
        '''
