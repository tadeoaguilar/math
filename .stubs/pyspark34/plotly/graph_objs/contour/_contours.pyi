...
class Contours(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg: Incomplete | None = None, coloring: Incomplete | None = None, end: Incomplete | None = None, labelfont: Incomplete | None = None, labelformat: Incomplete | None = None, operation: Incomplete | None = None, showlabels: Incomplete | None = None, showlines: Incomplete | None = None, size: Incomplete | None = None, start: Incomplete | None = None, type: Incomplete | None = None, value: Incomplete | None = None, **kwargs) -> None:
        '''
