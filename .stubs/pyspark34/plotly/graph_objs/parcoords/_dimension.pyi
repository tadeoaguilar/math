...
class Dimension(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg: Incomplete | None = None, constraintrange: Incomplete | None = None, label: Incomplete | None = None, multiselect: Incomplete | None = None, name: Incomplete | None = None, range: Incomplete | None = None, templateitemname: Incomplete | None = None, tickformat: Incomplete | None = None, ticktext: Incomplete | None = None, ticktextsrc: Incomplete | None = None, tickvals: Incomplete | None = None, tickvalssrc: Incomplete | None = None, values: Incomplete | None = None, valuessrc: Incomplete | None = None, visible: Incomplete | None = None, **kwargs) -> None:
        '''
