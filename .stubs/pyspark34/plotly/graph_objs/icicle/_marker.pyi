...
class Marker(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg: Incomplete | None = None, autocolorscale: Incomplete | None = None, cauto: Incomplete | None = None, cmax: Incomplete | None = None, cmid: Incomplete | None = None, cmin: Incomplete | None = None, coloraxis: Incomplete | None = None, colorbar: Incomplete | None = None, colors: Incomplete | None = None, colorscale: Incomplete | None = None, colorssrc: Incomplete | None = None, line: Incomplete | None = None, pattern: Incomplete | None = None, reversescale: Incomplete | None = None, showscale: Incomplete | None = None, **kwargs) -> None:
        '''
