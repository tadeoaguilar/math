...
class Splom(_BaseTraceType):
    ...
    @property
    def type(self): ...
    def __init__(self, arg: Incomplete | None = None, customdata: Incomplete | None = None, customdatasrc: Incomplete | None = None, diagonal: Incomplete | None = None, dimensions: Incomplete | None = None, dimensiondefaults: Incomplete | None = None, hoverinfo: Incomplete | None = None, hoverinfosrc: Incomplete | None = None, hoverlabel: Incomplete | None = None, hovertemplate: Incomplete | None = None, hovertemplatesrc: Incomplete | None = None, hovertext: Incomplete | None = None, hovertextsrc: Incomplete | None = None, ids: Incomplete | None = None, idssrc: Incomplete | None = None, legend: Incomplete | None = None, legendgroup: Incomplete | None = None, legendgrouptitle: Incomplete | None = None, legendrank: Incomplete | None = None, legendwidth: Incomplete | None = None, marker: Incomplete | None = None, meta: Incomplete | None = None, metasrc: Incomplete | None = None, name: Incomplete | None = None, opacity: Incomplete | None = None, selected: Incomplete | None = None, selectedpoints: Incomplete | None = None, showlegend: Incomplete | None = None, showlowerhalf: Incomplete | None = None, showupperhalf: Incomplete | None = None, stream: Incomplete | None = None, text: Incomplete | None = None, textsrc: Incomplete | None = None, uid: Incomplete | None = None, uirevision: Incomplete | None = None, unselected: Incomplete | None = None, visible: Incomplete | None = None, xaxes: Incomplete | None = None, xhoverformat: Incomplete | None = None, yaxes: Incomplete | None = None, yhoverformat: Incomplete | None = None, **kwargs) -> None:
        '''
