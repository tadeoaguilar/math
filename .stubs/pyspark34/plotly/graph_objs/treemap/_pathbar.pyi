...
class Pathbar(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg: Incomplete | None = None, edgeshape: Incomplete | None = None, side: Incomplete | None = None, textfont: Incomplete | None = None, thickness: Incomplete | None = None, visible: Incomplete | None = None, **kwargs) -> None:
        """
