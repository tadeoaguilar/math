...
class Tiling(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg: Incomplete | None = None, flip: Incomplete | None = None, packing: Incomplete | None = None, pad: Incomplete | None = None, squarifyratio: Incomplete | None = None, **kwargs) -> None:
        '''
