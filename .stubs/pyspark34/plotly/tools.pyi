...
from plotly.files import PLOTLY_DIR as PLOTLY_DIR

DEFAULT_PLOTLY_COLORS: Incomplete
REQUIRED_GANTT_KEYS: Incomplete
PLOTLY_SCALES: Incomplete
DEFAULT_FILLCOLOR: str
DEFAULT_HISTNORM: str
ALTERNATIVE_HISTNORM: str

def warning_on_one_line(message, category, filename, lineno, file: Incomplete | None = None, line: Incomplete | None = None): ...

ipython_core_display: Incomplete
sage_salvus: Incomplete

def mpl_to_plotly(fig, resize: bool = False, strip_style: bool = False, verbose: bool = False):
    ...
    """
def get_subplots(rows: int = 1, columns: int = 1, print_grid: bool = False, **kwargs):
    ...
    """
def make_subplots(rows: int = 1, cols: int = 1, shared_xaxes: bool = False, shared_yaxes: bool = False, start_cell: str = 'top-left', print_grid: Incomplete | None = None, **kwargs):
    ...
    row_width (kwargs, list of numbers)
        ...
        - For example, if row_width=[3, 1], vertical_spacing=0, and
          ...
          [0. 0.75] and [0.75, 1]
    '''
def get_graph_obj(obj, obj_type: Incomplete | None = None):
...
DIAG_CHOICES: Incomplete
VALID_COLORMAP_TYPES: Incomplete
