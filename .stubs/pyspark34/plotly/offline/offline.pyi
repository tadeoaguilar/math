from ._plotlyjs_version import __plotlyjs_version__ as __plotlyjs_version__
from _typeshed import Incomplete
from plotly import tools as tools
from plotly.optional_imports import get_module as get_module
...
def init_notebook_mode(connected: bool = False) -> None:
    """
    ...
    """
def iplot(figure_or_data, show_link: bool = False, link_text: str = 'Export to plot.ly', validate: bool = True, image: Incomplete | None = None, filename: str = 'plot_image', image_width: int = 800, image_height: int = 600, config: Incomplete | None = None, auto_play: bool = True, animation_opts: Incomplete | None = None) -> None:
    """
    ...
    ```
    """
def plot(figure_or_data, show_link: bool = False, link_text: str = 'Export to plot.ly', validate: bool = True, output_type: str = 'file', include_plotlyjs: bool = True, filename: str = 'temp-plot.html', auto_open: bool = True, image: Incomplete | None = None, image_filename: str = 'plot_image', image_width: int = 800, image_height: int = 600, config: Incomplete | None = None, include_mathjax: bool = False, auto_play: bool = True, animation_opts: Incomplete | None = None):
    ...
    ```
    """
def plot_mpl(mpl_fig, resize: bool = False, strip_style: bool = False, verbose: bool = False, show_link: bool = False, link_text: str = 'Export to plot.ly', validate: bool = True, output_type: str = 'file', include_plotlyjs: bool = True, filename: str = 'temp-plot.html', auto_open: bool = True, image: Incomplete | None = None, image_filename: str = 'plot_image', image_height: int = 600, image_width: int = 800):
    '''
    ...
    ```
    '''
def iplot_mpl(mpl_fig, resize: bool = False, strip_style: bool = False, verbose: bool = False, show_link: bool = False, link_text: str = 'Export to plot.ly', validate: bool = True, image: Incomplete | None = None, image_filename: str = 'plot_image', image_height: int = 600, image_width: int = 800):
    '''
    ...
    ```
    '''
def enable_mpl_offline(resize: bool = False, strip_style: bool = False, verbose: bool = False, show_link: bool = False, link_text: str = 'Export to plot.ly', validate: bool = True):
    '''
