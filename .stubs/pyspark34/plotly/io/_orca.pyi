...
from plotly.files import PLOTLY_DIR as PLOTLY_DIR, ensure_writable_plotly_dir as ensure_writable_plotly_dir
...
psutil: Incomplete
valid_formats: Incomplete
format_conversions: Incomplete

def raise_format_value_error(val) -> None: ...
...
def find_open_port():
    ...
    int
        An open port
    """
def which_py2(cmd, mode=..., path: Incomplete | None = None):
    '''
...
class OrcaConfig:
    ...
    def restore_defaults(self, reset_server: bool = True) -> None:
        """
    ...
    def update(self, d={}, **kwargs) -> None:
        ...
        >>> pio.orca.config.update(timeout=30, default_format='svg'})
        """
    def reload(self, warn: bool = True) -> None:
        """
...
def orca_env() -> Generator[None, None, None]:
    """
...
orca_lock: Incomplete
orca_state: Incomplete
...
def request_image_with_retrying(**kwargs):
    ...
    with retrying logic.
    """
def to_image(fig, format: Incomplete | None = None, width: Incomplete | None = None, height: Incomplete | None = None, scale: Incomplete | None = None, validate: bool = True):
    """
    ...
    bytes
        The image data
    """
def write_image(fig, file, format: Incomplete | None = None, scale: Incomplete | None = None, width: Incomplete | None = None, height: Incomplete | None = None, validate: bool = True) -> None:
    """
