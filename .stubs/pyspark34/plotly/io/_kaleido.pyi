...
def to_image(fig, format: Incomplete | None = None, width: Incomplete | None = None, height: Incomplete | None = None, scale: Incomplete | None = None, validate: bool = True, engine: str = 'auto'):
    '''
    ...
    bytes
        The image data
    '''
def write_image(fig, file, format: Incomplete | None = None, scale: Incomplete | None = None, width: Incomplete | None = None, height: Incomplete | None = None, validate: bool = True, engine: str = 'auto') -> None:
    '''
    ...
    None
    '''
def full_figure_for_development(fig, warn: bool = True, as_dict: bool = False):
    '''
