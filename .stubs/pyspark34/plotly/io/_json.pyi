...
from plotly.io._utils import validate_coerce_fig_to_dict as validate_coerce_fig_to_dict, validate_coerce_output_type as validate_coerce_output_type
...
def coerce_to_strict(const):
    ...
    """
def to_json_plotly(plotly_object, pretty: bool = False, engine: Incomplete | None = None):
    '''
    ...
    '''
def to_json(fig, validate: bool = True, pretty: bool = False, remove_uids: bool = True, engine: Incomplete | None = None):
    '''
    ...
    '''
def write_json(fig, file, validate: bool = True, pretty: bool = False, remove_uids: bool = True, engine: Incomplete | None = None) -> None:
    '''
    ...
    None
    '''
def from_json_plotly(value, engine: Incomplete | None = None):
    '''
    ...
    '''
def from_json(value, output_type: str = 'Figure', skip_invalid: bool = False, engine: Incomplete | None = None):
    '''
    ...
    '''
def read_json(file, output_type: str = 'Figure', skip_invalid: bool = False, engine: Incomplete | None = None):
    '''
