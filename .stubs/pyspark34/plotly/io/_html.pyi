...
from plotly import utils as utils
from plotly.io._utils import plotly_cdn_url as plotly_cdn_url, validate_coerce_fig_to_dict as validate_coerce_fig_to_dict
from plotly.offline.offline import get_plotlyjs as get_plotlyjs

def to_html(fig, config: Incomplete | None = None, auto_play: bool = True, include_plotlyjs: bool = True, include_mathjax: bool = False, post_script: Incomplete | None = None, full_html: bool = True, animation_opts: Incomplete | None = None, default_width: str = '100%', default_height: str = '100%', validate: bool = True, div_id: Incomplete | None = None):
    """
    ...
    """
def write_html(fig, file, config: Incomplete | None = None, auto_play: bool = True, include_plotlyjs: bool = True, include_mathjax: bool = False, post_script: Incomplete | None = None, full_html: bool = True, animation_opts: Incomplete | None = None, validate: bool = True, default_width: str = '100%', default_height: str = '100%', auto_open: bool = False, div_id: Incomplete | None = None) -> None:
    """
