...
class Renderer:
    ...
    def draw_figure(self, fig, props) -> Generator[None, None, None]: ...
    def draw_axes(self, ax, props) -> Generator[None, None, None]: ...
    def draw_legend(self, legend, props) -> Generator[None, None, None]: ...
    ...
    def close_legend(self, legend) -> None:
        ...
        """
    def draw_marked_line(self, data, coordinates, linestyle, markerstyle, label, mplobj: Incomplete | None = None) -> None:
    ...
    def draw_line(self, data, coordinates, style, label, mplobj: Incomplete | None = None) -> None:
        ...
        """
    def draw_path_collection(self, paths, path_coordinates, path_transforms, offsets, offset_coordinates, offset_order, styles, mplobj: Incomplete | None = None) -> None:
        '''
    ...
    def draw_text(self, text, position, coordinates, style, text_type: Incomplete | None = None, mplobj: Incomplete | None = None) -> None:
        ...
        '''
    def draw_path(self, data, coordinates, pathcodes, style, offset: Incomplete | None = None, offset_coordinates: str = 'data', mplobj: Incomplete | None = None) -> None:
        '''
        Draw a path.
        ...
        '''
    def draw_image(self, imdata, extent, coordinates, style, mplobj: Incomplete | None = None) -> None:
        """
        Draw an image.
