...
from plotly.matplotlylib import mpltools as mpltools
from plotly.matplotlylib.mplexporter import Renderer as Renderer

def warning_on_one_line(msg, category, filename, lineno, file: Incomplete | None = None, line: Incomplete | None = None): ...
...
class PlotlyRenderer(Renderer):
    ...
    """
    plotly_fig: Incomplete
    mpl_fig: Incomplete
    current_mpl_ax: Incomplete
    bar_containers: Incomplete
    current_bars: Incomplete
    axis_ct: int
    x_is_mpl_date: bool
    mpl_x_bounds: Incomplete
    mpl_y_bounds: Incomplete
    msg: str
