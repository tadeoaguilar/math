...
from plotly.figure_factory._ohlc import validate_ohlc as validate_ohlc
...
def make_decreasing_candle(open, high, low, close, dates, **kwargs):
    ...
    """
def create_candlestick(open, high, low, close, dates: Incomplete | None = None, direction: str = 'both', **kwargs):
    """
