...
def create_quiver(x, y, u, v, scale: float = 0.1, arrow_scale: float = 0.3, angle=..., scaleratio: Incomplete | None = None, **kwargs):
    """
...
class _Quiver:
    ...
    v: Incomplete
    scale: Incomplete
    scaleratio: Incomplete
    arrow_scale: Incomplete
    angle: Incomplete
    end_x: Incomplete
    end_y: Incomplete
    def __init__(self, x, y, u, v, scale, arrow_scale, angle, scaleratio: int = 1, **kwargs) -> None: ...
