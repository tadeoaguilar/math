...
from plotly.validators.heatmap import ColorscaleValidator as ColorscaleValidator
...
def validate_annotated_heatmap(z, x, y, annotation_text) -> None:
    ...
    :raises: (PlotlyError) If z and text matrices do not  have the same
        dimensions.
    """
def create_annotated_heatmap(z, x: Incomplete | None = None, y: Incomplete | None = None, annotation_text: Incomplete | None = None, colorscale: str = 'Plasma', font_colors: Incomplete | None = None, showscale: bool = False, reversescale: bool = False, **kwargs):
    """
...
class _AnnotatedHeatmap:
    ...
    x: Incomplete
    y: Incomplete
    annotation_text: Incomplete
    colorscale: Incomplete
    reversescale: Incomplete
    font_colors: Incomplete
    zmin: Incomplete
    zmax: Incomplete
    zmid: Incomplete
