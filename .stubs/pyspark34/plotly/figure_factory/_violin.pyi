...
def calc_stats(data):
    ...
    """
def make_half_violin(x, y, fillcolor: str = '#1f77b4', linecolor: str = 'rgb(0, 0, 0)'):
    """
    Produces a sideways probability distribution fig violin plot.
    """
def make_violin_rugplot(vals, pdf_max, distance, color: str = '#1f77b4'):
    """
...
def make_YAxis(yaxis_title):
    ...
    """
def violinplot(vals, fillcolor: str = '#1f77b4', rugplot: bool = True):
    """
...
def violin_dict(data, data_header, group_header, colors, use_colorscale, group_stats, rugplot, sort, height, width, title):
    ...
    """
def create_violin(data, data_header: Incomplete | None = None, group_header: Incomplete | None = None, colors: Incomplete | None = None, use_colorscale: bool = False, group_stats: Incomplete | None = None, rugplot: bool = True, sort: bool = False, height: int = 450, width: int = 600, title: str = 'Violin and Rug Plot'):
    '''
