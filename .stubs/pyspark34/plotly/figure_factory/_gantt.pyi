...
pd: Incomplete
REQUIRED_GANTT_KEYS: Incomplete

def validate_gantt(df):
    """
    Validates the inputted dataframe or list
    """
def gantt(chart, colors, title, bar_width, showgrid_x, showgrid_y, height, width, tasks: Incomplete | None = None, task_names: Incomplete | None = None, data: Incomplete | None = None, group_tasks: bool = False, show_hover_fill: bool = True, show_colorbar: bool = True):
    """
    Refer to create_gantt() for docstring
    """
def gantt_colorscale(chart, colors, title, index_col, show_colorbar, bar_width, showgrid_x, showgrid_y, height, width, tasks: Incomplete | None = None, task_names: Incomplete | None = None, data: Incomplete | None = None, group_tasks: bool = False, show_hover_fill: bool = True):
    """
    Refer to FigureFactory.create_gantt() for docstring
    """
def gantt_dict(chart, colors, title, index_col, show_colorbar, bar_width, showgrid_x, showgrid_y, height, width, tasks: Incomplete | None = None, task_names: Incomplete | None = None, data: Incomplete | None = None, group_tasks: bool = False, show_hover_fill: bool = True):
    """
    Refer to FigureFactory.create_gantt() for docstring
    """
def create_gantt(df, colors: Incomplete | None = None, index_col: Incomplete | None = None, show_colorbar: bool = False, reverse_colors: bool = False, title: str = 'Gantt Chart', bar_width: float = 0.2, showgrid_x: bool = False, showgrid_y: bool = False, height: int = 600, width: Incomplete | None = None, tasks: Incomplete | None = None, task_names: Incomplete | None = None, data: Incomplete | None = None, group_tasks: bool = False, show_hover_fill: bool = True):
    '''
