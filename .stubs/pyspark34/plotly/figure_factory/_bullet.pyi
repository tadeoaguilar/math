...
def create_bullet(data, markers: Incomplete | None = None, measures: Incomplete | None = None, ranges: Incomplete | None = None, subtitles: Incomplete | None = None, titles: Incomplete | None = None, orientation: str = 'h', range_colors=('rgb(200, 200, 200)', 'rgb(245, 245, 245)'), measure_colors=('rgb(31, 119, 180)', 'rgb(176, 196, 221)'), horizontal_spacing: Incomplete | None = None, vertical_spacing: Incomplete | None = None, scatter_options={}, **layout_options):
    '''
