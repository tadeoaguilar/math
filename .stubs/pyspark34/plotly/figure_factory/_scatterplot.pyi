...
def scatterplot_theme(dataframe, headers, diag, size, height, width, title, index, index_vals, endpts, colormap, colormap_type, **kwargs):
    ...
    """
def create_scatterplotmatrix(df, index: Incomplete | None = None, endpts: Incomplete | None = None, diag: str = 'scatter', height: int = 500, width: int = 500, size: int = 6, title: str = 'Scatterplot Matrix', colormap: Incomplete | None = None, colormap_type: str = 'cat', dataframe: Incomplete | None = None, headers: Incomplete | None = None, index_vals: Incomplete | None = None, **kwargs):
    """
