...
def map_face2color(face, colormap, scale, vmin, vmax):
    ...
    """
def trisurf(x, y, z, simplices, show_colorbar, edges_color, scale, colormap: Incomplete | None = None, color_func: Incomplete | None = None, plot_edges: bool = False, x_edge: Incomplete | None = None, y_edge: Incomplete | None = None, z_edge: Incomplete | None = None, facecolor: Incomplete | None = None):
    """
    Refer to FigureFactory.create_trisurf() for docstring
    """
def create_trisurf(x, y, z, simplices, colormap: Incomplete | None = None, show_colorbar: bool = True, scale: Incomplete | None = None, color_func: Incomplete | None = None, title: str = 'Trisurf Plot', plot_edges: bool = True, showbackground: bool = True, backgroundcolor: str = 'rgb(230, 230, 230)', gridcolor: str = 'rgb(255, 255, 255)', zerolinecolor: str = 'rgb(255, 255, 255)', edges_color: str = 'rgb(50, 50, 50)', height: int = 800, width: int = 800, aspectratio: Incomplete | None = None):
    '''
