...
def make_linear_colorscale(colors):
    ...
    """
def create_2d_density(x, y, colorscale: str = 'Earth', ncontours: int = 20, hist_color=(0, 0, 0.5), point_color=(0, 0, 0.5), point_size: int = 2, title: str = '2D Density Plot', height: int = 600, width: int = 600):
    """
