...
from plotly.exceptions import PlotlyError as PlotlyError
from plotly.figure_factory import utils as utils

shapely: Incomplete
shapefile: Incomplete
gp: Incomplete
st_to_state_name_dict: Incomplete
state_to_st_dict: Incomplete
USA_XRANGE: Incomplete
USA_YRANGE: Incomplete

def create_choropleth(fips, values, scope=['usa'], binning_endpoints: Incomplete | None = None, colorscale: Incomplete | None = None, order: Incomplete | None = None, simplify_county: float = 0.02, simplify_state: float = 0.02, asp: Incomplete | None = None, show_hover: bool = True, show_state_data: bool = True, state_outline: Incomplete | None = None, county_outline: Incomplete | None = None, centroid_marker: Incomplete | None = None, round_legend_values: bool = False, exponent_format: bool = False, legend_title: str = '', **layout_options):
    '''
