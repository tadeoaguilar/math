...
np: Incomplete
scipy_interp: Incomplete

def create_ternary_contour(coordinates, values, pole_labels=['a', 'b', 'c'], width: int = 500, height: int = 500, ncontours: Incomplete | None = None, showscale: bool = False, coloring: Incomplete | None = None, colorscale: str = 'Bluered', linecolor: Incomplete | None = None, title: Incomplete | None = None, interp_mode: str = 'ilr', showmarkers: bool = False):
    """
