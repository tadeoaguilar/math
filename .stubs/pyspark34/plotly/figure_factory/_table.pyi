...
def validate_table(table_text, font_colors) -> None:
    ...
    """
def create_table(table_text, colorscale: Incomplete | None = None, font_colors: Incomplete | None = None, index: bool = False, index_title: str = '', annotation_offset: float = 0.45, height_constant: int = 30, hoverinfo: str = 'none', **kwargs):
    """
...
class _Table:
    ...
    """
    table_text: Incomplete
    colorscale: Incomplete
    font_colors: Incomplete
    index: Incomplete
    annotation_offset: Incomplete
    x: Incomplete
    y: Incomplete
