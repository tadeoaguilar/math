...
def make_decreasing_ohlc(open, high, low, close, dates, **kwargs):
    ...
    :rtype (trace) ohlc_decr_data: Scatter trace of all decreasing ohlc
        sticks.
    """
def create_ohlc(open, high, low, close, dates: Incomplete | None = None, direction: str = 'both', **kwargs):
    """
...
class _OHLC:
    ...
    all_x: Incomplete
    all_y: Incomplete
    increase_x: Incomplete
    increase_y: Incomplete
    decrease_x: Incomplete
    decrease_y: Incomplete
