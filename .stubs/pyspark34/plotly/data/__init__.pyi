...
def gapminder(datetimes: bool = False, centroids: bool = False, year: Incomplete | None = None, pretty_names: bool = False):
    """
    ...
    """
def tips(pretty_names: bool = False):
    """
...
def stocks(indexed: bool = False, datetimes: bool = False):
    """
    ...
    Returns:
        ...
        is named 'company'"""
def experiment(indexed: bool = False):
    '''
...
def medals_wide(indexed: bool = False):
    """
    ...
    Returns:
        ...
        is named 'medal'"""
def medals_long(indexed: bool = False):
    """
    This dataset represents the medal table for Olympic Short Track Speed Skating for the
    top three nations as of 2020.
