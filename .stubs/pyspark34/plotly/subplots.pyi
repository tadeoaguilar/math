...
from ._subplots import SubplotDomain as SubplotDomain, SubplotRef as SubplotRef, SubplotXY as SubplotXY
from _typeshed import Incomplete

def make_subplots(rows: int = 1, cols: int = 1, shared_xaxes: bool = False, shared_yaxes: bool = False, start_cell: str = 'top-left', print_grid: bool = False, horizontal_spacing: Incomplete | None = None, vertical_spacing: Incomplete | None = None, subplot_titles: Incomplete | None = None, column_widths: Incomplete | None = None, row_heights: Incomplete | None = None, specs: Incomplete | None = None, insets: Incomplete | None = None, column_titles: Incomplete | None = None, row_titles: Incomplete | None = None, x_title: Incomplete | None = None, y_title: Incomplete | None = None, figure: Incomplete | None = None, **kwargs) -> go.Figure:
    '''
