...
from ._core import apply_default_cascade as apply_default_cascade, configure_animation_controls as configure_animation_controls, init_figure as init_figure
from .imshow_utils import rescale_intensity as rescale_intensity
from _typeshed import Incomplete
from plotly.utils import image_array_to_data_uri as image_array_to_data_uri

xarray_imported: bool

def imshow(img, zmin: Incomplete | None = None, zmax: Incomplete | None = None, origin: Incomplete | None = None, labels={}, x: Incomplete | None = None, y: Incomplete | None = None, animation_frame: Incomplete | None = None, facet_col: Incomplete | None = None, facet_col_wrap: Incomplete | None = None, facet_col_spacing: Incomplete | None = None, facet_row_spacing: Incomplete | None = None, color_continuous_scale: Incomplete | None = None, color_continuous_midpoint: Incomplete | None = None, range_color: Incomplete | None = None, title: Incomplete | None = None, template: Incomplete | None = None, width: Incomplete | None = None, height: Incomplete | None = None, aspect: Incomplete | None = None, contrast_rescaling: Incomplete | None = None, binary_string: Incomplete | None = None, binary_backend: str = 'auto', binary_compression_level: int = 4, binary_format: str = 'png', text_auto: bool = False) -> go.Figure:
    """
