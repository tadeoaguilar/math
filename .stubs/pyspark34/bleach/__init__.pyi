...
def clean(text, tags=..., attributes=..., protocols=..., strip: bool = False, strip_comments: bool = True, css_sanitizer: Incomplete | None = None):
    ...
    '''
def linkify(text, callbacks=..., skip_tags: Incomplete | None = None, parse_email: bool = False):
