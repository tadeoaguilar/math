...
class ServerInterface:
    ...
    def check_auth_interactive_response(self, responses):
        ...
        :rtype: int or `.InteractiveQuery`
        '''
    def check_auth_gssapi_with_mic(self, username, gss_authenticated=..., cc_file: Incomplete | None = None):
        """
        ...
        """
    def check_auth_gssapi_keyex(self, username, gss_authenticated=..., cc_file: Incomplete | None = None):
        """
        Authenticate the given user to the server if he is a valid krb5
    ...
    def check_port_forward_request(self, address, port):
        ...
        :return:
            ...
            to reject
        '''
    def cancel_port_forward_request(self, address, port) -> None:
        """
...
class InteractiveQuery:
    ...
    prompts: Incomplete
    def __init__(self, name: str = '', instructions: str = '', *prompts) -> None:
        """
        ...
        """
    def add_prompt(self, prompt, echo: bool = True) -> None:
        """
...
class SubsystemHandler(threading.Thread):
    ...
    '''
    def __init__(self, channel, name, server) -> None:
        """
