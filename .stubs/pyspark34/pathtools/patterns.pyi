...
def match_path_against(pathname, patterns, case_sensitive: bool = True):
    '''
    ...
    Doctests::
        ...
        True
    '''
def match_path(pathname, included_patterns: Incomplete | None = None, excluded_patterns: Incomplete | None = None, case_sensitive: bool = True):
    '''
    ...
    '''
def filter_paths(pathnames, included_patterns: Incomplete | None = None, excluded_patterns: Incomplete | None = None, case_sensitive: bool = True) -> Generator[Incomplete, None, None]:
    '''
    ...
    Doctests::
        ...
        True
    '''
def match_any_paths(pathnames, included_patterns: Incomplete | None = None, excluded_patterns: Incomplete | None = None, case_sensitive: bool = True):
    '''
