...
def model_to_estimator(keras_model: Incomplete | None = None, keras_model_path: Incomplete | None = None, custom_objects: Incomplete | None = None, model_dir: Incomplete | None = None, config: Incomplete | None = None, checkpoint_format: Incomplete | None = None, use_v2_estimator: bool = False, metric_names_map: Incomplete | None = None, export_outputs: Incomplete | None = None):
