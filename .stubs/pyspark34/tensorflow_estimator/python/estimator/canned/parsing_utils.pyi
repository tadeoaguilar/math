...
def classifier_parse_example_spec_v2(feature_columns, label_key, label_dtype=..., label_default: Incomplete | None = None, weight_column: Incomplete | None = None):
  ...
  * It is difficult to map expected label by a classifier such as
  ...
  '''
def regressor_parse_example_spec_v2(feature_columns, label_key, label_dtype=..., label_default: Incomplete | None = None, label_dimension: int = 1, weight_column: Incomplete | None = None):
  ...
  * It is difficult to map expected label by a regressor such as `DNNRegressor`
  ...
  Raises:
    ...
    ValueError: if label_key is None.
  '''
def classifier_parse_example_spec(feature_columns, label_key, label_dtype=..., label_default: Incomplete | None = None, weight_column: Incomplete | None = None): ...
def regressor_parse_example_spec(feature_columns, label_key, label_dtype=..., label_default: Incomplete | None = None, label_dimension: int = 1, weight_column: Incomplete | None = None): ...
