...
def predict_continuation(continue_from, signatures, session, steps: Incomplete | None = None, times: Incomplete | None = None, exogenous_features: Incomplete | None = None):
