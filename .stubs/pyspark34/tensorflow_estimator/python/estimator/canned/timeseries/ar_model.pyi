...
from tensorflow_estimator.python.estimator.canned.timeseries import model as model, model_utils as model_utils
from tensorflow_estimator.python.estimator.canned.timeseries.feature_keys import PredictionFeatures as PredictionFeatures, TrainEvalFeatures as TrainEvalFeatures
...
class LSTMPredictionModel(tf.keras.models.Model):
  ...
  """
    def __init__(self, num_features, input_window_size, output_window_size, num_units: int = 128) -> None:
...
class ARModel(model.TimeSeriesModel):
  ...
  """
    ...
    input_window_size: Incomplete
    output_window_size: Incomplete
    window_size: Incomplete
    loss: Incomplete
    exogenous_size: Incomplete
    def __init__(self, periodicities, input_window_size, output_window_size, num_features, prediction_model_factory=..., num_time_buckets: int = 10, loss=..., exogenous_feature_columns: Incomplete | None = None) -> None:
    ...
    def random_model_parameters(self, seed: Incomplete | None = None) -> None: ...
