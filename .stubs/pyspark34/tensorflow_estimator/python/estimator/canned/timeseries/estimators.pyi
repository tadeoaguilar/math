...
from tensorflow_estimator.python.estimator.canned.timeseries import ar_model as ar_model, feature_keys as feature_keys, math_utils as math_utils, state_management as state_management
...
class TimeSeriesRegressor(estimator_lib.Estimator):
    ...
    def __init__(self, model, state_manager: Incomplete | None = None, optimizer: Incomplete | None = None, model_dir: Incomplete | None = None, config: Incomplete | None = None, head_type=...) -> None:
    ...
    """
    def build_one_shot_parsing_serving_input_receiver_fn(self, filtering_length, prediction_length, default_batch_size: Incomplete | None = None, values_input_dtype: Incomplete | None = None, truncate_values: bool = False):
    ...
    Returns:
      ...
      features with the following shapes:
        ...
        all exogenous features: [filtering_length + prediction_length, ...]
          (various dtypes)
    """
    def build_raw_serving_input_receiver_fn(self, default_batch_size: Incomplete | None = None, default_series_length: Incomplete | None = None):
...
class LSTMAutoRegressor(TimeSeriesRegressor):
  ...
  ```
  '''
    def __init__(self, periodicities, input_window_size, output_window_size, model_dir: Incomplete | None = None, num_features: int = 1, extra_feature_columns: Incomplete | None = None, num_timesteps: int = 10, loss=..., num_units: int = 128, optimizer: str = 'Adam', config: Incomplete | None = None) -> None:
        """Initialize the Estimator.
