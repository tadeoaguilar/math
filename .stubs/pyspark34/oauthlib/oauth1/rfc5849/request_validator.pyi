from . import SIGNATURE_METHODS as SIGNATURE_METHODS, utils as utils
...
class RequestValidator:
    ...
    * @dummy_access_token
    ...
    def validate_access_token(self, client_key, token, request) -> None:
        ...
        * ResourceEndpoint
        """
    def validate_timestamp_and_nonce(self, client_key, timestamp, nonce, request, request_token: Incomplete | None = None, access_token: Incomplete | None = None) -> None:
    ...
    def validate_requested_realms(self, client_key, realms, request) -> None:
        ...
        * RequestTokenEndpoint
        """
    def validate_realms(self, client_key, token, request, uri: Incomplete | None = None, realms: Incomplete | None = None) -> None:
