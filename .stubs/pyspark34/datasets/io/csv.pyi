...
from ..packaged_modules.csv.csv import Csv as Csv
...
class CsvDatasetWriter:
    ...
    num_proc: Incomplete
    encoding: str
    to_csv_kwargs: Incomplete
    def __init__(self, dataset: Dataset, path_or_buf: PathLike | BinaryIO, batch_size: int | None = None, num_proc: int | None = None, **to_csv_kwargs) -> None: ...
    def write(self) -> int: ...
