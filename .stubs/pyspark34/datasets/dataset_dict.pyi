...
class DatasetDict(dict):
    ...
    def flatten_indices(self, keep_in_memory: bool = False, cache_file_names: Dict[str, str | None] | None = None, writer_batch_size: int | None = 1000, features: Features | None = None, disable_nullable: bool = False, num_proc: int | None = None, new_fingerprint: str | None = None) -> DatasetDict:
        ...
        """
    def sort(self, column_names: str | Sequence[str], reverse: bool | Sequence[bool] = False, kind: str = 'deprecated', null_placement: str = 'at_end', keep_in_memory: bool = False, load_from_cache_file: bool | None = None, indices_cache_file_names: Dict[str, str | None] | None = None, writer_batch_size: int | None = 1000) -> DatasetDict:
    ...
    def shuffle(self, seeds: int | Dict[str, int | None] | None = None, seed: int | None = None, generators: Dict[str, np.random.Generator] | None = None, keep_in_memory: bool = False, load_from_cache_file: bool | None = None, indices_cache_file_names: Dict[str, str | None] | None = None, writer_batch_size: int | None = 1000) -> DatasetDict:
        ...
        ```
        '''
    def save_to_disk(self, dataset_dict_path: PathLike, fs: str = 'deprecated', max_shard_size: str | int | None = None, num_shards: Dict[str, int] | None = None, num_proc: int | None = None, storage_options: dict | None = None):
        '''
        ...
        '''
    @staticmethod
    def load_from_disk(dataset_dict_path: PathLike, fs: str = 'deprecated', keep_in_memory: bool | None = None, storage_options: dict | None = None) -> DatasetDict:
        '''
    ...
    def from_text(path_or_paths: Dict[str, PathLike], features: Features | None = None, cache_dir: str = None, keep_in_memory: bool = False, **kwargs) -> DatasetDict:
        ...
        ```
        '''
    def prepare_for_task(self, task: str | TaskTemplate, id: int = 0) -> DatasetDict: ...
    def align_labels_with_mapping(self, label2id: Dict, label_column: str) -> DatasetDict: ...
    def push_to_hub(self, repo_id, config_name: str = 'default', private: bool | None = False, token: str | None = None, branch: None | None = None, max_shard_size: int | str | None = None, num_shards: Dict[str, int] | None = None, embed_external_files: bool = True):
...
class IterableDatasetDict(dict):
    def with_format(self, type: str | None = None) -> IterableDatasetDict:
        ...
        ```
        '''
    def map(self, function: Callable | None = None, with_indices: bool = False, input_columns: str | List[str] | None = None, batched: bool = False, batch_size: int = 1000, drop_last_batch: bool = False, remove_columns: str | List[str] | None = None, fn_kwargs: dict | None = None) -> IterableDatasetDict:
        '''
    ...
    def filter(self, function: Callable | None = None, with_indices: bool = False, input_columns: str | List[str] | None = None, batched: bool = False, batch_size: int | None = 1000, fn_kwargs: dict | None = None) -> IterableDatasetDict:
        ...
        ```
        '''
    def shuffle(self, seed: Incomplete | None = None, generator: np.random.Generator | None = None, buffer_size: int = 1000) -> IterableDatasetDict:
        '''
