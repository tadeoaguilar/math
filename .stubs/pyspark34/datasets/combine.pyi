...
def interleave_datasets(datasets: List[DatasetType], probabilities: List[float] | None = None, seed: int | None = None, info: DatasetInfo | None = None, split: NamedSplit | None = None, stopping_strategy: Literal['first_exhausted', 'all_exhausted'] = 'first_exhausted') -> DatasetType:
    '''
