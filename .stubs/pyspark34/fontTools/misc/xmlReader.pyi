...
class XMLReader:
    ...
    stackSize: int
    def __init__(self, fileOrPath, ttFont, progress: Incomplete | None = None, quiet: Incomplete | None = None, contentOnly: bool = False) -> None: ...
    def read(self, rootless: bool = False) -> None: ...
    def close(self) -> None: ...

class ProgressPrinter:
    def __init__(self, title, maxval: int = 100) -> None: ...
    def set(self, val, maxval: Incomplete | None = None) -> None: ...
