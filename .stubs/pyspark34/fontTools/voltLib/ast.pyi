...
class GlyphDefinition(Statement):
    ...
    def __init__(self, name, gid, gunicode, gtype, components, location: Incomplete | None = None) -> None: ...

class GroupDefinition(Statement):
    name: Incomplete
    enum: Incomplete
    glyphs_: Incomplete
    def __init__(self, name, enum, location: Incomplete | None = None) -> None: ...
    def glyphSet(self, groups: Incomplete | None = None): ...
...
class Enum(Expression):
    """An enum"""
    enum: Incomplete
    def __init__(self, enum, location: Incomplete | None = None) -> None: ...
    def __iter__(self): ...
    def glyphSet(self, groups: Incomplete | None = None): ...
...
class GroupName(Expression):
    ...
    group: Incomplete
    parser_: Incomplete
    def __init__(self, group, parser, location: Incomplete | None = None) -> None: ...
    glyphs_: Incomplete
    def glyphSet(self, groups: Incomplete | None = None): ...
...
class Range(Expression):
    ...
    parser: Incomplete
    def __init__(self, start, end, parser, location: Incomplete | None = None) -> None: ...
    def glyphSet(self): ...
...
class ScriptDefinition(Statement):
    ...
    tag: Incomplete
    langs: Incomplete
    def __init__(self, name, tag, langs, location: Incomplete | None = None) -> None: ...

class LangSysDefinition(Statement):
    name: Incomplete
    tag: Incomplete
    features: Incomplete
    def __init__(self, name, tag, features, location: Incomplete | None = None) -> None: ...

class FeatureDefinition(Statement):
    name: Incomplete
    tag: Incomplete
    lookups: Incomplete
    def __init__(self, name, tag, lookups, location: Incomplete | None = None) -> None: ...
...
class LookupDefinition(Statement):
    ...
    sub: Incomplete
    pos: Incomplete
    def __init__(self, name, process_base, process_marks, mark_glyph_set, direction, reversal, comments, context, sub, pos, location: Incomplete | None = None) -> None: ...

class SubstitutionDefinition(Statement):
    mapping: Incomplete
    def __init__(self, mapping, location: Incomplete | None = None) -> None: ...
...
class PositionAttachDefinition(Statement):
    ...
    def __init__(self, coverage, coverage_to, location: Incomplete | None = None) -> None: ...

class PositionAttachCursiveDefinition(Statement):
    coverages_exit: Incomplete
    coverages_enter: Incomplete
    def __init__(self, coverages_exit, coverages_enter, location: Incomplete | None = None) -> None: ...

class PositionAdjustPairDefinition(Statement):
    coverages_1: Incomplete
    coverages_2: Incomplete
    adjust_pair: Incomplete
    def __init__(self, coverages_1, coverages_2, adjust_pair, location: Incomplete | None = None) -> None: ...

class PositionAdjustSingleDefinition(Statement):
    adjust_single: Incomplete
    def __init__(self, adjust_single, location: Incomplete | None = None) -> None: ...

class ContextDefinition(Statement):
    ex_or_in: Incomplete
    left: Incomplete
    right: Incomplete
    def __init__(self, ex_or_in, left: Incomplete | None = None, right: Incomplete | None = None, location: Incomplete | None = None) -> None: ...
...
class AnchorDefinition(Statement):
    ...
    locked: Incomplete
    pos: Incomplete
    def __init__(self, name, gid, glyph_name, component, locked, pos, location: Incomplete | None = None) -> None: ...
