...
class WebSocket:
    ...
    '''
    sock_opt: Incomplete
    handshake_response: Incomplete
    sock: Incomplete
    connected: bool
    get_mask_key: Incomplete
    frame_buffer: Incomplete
    cont_frame: Incomplete
    lock: Incomplete
    readlock: Incomplete
    def __init__(self, get_mask_key: Incomplete | None = None, sockopt: Incomplete | None = None, sslopt: Incomplete | None = None, fire_cont_frame: bool = False, enable_multithread: bool = True, skip_utf8_validation: bool = False, **_) -> None:
        """
    ...
    def connect(self, url, **options) -> None:
        ...
        '''
    def send(self, payload: bytes | str, opcode: int = ...) -> int:
        """
    ...
    def recv_frame(self):
        ...
        """
    def send_close(self, status: int = ..., reason: bytes = b''):
        """
        ...
        """
    def close(self, status: int = ..., reason: bytes = b'', timeout: float = 3):
        """
...
def create_connection(url: str, timeout: Incomplete | None = None, class_=..., **options):
    '''
