...
def choose_colorbrewer_palette(data_type, as_cmap: bool = False):
    ...
    """
def choose_dark_palette(input: str = 'husl', as_cmap: bool = False):
    ...
    """
def choose_light_palette(input: str = 'husl', as_cmap: bool = False):
    ...
    """
def choose_diverging_palette(as_cmap: bool = False):
    ...
    """
def choose_cubehelix_palette(as_cmap: bool = False):
