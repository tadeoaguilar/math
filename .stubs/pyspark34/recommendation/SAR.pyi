...
class SAR(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaEstimator):
    ...
    userCol: Incomplete
    def __init__(self, java_obj: Incomplete | None = None, activityTimeFormat: str = "yyyy/MM/dd'T'h:mm:ss", alpha: float = 1.0, blockSize: int = 4096, checkpointInterval: int = 10, coldStartStrategy: str = 'nan', finalStorageLevel: str = 'MEMORY_AND_DISK', implicitPrefs: bool = False, intermediateStorageLevel: str = 'MEMORY_AND_DISK', itemCol: str = 'item', maxIter: int = 10, nonnegative: bool = False, numItemBlocks: int = 10, numUserBlocks: int = 10, predictionCol: str = 'prediction', rank: int = 10, ratingCol: str = 'rating', regParam: float = 0.1, seed: int = 356704333, similarityFunction: str = 'jaccard', startTime: Incomplete | None = None, startTimeFormat: str = 'EEE MMM dd HH:mm:ss Z yyyy', supportThreshold: int = 4, timeCol: str = 'time', timeDecayCoeff: int = 30, userCol: str = 'user') -> None: ...
    def setParams(self, activityTimeFormat: str = "yyyy/MM/dd'T'h:mm:ss", alpha: float = 1.0, blockSize: int = 4096, checkpointInterval: int = 10, coldStartStrategy: str = 'nan', finalStorageLevel: str = 'MEMORY_AND_DISK', implicitPrefs: bool = False, intermediateStorageLevel: str = 'MEMORY_AND_DISK', itemCol: str = 'item', maxIter: int = 10, nonnegative: bool = False, numItemBlocks: int = 10, numUserBlocks: int = 10, predictionCol: str = 'prediction', rank: int = 10, ratingCol: str = 'rating', regParam: float = 0.1, seed: int = 356704333, similarityFunction: str = 'jaccard', startTime: Incomplete | None = None, startTimeFormat: str = 'EEE MMM dd HH:mm:ss Z yyyy', supportThreshold: int = 4, timeCol: str = 'time', timeDecayCoeff: int = 30, userCol: str = 'user'):
        """
