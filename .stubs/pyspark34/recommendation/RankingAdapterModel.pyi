...
class RankingAdapterModel(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaModel):
    """
    Args:
    ...
    recommenderModel: Incomplete
    userCol: Incomplete
    def __init__(self, java_obj: Incomplete | None = None, itemCol: Incomplete | None = None, k: int = 10, labelCol: str = 'label', minRatingsPerItem: int = 1, minRatingsPerUser: int = 1, mode: str = 'allUsers', ratingCol: Incomplete | None = None, recommender: Incomplete | None = None, recommenderModel: Incomplete | None = None, userCol: Incomplete | None = None) -> None: ...
    def setParams(self, itemCol: Incomplete | None = None, k: int = 10, labelCol: str = 'label', minRatingsPerItem: int = 1, minRatingsPerUser: int = 1, mode: str = 'allUsers', ratingCol: Incomplete | None = None, recommender: Incomplete | None = None, recommenderModel: Incomplete | None = None, userCol: Incomplete | None = None):
        """
