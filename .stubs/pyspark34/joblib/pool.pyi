...
from ._multiprocessing_helpers import assert_spawning as assert_spawning, mp as mp
from _typeshed import Incomplete
from multiprocessing.pool import Pool
from pickle import Pickler

WindowsError: Incomplete
...
class CustomizablePickler(Pickler):
    ...
    def __init__(self, writer, reducers: Incomplete | None = None, protocol=...) -> None: ...
...
class CustomizablePicklingQueue:
    ...
    """
    def __init__(self, context, reducers: Incomplete | None = None) -> None: ...
    def empty(self): ...
...
class PicklingPool(Pool):
    ...
    """
    def __init__(self, processes: Incomplete | None = None, forward_reducers: Incomplete | None = None, backward_reducers: Incomplete | None = None, **kwargs) -> None: ...
...
class MemmappingPool(PicklingPool):
    ...
    '''
    def __init__(self, processes: Incomplete | None = None, temp_folder: Incomplete | None = None, max_nbytes: float = 1000000.0, mmap_mode: str = 'r', forward_reducers: Incomplete | None = None, backward_reducers: Incomplete | None = None, verbose: int = 0, context_id: Incomplete | None = None, prewarm: bool = False, **kwargs) -> None: ...
