...
class NumpyArrayWrapper:
    ...
    * writing the array bytes to a file.
    ...
    numpy_array_alignment_bytes: Incomplete
    def __init__(self, subclass, shape, order, dtype, allow_mmap: bool = False, numpy_array_alignment_bytes=...) -> None:
...
class NumpyPickler(Pickler):
    ...
    * optional compression with a special care on avoiding memory copies.
    ...
    buffered: Incomplete
    np: Incomplete
    def __init__(self, fp, protocol: Incomplete | None = None) -> None: ...
    def save(self, obj):
...
def dump(value, filename, compress: int = 0, protocol: Incomplete | None = None, cache_size: Incomplete | None = None):
...
def load(filename, mmap_mode: Incomplete | None = None):
