...
SYSTEM_SHARED_MEM_FS_MIN_SIZE: Incomplete
FOLDER_PERMISSIONS: Incomplete
FILE_PERMISSIONS: Incomplete
JOBLIB_MMAPS: Incomplete
...
class ArrayMemmapForwardReducer:
    ...
    """
    verbose: Incomplete
    def __init__(self, max_nbytes, temp_folder_resolver, mmap_mode, unlink_on_gc_collect, verbose: int = 0, prewarm: bool = True) -> None: ...
    def __reduce__(self): ...
    def __call__(self, a): ...

def get_memmapping_reducers(forward_reducers: Incomplete | None = None, backward_reducers: Incomplete | None = None, temp_folder_resolver: Incomplete | None = None, max_nbytes: float = 1000000.0, mmap_mode: str = 'r', verbose: int = 0, prewarm: bool = False, unlink_on_gc_collect: bool = True, **kwargs):
...
class TemporaryResourcesManager:
    ...
    - a temporary file/folder management API that internally uses the
      resource_tracker.
    """
    def __init__(self, temp_folder_root: Incomplete | None = None, context_id: Incomplete | None = None) -> None: ...
