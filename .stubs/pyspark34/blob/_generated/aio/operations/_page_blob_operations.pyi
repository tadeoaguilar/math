...
from ...operations._page_blob_operations import build_clear_pages_request as build_clear_pages_request, build_copy_incremental_request as build_copy_incremental_request, build_create_request as build_create_request, build_get_page_ranges_diff_request as build_get_page_ranges_diff_request, build_get_page_ranges_request as build_get_page_ranges_request, build_resize_request as build_resize_request, build_update_sequence_number_request as build_update_sequence_number_request, build_upload_pages_from_url_request as build_upload_pages_from_url_request, build_upload_pages_request as build_upload_pages_request
...
class PageBlobOperations:
    ...
    async def create(self, content_length: int, blob_content_length: int, timeout: int | None = None, tier: str | _models.PremiumPageBlobAccessTier | None = None, metadata: Dict[str, str] | None = None, blob_sequence_number: int = 0, request_id_parameter: str | None = None, blob_tags_string: str | None = None, immutability_policy_expiry: datetime.datetime | None = None, immutability_policy_mode: str | _models.BlobImmutabilityPolicyMode | None = None, legal_hold: bool | None = None, blob_http_headers: _models.BlobHTTPHeaders | None = None, lease_access_conditions: _models.LeaseAccessConditions | None = None, cpk_info: _models.CpkInfo | None = None, cpk_scope_info: _models.CpkScopeInfo | None = None, modified_access_conditions: _models.ModifiedAccessConditions | None = None, **kwargs: Any) -> None:
        ...
        '''
    async def upload_pages(self, content_length: int, body: IO, transactional_content_md5: bytes | None = None, transactional_content_crc64: bytes | None = None, timeout: int | None = None, range: str | None = None, request_id_parameter: str | None = None, lease_access_conditions: _models.LeaseAccessConditions | None = None, cpk_info: _models.CpkInfo | None = None, cpk_scope_info: _models.CpkScopeInfo | None = None, sequence_number_access_conditions: _models.SequenceNumberAccessConditions | None = None, modified_access_conditions: _models.ModifiedAccessConditions | None = None, **kwargs: Any) -> None:
    ...
    async def upload_pages_from_url(self, source_url: str, source_range: str, content_length: int, range: str, source_content_md5: bytes | None = None, source_contentcrc64: bytes | None = None, timeout: int | None = None, request_id_parameter: str | None = None, copy_source_authorization: str | None = None, cpk_info: _models.CpkInfo | None = None, cpk_scope_info: _models.CpkScopeInfo | None = None, lease_access_conditions: _models.LeaseAccessConditions | None = None, sequence_number_access_conditions: _models.SequenceNumberAccessConditions | None = None, modified_access_conditions: _models.ModifiedAccessConditions | None = None, source_modified_access_conditions: _models.SourceModifiedAccessConditions | None = None, **kwargs: Any) -> None:
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        '''
    async def get_page_ranges(self, snapshot: str | None = None, timeout: int | None = None, range: str | None = None, request_id_parameter: str | None = None, marker: str | None = None, maxresults: int | None = None, lease_access_conditions: _models.LeaseAccessConditions | None = None, modified_access_conditions: _models.ModifiedAccessConditions | None = None, **kwargs: Any) -> _models.PageList:
    ...
    async def get_page_ranges_diff(self, snapshot: str | None = None, timeout: int | None = None, prevsnapshot: str | None = None, prev_snapshot_url: str | None = None, range: str | None = None, request_id_parameter: str | None = None, marker: str | None = None, maxresults: int | None = None, lease_access_conditions: _models.LeaseAccessConditions | None = None, modified_access_conditions: _models.ModifiedAccessConditions | None = None, **kwargs: Any) -> _models.PageList:
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        '''
    async def resize(self, blob_content_length: int, timeout: int | None = None, request_id_parameter: str | None = None, lease_access_conditions: _models.LeaseAccessConditions | None = None, cpk_info: _models.CpkInfo | None = None, cpk_scope_info: _models.CpkScopeInfo | None = None, modified_access_conditions: _models.ModifiedAccessConditions | None = None, **kwargs: Any) -> None:
        '''Resize the Blob.
    ...
    async def update_sequence_number(self, sequence_number_action: str | _models.SequenceNumberActionType, timeout: int | None = None, blob_sequence_number: int = 0, request_id_parameter: str | None = None, lease_access_conditions: _models.LeaseAccessConditions | None = None, modified_access_conditions: _models.ModifiedAccessConditions | None = None, **kwargs: Any) -> None:
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        '''
    async def copy_incremental(self, copy_source: str, timeout: int | None = None, request_id_parameter: str | None = None, modified_access_conditions: _models.ModifiedAccessConditions | None = None, **kwargs: Any) -> None:
