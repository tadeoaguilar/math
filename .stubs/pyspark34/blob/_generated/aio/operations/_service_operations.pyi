...
from ...operations._service_operations import build_filter_blobs_request as build_filter_blobs_request, build_get_account_info_request as build_get_account_info_request, build_get_properties_request as build_get_properties_request, build_get_statistics_request as build_get_statistics_request, build_get_user_delegation_key_request as build_get_user_delegation_key_request, build_list_containers_segment_request as build_list_containers_segment_request, build_set_properties_request as build_set_properties_request, build_submit_batch_request as build_submit_batch_request
...
class ServiceOperations:
    ...
    async def set_properties(self, storage_service_properties: _models.StorageServiceProperties, timeout: int | None = None, request_id_parameter: str | None = None, **kwargs: Any) -> None:
        ...
        '''
    async def get_properties(self, timeout: int | None = None, request_id_parameter: str | None = None, **kwargs: Any) -> _models.StorageServiceProperties:
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        '''
    async def get_statistics(self, timeout: int | None = None, request_id_parameter: str | None = None, **kwargs: Any) -> _models.StorageServiceStats:
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        '''
    async def list_containers_segment(self, prefix: str | None = None, marker: str | None = None, maxresults: int | None = None, include: List[str | _models.ListContainersIncludeType] | None = None, timeout: int | None = None, request_id_parameter: str | None = None, **kwargs: Any) -> _models.ListContainersSegmentResponse:
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        '''
    async def get_user_delegation_key(self, key_info: _models.KeyInfo, timeout: int | None = None, request_id_parameter: str | None = None, **kwargs: Any) -> _models.UserDelegationKey:
