...
from ...operations._container_operations import build_acquire_lease_request as build_acquire_lease_request, build_break_lease_request as build_break_lease_request, build_change_lease_request as build_change_lease_request, build_create_request as build_create_request, build_delete_request as build_delete_request, build_filter_blobs_request as build_filter_blobs_request, build_get_access_policy_request as build_get_access_policy_request, build_get_account_info_request as build_get_account_info_request, build_get_properties_request as build_get_properties_request, build_list_blob_flat_segment_request as build_list_blob_flat_segment_request, build_list_blob_hierarchy_segment_request as build_list_blob_hierarchy_segment_request, build_release_lease_request as build_release_lease_request, build_rename_request as build_rename_request, build_renew_lease_request as build_renew_lease_request, build_restore_request as build_restore_request, build_set_access_policy_request as build_set_access_policy_request, build_set_metadata_request as build_set_metadata_request, build_submit_batch_request as build_submit_batch_request
from _typeshed import Incomplete
from azure.core.pipeline import PipelineResponse
from azure.core.pipeline.transport import AsyncHttpResponse
from azure.core.rest import HttpRequest
from typing import Any, AsyncIterator, Callable, Dict, IO, List, TypeVar
...
class ContainerOperations:
    ...
    async def create(self, timeout: int | None = None, metadata: Dict[str, str] | None = None, access: str | _models.PublicAccessType | None = None, request_id_parameter: str | None = None, container_cpk_scope_info: _models.ContainerCpkScopeInfo | None = None, **kwargs: Any) -> None:
        ...
        '''
    async def get_properties(self, timeout: int | None = None, request_id_parameter: str | None = None, lease_access_conditions: _models.LeaseAccessConditions | None = None, **kwargs: Any) -> None:
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        '''
    async def delete(self, timeout: int | None = None, request_id_parameter: str | None = None, lease_access_conditions: _models.LeaseAccessConditions | None = None, modified_access_conditions: _models.ModifiedAccessConditions | None = None, **kwargs: Any) -> None:
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        '''
    async def set_metadata(self, timeout: int | None = None, metadata: Dict[str, str] | None = None, request_id_parameter: str | None = None, lease_access_conditions: _models.LeaseAccessConditions | None = None, modified_access_conditions: _models.ModifiedAccessConditions | None = None, **kwargs: Any) -> None:
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        '''
    async def get_access_policy(self, timeout: int | None = None, request_id_parameter: str | None = None, lease_access_conditions: _models.LeaseAccessConditions | None = None, **kwargs: Any) -> List[_models.SignedIdentifier]:
    ...
    async def set_access_policy(self, timeout: int | None = None, access: str | _models.PublicAccessType | None = None, request_id_parameter: str | None = None, lease_access_conditions: _models.LeaseAccessConditions | None = None, modified_access_conditions: _models.ModifiedAccessConditions | None = None, container_acl: List[_models.SignedIdentifier] | None = None, **kwargs: Any) -> None:
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        '''
    async def restore(self, timeout: int | None = None, request_id_parameter: str | None = None, deleted_container_name: str | None = None, deleted_container_version: str | None = None, **kwargs: Any) -> None:
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        '''
    async def rename(self, source_container_name: str, timeout: int | None = None, request_id_parameter: str | None = None, source_lease_id: str | None = None, **kwargs: Any) -> None:
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        '''
    async def submit_batch(self, content_length: int, body: IO, timeout: int | None = None, request_id_parameter: str | None = None, **kwargs: Any) -> AsyncIterator[bytes]:
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        '''
    async def filter_blobs(self, timeout: int | None = None, request_id_parameter: str | None = None, where: str | None = None, marker: str | None = None, maxresults: int | None = None, include: List[str | _models.FilterBlobsIncludeItem] | None = None, **kwargs: Any) -> _models.FilterBlobSegment:
    ...
    async def change_lease(self, lease_id: str, proposed_lease_id: str, timeout: int | None = None, request_id_parameter: str | None = None, modified_access_conditions: _models.ModifiedAccessConditions | None = None, **kwargs: Any) -> None:
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        '''
    async def list_blob_flat_segment(self, prefix: str | None = None, marker: str | None = None, maxresults: int | None = None, include: List[str | _models.ListBlobsIncludeItem] | None = None, timeout: int | None = None, request_id_parameter: str | None = None, **kwargs: Any) -> _models.ListBlobsFlatSegmentResponse:
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        '''
    async def list_blob_hierarchy_segment(self, delimiter: str, prefix: str | None = None, marker: str | None = None, maxresults: int | None = None, include: List[str | _models.ListBlobsIncludeItem] | None = None, timeout: int | None = None, request_id_parameter: str | None = None, **kwargs: Any) -> _models.ListBlobsHierarchySegmentResponse:
        '''[Update] The List Blobs operation returns a list of the blobs under the specified container.
