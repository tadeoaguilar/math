...
from ._list_blobs_helper import BlobNamesPaged as BlobNamesPaged, BlobPrefix as BlobPrefix, BlobPropertiesPaged as BlobPropertiesPaged, FilteredBlobPaged as FilteredBlobPaged, IgnoreListBlobsDeserializer as IgnoreListBlobsDeserializer
...
from typing import Any, AnyStr, Dict, IO, Iterable, Iterator, List, overload
...
class ContainerClient(StorageAccountHostsMixin, StorageEncryptionMixin):
    ...
    def __init__(self, account_url: str, container_name: str, credential: str | Dict[str, str] | AzureNamedKeyCredential | AzureSasCredential | TokenCredential | None = None, **kwargs: Any) -> None: ...
    @classmethod
    def from_container_url(cls, container_url: str, credential: str | Dict[str, str] | AzureNamedKeyCredential | AzureSasCredential | TokenCredential | None = None, **kwargs: Any) -> Self:
        ...
        '''
    @classmethod
    def from_connection_string(cls, conn_str: str, container_name: str, credential: str | Dict[str, str] | AzureNamedKeyCredential | AzureSasCredential | TokenCredential | None = None, **kwargs: Any) -> Self:
        ...
        '''
    def create_container(self, metadata: Dict[str, str] | None = None, public_access: PublicAccess | str | None = None, **kwargs: Any) -> Dict[str, str | datetime]:
        """
    ...
    def delete_container(self, **kwargs: Any) -> None:
        ...
        """
    def acquire_lease(self, lease_duration: int = -1, lease_id: str | None = None, **kwargs) -> BlobLeaseClient:
        """
    ...
    def exists(self, **kwargs: Any) -> bool:
        ...
        :rtype: bool
        """
    def set_container_metadata(self, metadata: Dict[str, str] | None = None, **kwargs) -> Dict[str, str | datetime]:
    ...
    def get_container_access_policy(self, **kwargs: Any) -> Dict[str, Any]:
        ...
        """
    def set_container_access_policy(self, signed_identifiers: Dict[str, AccessPolicy], public_access: str | PublicAccess | None = None, **kwargs) -> Dict[str, str | datetime]:
        ...
        """
    def list_blobs(self, name_starts_with: str | None = None, include: str | List[str] | None = None, **kwargs: Any) -> ItemPaged[BlobProperties]:
    ...
    def list_blob_names(self, **kwargs: Any) -> ItemPaged[str]:
        ...
        """
    def walk_blobs(self, name_starts_with: str | None = None, include: List[str] | str | None = None, delimiter: str = '/', **kwargs: Any | None) -> ItemPaged[BlobProperties]:
        """Returns a generator to list the blobs under the specified container.
        The generator will lazily follow the continuation tokens returned by
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.storage.blob.BlobProperties]
        """
    def find_blobs_by_tags(self, filter_expression: str, **kwargs: Any | None) -> ItemPaged[FilteredBlob]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.storage.blob.BlobProperties]
        '''
    def upload_blob(self, name: str | BlobProperties, data: bytes | str | Iterable[AnyStr] | IO[AnyStr], blob_type: str | BlobType = ..., length: int | None = None, metadata: Dict[str, str] | None = None, **kwargs) -> BlobClient:
        ...
        '''
    def delete_blob(self, blob: str | BlobProperties, delete_snapshots: str | None = None, **kwargs) -> None:
        ...
        '''
    @overload
    def download_blob(self, blob: str | BlobProperties, offset: int = None, length: int = None, *, encoding: str, **kwargs) -> StorageStreamDownloader[str]: ...
    @overload
    def download_blob(self, blob: str | BlobProperties, offset: int = None, length: int = None, *, encoding: None = None, **kwargs) -> StorageStreamDownloader[bytes]: ...
    def delete_blobs(self, *blobs: str | Dict[str, Any] | BlobProperties, **kwargs: Any) -> Iterator[HttpResponse]:
        ...
        '''
    def set_standard_blob_tier_blobs(self, standard_blob_tier: str | StandardBlobTier | None, *blobs: str | Dict[str, Any] | BlobProperties, **kwargs: Any) -> Iterator[HttpResponse]:
        ...
        :rtype: Iterator[~azure.core.pipeline.transport.HttpResponse]
        '''
    def set_premium_page_blob_tier_blobs(self, premium_page_blob_tier: str | PremiumPageBlobTier | None, *blobs: str | Dict[str, Any] | BlobProperties, **kwargs: Any) -> Iterator[HttpResponse]:
        ...
        :rtype: iterator[~azure.core.pipeline.transport.HttpResponse]
        """
    def get_blob_client(self, blob: str | BlobProperties, snapshot: str = None, *, version_id: str | None = None) -> BlobClient:
