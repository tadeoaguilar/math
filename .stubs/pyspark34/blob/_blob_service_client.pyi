...
from ._list_blobs_helper import FilteredBlobPaged as FilteredBlobPaged
from ._models import BlobAnalyticsLogging as BlobAnalyticsLogging, BlobProperties as BlobProperties, ContainerProperties as ContainerProperties, ContainerPropertiesPaged as ContainerPropertiesPaged, CorsRule as CorsRule, FilteredBlob as FilteredBlob, Metrics as Metrics, PublicAccess as PublicAccess, RetentionPolicy as RetentionPolicy, StaticWebsite as StaticWebsite
...
class BlobServiceClient(StorageAccountHostsMixin, StorageEncryptionMixin):
    ...
    '''
    def __init__(self, account_url: str, credential: str | Dict[str, str] | AzureNamedKeyCredential | AzureSasCredential | TokenCredential | None = None, **kwargs: Any) -> None: ...
    @classmethod
    def from_connection_string(cls, conn_str: str, credential: str | Dict[str, str] | AzureNamedKeyCredential | AzureSasCredential | TokenCredential | None = None, **kwargs: Any) -> Self:
    ...
    def get_service_properties(self, **kwargs: Any) -> Dict[str, Any]:
        ...
        """
    def set_service_properties(self, analytics_logging: BlobAnalyticsLogging | None = None, hour_metrics: Metrics | None = None, minute_metrics: Metrics | None = None, cors: List[CorsRule] | None = None, target_version: str | None = None, delete_retention_policy: RetentionPolicy | None = None, static_website: StaticWebsite | None = None, **kwargs) -> None:
        ...
        """
    def list_containers(self, name_starts_with: str | None = None, include_metadata: bool | None = False, **kwargs) -> ItemPaged[ContainerProperties]:
    ...
    def find_blobs_by_tags(self, filter_expression: str, **kwargs: Any) -> ItemPaged[FilteredBlob]:
        ...
        '''
    def create_container(self, name: str, metadata: Dict[str, str] | None = None, public_access: PublicAccess | str | None = None, **kwargs) -> ContainerClient:
        ...
        """
    def delete_container(self, container: ContainerProperties | str, lease: BlobLeaseClient | str | None = None, **kwargs) -> None:
