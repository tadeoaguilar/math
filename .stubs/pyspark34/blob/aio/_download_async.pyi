...
from .._download import _ChunkDownloader, process_range_and_offset as process_range_and_offset
from .._encryption import adjust_blob_size_for_encryption as adjust_blob_size_for_encryption, decrypt_blob as decrypt_blob, is_encryption_v2 as is_encryption_v2, parse_encryption_data as parse_encryption_data
...
from typing import AsyncIterator, Generic, IO, TypeVar
...
class _AsyncChunkDownloader(_ChunkDownloader):
    ...
    async def process_chunk(self, chunk_start) -> None: ...
...
class StorageStreamDownloader(Generic[T]):
    ...
    def chunks(self) -> AsyncIterator[bytes]:
        ...
        """
    async def read(self, size: int | None = -1) -> T:
        """
    ...
    async def readall(self) -> T:
        ...
        :rtype: T
        """
    async def content_as_bytes(self, max_concurrency: int = 1):
        ...
        :rtype: bytes
        """
    async def content_as_text(self, max_concurrency: int = 1, encoding: str = 'UTF-8'):
    ...
    async def readinto(self, stream: IO[T]) -> int:
        ...
        :rtype: int
        """
    async def download_to_stream(self, stream, max_concurrency: int = 1):
