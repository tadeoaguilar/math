...
__all__ = ['upload_blob_to_url', 'download_blob_from_url', 'BlobServiceClient', 'BlobPrefix', 'ContainerClient', 'BlobClient', 'BlobLeaseClient', 'ExponentialRetry', 'LinearRetry', 'StorageStreamDownloader']

async def upload_blob_to_url(blob_url: str, data: Union[Iterable[AnyStr], IO[AnyStr]], credential: Optional[Union[str, Dict[str, str], AzureNamedKeyCredential, AzureSasCredential, 'TokenCredential']] = None, **kwargs) -> dict[str, Any]:
   ...
   :param credential:
    ...
    :rtype: dict(str, Any)
    '''
async def download_blob_from_url(blob_url: str, output: str, credential: Optional[Union[str, Dict[str, str], AzureNamedKeyCredential, AzureSasCredential, 'TokenCredential']] = None, **kwargs) -> None:
