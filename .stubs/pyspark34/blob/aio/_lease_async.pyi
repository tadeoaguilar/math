from .._generated.operations import BlobOperations as BlobOperations, ContainerOperations as ContainerOperations
from .._lease import BlobLeaseClient as LeaseClientBase
from .._serialize import get_modify_conditions as get_modify_conditions
...
class BlobLeaseClient(LeaseClientBase):
    ...
    async def change(self, proposed_lease_id: str, **kwargs: Any) -> None:
        ...
        :return: None
        '''
    async def break_lease(self, lease_break_period: int | None = None, **kwargs: Any) -> int:
