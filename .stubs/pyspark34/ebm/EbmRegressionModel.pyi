...
from synapse.ml.ebm._VisualizationModelWrap import _RegressionWrap
from typing import List

basestring = str

class EbmRegressionModel(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaModel):
    """
    Args:
    ...
    def getWeightCol(self):
        ...
        """
    def getVizWrapper(self) -> _RegressionWrap: ...
    @property
