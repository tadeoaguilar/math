...
def remove(predicate, seq):
    ...
    [1, 3]
    """
def accumulate(binop, seq, initial=...) -> Generator[Incomplete, None, None]:
...
def merge_sorted(*seqs, **kwargs):
    ...
    [2, 1, 3, 3]
    '''
def interleave(seqs) -> Generator[Incomplete, None, None]:
    ...
    """
def unique(seq, key: Incomplete | None = None) -> Generator[Incomplete, None, None]:
...
def reduceby(key, binop, seq, init=...):
    ...
    {True:  set([2, 4]),
     False: set([1, 3])}
    """
def iterate(func, x) -> Generator[Incomplete, None, None]:
...
def partition(n, seq, pad=...):
    ...
    See Also:
        partition_all
    """
def partition_all(n, seq) -> Generator[Incomplete, None, None]:
...
def pluck(ind, seqs, default=...):
    ...
    See Also:
        ...
        map
    """
def join(leftkey, leftseq, rightkey, rightseq, left_default=..., right_default=...) -> Generator[Incomplete, None, None]:
    ...
    """
def diff(*seqs, **kwargs) -> Generator[Incomplete, None, None]:
    ...
    [('bananas', 'Oranges')]
    """
def topk(k, seq, key: Incomplete | None = None):
...
def peekn(n, seq):
    ...
    [0, 1, 2, 3, 4]
    """
def random_sample(prob, seq, random_state: Incomplete | None = None):
