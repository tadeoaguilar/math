from ..keras import patch_tf_keras as patch_tf_keras
...
class WandbModelCheckpoint(callbacks.ModelCheckpoint):
    ...
    def __init__(self, filepath: StrPath, monitor: str = 'val_loss', verbose: int = 0, save_best_only: bool = False, save_weights_only: bool = False, mode: Mode = 'auto', save_freq: SaveStrategy | int = 'epoch', options: str | None = None, initial_value_threshold: float | None = None, **kwargs: Any) -> None: ...
