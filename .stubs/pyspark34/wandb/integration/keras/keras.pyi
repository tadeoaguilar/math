...
from wandb.sdk.integration_utils.data_logging import ValidationDataLogger as ValidationDataLogger
from wandb.sdk.lib.deprecate import Deprecated as Deprecated, deprecate as deprecate
from wandb.util import add_import_hook as add_import_hook
...
class WandbCallback(tf.keras.callbacks.Callback):
    ...
    save_graph: Incomplete
    filepath: Incomplete
    save_model: Incomplete
    save_model_as_artifact: bool
    log_weights: Incomplete
    log_gradients: Incomplete
    training_data: Incomplete
    generator: Incomplete
    input_type: Incomplete
    output_type: Incomplete
    log_evaluation: Incomplete
    validation_steps: Incomplete
    class_colors: Incomplete
    log_batch_frequency: Incomplete
    log_best_prefix: Incomplete
    compute_flops: Incomplete
    monitor_op: Incomplete
    best: Incomplete
    def __init__(self, monitor: str = 'val_loss', verbose: int = 0, mode: str = 'auto', save_weights_only: bool = False, log_weights: bool = False, log_gradients: bool = False, save_model: bool = True, training_data: Incomplete | None = None, validation_data: Incomplete | None = None, labels: Incomplete | None = None, predictions: int = 36, generator: Incomplete | None = None, input_type: Incomplete | None = None, output_type: Incomplete | None = None, log_evaluation: bool = False, validation_steps: Incomplete | None = None, class_colors: Incomplete | None = None, log_batch_frequency: Incomplete | None = None, log_best_prefix: str = 'best_', save_graph: bool = True, validation_indexes: Incomplete | None = None, validation_row_processor: Incomplete | None = None, prediction_row_processor: Incomplete | None = None, infer_missing_processors: bool = True, log_evaluation_frequency: int = 0, compute_flops: bool = False, **kwargs) -> None: ...
    params: Incomplete
