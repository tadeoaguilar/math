...
class WandbObserver(RunObserver):
    ...
    def started_event(self, ex_info, command, host_info, start_time, config, meta_info, _id) -> None: ...
    def completed_event(self, stop_time, result) -> None: ...
    def artifact_event(self, name, filename, metadata: Incomplete | None = None, content_type: Incomplete | None = None) -> None: ...
    def resource_event(self, filename) -> None:
        """TODO: Maintain resources list."""
    def log_metrics(self, metrics_by_name, info) -> None: ...
