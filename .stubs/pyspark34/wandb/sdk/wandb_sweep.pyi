from . import wandb_login as wandb_login
from typing import Callable, Dict
from wandb import env as env
from wandb.apis import InternalApi as InternalApi
from wandb.sdk.launch.sweeps.utils import handle_sweep_config_violations as handle_sweep_config_violations

def sweep(sweep: dict | Callable, entity: str | None = None, project: str | None = None) -> str:
    ...
    Examples:
        ...
        ```
    '''
def controller(sweep_id_or_config: str | Dict | None = None, entity: str | None = None, project: str | None = None):
