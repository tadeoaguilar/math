...
class Transliterate(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    toScript: Incomplete
    url: Incomplete
    def __init__(self, java_obj: Incomplete | None = None, AADToken: Incomplete | None = None, AADTokenCol: Incomplete | None = None, CustomAuthHeader: Incomplete | None = None, CustomAuthHeaderCol: Incomplete | None = None, concurrency: int = 1, concurrentTimeout: Incomplete | None = None, errorCol: str = 'Transliterate_aae5281f7bb7_error', fromScript: Incomplete | None = None, fromScriptCol: Incomplete | None = None, handler: Incomplete | None = None, language: Incomplete | None = None, languageCol: Incomplete | None = None, outputCol: str = 'Transliterate_aae5281f7bb7_output', subscriptionKey: Incomplete | None = None, subscriptionKeyCol: Incomplete | None = None, subscriptionRegion: Incomplete | None = None, subscriptionRegionCol: Incomplete | None = None, text: Incomplete | None = None, textCol: Incomplete | None = None, timeout: float = 60.0, toScript: Incomplete | None = None, toScriptCol: Incomplete | None = None, url: Incomplete | None = None) -> None: ...
    def setParams(self, AADToken: Incomplete | None = None, AADTokenCol: Incomplete | None = None, CustomAuthHeader: Incomplete | None = None, CustomAuthHeaderCol: Incomplete | None = None, concurrency: int = 1, concurrentTimeout: Incomplete | None = None, errorCol: str = 'Transliterate_aae5281f7bb7_error', fromScript: Incomplete | None = None, fromScriptCol: Incomplete | None = None, handler: Incomplete | None = None, language: Incomplete | None = None, languageCol: Incomplete | None = None, outputCol: str = 'Transliterate_aae5281f7bb7_output', subscriptionKey: Incomplete | None = None, subscriptionKeyCol: Incomplete | None = None, subscriptionRegion: Incomplete | None = None, subscriptionRegionCol: Incomplete | None = None, text: Incomplete | None = None, textCol: Incomplete | None = None, timeout: float = 60.0, toScript: Incomplete | None = None, toScriptCol: Incomplete | None = None, url: Incomplete | None = None):
        """
