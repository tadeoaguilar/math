...
class DictionaryExamples(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    textAndTranslation: Incomplete
    timeout: Incomplete
    toLanguage: Incomplete
    url: Incomplete
    def __init__(self, java_obj: Incomplete | None = None, AADToken: Incomplete | None = None, AADTokenCol: Incomplete | None = None, CustomAuthHeader: Incomplete | None = None, CustomAuthHeaderCol: Incomplete | None = None, concurrency: int = 1, concurrentTimeout: Incomplete | None = None, errorCol: str = 'DictionaryExamples_279ba136014e_error', fromLanguage: Incomplete | None = None, fromLanguageCol: Incomplete | None = None, handler: Incomplete | None = None, outputCol: str = 'DictionaryExamples_279ba136014e_output', subscriptionKey: Incomplete | None = None, subscriptionKeyCol: Incomplete | None = None, subscriptionRegion: Incomplete | None = None, subscriptionRegionCol: Incomplete | None = None, textAndTranslation: Incomplete | None = None, textAndTranslationCol: Incomplete | None = None, timeout: float = 60.0, toLanguage: Incomplete | None = None, toLanguageCol: Incomplete | None = None, url: Incomplete | None = None) -> None: ...
    def setParams(self, AADToken: Incomplete | None = None, AADTokenCol: Incomplete | None = None, CustomAuthHeader: Incomplete | None = None, CustomAuthHeaderCol: Incomplete | None = None, concurrency: int = 1, concurrentTimeout: Incomplete | None = None, errorCol: str = 'DictionaryExamples_279ba136014e_error', fromLanguage: Incomplete | None = None, fromLanguageCol: Incomplete | None = None, handler: Incomplete | None = None, outputCol: str = 'DictionaryExamples_279ba136014e_output', subscriptionKey: Incomplete | None = None, subscriptionKeyCol: Incomplete | None = None, subscriptionRegion: Incomplete | None = None, subscriptionRegionCol: Incomplete | None = None, textAndTranslation: Incomplete | None = None, textAndTranslationCol: Incomplete | None = None, timeout: float = 60.0, toLanguage: Incomplete | None = None, toLanguageCol: Incomplete | None = None, url: Incomplete | None = None):
        """
