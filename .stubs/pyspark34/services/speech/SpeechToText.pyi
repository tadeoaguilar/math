...
class SpeechToText(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    timeout: Incomplete
    url: Incomplete
    def __init__(self, java_obj: Incomplete | None = None, AADToken: Incomplete | None = None, AADTokenCol: Incomplete | None = None, CustomAuthHeader: Incomplete | None = None, CustomAuthHeaderCol: Incomplete | None = None, audioData: Incomplete | None = None, audioDataCol: Incomplete | None = None, concurrency: int = 1, concurrentTimeout: Incomplete | None = None, errorCol: str = 'SpeechToText_9944c5e1c963_error', format: Incomplete | None = None, formatCol: Incomplete | None = None, handler: Incomplete | None = None, language: Incomplete | None = None, languageCol: Incomplete | None = None, outputCol: str = 'SpeechToText_9944c5e1c963_output', profanity: Incomplete | None = None, profanityCol: Incomplete | None = None, subscriptionKey: Incomplete | None = None, subscriptionKeyCol: Incomplete | None = None, timeout: float = 60.0, url: Incomplete | None = None) -> None: ...
