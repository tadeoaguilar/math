...
class OCR(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    timeout: Incomplete
    url: Incomplete
    def __init__(self, java_obj: Incomplete | None = None, AADToken: Incomplete | None = None, AADTokenCol: Incomplete | None = None, CustomAuthHeader: Incomplete | None = None, CustomAuthHeaderCol: Incomplete | None = None, concurrency: int = 1, concurrentTimeout: Incomplete | None = None, detectOrientation: Incomplete | None = None, detectOrientationCol: Incomplete | None = None, errorCol: str = 'OCR_54dd506bb927_error', handler: Incomplete | None = None, imageBytes: Incomplete | None = None, imageBytesCol: Incomplete | None = None, imageUrl: Incomplete | None = None, imageUrlCol: Incomplete | None = None, language: Incomplete | None = None, languageCol: Incomplete | None = None, outputCol: str = 'OCR_54dd506bb927_output', subscriptionKey: Incomplete | None = None, subscriptionKeyCol: Incomplete | None = None, timeout: float = 60.0, url: Incomplete | None = None) -> None: ...
