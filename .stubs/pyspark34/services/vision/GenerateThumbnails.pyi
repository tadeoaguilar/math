...
class GenerateThumbnails(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    smartCropping: Incomplete
    subscriptionKey: Incomplete
    timeout: Incomplete
    url: Incomplete
    width: Incomplete
    def __init__(self, java_obj: Incomplete | None = None, AADToken: Incomplete | None = None, AADTokenCol: Incomplete | None = None, CustomAuthHeader: Incomplete | None = None, CustomAuthHeaderCol: Incomplete | None = None, concurrency: int = 1, concurrentTimeout: Incomplete | None = None, errorCol: str = 'GenerateThumbnails_c24f7b84d0e5_error', handler: Incomplete | None = None, height: Incomplete | None = None, heightCol: Incomplete | None = None, imageBytes: Incomplete | None = None, imageBytesCol: Incomplete | None = None, imageUrl: Incomplete | None = None, imageUrlCol: Incomplete | None = None, outputCol: str = 'GenerateThumbnails_c24f7b84d0e5_output', smartCropping: Incomplete | None = None, smartCroppingCol: Incomplete | None = None, subscriptionKey: Incomplete | None = None, subscriptionKeyCol: Incomplete | None = None, timeout: float = 60.0, url: Incomplete | None = None, width: Incomplete | None = None, widthCol: Incomplete | None = None) -> None: ...
