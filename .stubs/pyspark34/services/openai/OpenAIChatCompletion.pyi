...
class OpenAIChatCompletion(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    url: Incomplete
    user: Incomplete
    def __init__(self, java_obj: Incomplete | None = None, AADToken: Incomplete | None = None, AADTokenCol: Incomplete | None = None, CustomAuthHeader: Incomplete | None = None, CustomAuthHeaderCol: Incomplete | None = None, apiVersion: Incomplete | None = None, apiVersionCol: Incomplete | None = None, bestOf: Incomplete | None = None, bestOfCol: Incomplete | None = None, cacheLevel: Incomplete | None = None, cacheLevelCol: Incomplete | None = None, concurrency: int = 1, concurrentTimeout: Incomplete | None = None, deploymentName: Incomplete | None = None, deploymentNameCol: Incomplete | None = None, echo: Incomplete | None = None, echoCol: Incomplete | None = None, errorCol: str = 'OpenAIChatCompletion_660ce8754cea_error', frequencyPenalty: Incomplete | None = None, frequencyPenaltyCol: Incomplete | None = None, handler: Incomplete | None = None, logProbs: Incomplete | None = None, logProbsCol: Incomplete | None = None, maxTokens: Incomplete | None = None, maxTokensCol: Incomplete | None = None, messagesCol: Incomplete | None = None, n: Incomplete | None = None, nCol: Incomplete | None = None, outputCol: str = 'OpenAIChatCompletion_660ce8754cea_output', presencePenalty: Incomplete | None = None, presencePenaltyCol: Incomplete | None = None, stop: Incomplete | None = None, stopCol: Incomplete | None = None, subscriptionKey: Incomplete | None = None, subscriptionKeyCol: Incomplete | None = None, temperature: Incomplete | None = None, temperatureCol: Incomplete | None = None, timeout: float = 60.0, topP: Incomplete | None = None, topPCol: Incomplete | None = None, url: Incomplete | None = None, user: Incomplete | None = None, userCol: Incomplete | None = None) -> None: ...
