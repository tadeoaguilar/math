...
class _OptionsExported:
  ...
  """
    ...
    def __init__(self, bytes_per_pack: int = 0, timeout_seconds: Incomplete | None = None, implementation=...) -> None:
...
class Hints:
  ...
  '''
    def __new__(cls, bytes_per_pack: int = 0, timeout_seconds: Incomplete | None = None): ...
    def __init__(self, bytes_per_pack: int = 0, timeout_seconds: Incomplete | None = None) -> None:
        """Creates a CollectiveHints.
