...
from tensorflow.python.data.ops import dataset_autograph as dataset_autograph, debug_mode as debug_mode, iterator_ops as iterator_ops, structured_function as structured_function
from tensorflow.python.data.util import nest as nest, structure as structure, traverse as traverse
from tensorflow.python.eager import context as context
from tensorflow.python.framework import auto_control_deps as auto_control_deps, composite_tensor as composite_tensor, constant_op as constant_op, dtypes as dtypes, function as function, ops as ops, tensor_shape as tensor_shape, tensor_spec as tensor_spec, tensor_util as tensor_util, type_spec as type_spec
from tensorflow.python.ops import array_ops as array_ops, check_ops as check_ops, control_flow_ops as control_flow_ops, gen_dataset_ops as gen_dataset_ops, gen_io_ops as gen_io_ops, gen_parsing_ops as gen_parsing_ops, logging_ops as logging_ops, math_ops as math_ops, random_ops as random_ops, string_ops as string_ops
...
from tensorflow.python.trackable import asset as asset, base as tracking_base, resource as resource_lib
from tensorflow.python.types import data as data_types, trace as trace
...
prefetch_op: Incomplete
shuffle_op: Incomplete
AUTOTUNE: int
INFINITE: int
UNKNOWN: int
...
class DatasetV2(collections_abc.Iterable, tracking_base.Trackable, composite_tensor.CompositeTensor, data_types.DatasetV2, metaclass=abc.ABCMeta):
  ...
  **Component**: The leaf in the nested structure of an element.
  ...
  '''
    ...
    """
    @staticmethod
    def from_tensors(tensors, name: Incomplete | None = None):
    ...
    '''
    @staticmethod
    def from_tensor_slices(tensors, name: Incomplete | None = None):
    ...
    @staticmethod
    def from_generator(generator, output_types: Incomplete | None = None, output_shapes: Incomplete | None = None, args: Incomplete | None = None, output_signature: Incomplete | None = None, name: Incomplete | None = None):
    ...
    """
    @staticmethod
    def zip(datasets, name: Incomplete | None = None):
    ...
    """
    def concatenate(self, dataset, name: Incomplete | None = None):
    ...
    '''
    @staticmethod
    def counter(start: int = 0, step: int = 1, dtype=..., name: Incomplete | None = None):
    ...
    """
    def rebatch(self, batch_size, drop_remainder: bool = False, name: Incomplete | None = None):
    ...
    Returns:
      A `Dataset` of scalar `dtype` elements.
    """
    def prefetch(self, buffer_size, name: Incomplete | None = None):
    ...
    """
    @staticmethod
    def list_files(file_pattern, shuffle: Incomplete | None = None, seed: Incomplete | None = None, name: Incomplete | None = None):
    ...
    '''
    def repeat(self, count: Incomplete | None = None, name: Incomplete | None = None):
    ...
    Returns:
      A new `Dataset` with the transformation applied as described above.
    """
    def enumerate(self, start: int = 0, name: Incomplete | None = None):
    ...
    Returns:
      A new `Dataset` with the transformation applied as described above.
    """
    def shuffle(self, buffer_size, seed: Incomplete | None = None, reshuffle_each_iteration: Incomplete | None = None, name: Incomplete | None = None):
    ...
    Returns:
      A new `Dataset` with the transformation applied as described above.
    """
    def cache(self, filename: str = '', name: Incomplete | None = None):
    ...
    Returns:
      A new `Dataset` with the transformation applied as described above.
    '''
    def take(self, count, name: Incomplete | None = None):
    ...
    Returns:
      A new `Dataset` with the transformation applied as described above.
    """
    def skip(self, count, name: Incomplete | None = None):
    ...
    Returns:
      A new `Dataset` with the transformation applied as described above.
    """
    def shard(self, num_shards, index, name: Incomplete | None = None):
    ...
    """
    def save(self, path, compression: Incomplete | None = None, shard_func: Incomplete | None = None, checkpoint_args: Incomplete | None = None) -> None:
    ...
    '''
    @staticmethod
    def load(path, element_spec: Incomplete | None = None, compression: Incomplete | None = None, reader_func: Incomplete | None = None):
    ...
    Raises:
      ...
      ValueError: If `element_spec` is not specified and the method is executed
        in graph mode.
    '''
    def batch(self, batch_size, drop_remainder: bool = False, num_parallel_calls: Incomplete | None = None, deterministic: Incomplete | None = None, name: Incomplete | None = None):
    ...
    Returns:
      A new `Dataset` with the transformation applied as described above.
    """
    def padded_batch(self, batch_size, padded_shapes: Incomplete | None = None, padding_values: Incomplete | None = None, drop_remainder: bool = False, name: Incomplete | None = None):
    ...
    * If the dimension is unknown, the component will be padded out to the
    ...
    """
    def ragged_batch(self, batch_size, drop_remainder: bool = False, row_splits_dtype=..., name: Incomplete | None = None):
    ...
    *  If an input element is a `tf.RaggedTensor` or any other type, then it is
    ...
    Returns:
      A new `Dataset` with the transformation applied as described above.
    """
    def sparse_batch(self, batch_size, row_shape, name: Incomplete | None = None):
    ...
    Returns:
      A new `Dataset` with the transformation applied as described above.
    """
    def map(self, map_func, num_parallel_calls: Incomplete | None = None, deterministic: Incomplete | None = None, name: Incomplete | None = None):
    ...
    Returns:
      A new `Dataset` with the transformation applied as described above.
    '''
    def flat_map(self, map_func, name: Incomplete | None = None):
    ...
    Returns:
      A new `Dataset` with the transformation applied as described above.
    """
    def ignore_errors(self, log_warning: bool = False, name: Incomplete | None = None):
    ...
    Returns:
      A new `Dataset` with the transformation applied as described above.
    '''
    def interleave(self, map_func, cycle_length: Incomplete | None = None, block_length: Incomplete | None = None, num_parallel_calls: Incomplete | None = None, deterministic: Incomplete | None = None, name: Incomplete | None = None):
    ...
    Returns:
      A new `Dataset` with the transformation applied as described above.
    '''
    def filter(self, predicate, name: Incomplete | None = None):
    ...
    Returns:
      A new `Dataset` with the transformation applied as described above.
    """
    def window(self, size, shift: Incomplete | None = None, stride: int = 1, drop_remainder: bool = False, name: Incomplete | None = None):
    ...
    Returns:
      A new `Dataset` with the transformation applied as described above.
    '''
    def reduce(self, initial_state, reduce_func, name: Incomplete | None = None):
    ...
    """
    def get_single_element(self, name: Incomplete | None = None):
    ...
    Raises:
      InvalidArgumentError: (at runtime) if `dataset` does not contain exactly
        one element.
    '''
    def unbatch(self, name: Incomplete | None = None):
    ...
    Returns:
      A new `Dataset` with the transformation applied as described above.
    """
    def with_options(self, options, name: Incomplete | None = None):
    ...
    """
    def group_by_window(self, key_func, reduce_func, window_size: Incomplete | None = None, window_size_func: Incomplete | None = None, name: Incomplete | None = None):
    ...
    Raises:
      ValueError: if neither or both of {`window_size`, `window_size_func`} are
        passed.
    """
    def bucket_by_sequence_length(self, element_length_func, bucket_boundaries, bucket_batch_sizes, padded_shapes: Incomplete | None = None, padding_values: Incomplete | None = None, pad_to_bucket_boundary: bool = False, no_padding: bool = False, drop_remainder: bool = False, name: Incomplete | None = None):
    ...
    '''
    @staticmethod
    def random(seed: Incomplete | None = None, rerandomize_each_iteration: Incomplete | None = None, name: Incomplete | None = None):
    ...
    Returns:
      Dataset: A `Dataset`.
    """
    def snapshot(self, path, compression: str = 'AUTO', reader_func: Incomplete | None = None, shard_func: Incomplete | None = None, name: Incomplete | None = None):
    ...
    Returns:
      A new `Dataset` with the transformation applied as described above.
    '''
    def scan(self, initial_state, scan_func, name: Incomplete | None = None):
    ...
    Returns:
      A new `Dataset` with the transformation applied as described above.
    """
    def take_while(self, predicate, name: Incomplete | None = None):
    ...
    Returns:
      A new `Dataset` with the transformation applied as described above.
    """
    def unique(self, name: Incomplete | None = None):
    ...
    Returns:
      A new `Dataset` with the transformation applied as described above.
    """
    def rejection_resample(self, class_func, target_dist, initial_dist: Incomplete | None = None, seed: Incomplete | None = None, name: Incomplete | None = None):
    ...
    """
    @staticmethod
    def sample_from_datasets(datasets, weights: Incomplete | None = None, seed: Incomplete | None = None, stop_on_empty_dataset: bool = False, rerandomize_each_iteration: Incomplete | None = None):
    ...
    """
    @staticmethod
    def choose_from_datasets(datasets, choice_dataset, stop_on_empty_dataset: bool = True):
...
class DatasetV1(DatasetV2, data_types.DatasetV1, metaclass=abc.ABCMeta):
    '''Represents a potentially large set of elements.
  ...
  '''
    ...
    '''
    def make_initializable_iterator(self, shared_name: Incomplete | None = None):
        """Creates an iterator for elements of this dataset.
    ...
    def padded_batch(self, batch_size, padded_shapes: Incomplete | None = None, padding_values: Incomplete | None = None, drop_remainder: bool = False, name: Incomplete | None = None): ...
    def map(self, map_func, num_parallel_calls: Incomplete | None = None, deterministic: Incomplete | None = None, name: Incomplete | None = None): ...
    def map_with_legacy_function(self, map_func, num_parallel_calls: Incomplete | None = None, deterministic: Incomplete | None = None):
        """Maps `map_func` across the elements of this dataset.
...
def make_one_shot_iterator(dataset):
  ...
  @end_compatibility
  '''
def make_initializable_iterator(dataset, shared_name: Incomplete | None = None):
    """Creates an iterator for elements of `dataset`.
...
class _VariantDataset(DatasetV2):
    ...
    def __init__(self, dataset_variant, element_spec) -> None: ...
    @property
    def element_spec(self): ...
...
class _RestructuredDataset(UnaryDataset):
    ...
    def __init__(self, dataset, element_spec) -> None: ...
    @property
    def element_spec(self): ...
