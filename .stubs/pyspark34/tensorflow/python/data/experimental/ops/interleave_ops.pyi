...
def parallel_interleave(map_func, cycle_length, block_length: int = 1, sloppy: bool = False, buffer_output_elements: Incomplete | None = None, prefetch_input_elements: Incomplete | None = None):
  ...
  '''
def sample_from_datasets_v2(datasets, weights: Incomplete | None = None, seed: Incomplete | None = None, stop_on_empty_dataset: bool = False):
  ...
  """
def sample_from_datasets_v1(datasets, weights: Incomplete | None = None, seed: Incomplete | None = None, stop_on_empty_dataset: bool = False): ...
def choose_from_datasets_v2(datasets, choice_dataset, stop_on_empty_dataset: bool = False):
  ...
  '''
def choose_from_datasets_v1(datasets, choice_dataset, stop_on_empty_dataset: bool = False): ...
