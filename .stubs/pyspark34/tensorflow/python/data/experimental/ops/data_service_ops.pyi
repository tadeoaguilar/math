...
class _DataServiceDatasetV2(dataset_ops.DatasetSource):
    ...
    def __init__(self, dataset_id, processing_mode, address, element_spec, protocol, data_transfer_protocol, job_name: Incomplete | None = None, consumer_index: Incomplete | None = None, num_consumers: Incomplete | None = None, max_outstanding_requests: Incomplete | None = None, task_refresh_interval_hint_ms: Incomplete | None = None, cross_trainer_cache: Incomplete | None = None, target_workers: str = 'AUTO') -> None:
...
class _DataServiceDatasetV1(dataset_ops.DatasetV1Adapter):
    ...
    def __init__(self, dataset_id, processing_mode, address, element_spec, protocol, data_transfer_protocol, job_name, consumer_index, num_consumers, max_outstanding_requests, task_refresh_interval_hint_ms, cross_trainer_cache, target_workers) -> None: ...

def distribute(processing_mode, service, job_name: Incomplete | None = None, consumer_index: Incomplete | None = None, num_consumers: Incomplete | None = None, max_outstanding_requests: Incomplete | None = None, data_transfer_protocol: Incomplete | None = None, compression: str = 'AUTO', cross_trainer_cache: Incomplete | None = None, target_workers: str = 'AUTO'):
  ...
  **Keras and Distribution Strategies**
  ...
  '''
def register_dataset(service, dataset, compression: str = 'AUTO', dataset_id: Incomplete | None = None):
  ...
  '''
def from_dataset_id(processing_mode, service, dataset_id, element_spec: Incomplete | None = None, job_name: Incomplete | None = None, consumer_index: Incomplete | None = None, num_consumers: Incomplete | None = None, max_outstanding_requests: Incomplete | None = None, data_transfer_protocol: Incomplete | None = None, cross_trainer_cache: Incomplete | None = None, target_workers: str = 'AUTO'):
