...
class _LegacySnapshotDataset(dataset_ops.UnaryUnchangedStructureDataset):
    ...
    def __init__(self, input_dataset, path, compression: Incomplete | None = None, reader_path_prefix: Incomplete | None = None, writer_path_prefix: Incomplete | None = None, shard_size_bytes: Incomplete | None = None, pending_snapshot_expiry_seconds: Incomplete | None = None, num_reader_threads: Incomplete | None = None, reader_buffer_size: Incomplete | None = None, num_writer_threads: Incomplete | None = None, writer_buffer_size: Incomplete | None = None, shuffle_on_read: Incomplete | None = None, shuffle_seed: Incomplete | None = None, mode: Incomplete | None = None, snapshot_name: Incomplete | None = None) -> None: ...

def legacy_snapshot(path, compression: Incomplete | None = None, reader_path_prefix: Incomplete | None = None, writer_path_prefix: Incomplete | None = None, shard_size_bytes: Incomplete | None = None, pending_snapshot_expiry_seconds: Incomplete | None = None, num_reader_threads: Incomplete | None = None, reader_buffer_size: Incomplete | None = None, num_writer_threads: Incomplete | None = None, writer_buffer_size: Incomplete | None = None, shuffle_on_read: Incomplete | None = None, shuffle_seed: Incomplete | None = None, mode: Incomplete | None = None, snapshot_name: Incomplete | None = None):
  ...
  '''
def snapshot(path, compression: str = 'AUTO', reader_func: Incomplete | None = None, shard_func: Incomplete | None = None):
