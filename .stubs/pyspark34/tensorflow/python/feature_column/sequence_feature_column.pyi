...
def concatenate_context_input(context_input, sequence_input):
  ...
  Raises:
    ValueError: If `sequence_input` does not have rank 3 or `context_input` does
      not have rank 2.
  """
def sequence_categorical_column_with_identity(key, num_buckets, default_value: Incomplete | None = None):
...
def sequence_categorical_column_with_hash_bucket(key, hash_bucket_size, dtype=...):
  ...
  """
def sequence_categorical_column_with_vocabulary_file(key, vocabulary_file, vocabulary_size: Incomplete | None = None, num_oov_buckets: int = 0, default_value: Incomplete | None = None, dtype=...):
  ...
  Raises:
    ...
    ValueError: `dtype` is neither string nor integer.
  """
def sequence_categorical_column_with_vocabulary_list(key, vocabulary_list, dtype: Incomplete | None = None, default_value: int = -1, num_oov_buckets: int = 0):
  ...
  """
def sequence_numeric_column(key, shape=(1,), default_value: float = 0.0, dtype=..., normalizer_fn: Incomplete | None = None):
...
class SequenceNumericColumn(fc.SequenceDenseColumn, NamedTuple('SequenceNumericColumn', [('key', Incomplete), ('shape', Incomplete), ('default_value', Incomplete), ('dtype', Incomplete), ('normalizer_fn', Incomplete)])):
