...
def is_namedtuple(instance, strict: bool = False):
...
def flatten(structure, expand_composites: bool = False):
...
same_namedtuples: Incomplete

class _DotString: ...

def assert_same_structure(nest1, nest2, check_types: bool = True, expand_composites: bool = False):
...
def flatten_dict_items(dictionary):
  ...
  '''
def pack_sequence_as(structure, flat_sequence, expand_composites: bool = False):
...
def map_structure_with_tuple_paths(func, *structure, **kwargs):
  ...
  Raises:
    ...
    ValueError: If no structures are provided.
  """
def assert_shallow_structure(shallow_tree, input_tree, check_types: bool = True, expand_composites: bool = False) -> None:
  ...
  Raises:
    ...
    ValueError: If the sequence lengths of `shallow_tree` are different from
      `input_tree`.
  '''
def flatten_up_to(shallow_tree, input_tree, check_types: bool = True, expand_composites: bool = False):
  ...
  Raises:
    ...
    ValueError: If the structure lengths of `shallow_tree` are different from
      `input_tree`.
  """
def flatten_with_tuple_paths_up_to(shallow_tree, input_tree, check_types: bool = True, expand_composites: bool = False):
    """Flattens `input_tree` up to `shallow_tree`.
...
def map_structure_with_tuple_paths_up_to(shallow_tree, func, *inputs, **kwargs):
  ...
  *inputs.
  ...
  Returns:
    ...
    `shallow_tree`.
  '''
def get_traverse_shallow_structure(traverse_fn, structure, expand_composites: bool = False):
  ...
  Raises:
    TypeError: if `traverse_fn` returns a nested structure for an atom input.
      ...
      `bool`.
  '''
def yield_flat_paths(nest, expand_composites: bool = False) -> Generator[Incomplete, None, None]:
  ...
  """
def flatten_with_joined_string_paths(structure, separator: str = '/', expand_composites: bool = False):
  ...
  """
def flatten_with_tuple_paths(structure, expand_composites: bool = False):
