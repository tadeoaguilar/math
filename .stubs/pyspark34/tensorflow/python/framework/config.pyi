...
def set_synchronous_execution(enable) -> None:
  ...
  '''
def list_physical_devices(device_type: Incomplete | None = None):
  ...
  '''
def list_logical_devices(device_type: Incomplete | None = None):
  ...
  '''
def get_visible_devices(device_type: Incomplete | None = None):
  ...
  '''
def set_visible_devices(devices, device_type: Incomplete | None = None) -> None:
