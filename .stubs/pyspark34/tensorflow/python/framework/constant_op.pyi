...
from tensorflow.python.framework import dtypes as dtypes, op_callbacks as op_callbacks, ops as ops, tensor_conversion_registry as tensor_conversion_registry, tensor_shape as tensor_shape, tensor_util as tensor_util
from tensorflow.python.profiler import trace as trace
from tensorflow.python.util.tf_export import tf_export as tf_export

def convert_to_eager_tensor(value, ctx, dtype: Incomplete | None = None):
  ...
  """
def constant_v1(value, dtype: Incomplete | None = None, shape: Incomplete | None = None, name: str = 'Const', verify_shape: bool = False):
  ...
  *   Because `tf.constant` only embeds constant values in the graph, it does
  ...
  """
def constant(value, dtype: Incomplete | None = None, shape: Incomplete | None = None, name: str = 'Const'):
