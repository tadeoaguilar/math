...
class Graph(NamedTuple('Graph', [('entry', Incomplete), ('exit', Incomplete), ('error', Incomplete), ('index', Incomplete), ('stmt_prev', Incomplete), ('stmt_next', Incomplete)])):
...
class GraphBuilder:
  ...
  """
    ...
    leaves: Incomplete
    active_stmts: Incomplete
    owners: Incomplete
    forward_edges: Incomplete
    finally_sections: Incomplete
    finally_section_subgraphs: Incomplete
    finally_section_has_direct_flow: Incomplete
    pending_finally_sections: Incomplete
    exits: Incomplete
    section_entry: Incomplete
    continues: Incomplete
    raises: Incomplete
    cond_entry: Incomplete
    cond_leaves: Incomplete
    def reset(self) -> None:
...
class AstToCfg(gast.NodeVisitor):
  ...
  """
    builder_stack: Incomplete
    builder: Incomplete
    cfgs: Incomplete
    lexical_scopes: Incomplete
