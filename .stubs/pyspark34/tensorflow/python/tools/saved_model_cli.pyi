...
command_required_flags: Incomplete
...
def get_signature_def_map(saved_model_dir, tag_set):
  ...
  """
def scan_meta_graph_def(meta_graph_def, op_denylist) -> None:
  ...
  """
def run_saved_model_with_feed_dict(saved_model_dir, tag_set, signature_def_key, input_tensor_key_feed_dict, outdir, overwrite_flag, worker: Incomplete | None = None, init_tpu: bool = False, use_tfrt: bool = False, tf_debug: bool = False) -> None:
...
def preprocess_inputs_arg_string(inputs_str):
  ...
  '''
def preprocess_input_exprs_arg_string(input_exprs_str, safe: bool = True):
...
def add_freeze_model_subparser(subparsers) -> None:
