...
class Supervisor:
  ...
  * Specifying `\'grpc://hostname:port\'` requests a session that uses
  ...
  '''
    USE_DEFAULT: int
    def __init__(self, graph: Incomplete | None = None, ready_op=..., ready_for_local_init_op=..., is_chief: bool = True, init_op=..., init_feed_dict: Incomplete | None = None, local_init_op=..., logdir: Incomplete | None = None, summary_op=..., saver=..., global_step=..., save_summaries_secs: int = 120, save_model_secs: int = 600, recovery_wait_secs: int = 30, stop_grace_secs: int = 120, checkpoint_basename: str = 'model.ckpt', session_manager: Incomplete | None = None, summary_writer=..., init_fn: Incomplete | None = None, local_init_run_options: Incomplete | None = None) -> None:
        """Create a `Supervisor`.
    ...
    """
    def prepare_or_wait_for_session(self, master: str = '', config: Incomplete | None = None, wait_for_checkpoint: bool = False, max_wait_secs: int = 7200, start_standard_services: bool = True):
    ...
    """
    def start_queue_runners(self, sess, queue_runners: Incomplete | None = None):
    ...
    @end_compatibility
    """
    def loop(self, timer_interval_secs, target, args: Incomplete | None = None, kwargs: Incomplete | None = None):
    ...
    Returns:
      The started thread.
    """
    def stop(self, threads: Incomplete | None = None, close_summary_writer: bool = True, ignore_live_threads: bool = False) -> None:
    ...
    """
    def request_stop(self, ex: Incomplete | None = None) -> None:
    ...
    def summary_computed(self, sess, summary, global_step: Incomplete | None = None) -> None:
    ...
    """
    def managed_session(self, master: str = '', config: Incomplete | None = None, start_standard_services: bool = True, close_summary_writer: bool = True) -> Generator[Incomplete, None, None]:
...
class SVStepCounterThread(coordinator.LooperThread):
    ...
    def __init__(self, sv, sess, step_counter: Incomplete | None = None) -> None:
