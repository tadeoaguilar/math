...
class SessionManager:
  ...
  * Initializing variables on startup, restoring them from the most recent
  ...
  """
    def __init__(self, local_init_op: Incomplete | None = None, ready_op: Incomplete | None = None, ready_for_local_init_op: Incomplete | None = None, graph: Incomplete | None = None, recovery_wait_secs: int = 30, local_init_run_options: Incomplete | None = None, local_init_feed_dict: Incomplete | None = None) -> None:
    ...
    Raises:
      ValueError: If ready_for_local_init_op is not None but local_init_op is
        None
    """
    def prepare_session(self, master, init_op: Incomplete | None = None, saver: Incomplete | None = None, checkpoint_dir: Incomplete | None = None, checkpoint_filename_with_path: Incomplete | None = None, wait_for_checkpoint: bool = False, max_wait_secs: int = 7200, config: Incomplete | None = None, init_feed_dict: Incomplete | None = None, init_fn: Incomplete | None = None):
    ...
    Raises:
      ...
      ValueError: If both checkpoint_dir and checkpoint_filename_with_path are
        set.
    """
    def recover_session(self, master, saver: Incomplete | None = None, checkpoint_dir: Incomplete | None = None, checkpoint_filename_with_path: Incomplete | None = None, wait_for_checkpoint: bool = False, max_wait_secs: int = 7200, config: Incomplete | None = None):
    ...
    Raises:
      ValueError: If both checkpoint_dir and checkpoint_filename_with_path are
        set.
    """
    def wait_for_session(self, master, config: Incomplete | None = None, max_wait_secs=...):
