...
class Coordinator:
  ...
  ```
  """
    def __init__(self, clean_stop_exception_types: Incomplete | None = None) -> None:
    ...
    """
    def stop_on_exception(self) -> Generator[None, None, None]:
    ...
    Yields:
      nothing.
    """
    def wait_for_stop(self, timeout: Incomplete | None = None):
    ...
    """
    def join(self, threads: Incomplete | None = None, stop_grace_period_secs: int = 120, ignore_live_threads: bool = False) -> None:
...
class LooperThread(threading.Thread):
  ...
  """
    daemon: bool
    def __init__(self, coord, timer_interval_secs, target: Incomplete | None = None, args: Incomplete | None = None, kwargs: Incomplete | None = None) -> None:
    ...
    """
    @staticmethod
    def loop(coord, timer_interval_secs, target, args: Incomplete | None = None, kwargs: Incomplete | None = None):
