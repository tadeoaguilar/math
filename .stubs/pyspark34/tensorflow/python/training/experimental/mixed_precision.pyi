...
def register_loss_scale_wrapper(optimizer_cls, wrapper_fn, wrapper_cls: Incomplete | None = None) -> None:
  ...
  '''
def enable_mixed_precision_graph_rewrite_v1(opt, loss_scale: str = 'dynamic'):
