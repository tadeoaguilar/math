...
def scalar(name, tensor, collections: Incomplete | None = None, family: Incomplete | None = None):
  ...
  @end_compatibility
  '''
def image(name, tensor, max_outputs: int = 3, collections: Incomplete | None = None, family: Incomplete | None = None):
  ...
  *  The TF2 op just outputs the data under a single tag that contains multiple
  ...
  @end_compatibility
  '''
def histogram(name, values, collections: Incomplete | None = None, family: Incomplete | None = None):
  ...
  @end_compatibility
  '''
def audio(name, tensor, sample_rate, max_outputs: int = 3, collections: Incomplete | None = None, family: Incomplete | None = None):
  ...
  * The TF2 op just outputs the data under a single tag that contains multiple
  ...
  @end_compatibility
  '''
def text(name, tensor, collections: Incomplete | None = None):
  ...
  @end_compatibility
  '''
def tensor_summary(name, tensor, summary_description: Incomplete | None = None, collections: Incomplete | None = None, summary_metadata: Incomplete | None = None, family: Incomplete | None = None, display_name: Incomplete | None = None):
  ...
  Returns:
    ...
    buffer.
  """
def merge(inputs, collections: Incomplete | None = None, name: Incomplete | None = None):
    '''Merges summaries.
  ...
  @end_compatibility
  '''
def merge_all(key=..., scope: Incomplete | None = None, name: Incomplete | None = None):
