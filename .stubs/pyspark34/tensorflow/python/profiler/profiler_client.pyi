...
def trace(service_addr, logdir, duration_ms, worker_list: str = '', num_tracing_attempts: int = 3, options: Incomplete | None = None) -> None:
  ...
  """
def monitor(service_addr, duration_ms, level: int = 1):
