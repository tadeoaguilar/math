...
from tensorflow.python.distribute.cluster_resolver import cluster_resolver as cluster_resolver, tpu_cluster_resolver as tpu_cluster_resolver
...
def connect_to_remote_host(remote_host: Incomplete | None = None, job_name: str = 'worker') -> None:
  ...
  '''
def connect_to_cluster(cluster_spec_or_resolver, job_name: str = 'localhost', task_index: int = 0, protocol: Incomplete | None = None, make_master_device_default: bool = True, cluster_device_filters: Incomplete | None = None) -> None:
