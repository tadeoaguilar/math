...
from tensorflow.python.checkpoint import checkpoint as checkpoint, checkpoint_options as checkpoint_options, graph_view as graph_view, restore as restore
...
from tensorflow.python.framework import config as config, constant_op as constant_op, dtypes as dtypes, errors as errors, ops as ops
from tensorflow.python.ops import array_ops as array_ops, control_flow_ops as control_flow_ops, lookup_ops as lookup_ops, resource_variable_ops as resource_variable_ops, variables as variables
from tensorflow.python.saved_model import function_deserialization as function_deserialization, load_options as load_options, load_v1_in_v2 as load_v1_in_v2, loader_impl as loader_impl, path_helpers as path_helpers, registration as registration, revived_types as revived_types
from tensorflow.python.saved_model.pywrap_saved_model import fingerprinting as fingerprinting, metrics as metrics
from tensorflow.python.trackable import asset as asset, autotrackable as autotrackable, base as base, data_structures as data_structures, resource as resource, trackable_utils as trackable_utils
...
def load(export_dir, tags: Incomplete | None = None, options: Incomplete | None = None):
  ...
  * `.restore(save_path)`: A function that restores variables from a checkpoint
  ...
  '''
def load_partial(export_dir, filters, tags: Incomplete | None = None, options: Incomplete | None = None):
