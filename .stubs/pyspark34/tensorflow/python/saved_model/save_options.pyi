...
class SaveOptions:
  ...
  """
    namespace_whitelist: Incomplete
    save_debug_info: Incomplete
    function_aliases: Incomplete
    experimental_custom_gradients: Incomplete
    experimental_io_device: Incomplete
    experimental_variable_policy: Incomplete
    def __init__(self, namespace_whitelist: Incomplete | None = None, save_debug_info: bool = False, function_aliases: Incomplete | None = None, experimental_io_device: Incomplete | None = None, experimental_variable_policy: Incomplete | None = None, experimental_custom_gradients: bool = True) -> None:
