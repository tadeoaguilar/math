...
def register_serializable(package: str = 'Custom', name: Incomplete | None = None, predicate: Incomplete | None = None):
...
class RegisteredSaver(NamedTuple):
    name: Incomplete
    predicate: Incomplete
    save_fn: Incomplete
    restore_fn: Incomplete

def register_checkpoint_saver(package: str = 'Custom', name: Incomplete | None = None, predicate: Incomplete | None = None, save_fn: Incomplete | None = None, restore_fn: Incomplete | None = None, strict_predicate_restore: bool = True) -> None:
