...
from tensorflow.python.saved_model import save_options as save_options
...
class LoadOptions:
  ...
  """
    ...
    allow_partial_checkpoint: Incomplete
    experimental_skip_checkpoint: Incomplete
    experimental_variable_policy: Incomplete
    def __init__(self, allow_partial_checkpoint: bool = False, experimental_io_device: Incomplete | None = None, experimental_skip_checkpoint: bool = False, experimental_variable_policy: Incomplete | None = None) -> None:
