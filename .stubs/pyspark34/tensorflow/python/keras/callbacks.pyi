...
from tensorflow.python.distribute import collective_all_reduce_strategy as collective_all_reduce_strategy, mirrored_strategy as mirrored_strategy, parameter_server_strategy_v2 as parameter_server_strategy_v2, tpu_strategy as tpu_strategy
...
from tensorflow.python.keras.distribute import distributed_file_utils as distributed_file_utils, worker_training_state as worker_training_state
from tensorflow.python.keras.optimizer_v2 import learning_rate_schedule as learning_rate_schedule
from tensorflow.python.keras.utils import generic_utils as generic_utils, tf_utils as tf_utils, version_utils as version_utils
...
from tensorflow.python.ops import array_ops as array_ops, math_ops as math_ops, summary_ops_v2 as summary_ops_v2
...
class ModelCheckpoint(Callback):
  ...
  '''
    ...
    best: Incomplete
    def __init__(self, filepath, monitor: str = 'val_loss', verbose: int = 0, save_best_only: bool = False, save_weights_only: bool = False, mode: str = 'auto', save_freq: str = 'epoch', options: Incomplete | None = None, **kwargs) -> None: ...
    def on_train_begin(self, logs: Incomplete | None = None) -> None: ...
    def on_train_batch_end(self, batch, logs: Incomplete | None = None) -> None: ...
    def on_epoch_begin(self, epoch, logs: Incomplete | None = None) -> None: ...
    def on_epoch_end(self, epoch, logs: Incomplete | None = None) -> None: ...
...
class EarlyStopping(Callback):
  ...
  '''
    ...
    monitor_op: Incomplete
    def __init__(self, monitor: str = 'val_loss', min_delta: int = 0, patience: int = 0, verbose: int = 0, mode: str = 'auto', baseline: Incomplete | None = None, restore_best_weights: bool = False) -> None: ...
    best: Incomplete
    def on_train_begin(self, logs: Incomplete | None = None) -> None: ...
    def on_epoch_end(self, epoch, logs: Incomplete | None = None) -> None: ...
    def on_train_end(self, logs: Incomplete | None = None) -> None: ...
...
class TensorBoard(Callback, version_utils.TensorBoardVersionSelector):
  ...
  * Sampled profiling
  ...
  '''
    ...
    def __init__(self, log_dir: str = 'logs', histogram_freq: int = 0, write_graph: bool = True, write_images: bool = False, write_steps_per_second: bool = False, update_freq: str = 'epoch', profile_batch: int = 2, embeddings_freq: int = 0, embeddings_metadata: Incomplete | None = None, **kwargs) -> None: ...
    model: Incomplete
    def set_model(self, model) -> None:
