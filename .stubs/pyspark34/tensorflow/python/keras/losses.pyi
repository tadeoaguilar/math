...
class BinaryCrossentropy(LossFunctionWrapper):
  ...
  **Default Usage:** (set `from_logits=False`)
  ...
  '''
    ...
    def __init__(self, from_logits: bool = False, label_smoothing: int = 0, axis: int = -1, reduction=..., name: str = 'binary_crossentropy') -> None:
...
class CategoricalCrossentropy(LossFunctionWrapper):
  ...
  ```
  """
    def __init__(self, from_logits: bool = False, label_smoothing: int = 0, axis: int = -1, reduction=..., name: str = 'categorical_crossentropy') -> None:
...
class SparseCategoricalCrossentropy(LossFunctionWrapper):
  ...
  ```
  """
    def __init__(self, from_logits: bool = False, reduction=..., name: str = 'sparse_categorical_crossentropy') -> None:
...
def log_cosh(y_true, y_pred):
  ...
  """
def categorical_crossentropy(y_true, y_pred, from_logits: bool = False, label_smoothing: int = 0, axis: int = -1):
  ...
  """
def sparse_categorical_crossentropy(y_true, y_pred, from_logits: bool = False, axis: int = -1):
  ...
  """
def binary_crossentropy(y_true, y_pred, from_logits: bool = False, label_smoothing: int = 0, axis: int = -1):
...
def serialize(loss):
  ...
  """
def deserialize(name, custom_objects: Incomplete | None = None):
