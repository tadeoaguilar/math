...
from tensorflow.python.eager.context import get_config as get_config
from tensorflow.python.framework import composite_tensor as composite_tensor, config as config, constant_op as constant_op, device_spec as device_spec, func_graph as func_graph, ops as ops, sparse_tensor as sparse_tensor, tensor_shape as tensor_shape, tensor_spec as tensor_spec, tensor_util as tensor_util
...
from tensorflow.python.keras.utils import control_flow_util as control_flow_util, object_identity as object_identity, tf_contextlib as tf_contextlib, tf_inspect as tf_inspect
from tensorflow.python.ops import array_ops as array_ops, clip_ops as clip_ops, control_flow_ops as control_flow_ops, functional_ops as functional_ops, image_ops as image_ops, init_ops as init_ops, linalg_ops as linalg_ops, logging_ops as logging_ops, math_ops as math_ops, nn as nn, random_ops as random_ops, sparse_ops as sparse_ops, state_ops as state_ops, tensor_array_grad as tensor_array_grad, tensor_array_ops as tensor_array_ops
...
def stop_gradient(variables):
  ...
  """
def rnn(step_function, inputs, initial_states, go_backwards: bool = False, mask: Incomplete | None = None, constants: Incomplete | None = None, unroll: bool = False, input_length: Incomplete | None = None, time_major: bool = False, zero_output_for_mask: bool = False):
...
def categorical_crossentropy(target, output, from_logits: bool = False, axis: int = -1):
  ...
  """
def sparse_categorical_crossentropy(target, output, from_logits: bool = False, axis: int = -1):
