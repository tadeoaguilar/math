...
def make_variable(name, shape: Incomplete | None = None, dtype=..., initializer: Incomplete | None = None, trainable: Incomplete | None = None, caching_device: Incomplete | None = None, validate_shape: bool = True, constraint: Incomplete | None = None, use_resource: Incomplete | None = None, collections: Incomplete | None = None, synchronization=..., aggregation=..., partitioner: Incomplete | None = None):
