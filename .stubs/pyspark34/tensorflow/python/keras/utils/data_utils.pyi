...
def get_file(fname, origin, untar: bool = False, md5_hash: Incomplete | None = None, file_hash: Incomplete | None = None, cache_subdir: str = 'datasets', hash_algorithm: str = 'auto', extract: bool = False, archive_format: str = 'auto', cache_dir: Incomplete | None = None):
