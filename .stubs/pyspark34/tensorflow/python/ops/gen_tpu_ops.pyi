...
def all_to_all(input, group_assignment, concat_dimension, split_dimension, split_count, name: Incomplete | None = None):
...
def assign_variable_xla_concat_nd(resource, inputs, num_concats, paddings=[], name: Incomplete | None = None):
...
AssignVariableXlaConcatND: Incomplete

def assign_variable_xla_concat_nd_eager_fallback(resource, inputs, num_concats, paddings, name, ctx): ...
def collective_permute(input, source_target_pairs, name: Incomplete | None = None):
...
def cross_replica_sum(input, group_assignment, name: Incomplete | None = None):
...
InfeedDequeueTuple: Incomplete

def infeed_dequeue_tuple_eager_fallback(dtypes, shapes, name, ctx): ...
def infeed_enqueue(input, shape=[], layout=[], device_ordinal: int = -1, name: Incomplete | None = None):
...
InfeedEnqueue: Incomplete

def infeed_enqueue_eager_fallback(input, shape, layout, device_ordinal, name, ctx): ...
def infeed_enqueue_prelinearized_buffer(input, device_ordinal: int = -1, name: Incomplete | None = None):
...
InfeedEnqueuePrelinearizedBuffer: Incomplete

def infeed_enqueue_prelinearized_buffer_eager_fallback(input, device_ordinal, name, ctx): ...
def infeed_enqueue_tuple(inputs, shapes, layouts=[], device_ordinal: int = -1, name: Incomplete | None = None):
...
def load_tpu_embedding_adam_parameters(parameters, momenta, velocities, num_shards, shard_id, table_id: int = -1, table_name: str = '', config: str = '', name: Incomplete | None = None):
...
LoadTPUEmbeddingADAMParameters: Incomplete
...
def load_tpu_embedding_adadelta_parameters(parameters, accumulators, updates, num_shards, shard_id, table_id: int = -1, table_name: str = '', config: str = '', name: Incomplete | None = None):
...
LoadTPUEmbeddingAdadeltaParameters: Incomplete
...
def load_tpu_embedding_adagrad_momentum_parameters(parameters, accumulators, momenta, num_shards, shard_id, table_id: int = -1, table_name: str = '', config: str = '', name: Incomplete | None = None):
...
LoadTPUEmbeddingAdagradMomentumParameters: Incomplete
...
def load_tpu_embedding_adagrad_parameters(parameters, accumulators, num_shards, shard_id, table_id: int = -1, table_name: str = '', config: str = '', name: Incomplete | None = None):
...
LoadTPUEmbeddingAdagradParameters: Incomplete
...
def load_tpu_embedding_centered_rms_prop_parameters(parameters, ms, mom, mg, num_shards, shard_id, table_id: int = -1, table_name: str = '', config: str = '', name: Incomplete | None = None):
...
LoadTPUEmbeddingCenteredRMSPropParameters: Incomplete
...
def load_tpu_embedding_ftrl_parameters(parameters, accumulators, linears, num_shards, shard_id, table_id: int = -1, table_name: str = '', config: str = '', name: Incomplete | None = None):
...
LoadTPUEmbeddingFTRLParameters: Incomplete
...
def load_tpu_embedding_frequency_estimator_parameters(parameters, last_hit_step, num_shards, shard_id, table_id: int = -1, table_name: str = '', config: str = '', name: Incomplete | None = None):
...
LoadTPUEmbeddingFrequencyEstimatorParameters: Incomplete
...
def load_tpu_embedding_mdl_adagrad_light_parameters(parameters, accumulators, weights, benefits, num_shards, shard_id, table_id: int = -1, table_name: str = '', config: str = '', name: Incomplete | None = None):
...
LoadTPUEmbeddingMDLAdagradLightParameters: Incomplete
...
def load_tpu_embedding_momentum_parameters(parameters, momenta, num_shards, shard_id, table_id: int = -1, table_name: str = '', config: str = '', name: Incomplete | None = None):
...
LoadTPUEmbeddingMomentumParameters: Incomplete
...
def load_tpu_embedding_proximal_adagrad_parameters(parameters, accumulators, num_shards, shard_id, table_id: int = -1, table_name: str = '', config: str = '', name: Incomplete | None = None):
...
LoadTPUEmbeddingProximalAdagradParameters: Incomplete
...
def load_tpu_embedding_proximal_yogi_parameters(parameters, v, m, num_shards, shard_id, table_id: int = -1, table_name: str = '', config: str = '', name: Incomplete | None = None):
    '''TODO: add doc.
...
LoadTPUEmbeddingProximalYogiParameters: Incomplete
...
def load_tpu_embedding_rms_prop_parameters(parameters, ms, mom, num_shards, shard_id, table_id: int = -1, table_name: str = '', config: str = '', name: Incomplete | None = None):
...
LoadTPUEmbeddingRMSPropParameters: Incomplete
...
def load_tpu_embedding_stochastic_gradient_descent_parameters(parameters, num_shards, shard_id, table_id: int = -1, table_name: str = '', config: str = '', name: Incomplete | None = None):
...
LoadTPUEmbeddingStochasticGradientDescentParameters: Incomplete
...
def outfeed_dequeue(dtype, shape, device_ordinal: int = -1, name: Incomplete | None = None):
...
OutfeedDequeue: Incomplete

def outfeed_dequeue_eager_fallback(dtype, shape, device_ordinal, name, ctx): ...
def outfeed_dequeue_tuple(dtypes, shapes, device_ordinal: int = -1, name: Incomplete | None = None):
...
OutfeedDequeueTuple: Incomplete

def outfeed_dequeue_tuple_eager_fallback(dtypes, shapes, device_ordinal, name, ctx): ...
def outfeed_dequeue_tuple_v2(device_ordinal, dtypes, shapes, name: Incomplete | None = None):
...
OutfeedDequeueTupleV2: Incomplete

def outfeed_dequeue_tuple_v2_eager_fallback(device_ordinal, dtypes, shapes, name, ctx): ...
def outfeed_dequeue_v2(device_ordinal, dtype, shape, name: Incomplete | None = None):
...
OutfeedDequeueV2: Incomplete

def outfeed_dequeue_v2_eager_fallback(device_ordinal, dtype, shape, name, ctx): ...
def outfeed_enqueue(input, name: Incomplete | None = None):
...
OutfeedEnqueue: Incomplete

def outfeed_enqueue_eager_fallback(input, name, ctx): ...
def outfeed_enqueue_tuple(inputs, name: Incomplete | None = None):
...
OutfeedEnqueueTuple: Incomplete

def outfeed_enqueue_tuple_eager_fallback(inputs, name, ctx): ...
def prelinearize(input, shape=[], layout=[], name: Incomplete | None = None):
...
Prelinearize: Incomplete

def prelinearize_eager_fallback(input, shape, layout, name, ctx): ...
def prelinearize_tuple(inputs, shapes, layouts=[], name: Incomplete | None = None):
...
PrelinearizeTuple: Incomplete

def prelinearize_tuple_eager_fallback(inputs, shapes, layouts, name, ctx): ...
def read_variable_xla_split_nd(resource, T, N, num_splits, paddings=[], name: Incomplete | None = None):
...
ReadVariableXlaSplitND: Incomplete
...
def retrieve_tpu_embedding_adam_parameters(num_shards, shard_id, table_id: int = -1, table_name: str = '', config: str = '', name: Incomplete | None = None):
...
RetrieveTPUEmbeddingADAMParameters: Incomplete
...
class _RetrieveTPUEmbeddingAdadeltaParametersOutput(NamedTuple):
    parameters: Incomplete
    accumulators: Incomplete
    updates: Incomplete

def retrieve_tpu_embedding_adadelta_parameters(num_shards, shard_id, table_id: int = -1, table_name: str = '', config: str = '', name: Incomplete | None = None):
...
RetrieveTPUEmbeddingAdadeltaParameters: Incomplete
...
def retrieve_tpu_embedding_adagrad_momentum_parameters(num_shards, shard_id, table_id: int = -1, table_name: str = '', config: str = '', name: Incomplete | None = None):
...
RetrieveTPUEmbeddingAdagradMomentumParameters: Incomplete
...
def retrieve_tpu_embedding_adagrad_parameters(num_shards, shard_id, table_id: int = -1, table_name: str = '', config: str = '', name: Incomplete | None = None):
...
RetrieveTPUEmbeddingAdagradParameters: Incomplete
...
def retrieve_tpu_embedding_centered_rms_prop_parameters(num_shards, shard_id, table_id: int = -1, table_name: str = '', config: str = '', name: Incomplete | None = None):
...
RetrieveTPUEmbeddingCenteredRMSPropParameters: Incomplete
...
def retrieve_tpu_embedding_ftrl_parameters(num_shards, shard_id, table_id: int = -1, table_name: str = '', config: str = '', name: Incomplete | None = None):
...
RetrieveTPUEmbeddingFTRLParameters: Incomplete
...
def retrieve_tpu_embedding_frequency_estimator_parameters(num_shards, shard_id, table_id: int = -1, table_name: str = '', config: str = '', name: Incomplete | None = None):
...
RetrieveTPUEmbeddingFrequencyEstimatorParameters: Incomplete
...
def retrieve_tpu_embedding_mdl_adagrad_light_parameters(num_shards, shard_id, table_id: int = -1, table_name: str = '', config: str = '', name: Incomplete | None = None):
...
RetrieveTPUEmbeddingMDLAdagradLightParameters: Incomplete
...
def retrieve_tpu_embedding_momentum_parameters(num_shards, shard_id, table_id: int = -1, table_name: str = '', config: str = '', name: Incomplete | None = None):
...
RetrieveTPUEmbeddingMomentumParameters: Incomplete
...
def retrieve_tpu_embedding_proximal_adagrad_parameters(num_shards, shard_id, table_id: int = -1, table_name: str = '', config: str = '', name: Incomplete | None = None):
...
RetrieveTPUEmbeddingProximalAdagradParameters: Incomplete
...
def retrieve_tpu_embedding_proximal_yogi_parameters(num_shards, shard_id, table_id: int = -1, table_name: str = '', config: str = '', name: Incomplete | None = None):
    '''TODO: add doc.
...
RetrieveTPUEmbeddingProximalYogiParameters: Incomplete
...
def retrieve_tpu_embedding_rms_prop_parameters(num_shards, shard_id, table_id: int = -1, table_name: str = '', config: str = '', name: Incomplete | None = None):
...
RetrieveTPUEmbeddingRMSPropParameters: Incomplete

def retrieve_tpu_embedding_rms_prop_parameters_eager_fallback(num_shards, shard_id, table_id, table_name, config, name, ctx): ...
def retrieve_tpu_embedding_stochastic_gradient_descent_parameters(num_shards, shard_id, table_id: int = -1, table_name: str = '', config: str = '', name: Incomplete | None = None):
...
RetrieveTPUEmbeddingStochasticGradientDescentParameters: Incomplete
...
def tpu_compilation_result(name: Incomplete | None = None):
...
TPUCompilationResult: Incomplete
...
def tpu_ordinal_selector(name: Incomplete | None = None):
...
TPUOrdinalSelector: Incomplete

def tpu_ordinal_selector_eager_fallback(name, ctx): ...
def tpu_partitioned_call(args, device_ordinal, Tout, f, autotuner_thresh: int = 0, name: Incomplete | None = None):
...
TPUPartitionedCall: Incomplete

def tpu_partitioned_call_eager_fallback(args, device_ordinal, Tout, f, autotuner_thresh, name, ctx): ...
def tpu_replicate_metadata(num_replicas, num_cores_per_replica: int = 1, topology: str = '', use_tpu: bool = True, device_assignment=[], computation_shape=[], host_compute_core=[], padding_map=[], step_marker_location: str = 'STEP_MARK_AT_ENTRY', allow_soft_placement: bool = False, use_spmd_for_xla_partitioning: bool = False, tpu_compile_options_proto: str = '', name: Incomplete | None = None):
...
TPUReplicateMetadata: Incomplete

def tpu_replicate_metadata_eager_fallback(num_replicas, num_cores_per_replica, topology, use_tpu, device_assignment, computation_shape, host_compute_core, padding_map, step_marker_location, allow_soft_placement, use_spmd_for_xla_partitioning, tpu_compile_options_proto, name, ctx): ...
def tpu_replicated_input(inputs, is_mirrored_variable: bool = False, index: int = -1, is_packed: bool = False, name: Incomplete | None = None):
...
TPUReplicatedInput: Incomplete

def tpu_replicated_input_eager_fallback(inputs, is_mirrored_variable, index, is_packed, name, ctx): ...
def tpu_replicated_output(input, num_replicas, name: Incomplete | None = None):
...
TPUReplicatedOutput: Incomplete

def tpu_replicated_output_eager_fallback(input, num_replicas, name, ctx): ...
def worker_heartbeat(request, name: Incomplete | None = None):
    """Worker heartbeat op.
...
WorkerHeartbeat: Incomplete

def worker_heartbeat_eager_fallback(request, name, ctx): ...
def xla_concat_nd(inputs, num_concats, paddings=[], name: Incomplete | None = None):
    '''Concats input tensor across all dimensions.
...
XlaConcatND: Incomplete

def xla_concat_nd_eager_fallback(inputs, num_concats, paddings, name, ctx): ...
def xla_split_nd(input, N, num_splits, paddings=[], name: Incomplete | None = None):
