...
class _BatchOutput(NamedTuple):
    batched_tensors: Incomplete
    batch_index: Incomplete
    id: Incomplete

def batch(in_tensors, num_batch_threads, max_batch_size, batch_timeout_micros, grad_timeout_micros, max_enqueued_batches: int = 10, allowed_batch_sizes=[], container: str = '', shared_name: str = '', batching_queue: str = '', name: Incomplete | None = None):
...
def batch_function(in_tensors, captured_tensors, f, num_batch_threads, max_batch_size, batch_timeout_micros, Tout, max_enqueued_batches: int = 10, allowed_batch_sizes=[], container: str = '', shared_name: str = '', batching_queue: str = '', enable_large_batch_splitting: bool = False, name: Incomplete | None = None):
...
def unbatch(batched_tensor, batch_index, id, timeout_micros, container: str = '', shared_name: str = '', name: Incomplete | None = None):
...
def unbatch_grad(original_input, batch_index, grad, id, container: str = '', shared_name: str = '', name: Incomplete | None = None):
    '''Gradient of Unbatch.
