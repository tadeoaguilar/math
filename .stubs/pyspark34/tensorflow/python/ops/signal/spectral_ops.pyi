...
def stft(signals, frame_length, frame_step, fft_length: Incomplete | None = None, window_fn=..., pad_end: bool = False, name: Incomplete | None = None):
  ...
  """
def inverse_stft_window_fn(frame_step, forward_window_fn=..., name: Incomplete | None = None):
  ...
  Returns:
    A callable that takes a window length and a `dtype` keyword argument and
      ...
      inverse_stft.
  """
def inverse_stft(stfts, frame_length, frame_step, fft_length: Incomplete | None = None, window_fn=..., name: Incomplete | None = None):
  ...
  [stft]: https://en.wikipedia.org/wiki/Short-time_Fourier_transform
  """
def mdct(signals, frame_length, window_fn=..., pad_end: bool = False, norm: Incomplete | None = None, name: Incomplete | None = None):
  ...
  '''
def inverse_mdct(mdcts, window_fn=..., norm: Incomplete | None = None, name: Incomplete | None = None):
