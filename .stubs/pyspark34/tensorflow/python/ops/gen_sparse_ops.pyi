...
def add_many_sparse_to_tensors_map(sparse_indices, sparse_values, sparse_shape, container: str = '', shared_name: str = '', name: Incomplete | None = None):
...
AddManySparseToTensorsMap: Incomplete
...
def add_sparse_to_tensors_map(sparse_indices, sparse_values, sparse_shape, container: str = '', shared_name: str = '', name: Incomplete | None = None):
...
AddSparseToTensorsMap: Incomplete
...
class _DeserializeManySparseOutput(NamedTuple):
    ...
    sparse_shape: Incomplete

def deserialize_many_sparse(serialized_sparse, dtype, name: Incomplete | None = None):
...
DeserializeManySparse: Incomplete
...
def deserialize_sparse(serialized_sparse, dtype, name: Incomplete | None = None):
...
DeserializeSparse: Incomplete

def deserialize_sparse_eager_fallback(serialized_sparse, dtype, name, ctx): ...
def serialize_many_sparse(sparse_indices, sparse_values, sparse_shape, out_type=..., name: Incomplete | None = None):
...
SerializeManySparse: Incomplete

def serialize_many_sparse_eager_fallback(sparse_indices, sparse_values, sparse_shape, out_type, name, ctx): ...
def serialize_sparse(sparse_indices, sparse_values, sparse_shape, out_type=..., name: Incomplete | None = None):
...
class _SparseAddOutput(NamedTuple):
    sum_indices: Incomplete
    sum_values: Incomplete
    sum_shape: Incomplete

def sparse_add(a_indices, a_values, a_shape, b_indices, b_values, b_shape, thresh, name: Incomplete | None = None):
...
class _SparseAddGradOutput(NamedTuple):
    a_val_grad: Incomplete
    b_val_grad: Incomplete

def sparse_add_grad(backprop_val_grad, a_indices, b_indices, sum_indices, name: Incomplete | None = None):
...
def sparse_concat(indices, values, shapes, concat_dim, name: Incomplete | None = None):
...
def sparse_cross(indices, values, shapes, dense_inputs, hashed_output, num_buckets, hash_key, out_type, internal_type, name: Incomplete | None = None):
...
def sparse_cross_hashed(indices, values, shapes, dense_inputs, num_buckets, strong_hash, salt, name: Incomplete | None = None):
    '''Generates sparse cross from a list of sparse and dense tensors.
...
def sparse_cross_v2(indices, values, shapes, dense_inputs, sep, name: Incomplete | None = None):
    '''Generates sparse cross from a list of sparse and dense tensors.
...
SparseCrossV2: Incomplete

def sparse_cross_v2_eager_fallback(indices, values, shapes, dense_inputs, sep, name, ctx): ...
def sparse_dense_cwise_add(sp_indices, sp_values, sp_shape, dense, name: Incomplete | None = None):
...
SparseDenseCwiseAdd: Incomplete

def sparse_dense_cwise_add_eager_fallback(sp_indices, sp_values, sp_shape, dense, name, ctx): ...
def sparse_dense_cwise_div(sp_indices, sp_values, sp_shape, dense, name: Incomplete | None = None):
...
SparseDenseCwiseDiv: Incomplete

def sparse_dense_cwise_div_eager_fallback(sp_indices, sp_values, sp_shape, dense, name, ctx): ...
def sparse_dense_cwise_mul(sp_indices, sp_values, sp_shape, dense, name: Incomplete | None = None):
...
SparseDenseCwiseMul: Incomplete
...
class _SparseFillEmptyRowsOutput(NamedTuple):
    output_indices: Incomplete
    output_values: Incomplete
    empty_row_indicator: Incomplete
    reverse_index_map: Incomplete

def sparse_fill_empty_rows(indices, values, dense_shape, default_value, name: Incomplete | None = None):
...
SparseFillEmptyRows: Incomplete
...
class _SparseFillEmptyRowsGradOutput(NamedTuple):
    d_values: Incomplete
    d_default_value: Incomplete

def sparse_fill_empty_rows_grad(reverse_index_map, grad_values, name: Incomplete | None = None):
...
SparseFillEmptyRowsGrad: Incomplete

def sparse_fill_empty_rows_grad_eager_fallback(reverse_index_map, grad_values, name, ctx): ...
def sparse_reduce_max(input_indices, input_values, input_shape, reduction_axes, keep_dims: bool = False, name: Incomplete | None = None):
...
def sparse_reduce_max_sparse(input_indices, input_values, input_shape, reduction_axes, keep_dims: bool = False, name: Incomplete | None = None):
    """Computes the max of elements across dimensions of a SparseTensor.
...
SparseReduceMaxSparse: Incomplete

def sparse_reduce_max_sparse_eager_fallback(input_indices, input_values, input_shape, reduction_axes, keep_dims, name, ctx): ...
def sparse_reduce_sum(input_indices, input_values, input_shape, reduction_axes, keep_dims: bool = False, name: Incomplete | None = None):
...
def sparse_reduce_sum_sparse(input_indices, input_values, input_shape, reduction_axes, keep_dims: bool = False, name: Incomplete | None = None):
    """Computes the sum of elements across dimensions of a SparseTensor.
...
SparseReduceSumSparse: Incomplete
...
def sparse_reorder(input_indices, input_values, input_shape, name: Incomplete | None = None):
...
def sparse_reshape(input_indices, input_shape, new_shape, name: Incomplete | None = None):
...
def sparse_slice(indices, values, shape, start, size, name: Incomplete | None = None):
...
SparseSlice: Incomplete

def sparse_slice_eager_fallback(indices, values, shape, start, size, name, ctx): ...
def sparse_slice_grad(backprop_val_grad, input_indices, input_start, output_indices, name: Incomplete | None = None):
...
def sparse_sparse_maximum(a_indices, a_values, a_shape, b_indices, b_values, b_shape, name: Incomplete | None = None):
...
SparseSparseMaximum: Incomplete
...
def sparse_sparse_minimum(a_indices, a_values, a_shape, b_indices, b_values, b_shape, name: Incomplete | None = None):
...
SparseSparseMinimum: Incomplete
...
def sparse_split(split_dim, indices, values, shape, num_split, name: Incomplete | None = None):
...
SparseSplit: Incomplete

def sparse_split_eager_fallback(split_dim, indices, values, shape, num_split, name, ctx): ...
def sparse_tensor_dense_add(a_indices, a_values, a_shape, b, name: Incomplete | None = None):
...
SparseTensorDenseAdd: Incomplete

def sparse_tensor_dense_add_eager_fallback(a_indices, a_values, a_shape, b, name, ctx): ...
def sparse_tensor_dense_mat_mul(a_indices, a_values, a_shape, b, adjoint_a: bool = False, adjoint_b: bool = False, name: Incomplete | None = None):
...
SparseTensorDenseMatMul: Incomplete

def sparse_tensor_dense_mat_mul_eager_fallback(a_indices, a_values, a_shape, b, adjoint_a, adjoint_b, name, ctx): ...
def sparse_to_dense(sparse_indices, output_shape, sparse_values, default_value, validate_indices: bool = True, name: Incomplete | None = None):
...
def take_many_sparse_from_tensors_map(sparse_handles, dtype, container: str = '', shared_name: str = '', name: Incomplete | None = None):
...
TakeManySparseFromTensorsMap: Incomplete
