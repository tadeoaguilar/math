...
def make_template(name_, func_, create_scope_now_: bool = False, unique_name_: Incomplete | None = None, custom_getter_: Incomplete | None = None, **kwargs):
...
class Template(trackable.Trackable):
  ...
  call.
  """
    def __init__(self, name, func, create_scope_now: bool = False, unique_name: Incomplete | None = None, custom_getter: Incomplete | None = None, create_graph_function: bool = False) -> None:
...
class _EagerTemplateVariableStore:
    ...
    def as_default(self) -> Generator[None, None, None]: ...
    def variables(self): ...
    def trainable_variables(self): ...
    def non_trainable_variables(self): ...
...
class EagerTemplate(Template):
  ...
  call.
  """
    def __init__(self, name, func, create_scope_now: bool = False, custom_getter: Incomplete | None = None, create_graph_function: bool = False) -> None:
        """Creates a template for the given function.
