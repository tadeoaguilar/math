...
def banded_triangular_solve(matrix, rhs, lower: bool = True, adjoint: bool = False, name: Incomplete | None = None):
    """TODO: add doc.
...
BandedTriangularSolve: Incomplete

def banded_triangular_solve_eager_fallback(matrix, rhs, lower, adjoint, name, ctx): ...
def batch_cholesky(input, name: Incomplete | None = None):
    """TODO: add doc.
...
BatchCholesky: Incomplete

def batch_cholesky_eager_fallback(input, name, ctx): ...
def batch_cholesky_grad(l, grad, name: Incomplete | None = None):
    """TODO: add doc.
...
BatchCholeskyGrad: Incomplete

def batch_cholesky_grad_eager_fallback(l, grad, name, ctx): ...
def batch_matrix_determinant(input, name: Incomplete | None = None):
    """TODO: add doc.
...
BatchMatrixDeterminant: Incomplete

def batch_matrix_determinant_eager_fallback(input, name, ctx): ...
def batch_matrix_inverse(input, adjoint: bool = False, name: Incomplete | None = None):
    """TODO: add doc.
...
BatchMatrixInverse: Incomplete

def batch_matrix_inverse_eager_fallback(input, adjoint, name, ctx): ...
def batch_matrix_solve(matrix, rhs, adjoint: bool = False, name: Incomplete | None = None):
    """TODO: add doc.
...
BatchMatrixSolve: Incomplete

def batch_matrix_solve_eager_fallback(matrix, rhs, adjoint, name, ctx): ...
def batch_matrix_solve_ls(matrix, rhs, l2_regularizer, fast: bool = True, name: Incomplete | None = None):
    """TODO: add doc.
...
BatchMatrixSolveLs: Incomplete

def batch_matrix_solve_ls_eager_fallback(matrix, rhs, l2_regularizer, fast, name, ctx): ...
def batch_matrix_triangular_solve(matrix, rhs, lower: bool = True, adjoint: bool = False, name: Incomplete | None = None):
    """TODO: add doc.
...
BatchMatrixTriangularSolve: Incomplete

def batch_matrix_triangular_solve_eager_fallback(matrix, rhs, lower, adjoint, name, ctx): ...
def batch_self_adjoint_eig(input, name: Incomplete | None = None):
    """TODO: add doc.
...
BatchSelfAdjointEig: Incomplete
...
def batch_self_adjoint_eig_v2(input, compute_v: bool = True, name: Incomplete | None = None):
    """TODO: add doc.
...
BatchSelfAdjointEigV2: Incomplete
...
def batch_svd(input, compute_uv: bool = True, full_matrices: bool = False, name: Incomplete | None = None):
    """TODO: add doc.
...
def cholesky(input, name: Incomplete | None = None):
...
def cholesky_grad(l, grad, name: Incomplete | None = None):
...
def eig(input, Tout, compute_v: bool = True, name: Incomplete | None = None):
...
def einsum(inputs, equation, name: Incomplete | None = None):
...
class _LogMatrixDeterminantOutput(NamedTuple):
    sign: Incomplete
    log_abs_determinant: Incomplete

def log_matrix_determinant(input, name: Incomplete | None = None):
...
LogMatrixDeterminant: Incomplete
...
def lu(input, output_idx_type=..., name: Incomplete | None = None):
...
def matrix_determinant(input, name: Incomplete | None = None):
...
MatrixExponential: Incomplete

def matrix_exponential_eager_fallback(input, name, ctx): ...
def matrix_inverse(input, adjoint: bool = False, name: Incomplete | None = None):
...
MatrixInverse: Incomplete

def matrix_inverse_eager_fallback(input, adjoint, name, ctx): ...
def matrix_logarithm(input, name: Incomplete | None = None):
...
MatrixLogarithm: Incomplete

def matrix_logarithm_eager_fallback(input, name, ctx): ...
def matrix_solve(matrix, rhs, adjoint: bool = False, name: Incomplete | None = None):
...
MatrixSolve: Incomplete

def matrix_solve_eager_fallback(matrix, rhs, adjoint, name, ctx): ...
def matrix_solve_ls(matrix, rhs, l2_regularizer, fast: bool = True, name: Incomplete | None = None):
...
MatrixSolveLs: Incomplete

def matrix_solve_ls_eager_fallback(matrix, rhs, l2_regularizer, fast, name, ctx): ...
def matrix_square_root(input, name: Incomplete | None = None):
...
MatrixSquareRoot: Incomplete

def matrix_square_root_eager_fallback(input, name, ctx): ...
def matrix_triangular_solve(matrix, rhs, lower: bool = True, adjoint: bool = False, name: Incomplete | None = None):
...
MatrixTriangularSolve: Incomplete
...
def qr(input, full_matrices: bool = False, name: Incomplete | None = None):
...
def self_adjoint_eig(input, name: Incomplete | None = None):
...
def self_adjoint_eig_v2(input, compute_v: bool = True, name: Incomplete | None = None):
...
def svd(input, compute_uv: bool = True, full_matrices: bool = False, name: Incomplete | None = None):
...
def tridiagonal_mat_mul(superdiag, maindiag, subdiag, rhs, name: Incomplete | None = None):
...
TridiagonalMatMul: Incomplete

def tridiagonal_mat_mul_eager_fallback(superdiag, maindiag, subdiag, rhs, name, ctx): ...
def tridiagonal_solve(diagonals, rhs, partial_pivoting: bool = True, perturb_singular: bool = False, name: Incomplete | None = None):
