...
StatelessMultinomial: Incomplete

def stateless_multinomial_eager_fallback(logits, num_samples, seed, output_dtype, name, ctx): ...
def stateless_parameterized_truncated_normal(shape, seed, means, stddevs, minvals, maxvals, name: Incomplete | None = None):
    """TODO: add doc.
...
StatelessParameterizedTruncatedNormal: Incomplete

def stateless_parameterized_truncated_normal_eager_fallback(shape, seed, means, stddevs, minvals, maxvals, name, ctx): ...
def stateless_random_binomial(shape, seed, counts, probs, dtype=..., name: Incomplete | None = None):
...
StatelessRandomBinomial: Incomplete

def stateless_random_binomial_eager_fallback(shape, seed, counts, probs, dtype, name, ctx): ...
def stateless_random_gamma_v2(shape, seed, alpha, name: Incomplete | None = None):
...
StatelessRandomGammaV2: Incomplete

def stateless_random_gamma_v2_eager_fallback(shape, seed, alpha, name, ctx): ...
def stateless_random_normal(shape, seed, dtype=..., name: Incomplete | None = None):
...
StatelessRandomNormal: Incomplete
...
StatelessRandomPoisson: Incomplete

def stateless_random_poisson_eager_fallback(shape, seed, lam, dtype, name, ctx): ...
def stateless_random_uniform(shape, seed, dtype=..., name: Incomplete | None = None):
...
StatelessRandomUniform: Incomplete

def stateless_random_uniform_eager_fallback(shape, seed, dtype, name, ctx): ...
def stateless_random_uniform_full_int(shape, seed, dtype=..., name: Incomplete | None = None):
...
StatelessRandomUniformFullInt: Incomplete

def stateless_random_uniform_full_int_eager_fallback(shape, seed, dtype, name, ctx): ...
def stateless_random_uniform_int(shape, seed, minval, maxval, name: Incomplete | None = None):
    """Outputs deterministic pseudorandom random integers from a uniform distribution.
...
StatelessRandomUniformInt: Incomplete

def stateless_random_uniform_int_eager_fallback(shape, seed, minval, maxval, name, ctx): ...
def stateless_truncated_normal(shape, seed, dtype=..., name: Incomplete | None = None):
...
StatelessTruncatedNormal: Incomplete
