...
def clip_by_value(t, clip_value_min, clip_value_max, name: Incomplete | None = None):
  ...
  """
def clip_by_norm(t, clip_norm, axes: Incomplete | None = None, name: Incomplete | None = None):
  ...
  Raises:
    ...
    TypeError: If dtype of the input is not a floating point or
      complex type.
  """
def global_norm(t_list, name: Incomplete | None = None):
  ...
  """
def clip_by_global_norm(t_list, clip_norm, use_norm: Incomplete | None = None, name: Incomplete | None = None):
  ...
  """
def clip_by_average_norm(t, clip_norm, name: Incomplete | None = None):
