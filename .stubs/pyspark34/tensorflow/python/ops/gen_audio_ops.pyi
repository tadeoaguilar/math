...
def audio_spectrogram(input, window_size, stride, magnitude_squared: bool = False, name: Incomplete | None = None):
...
def decode_wav(contents, desired_channels: int = -1, desired_samples: int = -1, name: Incomplete | None = None):
...
EncodeWav: Incomplete

def encode_wav_eager_fallback(audio, sample_rate, name, ctx): ...
def mfcc(spectrogram, sample_rate, upper_frequency_limit: int = 4000, lower_frequency_limit: int = 20, filterbank_channel_count: int = 40, dct_coefficient_count: int = 13, name: Incomplete | None = None):
