...
def gradients(ys, xs, grad_ys: Incomplete | None = None, name: str = 'gradients', colocate_gradients_with_ops: bool = False, gate_gradients: bool = False, aggregation_method: Incomplete | None = None, stop_gradients: Incomplete | None = None, unconnected_gradients=...):
  ...
  """
def gradients_v2(ys, xs, grad_ys: Incomplete | None = None, name: str = 'gradients', gate_gradients: bool = False, aggregation_method: Incomplete | None = None, stop_gradients: Incomplete | None = None, unconnected_gradients=...):
    """Constructs symbolic derivatives of sum of `ys` w.r.t. x in `xs`.
  ...
  """
def hessians(ys, xs, name: str = 'hessians', colocate_gradients_with_ops: bool = False, gate_gradients: bool = False, aggregation_method: Incomplete | None = None):
  ...
  Raises:
    LookupError: if one of the operations between `xs` and `ys` does not
      have a registered gradient function.
  """
def HessiansV2(ys, xs, gate_gradients: bool = False, aggregation_method: Incomplete | None = None, name: str = 'hessians'):
    """Constructs the Hessian of sum of `ys` with respect to `x` in `xs`.
