...
class _ExecutionSignature(NamedTuple('_ExecutionSignature', [('op', Incomplete), ('handle', Incomplete), ('resources', Incomplete), ('exclusive_resource_access', Incomplete)])):
...
class CriticalSection:
  ...
  **NOTES**
  ...
  ```
  '''
    def __init__(self, name: Incomplete | None = None, shared_name: Incomplete | None = None, critical_section_def: Incomplete | None = None, import_scope: Incomplete | None = None) -> None:
        """Creates a critical section."""
    @property
    def name(self): ...
    def execute(self, fn, exclusive_resource_access: bool = True, name: Incomplete | None = None):
