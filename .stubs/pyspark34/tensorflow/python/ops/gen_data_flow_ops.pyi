...
def accumulator_apply_gradient(handle, local_step, gradient, name: Incomplete | None = None):
...
AccumulatorApplyGradient: Incomplete

def accumulator_apply_gradient_eager_fallback(handle, local_step, gradient, name, ctx) -> None: ...
def accumulator_num_accumulated(handle, name: Incomplete | None = None):
...
AccumulatorNumAccumulated: Incomplete

def accumulator_num_accumulated_eager_fallback(handle, name, ctx) -> None: ...
def accumulator_set_global_step(handle, new_global_step, name: Incomplete | None = None):
...
AccumulatorSetGlobalStep: Incomplete

def accumulator_set_global_step_eager_fallback(handle, new_global_step, name, ctx) -> None: ...
def accumulator_take_gradient(handle, num_required, dtype, name: Incomplete | None = None):
...
AccumulatorTakeGradient: Incomplete

def accumulator_take_gradient_eager_fallback(handle, num_required, dtype, name, ctx) -> None: ...
def barrier(component_types, shapes=[], capacity: int = -1, container: str = '', shared_name: str = '', name: Incomplete | None = None):
...
def barrier_close(handle, cancel_pending_enqueues: bool = False, name: Incomplete | None = None):
...
BarrierClose: Incomplete

def barrier_close_eager_fallback(handle, cancel_pending_enqueues, name, ctx) -> None: ...
def barrier_incomplete_size(handle, name: Incomplete | None = None):
...
BarrierIncompleteSize: Incomplete

def barrier_incomplete_size_eager_fallback(handle, name, ctx) -> None: ...
def barrier_insert_many(handle, keys, values, component_index, name: Incomplete | None = None):
...
def barrier_take_many(handle, num_elements, component_types, allow_small_batch: bool = False, wait_for_incomplete: bool = False, timeout_ms: int = -1, name: Incomplete | None = None):
...
def conditional_accumulator(dtype, shape, container: str = '', shared_name: str = '', reduction_type: str = 'MEAN', name: Incomplete | None = None):
...
ConditionalAccumulator: Incomplete
...
DeleteSessionTensor: Incomplete

def delete_session_tensor_eager_fallback(handle, name, ctx): ...
def dynamic_partition(data, partitions, num_partitions, name: Incomplete | None = None):
...
DynamicPartition: Incomplete

def dynamic_partition_eager_fallback(data, partitions, num_partitions, name, ctx): ...
def dynamic_stitch(indices, data, name: Incomplete | None = None):
...
DynamicStitch: Incomplete

def dynamic_stitch_eager_fallback(indices, data, name, ctx): ...
def fifo_queue(component_types, shapes=[], capacity: int = -1, container: str = '', shared_name: str = '', name: Incomplete | None = None):
...
FIFOQueue: Incomplete

def fifo_queue_eager_fallback(component_types, shapes, capacity, container, shared_name, name, ctx) -> None: ...
def fifo_queue_v2(component_types, shapes=[], capacity: int = -1, container: str = '', shared_name: str = '', name: Incomplete | None = None):
    '''A queue that produces elements in first-in first-out order.
...
FakeQueue: Incomplete

def fake_queue_eager_fallback(resource, name, ctx) -> None: ...
def get_session_handle(value, name: Incomplete | None = None):
...
GetSessionHandle: Incomplete

def get_session_handle_eager_fallback(value, name, ctx): ...
def get_session_handle_v2(value, name: Incomplete | None = None):
    """Store the input tensor in the state of the current session.
...
GetSessionTensor: Incomplete

def get_session_tensor_eager_fallback(handle, dtype, name, ctx): ...
def map_clear(dtypes, capacity: int = 0, memory_limit: int = 0, container: str = '', shared_name: str = '', name: Incomplete | None = None):
...
def map_incomplete_size(dtypes, capacity: int = 0, memory_limit: int = 0, container: str = '', shared_name: str = '', name: Incomplete | None = None):
...
MapIncompleteSize: Incomplete

def map_incomplete_size_eager_fallback(dtypes, capacity, memory_limit, container, shared_name, name, ctx): ...
def map_peek(key, indices, dtypes, capacity: int = 0, memory_limit: int = 0, container: str = '', shared_name: str = '', name: Incomplete | None = None):
...
def map_size(dtypes, capacity: int = 0, memory_limit: int = 0, container: str = '', shared_name: str = '', name: Incomplete | None = None):
...
def map_stage(key, indices, values, dtypes, capacity: int = 0, memory_limit: int = 0, container: str = '', shared_name: str = '', name: Incomplete | None = None):
...
def map_unstage(key, indices, dtypes, capacity: int = 0, memory_limit: int = 0, container: str = '', shared_name: str = '', name: Incomplete | None = None):
...
def map_unstage_no_key(indices, dtypes, capacity: int = 0, memory_limit: int = 0, container: str = '', shared_name: str = '', name: Incomplete | None = None):
...
MapUnstageNoKey: Incomplete

def map_unstage_no_key_eager_fallback(indices, dtypes, capacity, memory_limit, container, shared_name, name, ctx): ...
def ordered_map_clear(dtypes, capacity: int = 0, memory_limit: int = 0, container: str = '', shared_name: str = '', name: Incomplete | None = None):
    '''Op removes all elements in the underlying container.
...
OrderedMapClear: Incomplete

def ordered_map_clear_eager_fallback(dtypes, capacity, memory_limit, container, shared_name, name, ctx): ...
def ordered_map_incomplete_size(dtypes, capacity: int = 0, memory_limit: int = 0, container: str = '', shared_name: str = '', name: Incomplete | None = None):
    '''Op returns the number of incomplete elements in the underlying container.
...
OrderedMapIncompleteSize: Incomplete

def ordered_map_incomplete_size_eager_fallback(dtypes, capacity, memory_limit, container, shared_name, name, ctx): ...
def ordered_map_peek(key, indices, dtypes, capacity: int = 0, memory_limit: int = 0, container: str = '', shared_name: str = '', name: Incomplete | None = None):
    '''Op peeks at the values at the specified key.  If the
...
OrderedMapPeek: Incomplete

def ordered_map_peek_eager_fallback(key, indices, dtypes, capacity, memory_limit, container, shared_name, name, ctx): ...
def ordered_map_size(dtypes, capacity: int = 0, memory_limit: int = 0, container: str = '', shared_name: str = '', name: Incomplete | None = None):
    '''Op returns the number of elements in the underlying container.
...
OrderedMapSize: Incomplete

def ordered_map_size_eager_fallback(dtypes, capacity, memory_limit, container, shared_name, name, ctx): ...
def ordered_map_stage(key, indices, values, dtypes, capacity: int = 0, memory_limit: int = 0, container: str = '', shared_name: str = '', name: Incomplete | None = None):
...
OrderedMapStage: Incomplete

def ordered_map_stage_eager_fallback(key, indices, values, dtypes, capacity, memory_limit, container, shared_name, name, ctx): ...
def ordered_map_unstage(key, indices, dtypes, capacity: int = 0, memory_limit: int = 0, container: str = '', shared_name: str = '', name: Incomplete | None = None):
    '''Op removes and returns the values associated with the key
...
def ordered_map_unstage_no_key(indices, dtypes, capacity: int = 0, memory_limit: int = 0, container: str = '', shared_name: str = '', name: Incomplete | None = None):
...
OrderedMapUnstageNoKey: Incomplete

def ordered_map_unstage_no_key_eager_fallback(indices, dtypes, capacity, memory_limit, container, shared_name, name, ctx): ...
def padding_fifo_queue(component_types, shapes=[], capacity: int = -1, container: str = '', shared_name: str = '', name: Incomplete | None = None):
    '''A queue that produces elements in first-in first-out order.
...
PaddingFIFOQueue: Incomplete

def padding_fifo_queue_eager_fallback(component_types, shapes, capacity, container, shared_name, name, ctx) -> None: ...
def padding_fifo_queue_v2(component_types, shapes=[], capacity: int = -1, container: str = '', shared_name: str = '', name: Incomplete | None = None):
    '''A queue that produces elements in first-in first-out order.
...
ParallelDynamicStitch: Incomplete

def parallel_dynamic_stitch_eager_fallback(indices, data, name, ctx): ...
def priority_queue(shapes, component_types=[], capacity: int = -1, container: str = '', shared_name: str = '', name: Incomplete | None = None):
...
PriorityQueue: Incomplete

def priority_queue_eager_fallback(shapes, component_types, capacity, container, shared_name, name, ctx) -> None: ...
def priority_queue_v2(shapes, component_types=[], capacity: int = -1, container: str = '', shared_name: str = '', name: Incomplete | None = None):
    '''A queue that produces elements sorted by the first component value.
...
PriorityQueueV2: Incomplete

def priority_queue_v2_eager_fallback(shapes, component_types, capacity, container, shared_name, name, ctx): ...
def queue_close(handle, cancel_pending_enqueues: bool = False, name: Incomplete | None = None):
...
QueueClose: Incomplete

def queue_close_eager_fallback(handle, cancel_pending_enqueues, name, ctx) -> None: ...
def queue_close_v2(handle, cancel_pending_enqueues: bool = False, name: Incomplete | None = None):
    """Closes the given queue.
...
QueueCloseV2: Incomplete

def queue_close_v2_eager_fallback(handle, cancel_pending_enqueues, name, ctx): ...
def queue_dequeue(handle, component_types, timeout_ms: int = -1, name: Incomplete | None = None):
...
QueueDequeue: Incomplete

def queue_dequeue_eager_fallback(handle, component_types, timeout_ms, name, ctx) -> None: ...
def queue_dequeue_many(handle, n, component_types, timeout_ms: int = -1, name: Incomplete | None = None):
...
QueueDequeueMany: Incomplete

def queue_dequeue_many_eager_fallback(handle, n, component_types, timeout_ms, name, ctx) -> None: ...
def queue_dequeue_many_v2(handle, n, component_types, timeout_ms: int = -1, name: Incomplete | None = None):
    """Dequeues `n` tuples of one or more tensors from the given queue.
...
QueueDequeueManyV2: Incomplete

def queue_dequeue_many_v2_eager_fallback(handle, n, component_types, timeout_ms, name, ctx): ...
def queue_dequeue_up_to(handle, n, component_types, timeout_ms: int = -1, name: Incomplete | None = None):
    """Dequeues `n` tuples of one or more tensors from the given queue.
...
QueueDequeueUpTo: Incomplete

def queue_dequeue_up_to_eager_fallback(handle, n, component_types, timeout_ms, name, ctx) -> None: ...
def queue_dequeue_up_to_v2(handle, n, component_types, timeout_ms: int = -1, name: Incomplete | None = None):
    """Dequeues `n` tuples of one or more tensors from the given queue.
...
QueueDequeueUpToV2: Incomplete

def queue_dequeue_up_to_v2_eager_fallback(handle, n, component_types, timeout_ms, name, ctx): ...
def queue_dequeue_v2(handle, component_types, timeout_ms: int = -1, name: Incomplete | None = None):
    """Dequeues a tuple of one or more tensors from the given queue.
...
QueueDequeueV2: Incomplete

def queue_dequeue_v2_eager_fallback(handle, component_types, timeout_ms, name, ctx): ...
def queue_enqueue(handle, components, timeout_ms: int = -1, name: Incomplete | None = None):
...
QueueEnqueue: Incomplete

def queue_enqueue_eager_fallback(handle, components, timeout_ms, name, ctx) -> None: ...
def queue_enqueue_many(handle, components, timeout_ms: int = -1, name: Incomplete | None = None):
...
QueueEnqueueMany: Incomplete

def queue_enqueue_many_eager_fallback(handle, components, timeout_ms, name, ctx) -> None: ...
def queue_enqueue_many_v2(handle, components, timeout_ms: int = -1, name: Incomplete | None = None):
    """Enqueues zero or more tuples of one or more tensors in the given queue.
...
QueueEnqueueManyV2: Incomplete

def queue_enqueue_many_v2_eager_fallback(handle, components, timeout_ms, name, ctx): ...
def queue_enqueue_v2(handle, components, timeout_ms: int = -1, name: Incomplete | None = None):
    """Enqueues a tuple of one or more tensors in the given queue.
...
QueueEnqueueV2: Incomplete

def queue_enqueue_v2_eager_fallback(handle, components, timeout_ms, name, ctx): ...
def queue_is_closed(handle, name: Incomplete | None = None):
...
QueueIsClosed: Incomplete

def queue_is_closed_eager_fallback(handle, name, ctx) -> None: ...
def queue_is_closed_v2(handle, name: Incomplete | None = None):
    """Returns true if queue is closed.
...
QueueIsClosedV2: Incomplete

def queue_is_closed_v2_eager_fallback(handle, name, ctx): ...
def queue_size(handle, name: Incomplete | None = None):
...
QueueSize: Incomplete

def queue_size_eager_fallback(handle, name, ctx) -> None: ...
def queue_size_v2(handle, name: Incomplete | None = None):
    """Computes the number of elements in the given queue.
...
QueueSizeV2: Incomplete

def queue_size_v2_eager_fallback(handle, name, ctx): ...
def random_shuffle_queue(component_types, shapes=[], capacity: int = -1, min_after_dequeue: int = 0, seed: int = 0, seed2: int = 0, container: str = '', shared_name: str = '', name: Incomplete | None = None):
...
def random_shuffle_queue_v2(component_types, shapes=[], capacity: int = -1, min_after_dequeue: int = 0, seed: int = 0, seed2: int = 0, container: str = '', shared_name: str = '', name: Incomplete | None = None):
    '''A queue that randomizes the order of elements.
...
RandomShuffleQueueV2: Incomplete
...
def record_input(file_pattern, file_random_seed: int = 301, file_shuffle_shift_ratio: int = 0, file_buffer_size: int = 10000, file_parallelism: int = 16, batch_size: int = 32, compression_type: str = '', name: Incomplete | None = None):
...
def resource_accumulator_apply_gradient(handle, local_step, gradient, name: Incomplete | None = None):
    """Applies a gradient to a given accumulator.
...
ResourceAccumulatorApplyGradient: Incomplete

def resource_accumulator_apply_gradient_eager_fallback(handle, local_step, gradient, name, ctx): ...
def resource_accumulator_num_accumulated(handle, name: Incomplete | None = None):
    """Returns the number of gradients aggregated in the given accumulators.
...
ResourceAccumulatorNumAccumulated: Incomplete

def resource_accumulator_num_accumulated_eager_fallback(handle, name, ctx): ...
def resource_accumulator_set_global_step(handle, new_global_step, name: Incomplete | None = None):
    """Updates the accumulator with a new value for global_step.
...
ResourceAccumulatorSetGlobalStep: Incomplete

def resource_accumulator_set_global_step_eager_fallback(handle, new_global_step, name, ctx): ...
def resource_accumulator_take_gradient(handle, num_required, dtype, name: Incomplete | None = None):
    """Extracts the average gradient in the given ConditionalAccumulator.
...
ResourceAccumulatorTakeGradient: Incomplete

def resource_accumulator_take_gradient_eager_fallback(handle, num_required, dtype, name, ctx): ...
def resource_conditional_accumulator(dtype, shape, container: str = '', shared_name: str = '', reduction_type: str = 'MEAN', name: Incomplete | None = None):
    '''A conditional accumulator for aggregating gradients.
...
ResourceConditionalAccumulator: Incomplete

def resource_conditional_accumulator_eager_fallback(dtype, shape, container, shared_name, reduction_type, name, ctx): ...
def sparse_accumulator_apply_gradient(handle, local_step, gradient_indices, gradient_values, gradient_shape, has_known_shape, name: Incomplete | None = None):
...
SparseAccumulatorApplyGradient: Incomplete
...
def sparse_accumulator_take_gradient(handle, num_required, dtype, name: Incomplete | None = None):
...
SparseAccumulatorTakeGradient: Incomplete

def sparse_accumulator_take_gradient_eager_fallback(handle, num_required, dtype, name, ctx) -> None: ...
def sparse_conditional_accumulator(dtype, shape, container: str = '', shared_name: str = '', reduction_type: str = 'MEAN', name: Incomplete | None = None):
...
StackClose: Incomplete

def stack_close_eager_fallback(handle, name, ctx) -> None: ...
def stack_close_v2(handle, name: Incomplete | None = None):
...
StackCloseV2: Incomplete

def stack_close_v2_eager_fallback(handle, name, ctx): ...
def stack_pop(handle, elem_type, name: Incomplete | None = None):
...
def stack_pop_v2(handle, elem_type, name: Incomplete | None = None):
...
StackPopV2: Incomplete

def stack_pop_v2_eager_fallback(handle, elem_type, name, ctx): ...
def stack_push(handle, elem, swap_memory: bool = False, name: Incomplete | None = None):
...
StackPush: Incomplete

def stack_push_eager_fallback(handle, elem, swap_memory, name, ctx) -> None: ...
def stack_push_v2(handle, elem, swap_memory: bool = False, name: Incomplete | None = None):
...
StackPushV2: Incomplete

def stack_push_v2_eager_fallback(handle, elem, swap_memory, name, ctx): ...
def stack_v2(max_size, elem_type, stack_name: str = '', name: Incomplete | None = None):
...
def stage(values, capacity: int = 0, memory_limit: int = 0, container: str = '', shared_name: str = '', name: Incomplete | None = None):
...
def stage_clear(dtypes, capacity: int = 0, memory_limit: int = 0, container: str = '', shared_name: str = '', name: Incomplete | None = None):
    '''Op removes all elements in the underlying container.
...
StageClear: Incomplete

def stage_clear_eager_fallback(dtypes, capacity, memory_limit, container, shared_name, name, ctx): ...
def stage_peek(index, dtypes, capacity: int = 0, memory_limit: int = 0, container: str = '', shared_name: str = '', name: Incomplete | None = None):
...
StagePeek: Incomplete

def stage_peek_eager_fallback(index, dtypes, capacity, memory_limit, container, shared_name, name, ctx): ...
def stage_size(dtypes, capacity: int = 0, memory_limit: int = 0, container: str = '', shared_name: str = '', name: Incomplete | None = None):
    '''Op returns the number of elements in the underlying container.
...
StageSize: Incomplete

def stage_size_eager_fallback(dtypes, capacity, memory_limit, container, shared_name, name, ctx): ...
def tensor_array(size, dtype, dynamic_size: bool = False, clear_after_read: bool = True, tensor_array_name: str = '', element_shape: Incomplete | None = None, name: Incomplete | None = None):
    '''TODO: add doc.
...
TensorArrayClose: Incomplete

def tensor_array_close_eager_fallback(handle, name, ctx) -> None: ...
def tensor_array_close_v2(handle, name: Incomplete | None = None):
...
TensorArrayCloseV2: Incomplete

def tensor_array_close_v2_eager_fallback(handle, name, ctx): ...
def tensor_array_close_v3(handle, name: Incomplete | None = None):
...
def tensor_array_concat(handle, flow_in, dtype, element_shape_except0: Incomplete | None = None, name: Incomplete | None = None):
    """TODO: add doc.
...
def tensor_array_concat_v2(handle, flow_in, dtype, element_shape_except0: Incomplete | None = None, name: Incomplete | None = None):
...
TensorArrayConcatV2: Incomplete
...
def tensor_array_concat_v3(handle, flow_in, dtype, element_shape_except0: Incomplete | None = None, name: Incomplete | None = None):
...
TensorArrayConcatV3: Incomplete

def tensor_array_concat_v3_eager_fallback(handle, flow_in, dtype, element_shape_except0, name, ctx): ...
def tensor_array_gather(handle, indices, flow_in, dtype, element_shape: Incomplete | None = None, name: Incomplete | None = None):
    """TODO: add doc.
...
TensorArrayGather: Incomplete

def tensor_array_gather_eager_fallback(handle, indices, flow_in, dtype, element_shape, name, ctx) -> None: ...
def tensor_array_gather_v2(handle, indices, flow_in, dtype, element_shape: Incomplete | None = None, name: Incomplete | None = None):
...
TensorArrayGatherV2: Incomplete

def tensor_array_gather_v2_eager_fallback(handle, indices, flow_in, dtype, element_shape, name, ctx): ...
def tensor_array_gather_v3(handle, indices, flow_in, dtype, element_shape: Incomplete | None = None, name: Incomplete | None = None):
...
TensorArrayGatherV3: Incomplete

def tensor_array_gather_v3_eager_fallback(handle, indices, flow_in, dtype, element_shape, name, ctx): ...
def tensor_array_grad(handle, flow_in, source, name: Incomplete | None = None):
    """TODO: add doc.
...
TensorArrayGrad: Incomplete

def tensor_array_grad_eager_fallback(handle, flow_in, source, name, ctx) -> None: ...
def tensor_array_grad_v2(handle, flow_in, source, name: Incomplete | None = None):
...
TensorArrayGradV2: Incomplete

def tensor_array_grad_v2_eager_fallback(handle, flow_in, source, name, ctx): ...

class _TensorArrayGradV3Output(NamedTuple):
    grad_handle: Incomplete
    flow_out: Incomplete

def tensor_array_grad_v3(handle, flow_in, source, name: Incomplete | None = None):
...
def tensor_array_grad_with_shape(handle, flow_in, shape_to_prepend, source, name: Incomplete | None = None):
...
TensorArrayGradWithShape: Incomplete

def tensor_array_grad_with_shape_eager_fallback(handle, flow_in, shape_to_prepend, source, name, ctx): ...
def tensor_array_pack(handle, flow_in, dtype, element_shape: Incomplete | None = None, name: Incomplete | None = None):
    """TODO: add doc.
...
TensorArrayPack: Incomplete

def tensor_array_pack_eager_fallback(handle, flow_in, dtype, element_shape, name, ctx) -> None: ...
def tensor_array_read(handle, index, flow_in, dtype, name: Incomplete | None = None):
    """TODO: add doc.
...
TensorArrayRead: Incomplete

def tensor_array_read_eager_fallback(handle, index, flow_in, dtype, name, ctx) -> None: ...
def tensor_array_read_v2(handle, index, flow_in, dtype, name: Incomplete | None = None):
...
TensorArrayReadV2: Incomplete

def tensor_array_read_v2_eager_fallback(handle, index, flow_in, dtype, name, ctx): ...
def tensor_array_read_v3(handle, index, flow_in, dtype, name: Incomplete | None = None):
...
TensorArrayReadV3: Incomplete

def tensor_array_read_v3_eager_fallback(handle, index, flow_in, dtype, name, ctx): ...
def tensor_array_scatter(handle, indices, value, flow_in, name: Incomplete | None = None):
    """TODO: add doc.
...
TensorArrayScatter: Incomplete

def tensor_array_scatter_eager_fallback(handle, indices, value, flow_in, name, ctx) -> None: ...
def tensor_array_scatter_v2(handle, indices, value, flow_in, name: Incomplete | None = None):
...
TensorArrayScatterV2: Incomplete

def tensor_array_scatter_v2_eager_fallback(handle, indices, value, flow_in, name, ctx): ...
def tensor_array_scatter_v3(handle, indices, value, flow_in, name: Incomplete | None = None):
...
TensorArrayScatterV3: Incomplete

def tensor_array_scatter_v3_eager_fallback(handle, indices, value, flow_in, name, ctx): ...
def tensor_array_size(handle, flow_in, name: Incomplete | None = None):
    """TODO: add doc.
...
TensorArraySize: Incomplete

def tensor_array_size_eager_fallback(handle, flow_in, name, ctx) -> None: ...
def tensor_array_size_v2(handle, flow_in, name: Incomplete | None = None):
...
TensorArraySizeV2: Incomplete

def tensor_array_size_v2_eager_fallback(handle, flow_in, name, ctx): ...
def tensor_array_size_v3(handle, flow_in, name: Incomplete | None = None):
...
TensorArraySizeV3: Incomplete

def tensor_array_size_v3_eager_fallback(handle, flow_in, name, ctx): ...
def tensor_array_split(handle, value, lengths, flow_in, name: Incomplete | None = None):
    """TODO: add doc.
...
TensorArraySplit: Incomplete

def tensor_array_split_eager_fallback(handle, value, lengths, flow_in, name, ctx) -> None: ...
def tensor_array_split_v2(handle, value, lengths, flow_in, name: Incomplete | None = None):
...
TensorArraySplitV2: Incomplete

def tensor_array_split_v2_eager_fallback(handle, value, lengths, flow_in, name, ctx): ...
def tensor_array_split_v3(handle, value, lengths, flow_in, name: Incomplete | None = None):
...
TensorArraySplitV3: Incomplete

def tensor_array_split_v3_eager_fallback(handle, value, lengths, flow_in, name, ctx): ...
def tensor_array_unpack(handle, value, flow_in, name: Incomplete | None = None):
    """TODO: add doc.
...
TensorArrayUnpack: Incomplete

def tensor_array_unpack_eager_fallback(handle, value, flow_in, name, ctx) -> None: ...
def tensor_array_v2(size, dtype, element_shape: Incomplete | None = None, dynamic_size: bool = False, clear_after_read: bool = True, tensor_array_name: str = '', name: Incomplete | None = None):
...
def tensor_array_v3(size, dtype, element_shape: Incomplete | None = None, dynamic_size: bool = False, clear_after_read: bool = True, identical_element_shapes: bool = False, tensor_array_name: str = '', name: Incomplete | None = None):
...
def tensor_array_write(handle, index, value, flow_in, name: Incomplete | None = None):
    """TODO: add doc.
...
TensorArrayWrite: Incomplete

def tensor_array_write_eager_fallback(handle, index, value, flow_in, name, ctx) -> None: ...
def tensor_array_write_v2(handle, index, value, flow_in, name: Incomplete | None = None):
    """Deprecated. Use TensorArrayGradV3
...
TensorArrayWriteV2: Incomplete

def tensor_array_write_v2_eager_fallback(handle, index, value, flow_in, name, ctx): ...
def tensor_array_write_v3(handle, index, value, flow_in, name: Incomplete | None = None):
...
TensorArrayWriteV3: Incomplete

def tensor_array_write_v3_eager_fallback(handle, index, value, flow_in, name, ctx): ...
def unstage(dtypes, capacity: int = 0, memory_limit: int = 0, container: str = '', shared_name: str = '', name: Incomplete | None = None):
