...
from tensorflow.python.framework import composite_tensor_gradient as composite_tensor_gradient, dtypes as dtypes, ops as ops
...
VAR_OP_TYPES: Incomplete

def custom_gradient(f: Incomplete | None = None):
