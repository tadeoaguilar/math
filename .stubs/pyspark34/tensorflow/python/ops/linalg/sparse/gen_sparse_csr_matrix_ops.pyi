...
def csr_sparse_matrix_components(csr_sparse_matrix, index, type, name: Incomplete | None = None):
...
CSRSparseMatrixComponents: Incomplete

def csr_sparse_matrix_components_eager_fallback(csr_sparse_matrix, index, type, name, ctx): ...
def csr_sparse_matrix_to_dense(sparse_input, type, name: Incomplete | None = None):
...
CSRSparseMatrixToDense: Incomplete
...
def csr_sparse_matrix_to_sparse_tensor(sparse_matrix, type, name: Incomplete | None = None):
...
CSRSparseMatrixToSparseTensor: Incomplete

def csr_sparse_matrix_to_sparse_tensor_eager_fallback(sparse_matrix, type, name, ctx): ...
def dense_to_csr_sparse_matrix(dense_input, indices, name: Incomplete | None = None):
...
DenseToCSRSparseMatrix: Incomplete

def dense_to_csr_sparse_matrix_eager_fallback(dense_input, indices, name, ctx): ...
def sparse_matrix_add(a, b, alpha, beta, name: Incomplete | None = None):
...
SparseMatrixAdd: Incomplete

def sparse_matrix_add_eager_fallback(a, b, alpha, beta, name, ctx): ...
def sparse_matrix_mat_mul(a, b, transpose_a: bool = False, transpose_b: bool = False, adjoint_a: bool = False, adjoint_b: bool = False, transpose_output: bool = False, conjugate_output: bool = False, name: Incomplete | None = None):
...
def sparse_matrix_mul(a, b, name: Incomplete | None = None):
...
SparseMatrixMul: Incomplete

def sparse_matrix_mul_eager_fallback(a, b, name, ctx): ...
def sparse_matrix_nnz(sparse_matrix, name: Incomplete | None = None):
...
SparseMatrixNNZ: Incomplete

def sparse_matrix_nnz_eager_fallback(sparse_matrix, name, ctx): ...
def sparse_matrix_ordering_amd(input, name: Incomplete | None = None):
...
SparseMatrixOrderingAMD: Incomplete

def sparse_matrix_ordering_amd_eager_fallback(input, name, ctx): ...
def sparse_matrix_softmax(logits, type, name: Incomplete | None = None):
...
SparseMatrixSoftmax: Incomplete

def sparse_matrix_softmax_eager_fallback(logits, type, name, ctx): ...
def sparse_matrix_softmax_grad(softmax, grad_softmax, type, name: Incomplete | None = None):
...
SparseMatrixSoftmaxGrad: Incomplete

def sparse_matrix_softmax_grad_eager_fallback(softmax, grad_softmax, type, name, ctx): ...
def sparse_matrix_sparse_cholesky(input, permutation, type, name: Incomplete | None = None):
...
SparseMatrixSparseCholesky: Incomplete

def sparse_matrix_sparse_cholesky_eager_fallback(input, permutation, type, name, ctx): ...
def sparse_matrix_sparse_mat_mul(a, b, type, transpose_a: bool = False, transpose_b: bool = False, adjoint_a: bool = False, adjoint_b: bool = False, name: Incomplete | None = None):
...
SparseMatrixSparseMatMul: Incomplete

def sparse_matrix_sparse_mat_mul_eager_fallback(a, b, type, transpose_a, transpose_b, adjoint_a, adjoint_b, name, ctx): ...
def sparse_matrix_transpose(input, type, conjugate: bool = False, name: Incomplete | None = None):
...
SparseMatrixTranspose: Incomplete

def sparse_matrix_transpose_eager_fallback(input, type, conjugate, name, ctx): ...
def sparse_matrix_zeros(dense_shape, type, name: Incomplete | None = None):
...
SparseMatrixZeros: Incomplete

def sparse_matrix_zeros_eager_fallback(dense_shape, type, name, ctx): ...
def sparse_tensor_to_csr_sparse_matrix(indices, values, dense_shape, name: Incomplete | None = None):
...
SparseTensorToCSRSparseMatrix: Incomplete
