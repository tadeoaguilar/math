...
def map_fn(fn, elems, dtype: Incomplete | None = None, parallel_iterations: Incomplete | None = None, back_prop: bool = True, swap_memory: bool = False, infer_shape: bool = True, name: Incomplete | None = None):
