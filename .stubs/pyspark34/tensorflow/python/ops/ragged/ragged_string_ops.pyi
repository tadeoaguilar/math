...
map_fn_lib: Incomplete

def string_bytes_split(input, name: Incomplete | None = None):
  ...
  """
def unicode_encode(input, output_encoding, errors: str = 'replace', replacement_char: int = 65533, name: Incomplete | None = None):
  ...
  '''
def unicode_decode(input, input_encoding, errors: str = 'replace', replacement_char: int = 65533, replace_control_characters: bool = False, name: Incomplete | None = None):
  ...
  [[71, 246, 246, 100, 110, 105, 103, 104, 116], [128522]]
  """
def unicode_decode_with_offsets(input, input_encoding, errors: str = 'replace', replacement_char: int = 65533, replace_control_characters: bool = False, name: Incomplete | None = None):
  ...
  * `start_offsets[i1...iN, j]` is the start byte offset for the `j`th
  ...
  """
def unicode_split(input, input_encoding, errors: str = 'replace', replacement_char: int = 65533, name: Incomplete | None = None):
  ...
  [[b'G', b'\\xc3\\xb6', b'\\xc3\\xb6', b'd', b'n', b'i', b'g', b'h', b't'],
   [b'\\xf0\\x9f\\x98\\x8a']]
  """
def unicode_split_with_offsets(input, input_encoding, errors: str = 'replace', replacement_char: int = 65533, name: Incomplete | None = None):
  ...
  * `start_offsets[i1...iN, j]` is the start byte offset for the `j`th
  ...
  """
def string_split_v2(input, sep: Incomplete | None = None, maxsplit: int = -1, name: Incomplete | None = None):
  ...
  Returns:
    ...
    delimiter.
  '''
def string_split(source, sep: Incomplete | None = None, skip_empty: bool = True, delimiter: Incomplete | None = None, result_type: str = 'SparseTensor', name: Incomplete | None = None):
  ...
  '''
def strings_split_v1(input: Incomplete | None = None, sep: Incomplete | None = None, maxsplit: int = -1, result_type: str = 'SparseTensor', source: Incomplete | None = None, name: Incomplete | None = None):
  ...
  '''
def reduce_join(inputs: ragged_tensor.Ragged, axis: Incomplete | None = None, keepdims: Incomplete | None = None, separator: str = '', name: Incomplete | None = None):
    """For docs, see: _RAGGED_REDUCE_DOCSTRING."""
def ngrams(data, ngram_width, separator: str = ' ', pad_values: Incomplete | None = None, padding_width: Incomplete | None = None, preserve_short_sequences: bool = False, name: Incomplete | None = None):
  ...
  Raises:
    ...
    ValueError: if `pad_values`, `padding_width`, or `ngram_width` is set to an
      invalid value.
  '''
def string_format(template: str, inputs: typing.Union[ragged_tensor.Ragged, typing.List[ragged_tensor.RaggedOrDense]], placeholder: str = '{}', summarize: int = 3, name: Incomplete | None = None):
    """Version of tf.strings.format that handles RaggedTensors."""
def ragged_tensor_to_string(rt, summarize: Incomplete | None = None):
  ...
  '''
def string_join(inputs: typing.List[ragged_tensor.RaggedOrDense], separator: str = '', name: Incomplete | None = None):
