...
class _GenerateVocabRemappingOutput(NamedTuple):
    ...
    num_present: Incomplete

def generate_vocab_remapping(new_vocab_file, old_vocab_file, new_vocab_offset, num_new_vocab, old_vocab_size: int = -1, name: Incomplete | None = None):
...
GenerateVocabRemapping: Incomplete
...
def load_and_remap_matrix(ckpt_path, old_tensor_name, row_remapping, col_remapping, initializing_values, num_rows, num_cols, max_rows_in_memory: int = -1, name: Incomplete | None = None):
