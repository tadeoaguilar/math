...
def variable_axis_size_partitioner(max_shard_bytes, axis: int = 0, bytes_per_string_element: int = 16, max_shards: Incomplete | None = None):
  ...
  """
def min_max_variable_partitioner(max_partitions: int = 1, axis: int = 0, min_slice_size=..., bytes_per_string_element: int = 16):
  ...
  """
def fixed_size_partitioner(num_shards, axis: int = 0):
  ...
  Returns:
    ...
    `variable_scope` and `get_variable`.
  '''
def create_partitioned_variables(shape, slicing, initializer, dtype=..., trainable: bool = True, collections: Incomplete | None = None, name: Incomplete | None = None, reuse: Incomplete | None = None):
