...
def embedding_lookup(params, ids, partition_strategy: str = 'mod', name: Incomplete | None = None, validate_indices: bool = True, max_norm: Incomplete | None = None):
  ...
  '''
def embedding_lookup_v2(params, ids, max_norm: Incomplete | None = None, name: Incomplete | None = None):
    '''Looks up embeddings for the given `ids` from a list of tensors.
  ...
  Raises:
    ValueError: If `params` is empty.
  '''
def embedding_lookup_sparse(params, sp_ids, sp_weights, partition_strategy: str = 'mod', name: Incomplete | None = None, combiner: Incomplete | None = None, max_norm: Incomplete | None = None):
  ...
  '''
def embedding_lookup_sparse_v2(params, sp_ids, sp_weights, combiner: Incomplete | None = None, max_norm: Incomplete | None = None, name: Incomplete | None = None):
    '''Looks up embeddings for the given ids and weights from a list of tensors.
  ...
  Raises:
    ...
    ValueError: If `combiner` is not one of {"mean", "sqrtn", "sum"}.
  '''
def safe_embedding_lookup_sparse_v2(embedding_weights, sparse_ids, sparse_weights: Incomplete | None = None, combiner: str = 'mean', default_id: Incomplete | None = None, max_norm: Incomplete | None = None, name: Incomplete | None = None):
  ...
  '''
def safe_embedding_lookup_sparse(embedding_weights, sparse_ids, sparse_weights: Incomplete | None = None, combiner: str = 'mean', default_id: Incomplete | None = None, name: Incomplete | None = None, partition_strategy: str = 'div', max_norm: Incomplete | None = None):
    '''Lookup embedding results, accounting for invalid IDs and empty features.
  ...
  Raises:
    ValueError: if `embedding_weights` is empty.
  '''
def embedding_lookup_ragged(embedding_weights, ragged_ids, partition_strategy: str = 'mod', max_norm: Incomplete | None = None, name: Incomplete | None = None):
