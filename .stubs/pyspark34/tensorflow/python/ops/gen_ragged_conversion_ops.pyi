...
def ragged_tensor_from_variant(encoded_ragged, input_ragged_rank, output_ragged_rank, Tvalues, Tsplits=..., name: Incomplete | None = None):
...
RaggedTensorFromVariant: Incomplete
...
class _RaggedTensorToSparseOutput(NamedTuple):
    ...
    sparse_dense_shape: Incomplete

def ragged_tensor_to_sparse(rt_nested_splits, rt_dense_values, name: Incomplete | None = None):
...
RaggedTensorToSparse: Incomplete

def ragged_tensor_to_sparse_eager_fallback(rt_nested_splits, rt_dense_values, name, ctx): ...
def ragged_tensor_to_tensor(shape, values, default_value, row_partition_tensors, row_partition_types, name: Incomplete | None = None):
...
RaggedTensorToTensor: Incomplete

def ragged_tensor_to_tensor_eager_fallback(shape, values, default_value, row_partition_tensors, row_partition_types, name, ctx): ...
def ragged_tensor_to_variant(rt_nested_splits, rt_dense_values, batched_input, name: Incomplete | None = None):
...
RaggedTensorToVariant: Incomplete

def ragged_tensor_to_variant_eager_fallback(rt_nested_splits, rt_dense_values, batched_input, name, ctx): ...
def ragged_tensor_to_variant_gradient(encoded_ragged_grad, row_splits, dense_values_shape, Tvalues, name: Incomplete | None = None):
...
RaggedTensorToVariantGradient: Incomplete
