...
def matrix_triangular_solve(matrix, rhs, lower: bool = True, adjoint: bool = False, name: Incomplete | None = None):
  ...
  """
def cholesky_solve(chol, rhs, name: Incomplete | None = None):
...
def eye(num_rows, num_columns: Incomplete | None = None, batch_shape: Incomplete | None = None, dtype=..., name: Incomplete | None = None):
  ...
  '''
def matrix_solve_ls(matrix, rhs, l2_regularizer: float = 0.0, fast: bool = True, name: Incomplete | None = None):
  ...
  """
def eig(tensor, name: Incomplete | None = None):
  ...
  """
def eigvals(tensor, name: Incomplete | None = None):
  ...
  """
def self_adjoint_eig(tensor, name: Incomplete | None = None):
  ...
  Returns:
    ...
    v: Eigenvectors. Shape is `[..., N, N]`. The columns of the inner most
      matrices contain eigenvectors of the corresponding matrices in `tensor`
  """
def self_adjoint_eigvals(tensor, name: Incomplete | None = None):
  ...
  Returns:
    e: Eigenvalues. Shape is `[..., N]`. The vector `e[..., :]` contains the `N`
      eigenvalues of `tensor[..., :, :]`.
  """
def svd(tensor, full_matrices: bool = False, compute_uv: bool = True, name: Incomplete | None = None):
  ...
  @end_compatibility
  """
def norm_v2(tensor, ord: str = 'euclidean', axis: Incomplete | None = None, keepdims: Incomplete | None = None, name: Incomplete | None = None):
  ...
  @end_compatibility
  """
def norm(tensor, ord: str = 'euclidean', axis: Incomplete | None = None, keepdims: Incomplete | None = None, name: Incomplete | None = None, keep_dims: Incomplete | None = None):
    """Computes the norm of vectors, matrices, and tensors.
