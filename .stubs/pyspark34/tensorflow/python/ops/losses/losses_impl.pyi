...
def compute_weighted_loss(losses, weights: float = 1.0, scope: Incomplete | None = None, loss_collection=..., reduction=...):
  ...
  @end_compatibility
  """
def absolute_difference(labels, predictions, weights: float = 1.0, scope: Incomplete | None = None, loss_collection=..., reduction=...):
  ...
  @end_compatibility
  """
def cosine_distance(labels, predictions, axis: Incomplete | None = None, weights: float = 1.0, scope: Incomplete | None = None, loss_collection=..., reduction=..., dim: Incomplete | None = None):
  ...
  @end_compatibility
  """
def hinge_loss(labels, logits, weights: float = 1.0, scope: Incomplete | None = None, loss_collection=..., reduction=...):
  ...
  @end_compatibility
  """
def huber_loss(labels, predictions, weights: float = 1.0, delta: float = 1.0, scope: Incomplete | None = None, loss_collection=..., reduction=...):
  ...
  @end_compatibility
  """
def log_loss(labels, predictions, weights: float = 1.0, epsilon: float = 1e-07, scope: Incomplete | None = None, loss_collection=..., reduction=...):
  ...
  @end_compatibility
  """
def mean_pairwise_squared_error(labels, predictions, weights: float = 1.0, scope: Incomplete | None = None, loss_collection=...):
  ...
  @end_compatibility
  """
def mean_squared_error(labels, predictions, weights: float = 1.0, scope: Incomplete | None = None, loss_collection=..., reduction=...):
  ...
  @end_compatibility
  """
def sigmoid_cross_entropy(multi_class_labels, logits, weights: float = 1.0, label_smoothing: int = 0, scope: Incomplete | None = None, loss_collection=..., reduction=...):
  ...
  @end_compatibility
  """
def softmax_cross_entropy(onehot_labels, logits, weights: float = 1.0, label_smoothing: int = 0, scope: Incomplete | None = None, loss_collection=..., reduction=...):
  ...
  @end_compatibility
  """
def sparse_softmax_cross_entropy(labels, logits, weights: float = 1.0, scope: Incomplete | None = None, loss_collection=..., reduction=...):
