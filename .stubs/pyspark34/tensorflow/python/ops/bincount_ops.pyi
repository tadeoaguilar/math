...
def bincount(arr, weights: Incomplete | None = None, minlength: Incomplete | None = None, maxlength: Incomplete | None = None, dtype=..., name: Incomplete | None = None, axis: Incomplete | None = None, binary_output: bool = False):
  ...
  **Bin-counting with binary_output**
  ...
  """
def bincount_v1(arr, weights: Incomplete | None = None, minlength: Incomplete | None = None, maxlength: Incomplete | None = None, dtype=...):
    """Counts the number of occurrences of each value in an integer array.
  ...
  Returns:
    ...
    values.
  """
def sparse_bincount(values, weights: Incomplete | None = None, axis: int = 0, minlength: Incomplete | None = None, maxlength: Incomplete | None = None, binary_output: bool = False, name: Incomplete | None = None):
  ...
  **Weighted bin-counting**
  ...
  """
def validate_dense_weights(values, weights, dtype: Incomplete | None = None):
    """Validates the passed weight tensor or creates an empty one."""
def validate_sparse_weights(values, weights, dtype: Incomplete | None = None):
    """Validates the passed weight tensor or creates an empty one."""
def validate_ragged_weights(values, weights, dtype: Incomplete | None = None):
    """Validates the passed weight tensor or creates an empty one."""
