...
from .operations.ops import MigrateOperation as MigrateOperation
from .runtime.migration import MigrationContext as MigrationContext, MigrationInfo as MigrationInfo, _ProxyTransaction
from .script import ScriptDirectory as ScriptDirectory
from sqlalchemy.engine.base import Connection as Connection
from sqlalchemy.engine.url import URL as URL
from sqlalchemy.sql.elements import ClauseElement as ClauseElement
from sqlalchemy.sql.schema import Column as Column, FetchedValue as FetchedValue, MetaData as MetaData, SchemaItem as SchemaItem
from sqlalchemy.sql.type_api import TypeEngine as TypeEngine
from typing import Any, Callable, Collection, ContextManager, Dict, List, Literal, Mapping, MutableMapping, TextIO, Tuple, overload

def begin_transaction() -> _ProxyTransaction | ContextManager[None]:
...
def configure(connection: Connection | None = None, url: str | URL | None = None, dialect_name: str | None = None, dialect_opts: Dict[str, Any] | None = None, transactional_ddl: bool | None = None, transaction_per_migration: bool = False, output_buffer: TextIO | None = None, starting_rev: str | None = None, tag: str | None = None, template_args: Dict[str, Any] | None = None, render_as_batch: bool = False, target_metadata: MetaData | None = None, include_name: Callable[[str | None, Literal['schema', 'table', 'column', 'index', 'unique_constraint', 'foreign_key_constraint'], MutableMapping[Literal['schema_name', 'table_name', 'schema_qualified_table_name'], str | None]], bool] | None = None, include_object: Callable[[SchemaItem, str | None, Literal['schema', 'table', 'column', 'index', 'unique_constraint', 'foreign_key_constraint'], bool, SchemaItem | None], bool] | None = None, include_schemas: bool = False, process_revision_directives: Callable[[MigrationContext, Tuple[str, str], List[MigrateOperation]], None] | None = None, compare_type: bool | Callable[[MigrationContext, Column[Any], Column[Any], TypeEngine, TypeEngine], bool | None] = True, compare_server_default: bool | Callable[[MigrationContext, Column[Any], Column[Any], str | None, FetchedValue | None, str | None], bool | None] = False, render_item: Callable[[str, Any, AutogenContext], str | Literal[False]] | None = None, literal_binds: bool = False, upgrade_token: str = 'upgrades', downgrade_token: str = 'downgrades', alembic_module_prefix: str = 'op.', sqlalchemy_module_prefix: str = 'sa.', user_module_prefix: str | None = None, on_version_apply: Callable[[MigrationContext, MigrationInfo, Collection[Any], Mapping[str, Any]], None] | None = None, **kw: Any) -> None:
    ...
    '''
def execute(sql: ClauseElement | str, execution_options: dict | None = None) -> None:
