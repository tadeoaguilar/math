from .operations.ops import BatchOperations as BatchOperations, MigrateOperation as MigrateOperation
...
from sqlalchemy.sql.elements import BinaryExpression as BinaryExpression, TextClause as TextClause, conv as conv
from sqlalchemy.sql.expression import TableClause as TableClause, Update as Update
from sqlalchemy.sql.functions import Function as Function
from sqlalchemy.sql.schema import Column as Column, Computed as Computed, Identity as Identity, SchemaItem as SchemaItem, Table as Table
...
def add_column(table_name: str, column: Column[Any], *, schema: str | None = None) -> None:
...
def batch_alter_table(table_name: str, schema: str | None = None, recreate: Literal['auto', 'always', 'never'] = 'auto', partial_reordering: tuple | None = None, copy_from: Table | None = None, table_args: Tuple[Any, ...] = (), table_kwargs: Mapping[str, Any] = ..., reflect_args: Tuple[Any, ...] = (), reflect_kwargs: Mapping[str, Any] = ..., naming_convention: Dict[str, str] | None = None) -> Iterator[BatchOperations]:
    ...
    '''
def bulk_insert(table: Table | TableClause, rows: List[dict], *, multiinsert: bool = True) -> None:
    ...
    '''
def create_check_constraint(constraint_name: str | None, table_name: str, condition: str | BinaryExpression | TextClause, *, schema: str | None = None, **kw: Any) -> None:
    ...
    '''
def create_exclude_constraint(constraint_name: str, table_name: str, *elements: Any, **kw: Any) -> Table | None:
...
def create_foreign_key(constraint_name: str | None, source_table: str, referent_table: str, local_cols: List[str], remote_cols: List[str], *, onupdate: str | None = None, ondelete: str | None = None, deferrable: bool | None = None, initially: str | None = None, match: str | None = None, source_schema: str | None = None, referent_schema: str | None = None, **dialect_kw: Any) -> None:
    ...
    '''
def create_index(index_name: str | None, table_name: str, columns: Sequence[str | TextClause | Function[Any]], *, schema: str | None = None, unique: bool = False, if_not_exists: bool | None = None, **kw: Any) -> None:
    ...
    '''
def create_primary_key(constraint_name: str | None, table_name: str, columns: List[str], *, schema: str | None = None) -> None:
...
def create_table(table_name: str, *columns: SchemaItem, **kw: Any) -> Table:
    ...
    '''
def create_table_comment(table_name: str, comment: str | None, *, existing_comment: str | None = None, schema: str | None = None) -> None:
    ...
    """
def create_unique_constraint(constraint_name: str | None, table_name: str, columns: Sequence[str], *, schema: str | None = None, **kw: Any) -> Any:
    ...
    '''
def drop_column(table_name: str, column_name: str, *, schema: str | None = None, **kw: Any) -> None:
    ...
    '''
def drop_constraint(constraint_name: str, table_name: str, type_: str | None = None, *, schema: str | None = None) -> None:
    ...
    """
def drop_index(index_name: str, table_name: str | None = None, *, schema: str | None = None, if_exists: bool | None = None, **kw: Any) -> None:
    ...
    '''
def drop_table(table_name: str, *, schema: str | None = None, **kw: Any) -> None:
    ...
    '''
def drop_table_comment(table_name: str, *, existing_comment: str | None = None, schema: str | None = None) -> None:
    ...
    '''
def execute(sqltext: str | TextClause | Update, *, execution_options: dict[str, Any] | None = None) -> None:
...
def implementation_for(op_cls: Any) -> Callable[..., Any]:
    ...
    """
def inline_literal(value: str | int, type_: TypeEngine | None = None) -> _literal_bindparam:
...
def invoke(operation: MigrateOperation) -> Any:
    ...
    """
def register_operation(name: str, sourcename: str | None = None) -> Callable[[_T], _T]:
    ...
    """
def rename_table(old_table_name: str, new_table_name: str, *, schema: str | None = None) -> None:
    ...
    """
def run_async(async_function: Callable[..., Awaitable[_T]], *args: Any, **kw_args: Any) -> _T:
