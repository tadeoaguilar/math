...
from typing import Any, Awaitable, Callable, Dict, Iterator, List, Literal, Mapping, Sequence, Tuple, Type
...
class AbstractOperations(util.ModuleClsProxy):
    ...
    schema_obj: Incomplete
    def __init__(self, migration_context: MigrationContext, impl: BatchOperationsImpl | None = None) -> None:
        ...
        """
    @classmethod
    def register_operation(cls, name: str, sourcename: str | None = None) -> Callable[[_T], _T]:
    ...
    def f(self, name: str) -> conv:
        ...
        '''
    def inline_literal(self, value: str | int, type_: TypeEngine[Any] | None = None) -> _literal_bindparam:
    ...
    def get_bind(self) -> Connection:
        ...
        """
    def run_async(self, async_function: Callable[..., Awaitable[_T]], *args: Any, **kw_args: Any) -> _T:
...
class Operations(AbstractOperations):
    ...
    '''
    def add_column(self, table_name: str, column: Column[Any], *, schema: str | None = None) -> None:
    ...
    def alter_column(self, table_name: str, column_name: str, *, nullable: bool | None = None, comment: str | Literal[False] | None = False, server_default: Any = False, new_column_name: str | None = None, type_: TypeEngine | Type[TypeEngine] | None = None, existing_type: TypeEngine | Type[TypeEngine] | None = None, existing_server_default: str | bool | Identity | Computed | None = False, existing_nullable: bool | None = None, existing_comment: str | None = None, schema: str | None = None, **kw: Any) -> None:
        '''Issue an "alter column" instruction using the
            ...
            '''
    def bulk_insert(self, table: Table | TableClause, rows: List[dict], *, multiinsert: bool = True) -> None:
        '''Issue a "bulk insert" operation using the current
            ...
            '''
    def create_check_constraint(self, constraint_name: str | None, table_name: str, condition: str | BinaryExpression | TextClause, *, schema: str | None = None, **kw: Any) -> None:
        '''Issue a "create check constraint" instruction using the
            ...
            '''
    def create_exclude_constraint(self, constraint_name: str, table_name: str, *elements: Any, **kw: Any) -> Table | None:
    ...
    def create_foreign_key(self, constraint_name: str | None, source_table: str, referent_table: str, local_cols: List[str], remote_cols: List[str], *, onupdate: str | None = None, ondelete: str | None = None, deferrable: bool | None = None, initially: str | None = None, match: str | None = None, source_schema: str | None = None, referent_schema: str | None = None, **dialect_kw: Any) -> None:
        '''Issue a "create foreign key" instruction using the
            ...
            '''
    def create_index(self, index_name: str | None, table_name: str, columns: Sequence[str | TextClause | Function[Any]], *, schema: str | None = None, unique: bool = False, if_not_exists: bool | None = None, **kw: Any) -> None:
        '''Issue a "create index" instruction using the current
            ...
            '''
    def create_primary_key(self, constraint_name: str | None, table_name: str, columns: List[str], *, schema: str | None = None) -> None:
        '''Issue a "create primary key" instruction using the current
            ...
            '''
    def create_table(self, table_name: str, *columns: SchemaItem, **kw: Any) -> Table:
        '''Issue a "create table" instruction using the current migration
            ...
            '''
    def create_table_comment(self, table_name: str, comment: str | None, *, existing_comment: str | None = None, schema: str | None = None) -> None:
        """Emit a COMMENT ON operation to set the comment for a table.
            ...
            """
    def create_unique_constraint(self, constraint_name: str | None, table_name: str, columns: Sequence[str], *, schema: str | None = None, **kw: Any) -> Any:
        '''Issue a "create unique constraint" instruction using the
            ...
            '''
    def drop_column(self, table_name: str, column_name: str, *, schema: str | None = None, **kw: Any) -> None:
        '''Issue a "drop column" instruction using the current
            ...
            '''
    def drop_constraint(self, constraint_name: str, table_name: str, type_: str | None = None, *, schema: str | None = None) -> None:
        """Drop a constraint of the given name, typically via DROP CONSTRAINT.
            ...
            """
    def drop_index(self, index_name: str, table_name: str | None = None, *, schema: str | None = None, if_exists: bool | None = None, **kw: Any) -> None:
        '''Issue a "drop index" instruction using the current
            ...
            '''
    def drop_table(self, table_name: str, *, schema: str | None = None, **kw: Any) -> None:
        '''Issue a "drop table" instruction using the current
            ...
            '''
    def drop_table_comment(self, table_name: str, *, existing_comment: str | None = None, schema: str | None = None) -> None:
        '''Issue a "drop table comment" operation to
            ...
            '''
    def execute(self, sqltext: str | TextClause | Update, *, execution_options: dict[str, Any] | None = None) -> None:
        '''Execute the given SQL using the current migration context.
            ...
            * Any "executable" described in SQLAlchemy Core documentation,
            ...
            '''
    def rename_table(self, old_table_name: str, new_table_name: str, *, schema: str | None = None) -> None:
...
class BatchOperations(AbstractOperations):
    ...
    def add_column(self, column: Column[Any], *, insert_before: str | None = None, insert_after: str | None = None) -> None:
        '''Issue an "add column" instruction using the current
    ...
    def alter_column(self, column_name: str, *, nullable: bool | None = None, comment: str | Literal[False] | None = False, server_default: Any = False, new_column_name: str | None = None, type_: TypeEngine | Type[TypeEngine] | None = None, existing_type: TypeEngine | Type[TypeEngine] | None = None, existing_server_default: str | bool | Identity | Computed | None = False, existing_nullable: bool | None = None, existing_comment: str | None = None, insert_before: str | None = None, insert_after: str | None = None, **kw: Any) -> None:
        '''Issue an "alter column" instruction using the current
            ...
            '''
    def create_check_constraint(self, constraint_name: str, condition: str | BinaryExpression | TextClause, **kw: Any) -> None:
        '''Issue a "create check constraint" instruction using the
            ...
            '''
    def create_exclude_constraint(self, constraint_name: str, *elements: Any, **kw: Any):
        '''Issue a "create exclude constraint" instruction using the
            ...
            '''
    def create_foreign_key(self, constraint_name: str, referent_table: str, local_cols: List[str], remote_cols: List[str], *, referent_schema: str | None = None, onupdate: str | None = None, ondelete: str | None = None, deferrable: bool | None = None, initially: str | None = None, match: str | None = None, **dialect_kw: Any) -> None:
        '''Issue a "create foreign key" instruction using the
            current batch migration context.
    ...
    def create_primary_key(self, constraint_name: str, columns: List[str]) -> None:
        '''Issue a "create primary key" instruction using the
            ...
            '''
    def create_table_comment(self, comment: str | None, *, existing_comment: str | None = None) -> None:
        """Emit a COMMENT ON operation to set the comment for a table
    ...
    def drop_index(self, index_name: str, **kw: Any) -> None:
        '''Issue a "drop index" instruction using the
            ...
            '''
    def drop_table_comment(self, *, existing_comment: str | None = None) -> None:
        '''Issue a "drop table comment" operation to
