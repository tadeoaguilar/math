...
from ..ddl import DefaultImpl as DefaultImpl
from ..operations import Operations as Operations
from ..operations.ops import MigrateOperation as MigrateOperation
from ..script.base import ScriptDirectory as ScriptDirectory
from .migration import MigrationContext as MigrationContext, MigrationInfo as MigrationInfo, _ProxyTransaction
...
from sqlalchemy.sql.schema import Column as Column, MetaData as MetaData, SchemaItem as SchemaItem
from sqlalchemy.sql.type_api import TypeEngine as TypeEngine
from typing import Any, Callable, ContextManager, Dict, List, TextIO, overload
from typing_extensions import Literal

ProcessRevisionDirectiveFn: Incomplete
RenderItemFn: Incomplete
NameFilterType: Incomplete
NameFilterParentNames: Incomplete
IncludeNameFn = Callable[[str | None, NameFilterType, NameFilterParentNames], bool]
IncludeObjectFn: Incomplete
OnVersionApplyFn: Incomplete
CompareServerDefault: Incomplete
CompareType: Incomplete
...
class EnvironmentContext(util.ModuleClsProxy):
    ...
    def static_output(self, text: str) -> None:
        ...
        '''
    def begin_transaction(self) -> _ProxyTransaction | ContextManager[None]:
