...
from alembic.operations import ops as ops
from alembic.operations.ops import AddColumnOp as AddColumnOp, AlterColumnOp as AlterColumnOp, CreateTableOp as CreateTableOp, MigrateOperation as MigrateOperation, MigrationScript as MigrationScript, ModifyTableOps as ModifyTableOps, OpContainer as OpContainer
from alembic.runtime.migration import MigrationContext as MigrationContext
from alembic.script.revision import Revision as Revision
...
class Rewriter:
    ...
    def chain(self, other: Rewriter) -> Rewriter:
        ...
        '''
    def rewrites(self, operator: Type[AddColumnOp] | Type[MigrateOperation] | Type[AlterColumnOp] | Type[CreateTableOp] | Type[ModifyTableOps]) -> Callable:
