...
from typing import Any, Callable, Collection, Dict, Iterator, List, Sequence as _typing_Sequence, Set, Tuple, overload
...
class HasConditionalDDL:
    ...
    """
    def ddl_if(self, dialect: str | None = None, callable_: ddl.DDLIfCallable | None = None, state: Any | None = None) -> Self:
...
class Table(DialectKWArgs, HasSchemaAttr, TableClause, inspection.Inspectable['Table']):
    ...
    def drop(self, bind: _CreateDropBind, checkfirst: bool = False) -> None:
        ...
        """
    def tometadata(self, metadata: MetaData, schema: str | Literal[SchemaConst.RETAIN_SCHEMA] = ..., referred_schema_fn: Callable[[Table, str | None, ForeignKeyConstraint, str | None], str | None] | None = None, name: str | None = None) -> Table:
        ...
        """
    def to_metadata(self, metadata: MetaData, schema: str | Literal[SchemaConst.RETAIN_SCHEMA] = ..., referred_schema_fn: Callable[[Table, str | None, ForeignKeyConstraint, str | None], str | None] | None = None, name: str | None = None) -> Table:
...
class Column(DialectKWArgs, SchemaItem, ColumnClause[_T]):
    ...
    info: Incomplete
    def __init__(self, __name_pos: str | _TypeEngineArgument[_T] | SchemaEventTarget | None = None, __type_pos: _TypeEngineArgument[_T] | SchemaEventTarget | None = None, *args: SchemaEventTarget, name: str | None = None, type_: _TypeEngineArgument[_T] | None = None, autoincrement: _AutoIncrementType = 'auto', default: Any | None = None, doc: str | None = None, key: str | None = None, index: bool | None = None, unique: bool | None = None, info: _InfoType | None = None, nullable: bool | Literal[SchemaConst.NULL_UNSPECIFIED] | None = ..., onupdate: Any | None = None, primary_key: bool = False, server_default: _ServerDefaultArgument | None = None, server_onupdate: FetchedValue | None = None, quote: bool | None = None, system: bool = False, comment: str | None = None, insert_sentinel: bool = False, _omit_from_statements: bool = False, _proxies: Any | None = None, **dialect_kwargs: Any) -> None:
        '''
...
def insert_sentinel(name: str | None = None, type_: _TypeEngineArgument[_T] | None = None, *, default: Any | None = None, omit_from_statements: bool = True) -> Column[Any]:
...
def default_is_sequence(obj: DefaultGenerator | None) -> TypeGuard[Sequence]: ...
def default_is_clause_element(obj: DefaultGenerator | None) -> TypeGuard[ColumnElementColumnDefault]: ...
def default_is_scalar(obj: DefaultGenerator | None) -> TypeGuard[ScalarElementColumnDefault]: ...
...
class ColumnElementColumnDefault(ColumnDefault):
    ...
    arg: _SQLExprDefault
    for_update: Incomplete
    def __init__(self, arg: _SQLExprDefault, for_update: bool = False) -> None: ...
...
class CallableColumnDefault(ColumnDefault):
    ...
    has_arg: bool
    for_update: Incomplete
    def __init__(self, arg: _CallableColumnDefaultProtocol | Callable[[], Any], for_update: bool = False) -> None: ...
...
class IdentityOptions:
    ...
    cache: Incomplete
    order: Incomplete
    def __init__(self, start: int | None = None, increment: int | None = None, minvalue: int | None = None, maxvalue: int | None = None, nominvalue: bool | None = None, nomaxvalue: bool | None = None, cycle: bool | None = None, cache: int | None = None, order: bool | None = None) -> None:
...
class DefaultClause(FetchedValue):
    ...
    def __init__(self, arg: str | ClauseElement | TextClause, for_update: bool = False, _reflected: bool = False) -> None: ...
...
class Constraint(DialectKWArgs, HasConditionalDDL, SchemaItem):
    ...
    info: Incomplete
    comment: Incomplete
    def __init__(self, name: _ConstraintNameArgument = None, deferrable: bool | None = None, initially: str | None = None, info: _InfoType | None = None, comment: str | None = None, _create_rule: Any | None = None, _type_bound: bool = False, **dialect_kw: Any) -> None:
...
class ColumnCollectionMixin:
    ...
    """
    def __init__(self, *columns: _DDLColumnArgument, _autoattach: bool = True, _column_flag: bool = False, _gather_expressions: List[str | ColumnElement[Any]] | None = None) -> None: ...
    def columns(self) -> ReadOnlyColumnCollection[str, Column[Any]]: ...
    def c(self) -> ReadOnlyColumnCollection[str, Column[Any]]: ...

class ColumnCollectionConstraint(ColumnCollectionMixin, Constraint):
    """A constraint that proxies a ColumnCollection."""
    def __init__(self, *columns: _DDLColumnArgument, name: _ConstraintNameArgument = None, deferrable: bool | None = None, initially: str | None = None, info: _InfoType | None = None, _autoattach: bool = True, _column_flag: bool = False, _gather_expressions: List[_DDLColumnArgument] | None = None, **dialect_kw: Any) -> None:
        """
        :param \\*columns:
    ...
    def copy(self, *, target_table: Table | None = None, **kw: Any) -> ColumnCollectionConstraint: ...
...
class CheckConstraint(ColumnCollectionConstraint):
    ...
    __visit_name__: str
    sqltext: Incomplete
    def __init__(self, sqltext: _TextCoercedExpressionArgument[Any], name: _ConstraintNameArgument = None, deferrable: bool | None = None, initially: str | None = None, table: Table | None = None, info: _InfoType | None = None, _create_rule: Any | None = None, _autoattach: bool = True, _type_bound: bool = False, **dialect_kw: Any) -> None:
    ...
    def copy(self, *, target_table: Table | None = None, **kw: Any) -> CheckConstraint: ...
...
class ForeignKeyConstraint(ColumnCollectionConstraint):
    ...
    def column_keys(self) -> _typing_Sequence[str]:
        ...
        """
    def copy(self, *, schema: str | None = None, target_table: Table | None = None, **kw: Any) -> ForeignKeyConstraint: ...
...
class PrimaryKeyConstraint(ColumnCollectionConstraint):
    ...
    '''
    __visit_name__: str
    def __init__(self, *columns: _DDLColumnArgument, name: str | None = None, deferrable: bool | None = None, initially: str | None = None, info: _InfoType | None = None, _implicit_generated: bool = False, **dialect_kw: Any) -> None: ...
    @property
...
class Index(DialectKWArgs, ColumnCollectionMixin, HasConditionalDDL, SchemaItem):
    ...
    unique: Incomplete
    info: Incomplete
    def __init__(self, name: str | None, *expressions: _DDLColumnArgument, unique: bool = False, quote: bool | None = None, info: _InfoType | None = None, _table: Table | None = None, _column_flag: bool = False, **dialect_kw: Any) -> None:
...
class MetaData(HasSchemaAttr):
    ...
    info: Incomplete
    def __init__(self, schema: str | None = None, quote_schema: bool | None = None, naming_convention: _NamingSchemaParameter | None = None, info: _InfoType | None = None) -> None:
    ...
    def sorted_tables(self) -> List[Table]:
        ...
        """
    def reflect(self, bind: Engine | Connection, schema: str | None = None, views: bool = False, only: _typing_Sequence[str] | Callable[[str, MetaData], bool] | None = None, extend_existing: bool = False, autoload_replace: bool = True, resolve_fks: bool = True, **dialect_kwargs: Any) -> None:
        ...
        """
    def create_all(self, bind: _CreateDropBind, tables: _typing_Sequence[Table] | None = None, checkfirst: bool = True) -> None:
        ...
        """
    def drop_all(self, bind: _CreateDropBind, tables: _typing_Sequence[Table] | None = None, checkfirst: bool = True) -> None:
...
class Computed(FetchedValue, SchemaItem):
    ...
    def __init__(self, sqltext: _DDLColumnArgument, persisted: bool | None = None) -> None:
        ...
        """
    def copy(self, *, target_table: Table | None = None, **kw: Any) -> Computed: ...
...
class Identity(IdentityOptions, FetchedValue, SchemaItem):
    ...
    on_null: Incomplete
    column: Incomplete
    def __init__(self, always: bool = False, on_null: bool | None = None, start: int | None = None, increment: int | None = None, minvalue: int | None = None, maxvalue: int | None = None, nominvalue: bool | None = None, nomaxvalue: bool | None = None, cycle: bool | None = None, cache: int | None = None, order: bool | None = None) -> None:
