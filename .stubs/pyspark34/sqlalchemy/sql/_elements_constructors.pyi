...
from typing import Any, Callable, Iterable, Mapping, Sequence, Tuple as typing_Tuple, overload
...
def all_(expr: _ColumnExpressionArgument[_T]) -> CollectionAggregate[bool]:
    ...
    '''
def and_(initial_clause: Literal[True] | _ColumnExpressionArgument[bool], *clauses: _ColumnExpressionArgument[bool]) -> ColumnElement[bool]:
...
def between(expr: _ColumnExpressionOrLiteralArgument[_T], lower_bound: Any, upper_bound: Any, symmetric: bool = False) -> BinaryExpression[bool]:
    ...
    '''
def outparam(key: str, type_: TypeEngine[_T] | None = None) -> BindParameter[_T]:
...
def bindparam(key: str | None, value: Any = ..., type_: _TypeEngineArgument[_T] | None = None, unique: bool = False, required: bool | Literal[_NoArg.NO_ARG] = ..., quote: bool | None = None, callable_: Callable[[], Any] | None = None, expanding: bool = False, isoutparam: bool = False, literal_execute: bool = False) -> BindParameter[_T]:
    ...
    '''
def case(*whens: typing_Tuple[_ColumnExpressionArgument[bool], Any] | Mapping[Any, Any], value: Any | None = None, else_: Any | None = None) -> Case[Any]:
...
def try_cast(expression: _ColumnExpressionOrLiteralArgument[Any], type_: _TypeEngineArgument[_T]) -> TryCast[_T]:
    ...
    '''
def column(text: str, type_: _TypeEngineArgument[_T] | None = None, is_literal: bool = False, _selectable: FromClause | None = None) -> ColumnClause[_T]:
...
def funcfilter(func: FunctionElement[_T], *criterion: _ColumnExpressionArgument[bool]) -> FunctionFilter[_T]:
    ...
    '''
def label(name: str, element: _ColumnExpressionArgument[_T], type_: _TypeEngineArgument[_T] | None = None) -> Label[_T]:
...
def nulls_last(column: _ColumnExpressionArgument[_T]) -> UnaryExpression[_T]:
    ...
    """
def or_(initial_clause: Literal[False] | _ColumnExpressionArgument[bool], *clauses: _ColumnExpressionArgument[bool]) -> ColumnElement[bool]:
    ...
    '''
def over(element: FunctionElement[_T], partition_by: Iterable[_ColumnExpressionArgument[Any]] | _ColumnExpressionArgument[Any] | None = None, order_by: Iterable[_ColumnExpressionArgument[Any]] | _ColumnExpressionArgument[Any] | None = None, range_: typing_Tuple[int | None, int | None] | None = None, rows: typing_Tuple[int | None, int | None] | None = None) -> Over[_T]:
...
def true() -> True_:
    ...
    '''
def tuple_(*clauses: _ColumnExpressionArgument[Any], types: Sequence[_TypeEngineArgument[Any]] | None = None) -> Tuple:
