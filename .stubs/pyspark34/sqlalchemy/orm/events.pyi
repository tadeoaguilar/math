...
from typing import Any, Collection, Dict, Generic, Iterable, Sequence, Type
...
class AttributeEvents(event.Events[QueryableAttribute[Any]]):
    ...
    def append_wo_mutation(self, target: _O, value: _T, initiator: Event, *, key: EventConstants = ...) -> None:
        ...
        """
    def bulk_replace(self, target: _O, values: Iterable[_T], initiator: Event, *, keys: Iterable[EventConstants] | None = None) -> None:
