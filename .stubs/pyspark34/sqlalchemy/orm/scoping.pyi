...
from typing import Any, Callable, Dict, Generic, Iterable, Iterator, Sequence, Tuple, Type, overload
...
class scoped_session(Generic[_S]):
    ...
    def __init__(self, session_factory: sessionmaker[_S], scopefunc: Callable[[], Any] | None = None) -> None:
    ...
    def remove(self) -> None:
        ...
        """
    def query_property(self, query_cls: Type[Query[_T]] | None = None) -> QueryPropertyDescriptor:
    ...
    def bind(self) -> Engine | Connection | None:
        """Proxy for the :attr:`_orm.Session.bind` attribute
