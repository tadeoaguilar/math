...
from typing import Any, Callable, Collection, Iterable, Type, overload
...
def contains_alias(alias: Alias | Subquery) -> AliasOption:
    ...
    """
def mapped_column(__name_pos: str | _TypeEngineArgument[Any] | SchemaEventTarget | None = None, __type_pos: _TypeEngineArgument[Any] | SchemaEventTarget | None = None, *args: SchemaEventTarget, init: _NoArg | bool = ..., repr: _NoArg | bool = ..., default: Any | None = ..., default_factory: _NoArg | Callable[[], _T] = ..., compare: _NoArg | bool = ..., kw_only: _NoArg | bool = ..., nullable: bool | Literal[SchemaConst.NULL_UNSPECIFIED] | None = ..., primary_key: bool | None = False, deferred: _NoArg | bool = ..., deferred_group: str | None = None, deferred_raiseload: bool | None = None, use_existing_column: bool = False, name: str | None = None, type_: _TypeEngineArgument[Any] | None = None, autoincrement: _AutoIncrementType = 'auto', doc: str | None = None, key: str | None = None, index: bool | None = None, unique: bool | None = None, info: _InfoType | None = None, onupdate: Any | None = None, insert_default: Any | None = ..., server_default: _ServerDefaultArgument | None = None, server_onupdate: FetchedValue | None = None, active_history: bool = False, quote: bool | None = None, system: bool = False, comment: str | None = None, sort_order: _NoArg | int = ..., **kw: Any) -> MappedColumn[Any]:
    ...
    '''
def orm_insert_sentinel(name: str | None = None, type_: _TypeEngineArgument[Any] | None = None, *, default: Any | None = None, omit_from_statements: bool = True) -> MappedColumn[Any]:
    ...
    """
def column_property(column: _ORMColumnExprArgument[_T], *additional_columns: _ORMColumnExprArgument[Any], group: str | None = None, deferred: bool = False, raiseload: bool = False, comparator_factory: Type[PropComparator[_T]] | None = None, init: _NoArg | bool = ..., repr: _NoArg | bool = ..., default: Any | None = ..., default_factory: _NoArg | Callable[[], _T] = ..., compare: _NoArg | bool = ..., kw_only: _NoArg | bool = ..., active_history: bool = False, expire_on_flush: bool = True, info: _InfoType | None = None, doc: str | None = None) -> MappedSQLExpression[_T]:
    ...
    '''
@overload
def composite(_class_or_attr: _CompositeAttrType[Any], *attrs: _CompositeAttrType[Any], group: str | None = None, deferred: bool = False, raiseload: bool = False, comparator_factory: Type[Composite.Comparator[_T]] | None = None, active_history: bool = False, init: _NoArg | bool = ..., repr: _NoArg | bool = ..., default: Any | None = ..., default_factory: _NoArg | Callable[[], _T] = ..., compare: _NoArg | bool = ..., kw_only: _NoArg | bool = ..., info: _InfoType | None = None, doc: str | None = None, **__kw: Any) -> Composite[Any]: ...
@overload
def composite(_class_or_attr: Type[_CC], *attrs: _CompositeAttrType[Any], group: str | None = None, deferred: bool = False, raiseload: bool = False, comparator_factory: Type[Composite.Comparator[_T]] | None = None, active_history: bool = False, init: _NoArg | bool = ..., repr: _NoArg | bool = ..., default: Any | None = ..., default_factory: _NoArg | Callable[[], _T] = ..., compare: _NoArg | bool = ..., kw_only: _NoArg | bool = ..., info: _InfoType | None = None, doc: str | None = None, **__kw: Any) -> Composite[_CC]: ...
@overload
def composite(_class_or_attr: Callable[..., _CC], *attrs: _CompositeAttrType[Any], group: str | None = None, deferred: bool = False, raiseload: bool = False, comparator_factory: Type[Composite.Comparator[_T]] | None = None, active_history: bool = False, init: _NoArg | bool = ..., repr: _NoArg | bool = ..., default: Any | None = ..., default_factory: _NoArg | Callable[[], _T] = ..., compare: _NoArg | bool = ..., kw_only: _NoArg | bool = ..., info: _InfoType | None = None, doc: str | None = None, **__kw: Any) -> Composite[_CC]: ...
def with_loader_criteria(entity_or_base: _EntityType[Any], where_criteria: _ColumnExpressionArgument[bool], loader_only: bool = False, include_aliases: bool = False, propagate_to_loaders: bool = True, track_closure_variables: bool = True) -> LoaderCriteriaOption:
    ...
    **globally**, meaning it will apply to the entity as it appears
    ...
    '''
def relationship(argument: _RelationshipArgumentType[Any] | None = None, secondary: _RelationshipSecondaryArgument | None = None, *, uselist: bool | None = None, collection_class: Type[Collection[Any]] | Callable[[], Collection[Any]] | None = None, primaryjoin: _RelationshipJoinConditionArgument | None = None, secondaryjoin: _RelationshipJoinConditionArgument | None = None, back_populates: str | None = None, order_by: _ORMOrderByArgument = False, backref: ORMBackrefArgument | None = None, overlaps: str | None = None, post_update: bool = False, cascade: str = 'save-update, merge', viewonly: bool = False, init: _NoArg | bool = ..., repr: _NoArg | bool = ..., default: _NoArg | _T = ..., default_factory: _NoArg | Callable[[], _T] = ..., compare: _NoArg | bool = ..., kw_only: _NoArg | bool = ..., lazy: _LazyLoadArgumentType = 'select', passive_deletes: Literal['all'] | bool = False, passive_updates: bool = True, active_history: bool = False, enable_typechecks: bool = True, foreign_keys: _ORMColCollectionArgument | None = None, remote_side: _ORMColCollectionArgument | None = None, join_depth: int | None = None, comparator_factory: Type[RelationshipProperty.Comparator[Any]] | None = None, single_parent: bool = False, innerjoin: bool = False, distinct_target_key: bool | None = None, load_on_pending: bool = False, query_class: Type[Query[Any]] | None = None, info: _InfoType | None = None, omit_join: Literal[None, False] = None, sync_backref: bool | None = None, **kw: Any) -> Relationship[Any]:
    ...
    '''
def synonym(name: str, *, map_column: bool | None = None, descriptor: Any | None = None, comparator_factory: Type[PropComparator[_T]] | None = None, init: _NoArg | bool = ..., repr: _NoArg | bool = ..., default: _NoArg | _T = ..., default_factory: _NoArg | Callable[[], _T] = ..., compare: _NoArg | bool = ..., kw_only: _NoArg | bool = ..., info: _InfoType | None = None, doc: str | None = None) -> Synonym[Any]:
    ...
    '''
def create_session(bind: _SessionBind | None = None, **kwargs: Any) -> Session:
    ...
    """
def dynamic_loader(argument: _RelationshipArgumentType[Any] | None = None, **kw: Any) -> RelationshipProperty[Any]:
...
def backref(name: str, **kwargs: Any) -> ORMBackrefArgument:
    ...
    """
def deferred(column: _ORMColumnExprArgument[_T], *additional_columns: _ORMColumnExprArgument[Any], group: str | None = None, raiseload: bool = False, comparator_factory: Type[PropComparator[_T]] | None = None, init: _NoArg | bool = ..., repr: _NoArg | bool = ..., default: Any | None = ..., default_factory: _NoArg | Callable[[], _T] = ..., compare: _NoArg | bool = ..., kw_only: _NoArg | bool = ..., active_history: bool = False, expire_on_flush: bool = True, info: _InfoType | None = None, doc: str | None = None) -> MappedSQLExpression[_T]:
    ...
    """
def query_expression(default_expr: _ORMColumnExprArgument[_T] = ..., *, repr: _NoArg | bool = ..., compare: _NoArg | bool = ..., expire_on_flush: bool = True, info: _InfoType | None = None, doc: str | None = None) -> MappedSQLExpression[_T]:
...
@overload
def aliased(element: Type[_O], alias: FromClause | None = None, name: str | None = None, flat: bool = False, adapt_on_names: bool = False) -> AliasedType[_O]: ...
@overload
def aliased(element: AliasedClass[_O] | Mapper[_O] | AliasedInsp[_O], alias: FromClause | None = None, name: str | None = None, flat: bool = False, adapt_on_names: bool = False) -> AliasedClass[_O]: ...
@overload
def aliased(element: FromClause, alias: None = None, name: str | None = None, flat: bool = False, adapt_on_names: bool = False) -> FromClause: ...
def with_polymorphic(base: Type[_O] | Mapper[_O], classes: Literal['*'] | Iterable[Type[Any]], selectable: Literal[False, None] | FromClause = False, flat: bool = False, polymorphic_on: ColumnElement[Any] | None = None, aliased: bool = False, innerjoin: bool = False, adapt_on_names: bool = False, _use_mapper_path: bool = False) -> AliasedClass[_O]:
    ...
    '''
def join(left: _FromClauseArgument, right: _FromClauseArgument, onclause: _OnClauseArgument | None = None, isouter: bool = False, full: bool = False) -> _ORMJoin:
    ...
    '''
def outerjoin(left: _FromClauseArgument, right: _FromClauseArgument, onclause: _OnClauseArgument | None = None, full: bool = False) -> _ORMJoin:
