...
class QueuePool(Pool):
    ...
    """
    def __init__(self, creator: _CreatorFnType | _CreatorWRecFnType, pool_size: int = 5, max_overflow: int = 10, timeout: float = 30.0, use_lifo: bool = False, **kw: Any) -> None:
        '''
...
class SingletonThreadPool(Pool):
    ...
    """
    size: Incomplete
    def __init__(self, creator: _CreatorFnType | _CreatorWRecFnType, pool_size: int = 5, **kw: Any) -> None: ...
