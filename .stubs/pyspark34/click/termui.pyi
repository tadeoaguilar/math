import typing as t
from ._compat import isatty as isatty, strip_ansi as strip_ansi
from ._termui_impl import ProgressBar as ProgressBar
...
from .types import Choice as Choice, ParamType as ParamType, convert_type as convert_type
from .utils import LazyFile as LazyFile, echo as echo

V = t.TypeVar('V')
visible_prompt_func: t.Callable[[str], str]
...
def confirm(text: str, default: bool | None = False, abort: bool = False, prompt_suffix: str = ': ', show_default: bool = True, err: bool = False) -> bool:
    ...
    .. versionadded:: 4.0
        Added the ``err`` parameter.
    """
def echo_via_pager(text_or_generator: t.Iterable[str] | t.Callable[[], t.Iterable[str]] | str, color: bool | None = None) -> None:
...
def clear() -> None:
    ...
    .. versionadded:: 2.0
    """
def style(text: t.Any, fg: int | t.Tuple[int, int, int] | str | None = None, bg: int | t.Tuple[int, int, int] | str | None = None, bold: bool | None = None, dim: bool | None = None, underline: bool | None = None, overline: bool | None = None, italic: bool | None = None, blink: bool | None = None, reverse: bool | None = None, strikethrough: bool | None = None, reset: bool = True) -> str:
...
def secho(message: t.Any | None = None, file: t.IO[t.AnyStr] | None = None, nl: bool = True, err: bool = False, color: bool | None = None, **styles: t.Any) -> None:
    ...
    .. versionadded:: 2.0
    """
def edit(text: t.AnyStr | None = None, editor: str | None = None, env: t.Mapping[str, str] | None = None, require_save: bool = True, extension: str = '.txt', filename: str | None = None) -> t.AnyStr | None:
