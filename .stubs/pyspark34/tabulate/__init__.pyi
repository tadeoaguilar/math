...
def simple_separated_format(separator):
    ...
    '''
def tabulate(tabular_data, headers=(), tablefmt: str = 'simple', floatfmt=..., intfmt=..., numalign=..., stralign=..., missingval=..., showindex: str = 'default', disable_numparse: bool = False, colalign: Incomplete | None = None, maxcolwidths: Incomplete | None = None, rowalign: Incomplete | None = None, maxheadercolwidths: Incomplete | None = None):
