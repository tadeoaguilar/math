...
from mmap import ALLOCATIONGRANULARITY as ALLOCATIONGRANULARITY
...
class MapRegion:
    ...
    **Note:** deallocates used region automatically on destruction"""
    def __init__(self, path_or_fd, ofs, size, flags: int = 0) -> None:
    ...
    def increment_client_count(self, ofs: int = 1):
