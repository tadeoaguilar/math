from .affine_transformations import apply_affine_transform as apply_affine_transform, apply_brightness_shift as apply_brightness_shift, apply_channel_shift as apply_channel_shift, flip_axis as flip_axis
from .dataframe_iterator import DataFrameIterator as DataFrameIterator
from .directory_iterator import DirectoryIterator as DirectoryIterator
from .numpy_array_iterator import NumpyArrayIterator as NumpyArrayIterator
...
class ImageDataGenerator:
    ...
    mean: Incomplete
    std: Incomplete
    principal_components: Incomplete
    brightness_range: Incomplete
    def __init__(self, featurewise_center: bool = False, samplewise_center: bool = False, featurewise_std_normalization: bool = False, samplewise_std_normalization: bool = False, zca_whitening: bool = False, zca_epsilon: float = 1e-06, rotation_range: int = 0, width_shift_range: float = 0.0, height_shift_range: float = 0.0, brightness_range: Incomplete | None = None, shear_range: float = 0.0, zoom_range: float = 0.0, channel_shift_range: float = 0.0, fill_mode: str = 'nearest', cval: float = 0.0, horizontal_flip: bool = False, vertical_flip: bool = False, rescale: Incomplete | None = None, preprocessing_function: Incomplete | None = None, data_format: str = 'channels_last', validation_split: float = 0.0, interpolation_order: int = 1, dtype: str = 'float32') -> None: ...
    def flow(self, x, y: Incomplete | None = None, batch_size: int = 32, shuffle: bool = True, sample_weight: Incomplete | None = None, seed: Incomplete | None = None, save_to_dir: Incomplete | None = None, save_prefix: str = '', save_format: str = 'png', subset: Incomplete | None = None):
