...
class LinearSVC(LinearClassifierMixin, SparseCoefMixin, BaseEstimator):
    ...
    penalty: Incomplete
    loss: Incomplete
    def __init__(self, penalty: str = 'l2', loss: str = 'squared_hinge', *, dual: str = 'warn', tol: float = 0.0001, C: float = 1.0, multi_class: str = 'ovr', fit_intercept: bool = True, intercept_scaling: int = 1, class_weight: Incomplete | None = None, verbose: int = 0, random_state: Incomplete | None = None, max_iter: int = 1000) -> None: ...
    classes_: Incomplete
    n_iter_: Incomplete
    coef_: Incomplete
...
class LinearSVR(RegressorMixin, LinearModel):
    ...
    dual: Incomplete
    loss: Incomplete
    def __init__(self, *, epsilon: float = 0.0, tol: float = 0.0001, C: float = 1.0, loss: str = 'epsilon_insensitive', fit_intercept: bool = True, intercept_scaling: float = 1.0, dual: str = 'warn', verbose: int = 0, random_state: Incomplete | None = None, max_iter: int = 1000) -> None: ...
    coef_: Incomplete
    n_iter_: Incomplete
    def fit(self, X, y, sample_weight: Incomplete | None = None):
        """Fit the model according to the given training data.
...
class SVC(BaseSVC):
    ...
    [1]
    '''
    def __init__(self, *, C: float = 1.0, kernel: str = 'rbf', degree: int = 3, gamma: str = 'scale', coef0: float = 0.0, shrinking: bool = True, probability: bool = False, tol: float = 0.001, cache_size: int = 200, class_weight: Incomplete | None = None, verbose: bool = False, max_iter: int = -1, decision_function_shape: str = 'ovr', break_ties: bool = False, random_state: Incomplete | None = None) -> None: ...
...
class NuSVC(BaseSVC):
    ...
    [1]
    '''
    def __init__(self, *, nu: float = 0.5, kernel: str = 'rbf', degree: int = 3, gamma: str = 'scale', coef0: float = 0.0, shrinking: bool = True, probability: bool = False, tol: float = 0.001, cache_size: int = 200, class_weight: Incomplete | None = None, verbose: bool = False, max_iter: int = -1, decision_function_shape: str = 'ovr', break_ties: bool = False, random_state: Incomplete | None = None) -> None: ...
...
class SVR(RegressorMixin, BaseLibSVM):
    ...
    Pipeline(steps=[(\'standardscaler\', StandardScaler()),
                    (\'svr\', SVR(epsilon=0.2))])
    '''
    def __init__(self, *, kernel: str = 'rbf', degree: int = 3, gamma: str = 'scale', coef0: float = 0.0, tol: float = 0.001, C: float = 1.0, epsilon: float = 0.1, shrinking: bool = True, cache_size: int = 200, verbose: bool = False, max_iter: int = -1) -> None: ...
    @property
...
class NuSVR(RegressorMixin, BaseLibSVM):
    ...
    Pipeline(steps=[(\'standardscaler\', StandardScaler()),
                    (\'nusvr\', NuSVR(nu=0.1))])
    '''
    def __init__(self, *, nu: float = 0.5, C: float = 1.0, kernel: str = 'rbf', degree: int = 3, gamma: str = 'scale', coef0: float = 0.0, shrinking: bool = True, tol: float = 0.001, cache_size: int = 200, verbose: bool = False, max_iter: int = -1) -> None: ...
    @property
    def class_weight_(self): ...
...
class OneClassSVM(OutlierMixin, BaseLibSVM):
    ...
    """
    def __init__(self, *, kernel: str = 'rbf', degree: int = 3, gamma: str = 'scale', coef0: float = 0.0, tol: float = 0.001, nu: float = 0.5, shrinking: bool = True, cache_size: int = 200, verbose: bool = False, max_iter: int = -1) -> None: ...
    @property
    def class_weight_(self): ...
    offset_: Incomplete
