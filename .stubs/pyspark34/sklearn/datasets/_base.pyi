...
def get_data_home(data_home: Incomplete | None = None) -> str:
...
def clear_data_home(data_home: Incomplete | None = None) -> None:
    ...
    data_home : str or path-like, default=None
        ...
        is `~/sklearn_learn_data`.
    """
def load_files(container_path, *, description: Incomplete | None = None, categories: Incomplete | None = None, load_content: bool = True, shuffle: bool = True, encoding: Incomplete | None = None, decode_error: str = 'strict', random_state: int = 0, allowed_extensions: Incomplete | None = None):
    ...
    """
def load_csv_data(data_file_name, *, data_module=..., descr_file_name: Incomplete | None = None, descr_module=...):
    ...
    """
def load_gzip_compressed_csv_data(data_file_name, *, data_module=..., descr_file_name: Incomplete | None = None, descr_module=..., encoding: str = 'utf-8', **kwargs):
...
def load_descr(descr_file_name, *, descr_module=...):
    ...
    """
def load_wine(*, return_X_y: bool = False, as_frame: bool = False):
    ...
    """
def load_iris(*, return_X_y: bool = False, as_frame: bool = False):
    ...
    """
def load_breast_cancer(*, return_X_y: bool = False, as_frame: bool = False):
    ...
    ['malignant', 'benign']
    """
def load_digits(*, n_class: int = 10, return_X_y: bool = False, as_frame: bool = False):
    ...
    To load the data and visualize the images::
        ...
        >>> plt.show()
    """
def load_diabetes(*, return_X_y: bool = False, as_frame: bool = False, scaled: bool = True):
    ...
    (data, target) : tuple if ``return_X_y`` is True
        ...
        .. versionadded:: 0.18
    """
def load_linnerud(*, return_X_y: bool = False, as_frame: bool = False):
