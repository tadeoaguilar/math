from ..base import ClassNamePrefixFeaturesOutMixin as ClassNamePrefixFeaturesOutMixin, TransformerMixin as TransformerMixin
...
def kneighbors_graph(X, n_neighbors, *, mode: str = 'connectivity', metric: str = 'minkowski', p: int = 2, metric_params: Incomplete | None = None, include_self: bool = False, n_jobs: Incomplete | None = None):
    ...
    array([[1., 0., 1.],
           ...
           [1., 0., 1.]])
    '''
def radius_neighbors_graph(X, radius, *, mode: str = 'connectivity', metric: str = 'minkowski', p: int = 2, metric_params: Incomplete | None = None, include_self: bool = False, n_jobs: Incomplete | None = None):
...
class KNeighborsTransformer(ClassNamePrefixFeaturesOutMixin, KNeighborsMixin, TransformerMixin, NeighborsBase):
    ...
    '''
    mode: Incomplete
    def __init__(self, *, mode: str = 'distance', n_neighbors: int = 5, algorithm: str = 'auto', leaf_size: int = 30, metric: str = 'minkowski', p: int = 2, metric_params: Incomplete | None = None, n_jobs: Incomplete | None = None) -> None: ...
...
class RadiusNeighborsTransformer(ClassNamePrefixFeaturesOutMixin, RadiusNeighborsMixin, TransformerMixin, NeighborsBase):
    ...
    '''
    mode: Incomplete
    def __init__(self, *, mode: str = 'distance', radius: float = 1.0, algorithm: str = 'auto', leaf_size: int = 30, metric: str = 'minkowski', p: int = 2, metric_params: Incomplete | None = None, n_jobs: Incomplete | None = None) -> None: ...
    def fit(self, X, y: Incomplete | None = None):
