...
def dbscan(X, eps: float = 0.5, *, min_samples: int = 5, metric: str = 'minkowski', metric_params: Incomplete | None = None, algorithm: str = 'auto', leaf_size: int = 30, p: int = 2, sample_weight: Incomplete | None = None, n_jobs: Incomplete | None = None):
...
class DBSCAN(ClusterMixin, BaseEstimator):
    ...
    p: Incomplete
    n_jobs: Incomplete
    def __init__(self, eps: float = 0.5, *, min_samples: int = 5, metric: str = 'euclidean', metric_params: Incomplete | None = None, algorithm: str = 'auto', leaf_size: int = 30, p: Incomplete | None = None, n_jobs: Incomplete | None = None) -> None: ...
    core_sample_indices_: Incomplete
    labels_: Incomplete
