from .base import BaseEstimator, ClassNamePrefixFeaturesOutMixin, ClassifierMixin, TransformerMixin
...
class LinearDiscriminantAnalysis(ClassNamePrefixFeaturesOutMixin, LinearClassifierMixin, TransformerMixin, BaseEstimator):
    ...
    store_covariance: Incomplete
    tol: Incomplete
    covariance_estimator: Incomplete
    def __init__(self, solver: str = 'svd', shrinkage: Incomplete | None = None, priors: Incomplete | None = None, n_components: Incomplete | None = None, store_covariance: bool = False, tol: float = 0.0001, covariance_estimator: Incomplete | None = None) -> None: ...
    classes_: Incomplete
    priors_: Incomplete
    coef_: Incomplete
...
class QuadraticDiscriminantAnalysis(ClassifierMixin, BaseEstimator):
    ...
    """
    priors: Incomplete
    reg_param: Incomplete
    store_covariance: Incomplete
    tol: Incomplete
    def __init__(self, *, priors: Incomplete | None = None, reg_param: float = 0.0, store_covariance: bool = False, tol: float = 0.0001) -> None: ...
    priors_: Incomplete
    covariance_: Incomplete
    means_: Incomplete
    scalings_: Incomplete
    rotations_: Incomplete
    def fit(self, X, y):
