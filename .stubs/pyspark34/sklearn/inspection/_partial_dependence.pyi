...
def partial_dependence(estimator, X, features, *, sample_weight: Incomplete | None = None, categorical_features: Incomplete | None = None, feature_names: Incomplete | None = None, response_method: str = 'auto', percentiles=(0.05, 0.95), grid_resolution: int = 100, method: str = 'auto', kind: str = 'average'):
