...
class EllipticEnvelope(OutlierMixin, MinCovDet):
    ...
    def __init__(self, *, store_precision: bool = True, assume_centered: bool = False, support_fraction: Incomplete | None = None, contamination: float = 0.1, random_state: Incomplete | None = None) -> None: ...
    offset_: Incomplete
