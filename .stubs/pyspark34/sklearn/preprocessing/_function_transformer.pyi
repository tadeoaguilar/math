...
class FunctionTransformer(TransformerMixin, BaseEstimator):
    ...
    """
    func: Incomplete
    inverse_func: Incomplete
    validate: Incomplete
    accept_sparse: Incomplete
    check_inverse: Incomplete
    feature_names_out: Incomplete
    kw_args: Incomplete
    inv_kw_args: Incomplete
    def __init__(self, func: Incomplete | None = None, inverse_func: Incomplete | None = None, *, validate: bool = False, accept_sparse: bool = False, check_inverse: bool = True, feature_names_out: Incomplete | None = None, kw_args: Incomplete | None = None, inv_kw_args: Incomplete | None = None) -> None: ...
