...
def check_clusterings(labels_true, labels_pred):
    ...
    """
def contingency_matrix(labels_true, labels_pred, *, eps: Incomplete | None = None, sparse: bool = False, dtype=...):
...
def adjusted_rand_score(labels_true, labels_pred):
    ...
    are a worse choice than the expected value of random labels::
      ...
      -0.5
    '''
def homogeneity_completeness_v_measure(labels_true, labels_pred, *, beta: float = 1.0):
...
def completeness_score(labels_true, labels_pred):
    ...
    assignment cannot be complete::
      ...
      0.0
    """
def v_measure_score(labels_true, labels_pred, *, beta: float = 1.0):
    ...
    destroy the homogeneity of the labeling, hence::
      ...
      0.0...
    '''
def mutual_info_score(labels_true, labels_pred, *, contingency: Incomplete | None = None):
    ...
    """
def adjusted_mutual_info_score(labels_true, labels_pred, *, average_method: str = 'arithmetic'):
    ...
    the assignment is totally in-complete, hence the AMI is null::
      ...
      0.0
    """
def normalized_mutual_info_score(labels_true, labels_pred, *, average_method: str = 'arithmetic'):
    ...
    the assignment is totally in-complete, hence the NMI is null::
      ...
      0.0
    """
def fowlkes_mallows_score(labels_true, labels_pred, *, sparse: bool = False):
