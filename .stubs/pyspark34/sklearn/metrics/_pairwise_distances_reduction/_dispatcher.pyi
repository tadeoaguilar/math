...
from .._dist_metrics import BOOL_METRICS as BOOL_METRICS, METRIC_MAPPING64 as METRIC_MAPPING64
from ._argkmin import ArgKmin32 as ArgKmin32, ArgKmin64 as ArgKmin64
from ._argkmin_classmode import ArgKminClassMode32 as ArgKminClassMode32, ArgKminClassMode64 as ArgKminClassMode64
from ._radius_neighbors import RadiusNeighbors32 as RadiusNeighbors32, RadiusNeighbors64 as RadiusNeighbors64
...
class BaseDistancesReductionDispatcher(metaclass=abc.ABCMeta):
...
class ArgKmin(BaseDistancesReductionDispatcher):
    ...
    """
    @classmethod
    def compute(cls, X, Y, k, metric: str = 'euclidean', chunk_size: Incomplete | None = None, metric_kwargs: Incomplete | None = None, strategy: Incomplete | None = None, return_distance: bool = False):
...
class RadiusNeighbors(BaseDistancesReductionDispatcher):
    ...
    """
    @classmethod
    def compute(cls, X, Y, radius, metric: str = 'euclidean', chunk_size: Incomplete | None = None, metric_kwargs: Incomplete | None = None, strategy: Incomplete | None = None, return_distance: bool = False, sort_results: bool = False):
...
class ArgKminClassMode(BaseDistancesReductionDispatcher):
    ...
    def is_usable_for(cls, X, Y, metric) -> bool:
        ...
        """
    @classmethod
    def compute(cls, X, Y, k, weights, labels, unique_labels, metric: str = 'euclidean', chunk_size: Incomplete | None = None, metric_kwargs: Incomplete | None = None, strategy: Incomplete | None = None):
        """Compute the argkmin reduction.
