...
class BaseLossScaleOptimizer(metaclass=LossScaleOptimizerMetaclass):
    ...
    @property
    def loss_scale(self) -> None:
        """The current loss scale as a float32 scalar tensor."""
    @property
    def dynamic_counter(self) -> None:
    ...
    def initial_scale(self) -> None:
        ...
        """
    @property
    def dynamic_growth_steps(self) -> None:
        ...
        """
    @property
    def inner_optimizer(self) -> None:
        """The optimizer that this LossScaleOptimizer is wrapping."""
    def get_scaled_loss(self, loss) -> None:
        ...
        """
    def get_unscaled_gradients(self, grads) -> None:
...
class LossScaleOptimizer(tf.__internal__.tracking.DelegatingTrackableMixin, optimizer_v2.OptimizerV2, BaseLossScaleOptimizer):
    """An optimizer that applies loss scaling to prevent numeric underflow."""
...
class LossScaleOptimizerV3(tf.__internal__.tracking.DelegatingTrackableMixin, optimizer.Optimizer, BaseLossScaleOptimizer):
    ...
    def apply_gradients(self, grads_and_vars, skip_gradients_aggregation: bool = False, **kwargs): ...
    def get_config(self): ...
    @classmethod
    def from_config(cls, config, custom_objects: Incomplete | None = None): ...
    @property
    ...
    def use_ema(self): ...
    @use_ema.setter
    def use_ema(self, use_ema) -> None: ...
    @property
    def ema_momentum(self): ...
    @ema_momentum.setter
    def ema_momentum(self, ema_momentum) -> None: ...
