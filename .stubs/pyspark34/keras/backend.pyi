...
from keras.utils import control_flow_util as control_flow_util, object_identity as object_identity, tf_contextlib as tf_contextlib, tf_inspect as tf_inspect, tf_utils as tf_utils
...
PER_GRAPH_OBJECT_NAME_UIDS: Incomplete
OBSERVED_NAMES: Incomplete
...
def name_scope(name):
    ...
    '''
def variable(value, dtype: Incomplete | None = None, name: Incomplete | None = None, constraint: Incomplete | None = None):
...
def unique_object_name(name, name_uid_map: Incomplete | None = None, avoid_names: Incomplete | None = None, namespace: str = '', zero_based: bool = False, avoid_observed_names: bool = False):
    ...
    '''
def constant(value, dtype: Incomplete | None = None, shape: Incomplete | None = None, name: Incomplete | None = None):
...
def is_keras_tensor(x):
    ...
    '''
def placeholder(shape: Incomplete | None = None, ndim: Incomplete | None = None, dtype: Incomplete | None = None, sparse: bool = False, name: Incomplete | None = None, ragged: bool = False):
...
def ones(shape, dtype: Incomplete | None = None, name: Incomplete | None = None):
    ...
    """
def eye(size, dtype: Incomplete | None = None, name: Incomplete | None = None):
...
def ones_like(x, dtype: Incomplete | None = None, name: Incomplete | None = None):
    ...
    """
def identity(x, name: Incomplete | None = None):
...
class RandomGenerator(tf.__internal__.tracking.AutoTrackable):
    ...
    RNG_STATELESS: str
    RNG_STATEFUL: str
    RNG_LEGACY_STATEFUL: str
    def __init__(self, seed: Incomplete | None = None, rng_type: Incomplete | None = None, **kwargs) -> None: ...
    ...
    def make_legacy_seed(self):
        ...
        """
    def random_normal(self, shape, mean: float = 0.0, stddev: float = 1.0, dtype: Incomplete | None = None, nonce: Incomplete | None = None):
        ...
        Args:
          ...
          nonce: Optional integer scalar, that will be folded into the seed in
            the stateless mode.
        """
    def random_uniform(self, shape, minval: float = 0.0, maxval: Incomplete | None = None, dtype: Incomplete | None = None, nonce: Incomplete | None = None):
        ...
        Args:
          ...
          nonce: Optional integer scalar, that will be folded into the seed in
            the stateless mode.
        """
    def truncated_normal(self, shape, mean: float = 0.0, stddev: float = 1.0, dtype: Incomplete | None = None, nonce: Incomplete | None = None):
        ...
        Args:
          ...
          nonce: Optional integer scalar, that will be folded into the seed in
            the stateless mode.
        """
    def dropout(self, inputs, rate, noise_shape: Incomplete | None = None): ...

def random_uniform_variable(shape, low, high, dtype: Incomplete | None = None, name: Incomplete | None = None, seed: Incomplete | None = None):
    ...
    dtype=float32)>
    """
def random_normal_variable(shape, mean, scale, dtype: Incomplete | None = None, name: Incomplete | None = None, seed: Incomplete | None = None):
...
def dot(x, y):
    ...
    (2, 4, 5)
    """
def batch_dot(x, y, axes: Incomplete | None = None):
...
def gather(reference, indices):
    ...
    array([[1., 2., 3.],
           ...
           [1., 2., 3.]], dtype=float32)
    """
def max(x, axis: Incomplete | None = None, keepdims: bool = False):
    ...
    """
def min(x, axis: Incomplete | None = None, keepdims: bool = False):
...
def sum(x, axis: Incomplete | None = None, keepdims: bool = False):
    ...
    """
def prod(x, axis: Incomplete | None = None, keepdims: bool = False):
...
def cumprod(x, axis: int = 0):
    ...
    """
def var(x, axis: Incomplete | None = None, keepdims: bool = False):
    ...
    """
def std(x, axis: Incomplete | None = None, keepdims: bool = False):
...
def mean(x, axis: Incomplete | None = None, keepdims: bool = False):
    ...
    """
def any(x, axis: Incomplete | None = None, keepdims: bool = False):
    ...
    """
def all(x, axis: Incomplete | None = None, keepdims: bool = False):
...
def log(x):
    ...
    Returns:
        A tensor.
    """
def logsumexp(x, axis: Incomplete | None = None, keepdims: bool = False):
...
def cos(x):
    ...
    Returns:
        A tensor.
    """
def normalize_batch_in_training(x, gamma, beta, reduction_axes, epsilon: float = 0.001):
    ...
    """
def batch_normalization(x, mean, var, beta, gamma, axis: int = -1, epsilon: float = 0.001):
...
def permute_dimensions(x, pattern):
    ...
    """
def resize_images(x, height_factor, width_factor, data_format, interpolation: str = 'nearest'):
...
def repeat(x, n):
    ...
    """
def arange(start, stop: Incomplete | None = None, step: int = 1, dtype: str = 'int32'):
...
def temporal_padding(x, padding=(1, 1)):
    ...
    Returns:
        A padded 3D tensor.
    """
def spatial_2d_padding(x, padding=((1, 1), (1, 1)), data_format: Incomplete | None = None):
    ...
    Raises:
        ValueError: if `data_format` is neither
            `channels_last` or `channels_first`.
    """
def spatial_3d_padding(x, padding=((1, 1), (1, 1), (1, 1)), data_format: Incomplete | None = None):
...
def batch_set_value(tuples) -> None:
    ...
    """
def print_tensor(x, message: str = '', summarize: int = 3):
...
class GraphExecutionFunction:
    ...
    inputs: Incomplete
    outputs: Incomplete
    updates_op: Incomplete
    name: Incomplete
    feed_dict: Incomplete
    fetches: Incomplete
    run_options: Incomplete
    run_metadata: Incomplete
    session_kwargs: Incomplete
    fetch_callbacks: Incomplete
    def __init__(self, inputs, outputs, updates: Incomplete | None = None, name: Incomplete | None = None, **session_kwargs) -> None: ...
    def __call__(self, inputs): ...

def function(inputs, outputs, updates: Incomplete | None = None, name: Incomplete | None = None, **kwargs):
...
def stop_gradient(variables):
    ...
    """
def rnn(step_function, inputs, initial_states, go_backwards: bool = False, mask: Incomplete | None = None, constants: Incomplete | None = None, unroll: bool = False, input_length: Incomplete | None = None, time_major: bool = False, zero_output_for_mask: bool = False, return_all_outputs: bool = True):
...
def switch(condition, then_expression, else_expression):
    ...
    """
def in_train_phase(x, alt, training: Incomplete | None = None):
    ...
    """
def in_test_phase(x, alt, training: Incomplete | None = None):
...
def softsign(x):
    ...
    Returns:
        A tensor.
    """
def categorical_crossentropy(target, output, from_logits: bool = False, axis: int = -1):
    ...
    """
def sparse_categorical_crossentropy(target, output, from_logits: bool = False, axis: int = -1, ignore_class: Incomplete | None = None):
    ...
    Raises:
        ValueError: if `axis` is neither -1 nor one of the axes of `output`.
    '''
def binary_crossentropy(target, output, from_logits: bool = False):
    ...
    Returns:
        A tensor.
    """
def binary_focal_crossentropy(target, output, apply_class_balancing: bool = False, alpha: float = 0.25, gamma: float = 2.0, from_logits: bool = False):
...
def tanh(x):
    ...
    Returns:
        A tensor.
    """
def dropout(x, level, noise_shape: Incomplete | None = None, seed: Incomplete | None = None):
    ...
    Returns:
        A tensor.
    """
def l2_normalize(x, axis: Incomplete | None = None):
...
def in_top_k(predictions, targets, k):
    ...
    """
def conv1d(x, kernel, strides: int = 1, padding: str = 'valid', data_format: Incomplete | None = None, dilation_rate: int = 1):
    '''1D convolution.
    ...
    Raises:
        ...
        `channels_first`.
    '''
def conv2d(x, kernel, strides=(1, 1), padding: str = 'valid', data_format: Incomplete | None = None, dilation_rate=(1, 1)):
    '''2D convolution.
    ...
    Raises:
        ...
        `channels_first`.
    '''
def conv2d_transpose(x, kernel, output_shape, strides=(1, 1), padding: str = 'valid', data_format: Incomplete | None = None, dilation_rate=(1, 1)):
    ...
    Raises:
        ...
        `channels_first`.
    '''
def separable_conv1d(x, depthwise_kernel, pointwise_kernel, strides: int = 1, padding: str = 'valid', data_format: Incomplete | None = None, dilation_rate: int = 1):
    ...
    Raises:
        ...
        `channels_first`.
    '''
def separable_conv2d(x, depthwise_kernel, pointwise_kernel, strides=(1, 1), padding: str = 'valid', data_format: Incomplete | None = None, dilation_rate=(1, 1)):
    ...
    '''
def depthwise_conv2d(x, depthwise_kernel, strides=(1, 1), padding: str = 'valid', data_format: Incomplete | None = None, dilation_rate=(1, 1)):
    '''2D convolution with separable filters.
    ...
    Raises:
        ...
        `channels_first`.
    '''
def conv3d(x, kernel, strides=(1, 1, 1), padding: str = 'valid', data_format: Incomplete | None = None, dilation_rate=(1, 1, 1)):
    '''3D convolution.
    ...
    Raises:
        ...
        `channels_first`.
    '''
def conv3d_transpose(x, kernel, output_shape, strides=(1, 1, 1), padding: str = 'valid', data_format: Incomplete | None = None):
    ...
    Raises:
        ...
        `channels_first`.
    '''
def pool2d(x, pool_size, strides=(1, 1), padding: str = 'valid', data_format: Incomplete | None = None, pool_mode: str = 'max'):
    '''2D Pooling.
    ...
    '''
def pool3d(x, pool_size, strides=(1, 1, 1), padding: str = 'valid', data_format: Incomplete | None = None, pool_mode: str = 'max'):
    '''3D Pooling.
    ...
    Raises:
        ...
        ValueError: if `pool_mode` is neither `"max"` or `"avg"`.
    '''
def local_conv(inputs, kernel, kernel_size, strides, output_shape, data_format: Incomplete | None = None):
    ...
    '''
def local_conv1d(inputs, kernel, kernel_size, strides, data_format: Incomplete | None = None):
    ...
    Returns:
        ...
        if data_format=\'channels_last\'.
    '''
def local_conv2d(inputs, kernel, kernel_size, strides, output_shape, data_format: Incomplete | None = None):
    ...
    Returns:
        ...
        if data_format='channels_last'.
    """
def bias_add(x, bias, data_format: Incomplete | None = None):
    ...
    '''
def random_normal(shape, mean: float = 0.0, stddev: float = 1.0, dtype: Incomplete | None = None, seed: Incomplete | None = None):
    ...
    dtype=float32)>
    """
def random_uniform(shape, minval: float = 0.0, maxval: float = 1.0, dtype: Incomplete | None = None, seed: Incomplete | None = None):
    ...
    dtype=float32)>
    """
def random_binomial(shape, p: float = 0.0, dtype: Incomplete | None = None, seed: Incomplete | None = None):
    ...
    dtype=float32)>
    """
def random_bernoulli(shape, p: float = 0.0, dtype: Incomplete | None = None, seed: Incomplete | None = None):
    ...
    Returns:
        A tensor.
    """
def truncated_normal(shape, mean: float = 0.0, stddev: float = 1.0, dtype: Incomplete | None = None, seed: Incomplete | None = None):
...
def ctc_batch_cost(y_true, y_pred, input_length, label_length):
    ...
    """
def ctc_decode(y_pred, input_length, greedy: bool = True, beam_width: int = 100, top_paths: int = 1):
    ...
    """
def map_fn(fn, elems, name: Incomplete | None = None, dtype: Incomplete | None = None):
    ...
    """
def foldl(fn, elems, initializer: Incomplete | None = None, name: Incomplete | None = None):
    ...
    """
def foldr(fn, elems, initializer: Incomplete | None = None, name: Incomplete | None = None):
...
def maybe_convert_to_ragged(is_ragged_input, output, nested_row_lengths, go_backwards: bool = False):
...
class ContextValueCache(weakref.WeakKeyDictionary):
    ...
    def __getitem__(self, key):
        ...
        """
    def setdefault(self, key: Incomplete | None = None, default: Incomplete | None = None, kwargs: Incomplete | None = None):
