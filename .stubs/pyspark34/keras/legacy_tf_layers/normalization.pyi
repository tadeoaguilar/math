...
class BatchNormalization(batch_normalization_v1.BatchNormalization, base.Layer):
    ...
    @end_compatibility
    '''
    def __init__(self, axis: int = -1, momentum: float = 0.99, epsilon: float = 0.001, center: bool = True, scale: bool = True, beta_initializer=..., gamma_initializer=..., moving_mean_initializer=..., moving_variance_initializer=..., beta_regularizer: Incomplete | None = None, gamma_regularizer: Incomplete | None = None, beta_constraint: Incomplete | None = None, gamma_constraint: Incomplete | None = None, renorm: bool = False, renorm_clipping: Incomplete | None = None, renorm_momentum: float = 0.99, fused: Incomplete | None = None, trainable: bool = True, virtual_batch_size: Incomplete | None = None, adjustment: Incomplete | None = None, name: Incomplete | None = None, **kwargs) -> None: ...
    def call(self, inputs, training: bool = False, mask: Incomplete | None = None): ...

def batch_normalization(inputs, axis: int = -1, momentum: float = 0.99, epsilon: float = 0.001, center: bool = True, scale: bool = True, beta_initializer=..., gamma_initializer=..., moving_mean_initializer=..., moving_variance_initializer=..., beta_regularizer: Incomplete | None = None, gamma_regularizer: Incomplete | None = None, beta_constraint: Incomplete | None = None, gamma_constraint: Incomplete | None = None, training: bool = False, trainable: bool = True, name: Incomplete | None = None, reuse: Incomplete | None = None, renorm: bool = False, renorm_clipping: Incomplete | None = None, renorm_momentum: float = 0.99, fused: Incomplete | None = None, virtual_batch_size: Incomplete | None = None, adjustment: Incomplete | None = None):
