...
class TestDistributionStrategyErrorCases(tf.test.TestCase, parameterized.TestCase):
    def test_validating_dataset_input_tensors_with_shape_mismatch(self, distribution): ...
    def test_validating_dataset_input_tensors_with_dtype_mismatch(self, distribution): ...
