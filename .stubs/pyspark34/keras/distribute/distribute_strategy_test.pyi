...
def batch_wrapper(dataset, batch_size, distribution, repeat: Incomplete | None = None): ...
def get_model(): ...
def get_sample_weights_model(): ...
def get_dataset(distribution): ...
def get_predict_dataset(distribution): ...
def convert_numpy_to_dataset_with_unknown_cardinality(inputs, targets: Incomplete | None = None): ...
...
class BatchCountingCB(keras.callbacks.Callback):
    train_begin_batches: Incomplete
    train_end_batches: Incomplete
    test_begin_batches: Incomplete
    test_end_batches: Incomplete
    predict_begin_batches: Incomplete
    predict_end_batches: Incomplete
...
class TestDistributionStrategyWithNumpyArrays(tf.test.TestCase, parameterized.TestCase):
    ...
    extra_weight_1: Incomplete
    extra_weight_2: Incomplete
