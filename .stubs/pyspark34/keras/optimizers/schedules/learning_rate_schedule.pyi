...
class NoisyLinearCosineDecay(LearningRateSchedule):
    ...
    seed: Incomplete
    name: Incomplete
    def __init__(self, initial_learning_rate, decay_steps, initial_variance: float = 1.0, variance_decay: float = 0.55, num_periods: float = 0.5, alpha: float = 0.0, beta: float = 0.001, seed: Incomplete | None = None, name: Incomplete | None = None) -> None:
...
def serialize(learning_rate_schedule, use_legacy_format: bool = False):
