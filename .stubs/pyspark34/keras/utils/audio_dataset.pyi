...
from keras.utils import dataset_utils as dataset_utils

ALLOWED_FORMATS: Incomplete

def audio_dataset_from_directory(directory, labels: str = 'inferred', label_mode: str = 'int', class_names: Incomplete | None = None, batch_size: int = 32, sampling_rate: Incomplete | None = None, output_sequence_length: Incomplete | None = None, ragged: bool = False, shuffle: bool = True, seed: Incomplete | None = None, validation_split: Incomplete | None = None, subset: Incomplete | None = None, follow_links: bool = False):
...
def read_and_decode_audio(path, sampling_rate: Incomplete | None = None, output_sequence_length: Incomplete | None = None):
