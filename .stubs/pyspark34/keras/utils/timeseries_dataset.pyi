...
def timeseries_dataset_from_array(data, targets, sequence_length, sequence_stride: int = 1, sampling_rate: int = 1, batch_size: int = 128, shuffle: bool = False, seed: Incomplete | None = None, start_index: Incomplete | None = None, end_index: Incomplete | None = None):
