...
def load_data(path: str = 'reuters.npz', num_words: Incomplete | None = None, skip_top: int = 0, maxlen: Incomplete | None = None, test_split: float = 0.2, seed: int = 113, start_char: int = 1, oov_char: int = 2, index_from: int = 3, **kwargs):
