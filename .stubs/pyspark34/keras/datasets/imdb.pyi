...
def load_data(path: str = 'imdb.npz', num_words: Incomplete | None = None, skip_top: int = 0, maxlen: Incomplete | None = None, seed: int = 113, start_char: int = 1, oov_char: int = 2, index_from: int = 3, **kwargs):
    ...
    **y_train, y_test**: lists of integer labels (1 or 0).
    ...
    '''
def get_word_index(path: str = 'imdb_word_index.json'):
