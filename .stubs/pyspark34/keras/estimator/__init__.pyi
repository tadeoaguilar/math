...
def model_to_estimator(keras_model: Incomplete | None = None, keras_model_path: Incomplete | None = None, custom_objects: Incomplete | None = None, model_dir: Incomplete | None = None, config: Incomplete | None = None, checkpoint_format: str = 'saver', metric_names_map: Incomplete | None = None, export_outputs: Incomplete | None = None):
    ...
    """
def model_to_estimator_v2(keras_model: Incomplete | None = None, keras_model_path: Incomplete | None = None, custom_objects: Incomplete | None = None, model_dir: Incomplete | None = None, config: Incomplete | None = None, checkpoint_format: str = 'checkpoint', metric_names_map: Incomplete | None = None, export_outputs: Incomplete | None = None):
    """Constructs an `Estimator` instance from given keras model.
