...
def save_model(model, filepath, overwrite: bool = True, save_format: Incomplete | None = None, **kwargs):
    ...
    * Traced call and loss functions, which are stored as TensorFlow
    ...
    '''
def load_model(filepath, custom_objects: Incomplete | None = None, compile: bool = True, safe_mode: bool = True, **kwargs):
    ...
    access specific variables, e.g. `model.get_layer("dense_1").kernel`.
    '''
def save_weights(model, filepath, overwrite: bool = True, **kwargs) -> None: ...
def load_weights(model, filepath, skip_mismatch: bool = False, **kwargs): ...
