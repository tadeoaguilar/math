...
from keras.losses import binary_crossentropy as binary_crossentropy, categorical_crossentropy as categorical_crossentropy, kullback_leibler_divergence as kullback_leibler_divergence, poisson as poisson, sparse_categorical_crossentropy as sparse_categorical_crossentropy
...
class CategoricalCrossentropy(base_metric.MeanMetricWrapper):
    ...
    ```
    '''
    def __init__(self, name: str = 'categorical_crossentropy', dtype: Incomplete | None = None, from_logits: bool = False, label_smoothing: int = 0, axis: int = -1) -> None: ...
...
class SparseCategoricalCrossentropy(base_metric.MeanMetricWrapper):
    ...
    ```
    '''
    def __init__(self, name: str = 'sparse_categorical_crossentropy', dtype: str | tf.dtypes.DType | None = None, from_logits: bool = False, ignore_class: int | None = None, axis: int = -1) -> None: ...
