...
from keras.dtensor import lazy_variable as lazy_variable, utils as utils
...
class LayoutMap(collections.abc.MutableMapping):
    ...
    Args:
      mesh: An optional `Mesh` that can be used to create all replicated
        ...
        string query.
    """
    def __init__(self, mesh: Incomplete | None = None) -> None: ...
    def __getitem__(self, key):
        ...
        """
    def __setitem__(self, key, layout) -> None: ...
...
def layout_map_scope(layout_map) -> Generator[None, None, None]:
