...
class L1(Regularizer):
    ...
    """
    l1: Incomplete
    def __init__(self, l1: float = 0.01, **kwargs) -> None: ...
    def __call__(self, x): ...
    def get_config(self): ...
...
class L2(Regularizer):
    ...
    """
    l2: Incomplete
    def __init__(self, l2: float = 0.01, **kwargs) -> None: ...
    def __call__(self, x): ...
    def get_config(self): ...
...
class OrthogonalRegularizer(Regularizer):
    ...
    factor: Incomplete
    mode: Incomplete
    def __init__(self, factor: float = 0.01, mode: str = 'rows') -> None: ...
...
def serialize(regularizer, use_legacy_format: bool = False): ...
