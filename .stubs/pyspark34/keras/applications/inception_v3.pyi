...
def InceptionV3(include_top: bool = True, weights: str = 'imagenet', input_tensor: Incomplete | None = None, input_shape: Incomplete | None = None, pooling: Incomplete | None = None, classes: int = 1000, classifier_activation: str = 'softmax'):
    ...
    '''
def conv2d_bn(x, filters, num_row, num_col, padding: str = 'same', strides=(1, 1), name: Incomplete | None = None):
