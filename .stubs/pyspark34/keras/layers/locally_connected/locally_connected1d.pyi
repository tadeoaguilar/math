...
from keras.layers.locally_connected import locally_connected_utils as locally_connected_utils
...
class LocallyConnected1D(Layer):
    ...
    def __init__(self, filters, kernel_size, strides: int = 1, padding: str = 'valid', data_format: Incomplete | None = None, activation: Incomplete | None = None, use_bias: bool = True, kernel_initializer: str = 'glorot_uniform', bias_initializer: str = 'zeros', kernel_regularizer: Incomplete | None = None, bias_regularizer: Incomplete | None = None, activity_regularizer: Incomplete | None = None, kernel_constraint: Incomplete | None = None, bias_constraint: Incomplete | None = None, implementation: int = 1, **kwargs) -> None: ...
    output_length: Incomplete
    kernel_shape: Incomplete
    kernel: Incomplete
    kernel_mask: Incomplete
    kernel_idxs: Incomplete
    bias: Incomplete
    built: bool
