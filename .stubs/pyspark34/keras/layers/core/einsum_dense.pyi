...
class EinsumDense(Layer):
    ...
    **Applying a dense layer to a sequence using ellipses**
    ...
    '''
    equation: Incomplete
    partial_output_shape: Incomplete
    bias_axes: Incomplete
    ...
    def __init__(self, equation, output_shape, activation: Incomplete | None = None, bias_axes: Incomplete | None = None, kernel_initializer: str = 'glorot_uniform', bias_initializer: str = 'zeros', kernel_regularizer: Incomplete | None = None, bias_regularizer: Incomplete | None = None, activity_regularizer: Incomplete | None = None, kernel_constraint: Incomplete | None = None, bias_constraint: Incomplete | None = None, **kwargs) -> None: ...
    kernel: Incomplete
    bias: Incomplete
