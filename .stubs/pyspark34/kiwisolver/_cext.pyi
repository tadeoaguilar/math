...
class Strength:
    ...
    def create(self, a: int | float, b: int | float, c: int | float, weight: int | float = 1.0) -> float: ...
...
class Variable:
    ...
    def __eq__(self, other: float | Variable | Term | Expression) -> Constraint: ...
...
class Constraint:
    def __init__(self, expression: Expression, op: Literal['=='] | Literal['<='] | Literal['>='], strength: float | Literal['weak'] | Literal['medium'] | Literal['strong'] | Literal['required'] = 'required') -> None: ...
    ...
    def __or__(self, other: float | Literal['weak'] | Literal['medium'] | Literal['strong'] | Literal['required']) -> Constraint: ...
    def __ror__(self, other: float | Literal['weak'] | Literal['medium'] | Literal['strong'] | Literal['required']) -> Constraint: ...
