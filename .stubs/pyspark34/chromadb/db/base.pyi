...
class Cursor(Protocol):
    ...
    def execute(self, sql: str, params: Tuple[Any, ...] | None = None) -> Self: ...
    def executescript(self, script: str) -> Self: ...
    def executemany(self, sql: str, params: Sequence[Tuple[Any, ...]] | None = None) -> Self: ...
    def fetchone(self) -> Tuple[Any, ...]: ...
    def fetchall(self) -> Sequence[Tuple[Any, ...]]: ...

class TxWrapper(ABC, EnforceOverrides, metaclass=abc.ABCMeta):
...
class SqlDB(Component, metaclass=abc.ABCMeta):
...
def get_sql(query: pypika.queries.QueryBuilder, formatstr: str = '?') -> Tuple[str, Tuple[Any, ...]]:
    '''
