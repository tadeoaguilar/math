...
class LightGBMRanker(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaEstimator):
    ...
    def __init__(self, java_obj: Incomplete | None = None, baggingFraction: float = 1.0, baggingFreq: int = 0, baggingSeed: int = 3, binSampleCount: int = 200000, boostFromAverage: bool = True, boostingType: str = 'gbdt', catSmooth: float = 10.0, categoricalSlotIndexes=[], categoricalSlotNames=[], catl2: float = 10.0, chunkSize: int = 10000, dataRandomSeed: int = 1, dataTransferMode: str = 'streaming', defaultListenPort: int = 12400, deterministic: bool = False, driverListenPort: int = 0, dropRate: float = 0.1, dropSeed: int = 4, earlyStoppingRound: int = 0, evalAt=[1, 2, 3, 4, 5], executionMode: Incomplete | None = None, extraSeed: int = 6, featureFraction: float = 1.0, featureFractionByNode: Incomplete | None = None, featureFractionSeed: int = 2, featuresCol: str = 'features', featuresShapCol: str = '', fobj: Incomplete | None = None, groupCol: Incomplete | None = None, improvementTolerance: float = 0.0, initScoreCol: Incomplete | None = None, isEnableSparse: bool = True, isProvideTrainingMetric: bool = False, labelCol: str = 'label', labelGain=[], lambdaL1: float = 0.0, lambdaL2: float = 0.0, leafPredictionCol: str = '', learningRate: float = 0.1, matrixType: str = 'auto', maxBin: int = 255, maxBinByFeature=[], maxCatThreshold: int = 32, maxCatToOnehot: int = 4, maxDeltaStep: float = 0.0, maxDepth: int = -1, maxDrop: int = 50, maxNumClasses: int = 100, maxPosition: int = 20, maxStreamingOMPThreads: int = 16, metric: str = '', microBatchSize: int = 100, minDataInLeaf: int = 20, minDataPerBin: int = 3, minDataPerGroup: int = 100, minGainToSplit: float = 0.0, minSumHessianInLeaf: float = 0.001, modelString: str = '', monotoneConstraints=[], monotoneConstraintsMethod: str = 'basic', monotonePenalty: float = 0.0, negBaggingFraction: float = 1.0, numBatches: int = 0, numIterations: int = 100, numLeaves: int = 31, numTasks: int = 0, numThreads: int = 0, objective: str = 'lambdarank', objectiveSeed: int = 5, otherRate: float = 0.1, parallelism: str = 'data_parallel', passThroughArgs: str = '', posBaggingFraction: float = 1.0, predictDisableShapeCheck: bool = False, predictionCol: str = 'prediction', referenceDataset: Incomplete | None = None, repartitionByGroupingColumn: bool = True, samplingMode: str = 'subset', samplingSubsetSize: int = 1000000, seed: Incomplete | None = None, skipDrop: float = 0.5, slotNames=[], timeout: float = 1200.0, topK: int = 20, topRate: float = 0.2, uniformDrop: bool = False, useBarrierExecutionMode: bool = False, useMissing: bool = True, useSingleDatasetMode: bool = True, validationIndicatorCol: Incomplete | None = None, verbosity: int = -1, weightCol: Incomplete | None = None, xGBoostDartMode: bool = False, zeroAsMissing: bool = False) -> None: ...
    def setParams(self, baggingFraction: float = 1.0, baggingFreq: int = 0, baggingSeed: int = 3, binSampleCount: int = 200000, boostFromAverage: bool = True, boostingType: str = 'gbdt', catSmooth: float = 10.0, categoricalSlotIndexes=[], categoricalSlotNames=[], catl2: float = 10.0, chunkSize: int = 10000, dataRandomSeed: int = 1, dataTransferMode: str = 'streaming', defaultListenPort: int = 12400, deterministic: bool = False, driverListenPort: int = 0, dropRate: float = 0.1, dropSeed: int = 4, earlyStoppingRound: int = 0, evalAt=[1, 2, 3, 4, 5], executionMode: Incomplete | None = None, extraSeed: int = 6, featureFraction: float = 1.0, featureFractionByNode: Incomplete | None = None, featureFractionSeed: int = 2, featuresCol: str = 'features', featuresShapCol: str = '', fobj: Incomplete | None = None, groupCol: Incomplete | None = None, improvementTolerance: float = 0.0, initScoreCol: Incomplete | None = None, isEnableSparse: bool = True, isProvideTrainingMetric: bool = False, labelCol: str = 'label', labelGain=[], lambdaL1: float = 0.0, lambdaL2: float = 0.0, leafPredictionCol: str = '', learningRate: float = 0.1, matrixType: str = 'auto', maxBin: int = 255, maxBinByFeature=[], maxCatThreshold: int = 32, maxCatToOnehot: int = 4, maxDeltaStep: float = 0.0, maxDepth: int = -1, maxDrop: int = 50, maxNumClasses: int = 100, maxPosition: int = 20, maxStreamingOMPThreads: int = 16, metric: str = '', microBatchSize: int = 100, minDataInLeaf: int = 20, minDataPerBin: int = 3, minDataPerGroup: int = 100, minGainToSplit: float = 0.0, minSumHessianInLeaf: float = 0.001, modelString: str = '', monotoneConstraints=[], monotoneConstraintsMethod: str = 'basic', monotonePenalty: float = 0.0, negBaggingFraction: float = 1.0, numBatches: int = 0, numIterations: int = 100, numLeaves: int = 31, numTasks: int = 0, numThreads: int = 0, objective: str = 'lambdarank', objectiveSeed: int = 5, otherRate: float = 0.1, parallelism: str = 'data_parallel', passThroughArgs: str = '', posBaggingFraction: float = 1.0, predictDisableShapeCheck: bool = False, predictionCol: str = 'prediction', referenceDataset: Incomplete | None = None, repartitionByGroupingColumn: bool = True, samplingMode: str = 'subset', samplingSubsetSize: int = 1000000, seed: Incomplete | None = None, skipDrop: float = 0.5, slotNames=[], timeout: float = 1200.0, topK: int = 20, topRate: float = 0.2, uniformDrop: bool = False, useBarrierExecutionMode: bool = False, useMissing: bool = True, useSingleDatasetMode: bool = True, validationIndicatorCol: Incomplete | None = None, verbosity: int = -1, weightCol: Incomplete | None = None, xGBoostDartMode: bool = False, zeroAsMissing: bool = False):
        """
