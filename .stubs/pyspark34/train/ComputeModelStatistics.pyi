...
class ComputeModelStatistics(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(self, java_obj: Incomplete | None = None, evaluationMetric: str = 'all', labelCol: Incomplete | None = None, scoredLabelsCol: Incomplete | None = None, scoresCol: Incomplete | None = None) -> None: ...
    def setParams(self, evaluationMetric: str = 'all', labelCol: Incomplete | None = None, scoredLabelsCol: Incomplete | None = None, scoresCol: Incomplete | None = None):
        """
