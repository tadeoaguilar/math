...
from .dep_util import newer_group as newer_group
from .dir_util import mkpath as mkpath
from .errors import CompileError as CompileError, DistutilsModuleError as DistutilsModuleError, DistutilsPlatformError as DistutilsPlatformError, LinkError as LinkError, UnknownFileError as UnknownFileError
from .file_util import move_file as move_file
from .spawn import spawn as spawn
from .util import execute as execute, split_quoted as split_quoted
...
class CCompiler:
    ...
    obj_extension: Incomplete
    static_lib_extension: Incomplete
    shared_lib_extension: Incomplete
    static_lib_format: Incomplete
    shared_lib_format: Incomplete
    exe_extension: Incomplete
    ...
    def define_macro(self, name, value: Incomplete | None = None) -> None:
    ...
    def link(self, target_desc, objects, output_filename, output_dir: Incomplete | None = None, libraries: Incomplete | None = None, library_dirs: Incomplete | None = None, runtime_library_dirs: Incomplete | None = None, export_symbols: Incomplete | None = None, debug: int = 0, extra_preargs: Incomplete | None = None, extra_postargs: Incomplete | None = None, build_temp: Incomplete | None = None, target_lang: Incomplete | None = None) -> None:
        ...
        '''
    def link_shared_lib(self, objects, output_libname, output_dir: Incomplete | None = None, libraries: Incomplete | None = None, library_dirs: Incomplete | None = None, runtime_library_dirs: Incomplete | None = None, export_symbols: Incomplete | None = None, debug: int = 0, extra_preargs: Incomplete | None = None, extra_postargs: Incomplete | None = None, build_temp: Incomplete | None = None, target_lang: Incomplete | None = None) -> None: ...
    def link_shared_object(self, objects, output_filename, output_dir: Incomplete | None = None, libraries: Incomplete | None = None, library_dirs: Incomplete | None = None, runtime_library_dirs: Incomplete | None = None, export_symbols: Incomplete | None = None, debug: int = 0, extra_preargs: Incomplete | None = None, extra_postargs: Incomplete | None = None, build_temp: Incomplete | None = None, target_lang: Incomplete | None = None) -> None: ...
    def link_executable(self, objects, output_progname, output_dir: Incomplete | None = None, libraries: Incomplete | None = None, library_dirs: Incomplete | None = None, runtime_library_dirs: Incomplete | None = None, debug: int = 0, extra_preargs: Incomplete | None = None, extra_postargs: Incomplete | None = None, target_lang: Incomplete | None = None) -> None: ...
    ...
    def library_option(self, lib) -> None:
        ...
        """
    def has_function(self, funcname, includes: Incomplete | None = None, include_dirs: Incomplete | None = None, libraries: Incomplete | None = None, library_dirs: Incomplete | None = None):
        ...
        """
    def find_library_file(self, dirs, lib, debug: int = 0) -> None:
    ...
    def shared_object_filename(self, basename, strip_dir: int = 0, output_dir: str = ''): ...
    def executable_filename(self, basename, strip_dir: int = 0, output_dir: str = ''): ...
    def library_filename(self, libname, lib_type: str = 'static', strip_dir: int = 0, output_dir: str = ''): ...
    def announce(self, msg, level: int = 1) -> None: ...
...
def get_default_compiler(osname: Incomplete | None = None, platform: Incomplete | None = None):
...
def show_compilers() -> None:
    ...
    '''
def new_compiler(plat: Incomplete | None = None, compiler: Incomplete | None = None, verbose: int = 0, dry_run: int = 0, force: int = 0):
