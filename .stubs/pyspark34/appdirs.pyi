...
def user_cache_dir(appname: Incomplete | None = None, appauthor: Incomplete | None = None, version: Incomplete | None = None, opinion: bool = True):
    ...
    '''
def user_state_dir(appname: Incomplete | None = None, appauthor: Incomplete | None = None, version: Incomplete | None = None, roaming: bool = False):
...
class AppDirs:
    ...
    def __init__(self, appname: Incomplete | None = None, appauthor: Incomplete | None = None, version: Incomplete | None = None, roaming: bool = False, multipath: bool = False) -> None: ...
    @property
