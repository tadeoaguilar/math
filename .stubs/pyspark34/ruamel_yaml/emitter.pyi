...
class ScalarAnalysis:
    ...
    def __init__(self, scalar: Any, empty: Any, multiline: Any, allow_flow_plain: bool, allow_block_plain: bool, allow_single_quoted: bool, allow_double_quoted: bool, allow_block: bool) -> None: ...
...
class Emitter:
    ...
    analysis: Incomplete
    style: Incomplete
    def __init__(self, stream: StreamType, canonical: Any = None, indent: int | None = None, width: int | None = None, allow_unicode: bool | None = None, line_break: Any = None, block_seq_indent: int | None = None, top_level_colon_align: bool | None = None, prefix_colon: Any = None, brace_single_entry_mapping_in_flow_sequence: bool | None = None, dumper: Any = None) -> None: ...
    @property
    def stream(self) -> Any: ...
    @stream.setter
    ...
    def process_anchor(self, indicator: Any) -> None: ...
    ...
    def write_indicator(self, indicator: Any, need_whitespace: Any, whitespace: bool = False, indention: bool = False) -> None: ...
