...
class HistPlot(LinePlot):
    ...
    xlabel: Incomplete
    ylabel: Incomplete
    def __init__(self, data, bins: int | np.ndarray | list[np.ndarray] = 10, bottom: int | np.ndarray = 0, **kwargs) -> None: ...
    @property
...
class KdePlot(HistPlot):
    ...
    ind: Incomplete
    def __init__(self, data, bw_method: Incomplete | None = None, ind: Incomplete | None = None, **kwargs) -> None: ...

def hist_series(self, by: Incomplete | None = None, ax: Incomplete | None = None, grid: bool = True, xlabelsize: Incomplete | None = None, xrot: Incomplete | None = None, ylabelsize: Incomplete | None = None, yrot: Incomplete | None = None, figsize: Incomplete | None = None, bins: int = 10, legend: bool = False, **kwds): ...
def hist_frame(data, column: Incomplete | None = None, by: Incomplete | None = None, grid: bool = True, xlabelsize: Incomplete | None = None, xrot: Incomplete | None = None, ylabelsize: Incomplete | None = None, yrot: Incomplete | None = None, ax: Incomplete | None = None, sharex: bool = False, sharey: bool = False, figsize: Incomplete | None = None, layout: Incomplete | None = None, bins: int = 10, legend: bool = False, **kwds): ...
