...
def get_blkno_indexers(blknos: np.ndarray, group: bool = ...) -> list[tuple[int, slice | np.ndarray]]: ...
...
class SharedBlock:
    ...
    def __init__(self, values: ArrayLike, placement: BlockPlacement, ndim: int, refs: BlockValuesRefs | None = ...) -> None: ...
