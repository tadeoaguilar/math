...
def asof_join_backward_on_X_by_Y(left_values: np.ndarray, right_values: np.ndarray, left_by_values: np.ndarray, right_by_values: np.ndarray, allow_exact_matches: bool = ..., tolerance: np.number | float | None = ..., use_hashtable: bool = ...) -> tuple[npt.NDArray[np.intp], npt.NDArray[np.intp]]: ...
def asof_join_forward_on_X_by_Y(left_values: np.ndarray, right_values: np.ndarray, left_by_values: np.ndarray, right_by_values: np.ndarray, allow_exact_matches: bool = ..., tolerance: np.number | float | None = ..., use_hashtable: bool = ...) -> tuple[npt.NDArray[np.intp], npt.NDArray[np.intp]]: ...
def asof_join_nearest_on_X_by_Y(left_values: np.ndarray, right_values: np.ndarray, left_by_values: np.ndarray, right_by_values: np.ndarray, allow_exact_matches: bool = ..., tolerance: np.number | float | None = ..., use_hashtable: bool = ...) -> tuple[npt.NDArray[np.intp], npt.NDArray[np.intp]]: ...
