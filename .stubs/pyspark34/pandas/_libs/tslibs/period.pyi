...
from pandas._typing import Frequency as Frequency, npt as npt
...
def from_ordinals(values: npt.NDArray[np.int64], freq: timedelta | BaseOffset | str) -> npt.NDArray[np.int64]: ...
def extract_ordinals(values: npt.NDArray[np.object_], freq: Frequency | int) -> npt.NDArray[np.int64]: ...
...
class Period(PeriodMixin):
    ordinal: int
    freq: BaseOffset
    def __new__(cls, value=..., freq: int | str | BaseOffset | None = ..., ordinal: int | None = ..., year: int | None = ..., month: int | None = ..., quarter: int | None = ..., day: int | None = ..., hour: int | None = ..., minute: int | None = ..., second: int | None = ...) -> Period | NaTType: ...
    @classmethod
    def now(cls, freq: BaseOffset = ...) -> Period: ...
    def strftime(self, fmt: str) -> str: ...
    def to_timestamp(self, freq: str | BaseOffset | None = ..., how: str = ...) -> Timestamp: ...
