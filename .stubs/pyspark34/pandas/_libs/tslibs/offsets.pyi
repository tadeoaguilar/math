...
class BaseOffset:
    ...
    @overload
    def __add__(self, other: BaseOffset) -> _BaseOffsetT: ...
    @overload
    ...
    @overload
    def __radd__(self, other: BaseOffset) -> _BaseOffsetT: ...
    @overload
    ...
    def __sub__(self, other: BaseOffset) -> _BaseOffsetT: ...
    @overload
    def __rsub__(self, other: npt.NDArray[np.object_]) -> npt.NDArray[np.object_]: ...
    @overload
    def __rsub__(self, other: BaseOffset) -> _BaseOffsetT: ...
    @overload
    ...
    @overload
    def __mul__(self, other: int) -> _BaseOffsetT: ...
    @overload
    def __rmul__(self, other: np.ndarray) -> np.ndarray: ...
    @overload
    def __rmul__(self, other: int) -> _BaseOffsetT: ...
    def __neg__(self) -> _BaseOffsetT: ...
    def copy(self) -> _BaseOffsetT: ...
    @property
    def name(self) -> str: ...
    @property
...
class BusinessMixin(SingleConstructorOffset):
    def __init__(self, n: int = ..., normalize: bool = ..., offset: timedelta = ...) -> None: ...

class BusinessDay(BusinessMixin): ...

class BusinessHour(BusinessMixin):
    def __init__(self, n: int = ..., normalize: bool = ..., start: str | Collection[str] = ..., end: str | Collection[str] = ..., offset: timedelta = ...) -> None: ...

class WeekOfMonthMixin(SingleConstructorOffset):
    def __init__(self, n: int = ..., normalize: bool = ..., weekday: int = ...) -> None: ...

class YearOffset(SingleConstructorOffset):
    def __init__(self, n: int = ..., normalize: bool = ..., month: int | None = ...) -> None: ...
...
class FY5253Mixin(SingleConstructorOffset):
    def __init__(self, n: int = ..., normalize: bool = ..., weekday: int = ..., startingMonth: int = ..., variation: Literal['nearest', 'last'] = ...) -> None: ...

class FY5253(FY5253Mixin): ...

class FY5253Quarter(FY5253Mixin):
    def __init__(self, n: int = ..., normalize: bool = ..., weekday: int = ..., startingMonth: int = ..., qtr_with_extra_week: int = ..., variation: Literal['nearest', 'last'] = ...) -> None: ...

class Easter(SingleConstructorOffset): ...

class _CustomBusinessMonth(BusinessMixin):
    def __init__(self, n: int = ..., normalize: bool = ..., weekmask: str = ..., holidays: list | None = ..., calendar: np.busdaycalendar | None = ..., offset: timedelta = ...) -> None: ...

class CustomBusinessDay(BusinessDay):
    def __init__(self, n: int = ..., normalize: bool = ..., weekmask: str = ..., holidays: list | None = ..., calendar: np.busdaycalendar | None = ..., offset: timedelta = ...) -> None: ...

class CustomBusinessHour(BusinessHour):
    def __init__(self, n: int = ..., normalize: bool = ..., weekmask: str = ..., holidays: list | None = ..., calendar: np.busdaycalendar | None = ..., start: str = ..., end: str = ..., offset: timedelta = ...) -> None: ...
