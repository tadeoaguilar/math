...
def kth_smallest(arr: np.ndarray, k: int) -> Any: ...
...
def rank_1d(values: np.ndarray, labels: np.ndarray | None = ..., is_datetimelike: bool = ..., ties_method=..., ascending: bool = ..., pct: bool = ..., na_option=..., mask: npt.NDArray[np.bool_] | None = ...) -> np.ndarray: ...
