...
def optional_args(decorator):
    ...
    """
def network(t, url: str = 'https://www.google.com', raise_on_error: bool = False, check_before_test: bool = False, error_classes: Incomplete | None = None, skip_errnos=..., _skip_on_messages=...):
    '''
    ...
    * ``raise_on_error`` supersedes ``check_before_test``
    ...
    '''
def can_connect(url, error_classes: Incomplete | None = None) -> bool:
    """
...
def write_to_compressed(compression, path, data, dest: str = 'test'):
    ...
    '''
def close(fignum: Incomplete | None = None) -> None: ...
