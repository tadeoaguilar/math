...
from pandas.core.dtypes.common import is_categorical_dtype as is_categorical_dtype, is_scalar as is_scalar
...
class CategoricalIndex(NDArrayBackedExtensionIndex):
    ...
    categories: Index
    ordered: bool | None
    def __new__(cls, data: Incomplete | None = None, categories: Incomplete | None = None, ordered: Incomplete | None = None, dtype: Dtype | None = None, copy: bool = False, name: Hashable = None) -> CategoricalIndex: ...
