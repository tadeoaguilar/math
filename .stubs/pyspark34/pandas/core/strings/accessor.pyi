...
from pandas._typing import AlignJoin as AlignJoin, DtypeObj as DtypeObj, F as F, Scalar as Scalar
...
class StringMethods(NoNewAttributesMixin):
    ...
    def cat(self, others: Incomplete | None = None, sep: Incomplete | None = None, na_rep: Incomplete | None = None, join: AlignJoin = 'left') -> str | Series | Index:
        """
    ...
    def contains(self, pat, case: bool = True, flags: int = 0, na: Incomplete | None = None, regex: bool = True):
        ...
        dtype: bool
        """
    def match(self, pat, case: bool = True, flags: int = 0, na: Incomplete | None = None):
        """
