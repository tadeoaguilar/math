...
from pandas._typing import ArrayLike as ArrayLike, AxisInt as AxisInt, DtypeObj as DtypeObj, NDFrameT as NDFrameT, Shape as Shape, npt as npt
...
from typing import Callable, Generic, Hashable, Iterator, Sequence
...
class BaseGrouper:
    ...
    def apply(self, f: Callable, data: DataFrame | Series, axis: AxisInt = 0) -> tuple[list, bool]: ...
...
class DataSplitter(Generic[NDFrameT]):
    ...
    ngroups: Incomplete
    axis: Incomplete
    def __init__(self, data: NDFrameT, labels: npt.NDArray[np.intp], ngroups: int, axis: AxisInt = 0) -> None: ...
