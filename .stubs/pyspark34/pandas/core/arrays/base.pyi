...
from pandas.core.dtypes.common import is_datetime64_dtype as is_datetime64_dtype, is_dtype_equal as is_dtype_equal, is_list_like as is_list_like, is_scalar as is_scalar, is_timedelta64_dtype as is_timedelta64_dtype, pandas_dtype as pandas_dtype
...
class ExtensionArray:
    ...
    * _from_sequence_of_strings
    ...
    def argmax(self, skipna: bool = True) -> int:
        ...
        """
    def fillna(self, value: object | ArrayLike | None = None, method: FillnaOptions | None = None, limit: int | None = None) -> ExtensionArrayT:
        """
    ...
    def factorize(self, use_na_sentinel: bool = True) -> tuple[np.ndarray, ExtensionArray]:
        ...
        """
    def repeat(self, repeats: int | Sequence[int], axis: AxisInt | None = None) -> ExtensionArrayT: ...
    def take(self, indices: TakeIndexer, *, allow_fill: bool = False, fill_value: Any = None) -> ExtensionArrayT:
        '''
