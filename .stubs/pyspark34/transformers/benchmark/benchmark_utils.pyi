import abc
from .. import AutoConfig as AutoConfig, PretrainedConfig as PretrainedConfig
from ..utils import is_psutil_available as is_psutil_available, is_py3nvml_available as is_py3nvml_available, is_tf_available as is_tf_available, is_torch_available as is_torch_available, logging as logging
...
class BenchmarkOutput(NamedTuple):
    time_inference_result: Incomplete
    memory_inference_result: Incomplete
    time_train_result: Incomplete
    memory_train_result: Incomplete
    inference_summary: Incomplete
    train_summary: Incomplete
...
def measure_peak_memory_cpu(function: Callable[[], None], interval: float = 0.5, device_idx: Incomplete | None = None) -> int:
    """
...
class Benchmark(ABC, metaclass=abc.ABCMeta):
    """
    ...
    def __init__(self, args: BenchmarkArguments = None, configs: PretrainedConfig = None) -> None: ...
    @property
    def print_fn(self): ...
    @property
    @abstractmethod
