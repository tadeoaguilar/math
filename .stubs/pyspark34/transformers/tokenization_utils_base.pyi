...
from .utils import ExplicitEnum as ExplicitEnum, PaddingStrategy as PaddingStrategy, PushToHubMixin as PushToHubMixin, TensorType as TensorType, add_end_docstrings as add_end_docstrings, cached_file as cached_file, copy_func as copy_func, download_url as download_url, extract_commit_hash as extract_commit_hash, is_flax_available as is_flax_available, is_jax_tensor as is_jax_tensor, is_numpy_array as is_numpy_array, is_offline_mode as is_offline_mode, is_remote_url as is_remote_url, is_tf_available as is_tf_available, is_tf_tensor as is_tf_tensor, is_tokenizers_available as is_tokenizers_available, is_torch_available as is_torch_available, is_torch_device as is_torch_device, is_torch_tensor as is_torch_tensor, logging as logging, requires_backends as requires_backends, to_py_obj as to_py_obj
...
class AddedToken:
    ...
    rstrip: bool = ...
    normalized: bool = ...
    def __init__(self, content, single_word, lstrip, rstrip, normalized) -> None: ...
...
logger: Incomplete
VERY_LARGE_INTEGER: Incomplete
LARGE_INTEGER: Incomplete
TextInput = str
...
class BatchEncoding(UserDict):
    ...
    Args:
        ...
        n_sequences (`Optional[int]`, *optional*):
            ...
            initialization.
    """
    def __init__(self, data: Optional[Dict[str, Any]] = None, encoding: Optional[Union[EncodingFast, Sequence[EncodingFast]]] = None, tensor_type: Union[None, str, TensorType] = None, prepend_batch_axis: bool = False, n_sequences: Optional[int] = None) -> None: ...
    @property
...
class SpecialTokensMixin:
    ...
    """
    SPECIAL_TOKENS_ATTRIBUTES: Incomplete
    verbose: Incomplete
    ...
    def sanitize_special_tokens(self) -> int:
        ...
        """
    def add_special_tokens(self, special_tokens_dict: Dict[str, Union[str, AddedToken]], replace_additional_special_tokens: bool = True) -> int:
        '''
...
class PreTrainedTokenizerBase(SpecialTokensMixin, PushToHubMixin):
    ...
    padding_side: str
    truncation_side: str
    slow_tokenizer_class: Incomplete
    init_inputs: Incomplete
    init_kwargs: Incomplete
    name_or_path: Incomplete
    model_max_length: Incomplete
    deprecation_warnings: Incomplete
    ...
    def batch_decode(self, sequences: Union[List[int], List[List[int]], 'np.ndarray', 'torch.Tensor', 'tf.Tensor'], skip_special_tokens: bool = False, clean_up_tokenization_spaces: bool = True, **kwargs) -> List[str]:
        ...
        """
    def decode(self, token_ids: Union[int, List[int], 'np.ndarray', 'torch.Tensor', 'tf.Tensor'], skip_special_tokens: bool = False, clean_up_tokenization_spaces: bool = True, **kwargs) -> str:
        """
    ...
    def clean_up_tokenization(out_string: str) -> str:
        ...
        """
    def as_target_tokenizer(self) -> Generator[None, None, None]:
        """
        Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
        sequence-to-sequence models that need a slightly different processing for the labels.
        """
    @classmethod
    def register_for_auto_class(cls, auto_class: str = 'AutoTokenizer') -> None:
        '''
