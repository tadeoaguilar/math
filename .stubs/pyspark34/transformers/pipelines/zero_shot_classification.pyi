...
class ZeroShotClassificationPipeline(ChunkPipeline):
    ...
    **much** more flexible.
    ...
    def __call__(self, sequences: Union[str, List[str]], *args, **kwargs):
        ...
        '''
    def preprocess(self, inputs, candidate_labels: Incomplete | None = None, hypothesis_template: str = 'This example is {}.') -> Generator[Incomplete, None, None]: ...
    def postprocess(self, model_outputs, multi_label: bool = False): ...
