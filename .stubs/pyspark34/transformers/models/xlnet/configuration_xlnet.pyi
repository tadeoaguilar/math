...
logger: Incomplete
XLNET_PRETRAINED_CONFIG_ARCHIVE_MAP: Incomplete
...
class XLNetConfig(PretrainedConfig):
    ...
    def __init__(self, vocab_size: int = 32000, d_model: int = 1024, n_layer: int = 24, n_head: int = 16, d_inner: int = 4096, ff_activation: str = 'gelu', untie_r: bool = True, attn_type: str = 'bi', initializer_range: float = 0.02, layer_norm_eps: float = 1e-12, dropout: float = 0.1, mem_len: int = 512, reuse_len: Incomplete | None = None, use_mems_eval: bool = True, use_mems_train: bool = False, bi_data: bool = False, clamp_len: int = -1, same_length: bool = False, summary_type: str = 'last', summary_use_proj: bool = True, summary_activation: str = 'tanh', summary_last_dropout: float = 0.1, start_n_top: int = 5, end_n_top: int = 5, pad_token_id: int = 5, bos_token_id: int = 1, eos_token_id: int = 2, **kwargs) -> None:
