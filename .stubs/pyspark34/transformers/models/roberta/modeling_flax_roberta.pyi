...
from .configuration_roberta import RobertaConfig as RobertaConfig
...
ROBERTA_START_DOCSTRING: str
ROBERTA_INPUTS_DOCSTRING: str
...
class FlaxRobertaPreTrainedModel(FlaxPreTrainedModel):
    ...
    def __init__(self, config: RobertaConfig, input_shape: Tuple = (1, 1), seed: int = 0, dtype: jnp.dtype = ..., _do_init: bool = True, gradient_checkpointing: bool = False, **kwargs) -> None: ...
