...
class DetrImageProcessor(BaseImageProcessor):
    ...
    def prepare_annotation(self, image: np.ndarray, target: Dict, format: Optional[AnnotionFormat] = None, return_segmentation_masks: bool = None, masks_path: Optional[Union[str, pathlib.Path]] = None) -> Dict:
        ...
        """
    def prepare(self, image, target, return_segmentation_masks: Incomplete | None = None, masks_path: Incomplete | None = None): ...
    ...
    def post_process(self, outputs, target_sizes):
        ...
        """
    def post_process_segmentation(self, outputs, target_sizes, threshold: float = 0.9, mask_threshold: float = 0.5):
        """
        ...
        Returns:
            ...
            in the batch as predicted by the model.
        """
    def post_process_instance(self, results, outputs, orig_target_sizes, max_target_sizes, threshold: float = 0.5):
        '''
        ...
        '''
    def post_process_panoptic(self, outputs, processed_sizes, target_sizes: Incomplete | None = None, is_thing_map: Incomplete | None = None, threshold: float = 0.85):
        """
