...
from transformers import is_flax_available as is_flax_available, is_tf_available as is_tf_available, is_torch_available as is_torch_available
...
class OwlViTProcessor(ProcessorMixin):
    ...
    def __call__(self, text: Incomplete | None = None, images: Incomplete | None = None, query_images: Incomplete | None = None, padding: str = 'max_length', return_tensors: str = 'np', **kwargs):
        '''
