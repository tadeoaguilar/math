...
from transformers.image_transforms import center_crop as center_crop, center_to_corners_format as center_to_corners_format, normalize as normalize, rescale as rescale, resize as resize, to_channel_dimension_format as to_channel_dimension_format, to_numpy_array as to_numpy_array
from transformers.image_utils import ChannelDimension as ChannelDimension, ImageInput as ImageInput, PILImageResampling as PILImageResampling, is_batched as is_batched, valid_images as valid_images
from transformers.utils import TensorType as TensorType, is_torch_available as is_torch_available, logging as logging
...
class OwlViTImageProcessor(BaseImageProcessor):
    ...
    def __init__(self, do_resize: bool = True, size: Incomplete | None = None, resample=..., do_center_crop: bool = False, crop_size: Incomplete | None = None, do_rescale: bool = True, rescale_factor=..., do_normalize: bool = True, image_mean: Incomplete | None = None, image_std: Incomplete | None = None, **kwargs) -> None: ...
    def resize(self, image: np.ndarray, size: Dict[str, int], resample: PILImageResampling.BICUBIC, data_format: Optional[Union[str, ChannelDimension]] = None, **kwargs) -> np.ndarray:
        """
        Resize an image to a certain size.
        """
    def center_crop(self, image: np.ndarray, crop_size: Dict[str, int], data_format: Optional[Union[str, ChannelDimension]] = None, **kwargs) -> np.ndarray:
        """
        Center crop an image to a certain size.
        """
    def rescale(self, image: np.ndarray, rescale_factor: float, data_format: Optional[Union[str, ChannelDimension]] = None, **kwargs) -> np.ndarray:
        """
        Rescale an image by a certain factor.
        """
    def normalize(self, image: np.ndarray, mean: List[float], std: List[float], data_format: Optional[Union[str, ChannelDimension]] = None, **kwargs) -> np.ndarray:
        """
        Normalize an image with a certain mean and standard deviation.
        """
    def preprocess(self, images: ImageInput, do_resize: Optional[bool] = None, size: Optional[Dict[str, int]] = None, resample: PILImageResampling = None, do_center_crop: Optional[bool] = None, crop_size: Optional[Dict[str, int]] = None, do_rescale: Optional[bool] = None, rescale_factor: Optional[float] = None, do_normalize: Optional[bool] = None, image_mean: Optional[Union[float, List[float]]] = None, image_std: Optional[Union[float, List[float]]] = None, return_tensors: Optional[Union[TensorType, str]] = None, data_format: Union[str, ChannelDimension] = ..., **kwargs) -> BatchFeature:
        """
    ...
    def post_process_object_detection(self, outputs, threshold: float = 0.1, target_sizes: Union[TensorType, List[Tuple]] = None):
        ...
        Returns:
            ...
            in the batch as predicted by the model.
        """
    def post_process_image_guided_detection(self, outputs, threshold: float = 0.6, nms_threshold: float = 0.3, target_sizes: Incomplete | None = None):
        """
