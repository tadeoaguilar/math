...
class YolosImageProcessor(BaseImageProcessor):
    ...
    def normalize_annotation(self, annotation: Dict, image_size: Tuple[int, int]) -> Dict:
        ...
        """
    def pad(self, images: List[np.ndarray], return_pixel_mask: bool = False, return_tensors: Optional[Union[str, TensorType]] = None, data_format: Optional[ChannelDimension] = None) -> np.ndarray:
        """
