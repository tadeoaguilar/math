...
class Wav2Vec2FeatureExtractor(SequenceFeatureExtractor):
    ...
    def __init__(self, feature_size: int = 1, sampling_rate: int = 16000, padding_value: float = 0.0, return_attention_mask: bool = False, do_normalize: bool = True, **kwargs) -> None: ...
    @staticmethod
