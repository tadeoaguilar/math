...
class XGLMTokenizer(PreTrainedTokenizer):
    ...
    def __init__(self, vocab_file, bos_token: str = '<s>', eos_token: str = '</s>', sep_token: str = '</s>', cls_token: str = '<s>', unk_token: str = '<unk>', pad_token: str = '<pad>', sp_model_kwargs: Optional[Dict[str, Any]] = None, **kwargs) -> None: ...
