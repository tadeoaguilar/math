...
class TFRemBertLMPredictionHead(tf.keras.layers.Layer):
    ...
    LayerNorm: Incomplete
    def __init__(self, config: RemBertConfig, input_embeddings: tf.keras.layers.Layer, **kwargs) -> None: ...
    decoder: Incomplete
...
class TFRemBertMainLayer(tf.keras.layers.Layer):
    ...
    encoder: Incomplete
    pooler: Incomplete
    def __init__(self, config: RemBertConfig, add_pooling_layer: bool = True, **kwargs) -> None: ...
