...
from ...modeling_tf_utils import DUMMY_INPUTS as DUMMY_INPUTS, TFCausalLanguageModelingLoss as TFCausalLanguageModelingLoss, TFModelInputType as TFModelInputType, TFPreTrainedModel as TFPreTrainedModel, keras_serializable as keras_serializable, unpack_inputs as unpack_inputs
...
from .configuration_mbart import MBartConfig as MBartConfig
...
MBART_START_DOCSTRING: str
MBART_INPUTS_DOCSTRING: str
MBART_GENERATION_EXAMPLE: str
...
class TFMBartEncoder(tf.keras.layers.Layer):
    ...
    def __init__(self, config: MBartConfig, embed_tokens: Optional[tf.keras.layers.Embedding] = None, **kwargs) -> None: ...
    def get_embed_tokens(self): ...
    def set_embed_tokens(self, embed_tokens) -> None: ...
    def call(self, input_ids: Optional[TFModelInputType] = None, inputs_embeds: Optional[tf.Tensor] = None, attention_mask: Optional[tf.Tensor] = None, head_mask: Optional[tf.Tensor] = None, output_attentions: Optional[bool] = None, output_hidden_states: Optional[bool] = None, return_dict: Optional[bool] = None, training: Optional[bool] = False) -> Union[TFBaseModelOutput, Tuple[tf.Tensor]]:
        """
        Args:
...
class TFMBartDecoder(tf.keras.layers.Layer):
    ...
    def get_embed_tokens(self): ...
    def set_embed_tokens(self, embed_tokens) -> None: ...
    def call(self, input_ids: TFModelInputType = None, inputs_embeds: Optional[tf.Tensor] = None, attention_mask: Optional[tf.Tensor] = None, position_ids: Optional[tf.Tensor] = None, encoder_hidden_states: Optional[tf.Tensor] = None, encoder_attention_mask: Optional[tf.Tensor] = None, head_mask: Optional[tf.Tensor] = None, cross_attn_head_mask: Optional[tf.Tensor] = None, past_key_values: Optional[Tuple[Tuple[tf.Tensor]]] = None, use_cache: Optional[bool] = None, output_attentions: Optional[bool] = None, output_hidden_states: Optional[bool] = None, return_dict: Optional[bool] = None, training: Optional[bool] = False) -> Union[TFBaseModelOutputWithPastAndCrossAttentions, Tuple[tf.Tensor, tf.Tensor, tf.Tensor, tf.Tensor, tf.Tensor]]:
        """
        Args:
            input_ids (`tf.Tensor` of shape `(batch_size, sequence_length)`):
                Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you
