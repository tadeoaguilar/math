...
from .configuration_maskformer import MaskFormerConfig as MaskFormerConfig
...
class MaskFormerPixelLevelModuleOutput(ModelOutput):
    ...
    def __init__(self, encoder_last_hidden_state, decoder_last_hidden_state, encoder_hidden_states, decoder_hidden_states) -> None: ...
...
class MaskFormerModelOutput(ModelOutput):
    ...
    hidden_states: Optional[Tuple[torch.FloatTensor]] = ...
    attentions: Optional[Tuple[torch.FloatTensor]] = ...
    def __init__(self, encoder_last_hidden_state, pixel_decoder_last_hidden_state, transformer_decoder_last_hidden_state, encoder_hidden_states, pixel_decoder_hidden_states, transformer_decoder_hidden_states, hidden_states, attentions) -> None: ...
...
class MaskFormerForInstanceSegmentationOutput(ModelOutput):
    ...
    hidden_states: Optional[Tuple[torch.FloatTensor]] = ...
    attentions: Optional[Tuple[torch.FloatTensor]] = ...
    def __init__(self, loss, class_queries_logits, masks_queries_logits, auxiliary_logits, encoder_last_hidden_state, pixel_decoder_last_hidden_state, transformer_decoder_last_hidden_state, encoder_hidden_states, pixel_decoder_hidden_states, transformer_decoder_hidden_states, hidden_states, attentions) -> None: ...
...
class MaskFormerHungarianMatcher(nn.Module):
    ...
    def __init__(self, cost_class: float = 1.0, cost_mask: float = 1.0, cost_dice: float = 1.0) -> None:
        """Creates the matcher
...
class MaskFormerFPNConvLayer(nn.Module):
    layers: Incomplete
    def __init__(self, in_features: int, out_features: int, kernel_size: int = 3, padding: int = 1) -> None:
        """
...
class MaskFormerFPNModel(nn.Module):
    stem: Incomplete
    layers: Incomplete
    def __init__(self, in_features: int, lateral_widths: List[int], feature_size: int = 256) -> None:
        """
...
class MaskFormerPixelDecoder(nn.Module):
    ...
    def __init__(self, *args, feature_size: int = 256, mask_feature_size: int = 256, **kwargs) -> None:
        """
...
class MaskFormerTransformerModule(nn.Module):
    ...
    def forward(self, image_features: Tensor, output_hidden_states: bool = False, output_attentions: bool = False) -> DetrDecoderOutput: ...

MASKFORMER_START_DOCSTRING: str
MASKFORMER_INPUTS_DOCSTRING: str
