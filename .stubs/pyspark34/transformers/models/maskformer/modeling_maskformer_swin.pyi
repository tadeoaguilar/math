...
class MaskFormerSwinModelOutputWithPooling(ModelOutput):
    ...
    def __init__(self, last_hidden_state, pooler_output, hidden_states, hidden_states_spatial_dimensions, attentions) -> None: ...
...
class MaskFormerSwinBaseModelOutput(ModelOutput):
    ...
    hidden_states_spatial_dimensions: Tuple[Tuple[int, int]] = ...
    attentions: Optional[Tuple[torch.FloatTensor]] = ...
    def __init__(self, last_hidden_state, hidden_states, hidden_states_spatial_dimensions, attentions) -> None: ...
...
class MaskFormerSwinLayer(nn.Module):
    ...
    def forward(self, hidden_states, input_dimensions, head_mask: Incomplete | None = None, output_attentions: bool = False): ...
...
class MaskFormerSwinStage(nn.Module):
    ...
    def forward(self, hidden_states, input_dimensions, head_mask: Incomplete | None = None, output_attentions: bool = False, output_hidden_states: bool = False): ...
...
class MaskFormerSwinEncoder(nn.Module):
    ...
    def forward(self, hidden_states, input_dimensions, head_mask: Incomplete | None = None, output_attentions: bool = False, output_hidden_states: bool = False, return_dict: bool = True): ...
...
class MaskFormerSwinModel(MaskFormerSwinPreTrainedModel):
    ...
    def forward(self, pixel_values: Incomplete | None = None, head_mask: Incomplete | None = None, output_attentions: Incomplete | None = None, output_hidden_states: Incomplete | None = None, return_dict: Incomplete | None = None): ...
