...
from .tokenization_camembert import CamembertTokenizer as CamembertTokenizer
...
class CamembertTokenizerFast(PreTrainedTokenizerFast):
    ...
    def __init__(self, vocab_file: Incomplete | None = None, tokenizer_file: Incomplete | None = None, bos_token: str = '<s>', eos_token: str = '</s>', sep_token: str = '</s>', cls_token: str = '<s>', unk_token: str = '<unk>', pad_token: str = '<pad>', mask_token: str = '<mask>', additional_special_tokens=['<s>NOTUSED', '</s>NOTUSED'], **kwargs) -> None: ...
