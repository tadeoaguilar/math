...
class CamembertTokenizer(PreTrainedTokenizer):
    ...
    fairseq_offset: Incomplete
    fairseq_ids_to_tokens: Incomplete
    def __init__(self, vocab_file, bos_token: str = '<s>', eos_token: str = '</s>', sep_token: str = '</s>', cls_token: str = '<s>', unk_token: str = '<unk>', pad_token: str = '<pad>', mask_token: str = '<mask>', additional_special_tokens=['<s>NOTUSED', '</s>NOTUSED'], sp_model_kwargs: Optional[Dict[str, Any]] = None, **kwargs) -> None: ...
