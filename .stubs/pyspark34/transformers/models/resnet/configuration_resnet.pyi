...
logger: Incomplete
RESNET_PRETRAINED_CONFIG_ARCHIVE_MAP: Incomplete
...
class ResNetConfig(PretrainedConfig):
    ...
    downsample_in_first_stage: Incomplete
    stage_names: Incomplete
    out_features: Incomplete
    def __init__(self, num_channels: int = 3, embedding_size: int = 64, hidden_sizes=[256, 512, 1024, 2048], depths=[3, 4, 6, 3], layer_type: str = 'bottleneck', hidden_act: str = 'relu', downsample_in_first_stage: bool = False, out_features: Incomplete | None = None, **kwargs) -> None: ...
