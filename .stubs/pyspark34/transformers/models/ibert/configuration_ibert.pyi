...
from transformers.onnx import OnnxConfig as OnnxConfig
from typing import Mapping

logger: Incomplete
IBERT_PRETRAINED_CONFIG_ARCHIVE_MAP: Incomplete
...
class IBertConfig(PretrainedConfig):
    ...
    force_dequant: Incomplete
    def __init__(self, vocab_size: int = 30522, hidden_size: int = 768, num_hidden_layers: int = 12, num_attention_heads: int = 12, intermediate_size: int = 3072, hidden_act: str = 'gelu', hidden_dropout_prob: float = 0.1, attention_probs_dropout_prob: float = 0.1, max_position_embeddings: int = 512, type_vocab_size: int = 2, initializer_range: float = 0.02, layer_norm_eps: float = 1e-12, pad_token_id: int = 1, bos_token_id: int = 0, eos_token_id: int = 2, position_embedding_type: str = 'absolute', quant_mode: bool = False, force_dequant: str = 'none', **kwargs) -> None: ...
