...
logger: Incomplete
PLBART_PRETRAINED_CONFIG_ARCHIVE_MAP: Incomplete
...
class PLBartConfig(PretrainedConfig):
    ...
    def __init__(self, vocab_size: int = 50005, max_position_embeddings: int = 1024, encoder_layers: int = 6, encoder_ffn_dim: int = 3072, encoder_attention_heads: int = 12, decoder_layers: int = 6, decoder_ffn_dim: int = 3072, decoder_attention_heads: int = 12, encoder_layerdrop: float = 0.0, decoder_layerdrop: float = 0.0, use_cache: bool = True, is_encoder_decoder: bool = True, activation_function: str = 'gelu', d_model: int = 768, dropout: float = 0.1, attention_dropout: float = 0.1, activation_dropout: float = 0.0, init_std: float = 0.02, classifier_dropout: float = 0.0, scale_embedding: bool = True, pad_token_id: int = 1, bos_token_id: int = 0, eos_token_id: int = 2, forced_eos_token_id: int = 2, **kwargs) -> None: ...
