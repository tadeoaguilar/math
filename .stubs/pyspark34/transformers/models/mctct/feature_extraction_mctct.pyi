...
from ...file_utils import PaddingStrategy as PaddingStrategy, TensorType as TensorType
from ...utils import logging as logging
from _typeshed import Incomplete
from typing import List, Optional, Union

logger: Incomplete
parsed_torchaudio_version_base: Incomplete
...
class MCTCTFeatureExtractor(SequenceFeatureExtractor):
    ...
    padding_value: Incomplete
    hop_length: Incomplete
    win_length: Incomplete
    frame_signal_scale: Incomplete
    preemphasis_coeff: Incomplete
    mel_floor: Incomplete
    normalize_means: Incomplete
    normalize_vars: Incomplete
    win_function: Incomplete
    return_attention_mask: Incomplete
    sample_size: Incomplete
    sample_stride: Incomplete
    n_fft: Incomplete
    n_freqs: Incomplete
    def __init__(self, feature_size: int = 80, sampling_rate: int = 16000, padding_value: float = 0.0, hop_length: int = 10, win_length: int = 25, win_function: str = 'hamming_window', frame_signal_scale: float = 32768.0, preemphasis_coeff: float = 0.97, mel_floor: float = 1.0, normalize_means: bool = True, normalize_vars: bool = True, return_attention_mask: bool = False, **kwargs) -> None: ...
