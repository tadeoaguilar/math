...
logger: Incomplete
FLAVA_PRETRAINED_CONFIG_ARCHIVE_MAP: Incomplete
...
class FlavaImageCodebookConfig(PretrainedConfig):
    ...
    freeze: Incomplete
    initializer_range: Incomplete
    def __init__(self, num_groups: int = 4, input_channels: int = 3, num_blocks_per_group: int = 2, hidden_size: int = 256, vocab_size: int = 8192, freeze: int = True, initializer_range: float = 0.02, **kwargs) -> None: ...
    @classmethod
    def from_pretrained(cls, pretrained_model_name_or_path: Union[str, os.PathLike], **kwargs) -> PretrainedConfig: ...
...
class FlavaConfig(PretrainedConfig):
    ...
    image_codebook_config: Incomplete
    projection_dim: Incomplete
    init_codebook: Incomplete
    hidden_size: Incomplete
    layer_norm_eps: Incomplete
    initializer_range: Incomplete
