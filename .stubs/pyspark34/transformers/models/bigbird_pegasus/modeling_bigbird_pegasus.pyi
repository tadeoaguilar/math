...
from .configuration_bigbird_pegasus import BigBirdPegasusConfig as BigBirdPegasusConfig
...
class BigBirdPegasusEncoderLayer(nn.Module):
    ...
    def __init__(self, config: BigBirdPegasusConfig, seed: Incomplete | None = None) -> None: ...
    def forward(self, hidden_states: torch.Tensor, attention_mask: torch.Tensor, layer_head_mask: torch.Tensor, band_mask: Incomplete | None = None, from_mask: Incomplete | None = None, to_mask: Incomplete | None = None, from_blocked_mask: Incomplete | None = None, to_blocked_mask: Incomplete | None = None, output_attentions: bool = False):
        """
        Args:
...
BIGBIRD_PEGASUS_START_DOCSTRING: str
BIGBIRD_PEGASUS_GENERATION_EXAMPLE: str
BIGBIRD_PEGASUS_INPUTS_DOCSTRING: str
BIGBIRD_PEGASUS_STANDALONE_INPUTS_DOCSTRING: str
...
class BigBirdPegasusEncoder(BigBirdPegasusPreTrainedModel):
    ...
    def __init__(self, config: BigBirdPegasusConfig, embed_tokens: Optional[nn.Embedding] = None) -> None: ...
    encoder_o: Incomplete
