...
from .configuration_dinat import DinatConfig as DinatConfig
...
class DinatLayer(nn.Module):
    ...
    def __init__(self, config, dim, num_heads, dilation, drop_path_rate: float = 0.0) -> None: ...
...
DINAT_START_DOCSTRING: str
DINAT_INPUTS_DOCSTRING: str
