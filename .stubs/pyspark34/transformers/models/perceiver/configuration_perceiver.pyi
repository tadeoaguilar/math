...
logger: Incomplete
PERCEIVER_PRETRAINED_CONFIG_ARCHIVE_MAP: Incomplete
...
class PerceiverConfig(PretrainedConfig):
    ...
    ```'''
    model_type: str
    num_latents: Incomplete
    d_latents: Incomplete
    d_model: Incomplete
    num_blocks: Incomplete
    num_self_attends_per_block: Incomplete
    num_self_attention_heads: Incomplete
    num_cross_attention_heads: Incomplete
    qk_channels: Incomplete
    v_channels: Incomplete
    cross_attention_shape_for_attention: Incomplete
    self_attention_widening_factor: Incomplete
    cross_attention_widening_factor: Incomplete
    ...
    audio_samples_per_frame: Incomplete
    samples_per_patch: Incomplete
    output_shape: Incomplete
    def __init__(self, num_latents: int = 256, d_latents: int = 1280, d_model: int = 768, num_blocks: int = 1, num_self_attends_per_block: int = 26, num_self_attention_heads: int = 8, num_cross_attention_heads: int = 8, qk_channels: Incomplete | None = None, v_channels: Incomplete | None = None, cross_attention_shape_for_attention: str = 'kv', self_attention_widening_factor: int = 1, cross_attention_widening_factor: int = 1, hidden_act: str = 'gelu', attention_probs_dropout_prob: float = 0.1, position_embedding_init_scale: float = 0.02, initializer_range: float = 0.02, layer_norm_eps: float = 1e-12, use_query_residual: bool = True, vocab_size: int = 262, max_position_embeddings: int = 2048, image_size: int = 56, train_size=[368, 496], num_frames: int = 16, audio_samples_per_frame: int = 1920, samples_per_patch: int = 16, output_shape=[1, 16, 224, 224], **kwargs) -> None: ...
