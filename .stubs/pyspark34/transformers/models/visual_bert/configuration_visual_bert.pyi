...
logger: Incomplete
VISUAL_BERT_PRETRAINED_CONFIG_ARCHIVE_MAP: Incomplete
...
class VisualBertConfig(PretrainedConfig):
    ...
    visual_embedding_dim: Incomplete
