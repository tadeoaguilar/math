...
logger: Incomplete
GPT_NEOX_PRETRAINED_CONFIG_ARCHIVE_MAP: Incomplete
...
class GPTNeoXConfig(PretrainedConfig):
    ...
    def __init__(self, vocab_size: int = 50432, hidden_size: int = 6144, num_hidden_layers: int = 44, num_attention_heads: int = 64, intermediate_size: int = 24576, hidden_act: str = 'gelu', rotary_pct: float = 0.25, rotary_emb_base: int = 10000, max_position_embeddings: int = 2048, initializer_range: float = 0.02, layer_norm_eps: float = 1e-05, use_cache: bool = True, bos_token_id: int = 0, eos_token_id: int = 2, tie_word_embeddings: bool = False, use_parallel_residual: bool = True, **kwargs) -> None: ...
