...
logger: Incomplete
LEVIT_PRETRAINED_CONFIG_ARCHIVE_MAP: Incomplete
...
class LevitConfig(PretrainedConfig):
    ...
    down_ops: Incomplete
    def __init__(self, image_size: int = 224, num_channels: int = 3, kernel_size: int = 3, stride: int = 2, padding: int = 1, patch_size: int = 16, hidden_sizes=[128, 256, 384], num_attention_heads=[4, 8, 12], depths=[4, 4, 4], key_dim=[16, 16, 16], drop_path_rate: int = 0, mlp_ratio=[2, 2, 2], attention_ratio=[2, 2, 2], initializer_range: float = 0.02, **kwargs) -> None: ...
