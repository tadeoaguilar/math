...
class PegasusTokenizerFast(PreTrainedTokenizerFast):
    ...
    def __init__(self, vocab_file: Incomplete | None = None, tokenizer_file: Incomplete | None = None, pad_token: str = '<pad>', eos_token: str = '</s>', unk_token: str = '<unk>', mask_token: str = '<mask_2>', mask_token_sent: str = '<mask_1>', additional_special_tokens: Incomplete | None = None, offset: int = 103, **kwargs) -> None: ...
