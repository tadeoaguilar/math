...
from ...modeling_flax_utils import ACT2FN as ACT2FN, FlaxPreTrainedModel as FlaxPreTrainedModel, add_start_docstrings_to_model_forward as add_start_docstrings_to_model_forward, append_call_sample_docstring as append_call_sample_docstring, append_replace_return_docstrings as append_replace_return_docstrings, overwrite_call_docstring as overwrite_call_docstring
...
from .configuration_pegasus import PegasusConfig as PegasusConfig
...
logger: Incomplete
PEGASUS_START_DOCSTRING: str
PEGASUS_INPUTS_DOCSTRING: str
PEGASUS_ENCODE_INPUTS_DOCSTRING: str
PEGASUS_DECODE_INPUTS_DOCSTRING: str
...
class FlaxPegasusPreTrainedModel(FlaxPreTrainedModel):
    ...
    def __init__(self, config: PegasusConfig, input_shape: Tuple[int] = (1, 1), seed: int = 0, dtype: jnp.dtype = ..., _do_init: bool = True, **kwargs) -> None: ...
...
FLAX_PEGASUS_CONDITIONAL_GENERATION_DOCSTRING: str
