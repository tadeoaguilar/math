...
class PegasusTokenizer(PreTrainedTokenizer):
    ...
    mask_token_sent: Incomplete
    vocab_file: Incomplete
    sp_model: Incomplete
    encoder: Incomplete
    decoder: Incomplete
    def __init__(self, vocab_file, pad_token: str = '<pad>', eos_token: str = '</s>', unk_token: str = '<unk>', mask_token: str = '<mask_2>', mask_token_sent: str = '<mask_1>', additional_special_tokens: Incomplete | None = None, offset: int = 103, sp_model_kwargs: Optional[Dict[str, Any]] = None, **kwargs) -> None: ...
    @property
