...
from .configuration_ernie import ErnieConfig as ErnieConfig
...
class ErnieEmbeddings(nn.Module):
    ...
    use_task_id: Incomplete
    task_type_embeddings: Incomplete
...
ERNIE_START_DOCSTRING: str
ERNIE_INPUTS_DOCSTRING: str
