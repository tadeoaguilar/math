...
logger: Incomplete
DATA2VEC_AUDIO_PRETRAINED_CONFIG_ARCHIVE_MAP: Incomplete
...
class Data2VecAudioConfig(PretrainedConfig):
    ...
    conv_pos_kernel_size: Incomplete
