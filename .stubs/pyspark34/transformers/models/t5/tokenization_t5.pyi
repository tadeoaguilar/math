...
class T5Tokenizer(PreTrainedTokenizer):
    ...
    sp_model: Incomplete
    def __init__(self, vocab_file, eos_token: str = '</s>', unk_token: str = '<unk>', pad_token: str = '<pad>', extra_ids: int = 100, additional_special_tokens: Incomplete | None = None, sp_model_kwargs: Optional[Dict[str, Any]] = None, **kwargs) -> None: ...
    @property
    def vocab_size(self): ...
    def get_vocab(self): ...
