...
from .configuration_x_clip import XCLIPConfig as XCLIPConfig, XCLIPTextConfig as XCLIPTextConfig, XCLIPVisionConfig as XCLIPVisionConfig
...
class XCLIPOutput(ModelOutput):
    ...
    def __init__(self, loss, logits_per_video, logits_per_text, text_embeds, video_embeds, text_model_output, vision_model_output, mit_output) -> None: ...
...
class XCLIPVisionEncoderLayer(nn.Module):
    ...
    embed_dim: Incomplete
    message_fc: Incomplete
    message_ln: Incomplete
    message_attn: Incomplete
...
X_CLIP_START_DOCSTRING: str
X_CLIP_TEXT_INPUTS_DOCSTRING: str
X_CLIP_VISION_INPUTS_DOCSTRING: str
X_CLIP_INPUTS_DOCSTRING: str
...
class XCLIPModel(XCLIPPreTrainedModel):
    ...
    prompts_visual_layernorm: Incomplete
    prompts_visual_projection: Incomplete
    mit: Incomplete
    prompts_generator: Incomplete
    def __init__(self, config: XCLIPConfig) -> None: ...
