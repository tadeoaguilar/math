...
from ...utils import ModelOutput as ModelOutput, is_flax_available as is_flax_available, is_tf_available as is_tf_available, is_torch_available as is_torch_available, logging as logging, requires_backends as requires_backends, to_py_obj as to_py_obj
...
class Wav2Vec2PhonemeCTCTokenizerOutput(ModelOutput):
    ...
    def __init__(self, text, char_offsets) -> None: ...
...
class Wav2Vec2PhonemeCTCTokenizer(PreTrainedTokenizer):
    ...
    do_phonemize: Incomplete
    phonemizer_lang: Incomplete
    phonemizer_backend: Incomplete
    encoder: Incomplete
    decoder: Incomplete
    def __init__(self, vocab_file, bos_token: str = '<s>', eos_token: str = '</s>', unk_token: str = '<unk>', pad_token: str = '<pad>', phone_delimiter_token: str = ' ', word_delimiter_token: Incomplete | None = None, do_phonemize: bool = True, phonemizer_lang: str = 'en-us', phonemizer_backend: str = 'espeak', **kwargs) -> None: ...
    @property
