...
from ...file_utils import TensorType as TensorType, is_torch_available as is_torch_available
...
logger: Incomplete
BLENDERBOT_PRETRAINED_CONFIG_ARCHIVE_MAP: Incomplete
...
class BlenderbotConfig(PretrainedConfig):
    ...
    def __init__(self, vocab_size: int = 8008, max_position_embeddings: int = 128, encoder_layers: int = 2, encoder_ffn_dim: int = 10240, encoder_attention_heads: int = 32, decoder_layers: int = 24, decoder_ffn_dim: int = 10240, decoder_attention_heads: int = 32, encoder_layerdrop: float = 0.0, decoder_layerdrop: float = 0.0, use_cache: bool = True, is_encoder_decoder: bool = True, activation_function: str = 'gelu', d_model: int = 2560, dropout: float = 0.1, attention_dropout: float = 0.0, activation_dropout: float = 0.0, init_std: float = 0.02, decoder_start_token_id: int = 1, scale_embedding: bool = False, pad_token_id: int = 0, bos_token_id: int = 1, eos_token_id: int = 2, encoder_no_repeat_ngram_size: int = 3, forced_eos_token_id: int = 2, **kwargs) -> None: ...
