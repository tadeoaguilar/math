...
BLENDERBOT_ENCODE_INPUTS_DOCSTRING: str
BLENDERBOT_DECODE_INPUTS_DOCSTRING: str
...
class FlaxBlenderbotPreTrainedModel(FlaxPreTrainedModel):
    ...
    def __init__(self, config: BlenderbotConfig, input_shape: Tuple[int] = (1, 1), seed: int = 0, dtype: jnp.dtype = ..., _do_init: bool = True, **kwargs) -> None: ...
...
FLAX_BLENDERBOT_CONDITIONAL_GENERATION_DOCSTRING: str
