...
logger: Incomplete
REFORMER_PRETRAINED_CONFIG_ARCHIVE_MAP: Incomplete
...
'''
    ...
    lsh_attn_chunk_length: Incomplete
    local_attn_chunk_length: Incomplete
    lsh_num_chunks_after: Incomplete
    lsh_num_chunks_before: Incomplete
    local_num_chunks_after: Incomplete
    local_num_chunks_before: Incomplete
    hidden_act: Incomplete
    feed_forward_size: Incomplete
    hidden_dropout_prob: Incomplete
    lsh_attention_probs_dropout_prob: Incomplete
    local_attention_probs_dropout_prob: Incomplete
    max_position_embeddings: Incomplete
    initializer_range: Incomplete
    layer_norm_eps: Incomplete
    axial_pos_embds: Incomplete
    axial_pos_shape: Incomplete
    axial_pos_embds_dim: Incomplete
    axial_norm_std: Incomplete
    chunk_size_lm_head: Incomplete
    attn_layers: Incomplete
    use_cache: Incomplete
    classifier_dropout: Incomplete
    def __init__(self, attention_head_size: int = 64, attn_layers=['local', 'lsh', 'local', 'lsh', 'local', 'lsh'], axial_norm_std: float = 1.0, axial_pos_embds: bool = True, axial_pos_shape=[64, 64], axial_pos_embds_dim=[64, 192], chunk_size_lm_head: int = 0, eos_token_id: int = 2, feed_forward_size: int = 512, hash_seed: Incomplete | None = None, hidden_act: str = 'relu', hidden_dropout_prob: float = 0.05, hidden_size: int = 256, initializer_range: float = 0.02, is_decoder: bool = False, layer_norm_eps: float = 1e-12, local_num_chunks_before: int = 1, local_num_chunks_after: int = 0, local_attention_probs_dropout_prob: float = 0.05, local_attn_chunk_length: int = 64, lsh_attn_chunk_length: int = 64, lsh_attention_probs_dropout_prob: float = 0.0, lsh_num_chunks_before: int = 1, lsh_num_chunks_after: int = 0, max_position_embeddings: int = 4096, num_attention_heads: int = 12, num_buckets: Incomplete | None = None, num_hashes: int = 1, pad_token_id: int = 0, vocab_size: int = 320, tie_word_embeddings: bool = False, use_cache: bool = True, classifier_dropout: Incomplete | None = None, **kwargs) -> None: ...
