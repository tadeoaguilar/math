...
logger: Incomplete
MOBILENET_V2_PRETRAINED_CONFIG_ARCHIVE_MAP: Incomplete
...
class MobileNetV2Config(PretrainedConfig):
    ...
    depth_divisible_by: Incomplete
    min_depth: Incomplete
    expand_ratio: Incomplete
    output_stride: Incomplete
    first_layer_is_expansion: Incomplete
    finegrained_output: Incomplete
    ...
    def __init__(self, num_channels: int = 3, image_size: int = 224, depth_multiplier: float = 1.0, depth_divisible_by: int = 8, min_depth: int = 8, expand_ratio: int = 6, output_stride: int = 32, first_layer_is_expansion: bool = True, finegrained_output: bool = True, hidden_act: str = 'relu6', tf_padding: bool = True, classifier_dropout_prob: float = 0.8, initializer_range: float = 0.02, layer_norm_eps: float = 0.001, semantic_loss_ignore_index: int = 255, **kwargs) -> None: ...
