...
logger: Incomplete
BLOOM_PRETRAINED_CONFIG_ARCHIVE_MAP: Incomplete
...
class BloomConfig(PretrainedConfig):
    ...
    def __init__(self, vocab_size: int = 250880, hidden_size: int = 64, n_layer: int = 2, n_head: int = 8, layer_norm_epsilon: float = 1e-05, initializer_range: float = 0.02, use_cache: bool = True, bos_token_id: int = 1, eos_token_id: int = 2, apply_residual_connection_post_layernorm: bool = False, hidden_dropout: float = 0.0, attention_dropout: float = 0.0, pretraining_tp: int = 1, slow_but_exact: bool = False, **kwargs) -> None: ...
