...
class BloomTokenizerFast(PreTrainedTokenizerFast):
    ...
    def __init__(self, vocab_file: Incomplete | None = None, merges_file: Incomplete | None = None, tokenizer_file: Incomplete | None = None, unk_token: str = '<unk>', bos_token: str = '<s>', eos_token: str = '</s>', pad_token: str = '<pad>', add_prefix_space: bool = False, **kwargs) -> None: ...
