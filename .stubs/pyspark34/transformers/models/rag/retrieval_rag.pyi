...
from ...utils import cached_file as cached_file, is_datasets_available as is_datasets_available, is_faiss_available as is_faiss_available, logging as logging, requires_backends as requires_backends
from .configuration_rag import RagConfig as RagConfig
from .tokenization_rag import RagTokenizer as RagTokenizer
...
class LegacyIndex(Index):
    ...
    index_id_to_db_id: Incomplete
    index_path: Incomplete
    passages: Incomplete
    vector_size: Incomplete
    index: Incomplete
...
class HFIndexBase(Index):
    vector_size: Incomplete
    dataset: Incomplete
    def __init__(self, vector_size, dataset, index_initialized: bool = False) -> None: ...
    def init_index(self) -> None: ...
    def is_initialized(self): ...
    def get_doc_dicts(self, doc_ids: np.ndarray) -> List[dict]: ...
    def get_top_docs(self, question_hidden_states: np.ndarray, n_docs: int = 5) -> Tuple[np.ndarray, np.ndarray]: ...
...
class CanonicalHFIndex(HFIndexBase):
    ...
    def __init__(self, vector_size: int, dataset_name: str = 'wiki_dpr', dataset_split: str = 'train', index_name: Optional[str] = None, index_path: Optional[str] = None, use_dummy_dataset: bool = False) -> None: ...
    dataset: Incomplete
    def init_index(self) -> None: ...
...
class CustomHFIndex(HFIndexBase):
    ...
    """
    index_path: Incomplete
    def __init__(self, vector_size: int, dataset, index_path: Incomplete | None = None) -> None: ...
    @classmethod
...
class RagRetriever:
    ...
    ```'''
    index: Incomplete
    generator_tokenizer: Incomplete
    question_encoder_tokenizer: Incomplete
    n_docs: Incomplete
    batch_size: Incomplete
    config: Incomplete
    ctx_encoder_tokenizer: Incomplete
    return_tokenized_docs: bool
    def __init__(self, config, question_encoder_tokenizer, generator_tokenizer, index: Incomplete | None = None, init_retrieval: bool = True) -> None: ...
    @classmethod
    def from_pretrained(cls, retriever_name_or_path, indexed_dataset: Incomplete | None = None, **kwargs): ...
    def save_pretrained(self, save_directory) -> None: ...
    def init_retrieval(self) -> None:
        """
        Retriever initialization function. It loads the index into memory.
        """
    def postprocess_docs(self, docs, input_strings, prefix, n_docs, return_tensors: Incomplete | None = None):
        """
    ...
    def __call__(self, question_input_ids: List[List[int]], question_hidden_states: np.ndarray, prefix: Incomplete | None = None, n_docs: Incomplete | None = None, return_tensors: Incomplete | None = None) -> BatchEncoding:
        '''
        Retrieves documents for specified `question_hidden_states`.
