...
class MLukeTokenizer(PreTrainedTokenizer):
    ...
    def __init__(self, vocab_file, entity_vocab_file, bos_token: str = '<s>', eos_token: str = '</s>', sep_token: str = '</s>', cls_token: str = '<s>', unk_token: str = '<unk>', pad_token: str = '<pad>', mask_token: str = '<mask>', task: Incomplete | None = None, max_entity_length: int = 32, max_mention_length: int = 30, entity_token_1: str = '<ent>', entity_token_2: str = '<ent2>', entity_unk_token: str = '[UNK]', entity_pad_token: str = '[PAD]', entity_mask_token: str = '[MASK]', entity_mask2_token: str = '[MASK2]', sp_model_kwargs: Optional[Dict[str, Any]] = None, **kwargs) -> None: ...
