...
def get_oneformer_resize_output_image_size(image: np.ndarray, size: Union[int, Tuple[int, int], List[int], Tuple[int]], max_size: Optional[int] = None, default_to_square: bool = True) -> tuple:
    """
...
class OneFormerImageProcessor(BaseImageProcessor):
    ...
    class_info_file: Incomplete
    repo_path: Incomplete
    metadata: Incomplete
    num_text: Incomplete
    def __init__(self, do_resize: bool = True, size: Dict[str, int] = None, resample: PILImageResampling = ..., do_rescale: bool = True, rescale_factor: float = ..., do_normalize: bool = True, image_mean: Union[float, List[float]] = None, image_std: Union[float, List[float]] = None, ignore_index: Optional[int] = None, do_reduce_labels: bool = False, repo_path: str = 'shi-labs/oneformer_demo', class_info_file: str = None, num_text: Optional[int] = None, **kwargs) -> None: ...
    def resize(self, image: np.ndarray, size: Dict[str, int], resample: PILImageResampling = ..., data_format: Incomplete | None = None, **kwargs) -> np.ndarray:
        """
