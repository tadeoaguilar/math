...
logger: Incomplete
ONEFORMER_PRETRAINED_CONFIG_ARCHIVE_MAP: Incomplete
...
class OneFormerConfig(PretrainedConfig):
    ...
    strides: Incomplete
    task_seq_len: Incomplete
    max_seq_len: Incomplete
    text_encoder_width: Incomplete
    text_encoder_context_length: Incomplete
    text_encoder_num_layers: Incomplete
    text_encoder_vocab_size: Incomplete
    text_encoder_proj_layers: Incomplete
    text_encoder_n_ctx: Incomplete
    conv_dim: Incomplete
    mask_dim: Incomplete
