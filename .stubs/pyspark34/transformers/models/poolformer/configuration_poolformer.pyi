...
logger: Incomplete
POOLFORMER_PRETRAINED_CONFIG_ARCHIVE_MAP: Incomplete
...
class PoolFormerConfig(PretrainedConfig):
    ...
    def __init__(self, num_channels: int = 3, patch_size: int = 16, stride: int = 16, pool_size: int = 3, mlp_ratio: float = 4.0, depths=[2, 2, 6, 2], hidden_sizes=[64, 128, 320, 512], patch_sizes=[7, 3, 3, 3], strides=[4, 2, 2, 2], padding=[2, 1, 1, 1], num_encoder_blocks: int = 4, drop_path_rate: float = 0.0, hidden_act: str = 'gelu', use_layer_scale: bool = True, layer_scale_init_value: float = 1e-05, initializer_range: float = 0.02, **kwargs) -> None: ...
