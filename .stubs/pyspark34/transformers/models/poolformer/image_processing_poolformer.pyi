...
from transformers import is_vision_available as is_vision_available
...
class PoolFormerImageProcessor(BaseImageProcessor):
    ...
    def __init__(self, do_resize: bool = True, size: Dict[str, int] = None, crop_pct: int = 0.9, resample: PILImageResampling = ..., do_center_crop: bool = True, crop_size: Dict[str, int] = None, rescale_factor: Union[int, float] = ..., do_rescale: bool = True, do_normalize: bool = True, image_mean: Optional[Union[float, List[float]]] = None, image_std: Optional[Union[float, List[float]]] = None, **kwargs) -> None: ...
    def resize(self, image: np.ndarray, size: Dict[str, int], crop_pct: Optional[float] = None, resample: PILImageResampling = ..., data_format: Optional[Union[str, ChannelDimension]] = None, **kwargs) -> np.ndarray:
        '''
        Resize an image.
