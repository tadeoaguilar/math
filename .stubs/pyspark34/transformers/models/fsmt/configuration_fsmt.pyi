...
logger: Incomplete
FSMT_PRETRAINED_CONFIG_ARCHIVE_MAP: Incomplete
...
class DecoderConfig(PretrainedConfig):
    ...
    def __init__(self, vocab_size: int = 0, bos_token_id: int = 0) -> None: ...
...
class FSMTConfig(PretrainedConfig):
    ...
    langs: Incomplete
    src_vocab_size: Incomplete
    tgt_vocab_size: Incomplete
    d_model: Incomplete
    ...
    def __init__(self, langs=['en', 'de'], src_vocab_size: int = 42024, tgt_vocab_size: int = 42024, activation_function: str = 'relu', d_model: int = 1024, max_length: int = 200, max_position_embeddings: int = 1024, encoder_ffn_dim: int = 4096, encoder_layers: int = 12, encoder_attention_heads: int = 16, encoder_layerdrop: float = 0.0, decoder_ffn_dim: int = 4096, decoder_layers: int = 12, decoder_attention_heads: int = 16, decoder_layerdrop: float = 0.0, attention_dropout: float = 0.0, dropout: float = 0.1, activation_dropout: float = 0.0, init_std: float = 0.02, decoder_start_token_id: int = 2, is_encoder_decoder: bool = True, scale_embedding: bool = True, tie_word_embeddings: bool = False, num_beams: int = 5, length_penalty: float = 1.0, early_stopping: bool = False, use_cache: bool = True, pad_token_id: int = 1, bos_token_id: int = 0, eos_token_id: int = 2, forced_eos_token_id: int = 2, **common_kwargs) -> None: ...
    def to_dict(self):
        """
