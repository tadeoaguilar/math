...
from .configuration_trocr import TrOCRConfig as TrOCRConfig
...
class TrOCRAttention(nn.Module):
    ...
    q_proj: Incomplete
    out_proj: Incomplete
    def __init__(self, config, embed_dim: int, num_heads: int, kdim: int = None, vdim: int = None, dropout: float = 0.0, is_decoder: bool = False, bias: bool = True, is_cross_attention: bool = False) -> None: ...
