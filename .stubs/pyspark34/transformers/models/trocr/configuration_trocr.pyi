...
logger: Incomplete
TROCR_PRETRAINED_CONFIG_ARCHIVE_MAP: Incomplete
...
class TrOCRConfig(PretrainedConfig):
    ...
    use_learned_position_embeddings: Incomplete
    layernorm_embedding: Incomplete
    def __init__(self, vocab_size: int = 50265, d_model: int = 1024, decoder_layers: int = 12, decoder_attention_heads: int = 16, decoder_ffn_dim: int = 4096, activation_function: str = 'gelu', max_position_embeddings: int = 512, dropout: float = 0.1, attention_dropout: float = 0.0, activation_dropout: float = 0.0, decoder_start_token_id: int = 2, classifier_dropout: float = 0.0, init_std: float = 0.02, decoder_layerdrop: float = 0.0, use_cache: bool = True, scale_embedding: bool = False, use_learned_position_embeddings: bool = True, layernorm_embedding: bool = True, pad_token_id: int = 1, bos_token_id: int = 0, eos_token_id: int = 2, **kwargs) -> None: ...
