...
ENCODER_DECODER_ENCODE_INPUTS_DOCSTRING: str
ENCODER_DECODER_DECODE_INPUTS_DOCSTRING: str
...
class FlaxEncoderDecoderModel(FlaxPreTrainedModel):
    ...
    def __init__(self, config: EncoderDecoderConfig, input_shape: Optional[Tuple] = None, seed: int = 0, dtype: jnp.dtype = ..., _do_init: bool = True, **kwargs) -> None: ...
