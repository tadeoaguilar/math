...
logger: Incomplete
FLAUBERT_PRETRAINED_CONFIG_ARCHIVE_MAP: Incomplete
...
class FlaubertConfig(PretrainedConfig):
    ...
    gelu_activation: Incomplete
    sinusoidal_embeddings: Incomplete
    causal: Incomplete
    asm: Incomplete
    n_langs: Incomplete
    ...
    lang_id: Incomplete
    n_words: Incomplete
    def __init__(self, pre_norm: bool = False, layerdrop: float = 0.0, vocab_size: int = 30145, emb_dim: int = 2048, n_layers: int = 12, n_heads: int = 16, dropout: float = 0.1, attention_dropout: float = 0.1, gelu_activation: bool = True, sinusoidal_embeddings: bool = False, causal: bool = False, asm: bool = False, n_langs: int = 1, use_lang_emb: bool = True, max_position_embeddings: int = 512, embed_init_std=..., layer_norm_eps: float = 1e-12, init_std: float = 0.02, bos_index: int = 0, eos_index: int = 1, pad_index: int = 2, unk_index: int = 3, mask_index: int = 5, is_encoder: bool = True, summary_type: str = 'first', summary_use_proj: bool = True, summary_activation: Incomplete | None = None, summary_proj_to_labels: bool = True, summary_first_dropout: float = 0.1, start_n_top: int = 5, end_n_top: int = 5, mask_token_id: int = 0, lang_id: int = 0, pad_token_id: int = 2, bos_token_id: int = 0, **kwargs) -> None:
