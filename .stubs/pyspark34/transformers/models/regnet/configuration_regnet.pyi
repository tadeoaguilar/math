...
logger: Incomplete
REGNET_PRETRAINED_CONFIG_ARCHIVE_MAP: Incomplete
...
class RegNetConfig(PretrainedConfig):
    ...
    depths: Incomplete
    groups_width: Incomplete
    layer_type: Incomplete
    hidden_act: Incomplete
    downsample_in_first_stage: bool
    def __init__(self, num_channels: int = 3, embedding_size: int = 32, hidden_sizes=[128, 192, 512, 1088], depths=[2, 6, 12, 2], groups_width: int = 64, layer_type: str = 'y', hidden_act: str = 'relu', **kwargs) -> None: ...
