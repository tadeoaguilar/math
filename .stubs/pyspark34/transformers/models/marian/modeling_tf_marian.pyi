...
class TFMarianEncoder(tf.keras.layers.Layer):
    ...
    layers: Incomplete
    def __init__(self, config: MarianConfig, embed_tokens: Optional[tf.keras.layers.Embedding] = None, **kwargs) -> None: ...
...
class TFMarianMTModel(TFMarianPreTrainedModel, TFCausalLanguageModelingLoss):
    ...
    def call(self, input_ids: Incomplete | None = None, attention_mask: Incomplete | None = None, decoder_input_ids: Incomplete | None = None, decoder_attention_mask: Incomplete | None = None, decoder_position_ids: Incomplete | None = None, head_mask: Incomplete | None = None, decoder_head_mask: Incomplete | None = None, cross_attn_head_mask: Incomplete | None = None, encoder_outputs: Optional[TFBaseModelOutput] = None, past_key_values: Incomplete | None = None, inputs_embeds: Incomplete | None = None, decoder_inputs_embeds: Incomplete | None = None, use_cache: Incomplete | None = None, output_attentions: Incomplete | None = None, output_hidden_states: Incomplete | None = None, return_dict: Incomplete | None = None, labels: Incomplete | None = None, training: bool = False):
        """
