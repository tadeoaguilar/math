...
class PhobertTokenizer(PreTrainedTokenizer):
    ...
    cache: Incomplete
    def __init__(self, vocab_file, merges_file, bos_token: str = '<s>', eos_token: str = '</s>', sep_token: str = '</s>', cls_token: str = '<s>', unk_token: str = '<unk>', pad_token: str = '<pad>', mask_token: str = '<mask>', **kwargs) -> None: ...
