...
from ...modeling_outputs import BaseModelOutputWithPastAndCrossAttentions as BaseModelOutputWithPastAndCrossAttentions, BaseModelOutputWithPoolingAndCrossAttentions as BaseModelOutputWithPoolingAndCrossAttentions, MaskedLMOutput as MaskedLMOutput, MultipleChoiceModelOutput as MultipleChoiceModelOutput, NextSentencePredictorOutput as NextSentencePredictorOutput, QuestionAnsweringModelOutput as QuestionAnsweringModelOutput, SequenceClassifierOutput as SequenceClassifierOutput, TokenClassifierOutput as TokenClassifierOutput
...
from .configuration_nezha import NezhaConfig as NezhaConfig
...
class NezhaRelativePositionsEncoding(nn.Module):
    ...
    def __init__(self, length, depth, max_relative_position: int = 127) -> None: ...
...
class NezhaSelfAttention(nn.Module):
    ...
    value: Incomplete
    dropout: Incomplete
    relative_positions_encoding: Incomplete
...
NEZHA_START_DOCSTRING: str
NEZHA_INPUTS_DOCSTRING: str
