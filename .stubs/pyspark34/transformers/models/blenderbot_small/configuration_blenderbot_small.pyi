...
logger: Incomplete
BLENDERBOT_SMALL_PRETRAINED_CONFIG_ARCHIVE_MAP: Incomplete
...
class BlenderbotSmallConfig(PretrainedConfig):
    ...
    def __init__(self, vocab_size: int = 50265, max_position_embeddings: int = 512, encoder_layers: int = 8, encoder_ffn_dim: int = 2048, encoder_attention_heads: int = 16, decoder_layers: int = 8, decoder_ffn_dim: int = 2048, decoder_attention_heads: int = 16, encoder_layerdrop: float = 0.0, decoder_layerdrop: float = 0.0, use_cache: bool = True, is_encoder_decoder: bool = True, activation_function: str = 'gelu', d_model: int = 512, dropout: float = 0.1, attention_dropout: float = 0.0, activation_dropout: float = 0.0, init_std: float = 0.02, decoder_start_token_id: int = 1, scale_embedding: bool = False, pad_token_id: int = 0, bos_token_id: int = 1, eos_token_id: int = 2, forced_eos_token_id: int = 2, **kwargs) -> None: ...
