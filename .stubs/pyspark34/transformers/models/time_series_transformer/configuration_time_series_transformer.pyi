...
logger: Incomplete
TIME_SERIES_TRANSFORMER_PRETRAINED_CONFIG_ARCHIVE_MAP: Incomplete
...
class TimeSeriesTransformerConfig(PretrainedConfig):
    ...
    prediction_length: Incomplete
    context_length: Incomplete
    distribution_output: Incomplete
    loss: Incomplete
    input_size: Incomplete
    num_time_features: Incomplete
    lags_sequence: Incomplete
    scaling: Incomplete
    num_dynamic_real_features: Incomplete
    num_static_real_features: Incomplete
    num_static_categorical_features: Incomplete
    cardinality: Incomplete
    embedding_dimension: Incomplete
    num_parallel_samples: Incomplete
    d_model: Incomplete
