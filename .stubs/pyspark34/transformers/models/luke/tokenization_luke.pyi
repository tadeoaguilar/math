...
from ...tokenization_utils_base import AddedToken as AddedToken, BatchEncoding as BatchEncoding, ENCODE_KWARGS_DOCSTRING as ENCODE_KWARGS_DOCSTRING, EncodedInput as EncodedInput, PaddingStrategy as PaddingStrategy, TensorType as TensorType, TextInput as TextInput, TextInputPair as TextInputPair, TruncationStrategy as TruncationStrategy, to_py_obj as to_py_obj
from ...utils import add_end_docstrings as add_end_docstrings, is_tf_tensor as is_tf_tensor, is_torch_tensor as is_torch_tensor, logging as logging
...
class LukeTokenizer(PreTrainedTokenizer):
    ...
    pat: Incomplete
    entity_vocab: Incomplete
    entity_unk_token_id: Incomplete
    entity_pad_token_id: Incomplete
    entity_mask_token_id: Incomplete
    entity_mask2_token_id: Incomplete
    task: Incomplete
    max_entity_length: Incomplete
    max_mention_length: Incomplete
    def __init__(self, vocab_file, merges_file, entity_vocab_file, task: Incomplete | None = None, max_entity_length: int = 32, max_mention_length: int = 30, entity_token_1: str = '<ent>', entity_token_2: str = '<ent2>', entity_unk_token: str = '[UNK]', entity_pad_token: str = '[PAD]', entity_mask_token: str = '[MASK]', entity_mask2_token: str = '[MASK2]', errors: str = 'replace', bos_token: str = '<s>', eos_token: str = '</s>', sep_token: str = '</s>', cls_token: str = '<s>', unk_token: str = '<unk>', pad_token: str = '<pad>', mask_token: str = '<mask>', add_prefix_space: bool = False, **kwargs) -> None: ...
    @property
    def vocab_size(self): ...
    def get_vocab(self): ...
    def bpe(self, token): ...
