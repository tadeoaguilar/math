...
def load_tf_weights_in_big_bird(model, tf_checkpoint_path, is_trivia_qa: bool = False):
...
class BigBirdBlockSparseAttention(nn.Module):
    ...
    key: Incomplete
    value: Incomplete
    def __init__(self, config, seed: Incomplete | None = None) -> None: ...
    def transpose_for_scores(self, x): ...
    def forward(self, hidden_states, band_mask: Incomplete | None = None, from_mask: Incomplete | None = None, to_mask: Incomplete | None = None, from_blocked_mask: Incomplete | None = None, to_blocked_mask: Incomplete | None = None, output_attentions: Incomplete | None = None): ...
    @staticmethod
    def torch_bmm_nd(inp_1, inp_2, ndim: Incomplete | None = None):
        """Fast nd matrix multiplication"""
    @staticmethod
    def torch_bmm_nd_transpose(inp_1, inp_2, ndim: Incomplete | None = None):
...
class BigBirdAttention(nn.Module):
    ...
    def forward(self, hidden_states, attention_mask: Incomplete | None = None, head_mask: Incomplete | None = None, encoder_hidden_states: Incomplete | None = None, encoder_attention_mask: Incomplete | None = None, past_key_value: Incomplete | None = None, output_attentions: bool = False, band_mask: Incomplete | None = None, from_mask: Incomplete | None = None, to_mask: Incomplete | None = None, from_blocked_mask: Incomplete | None = None, to_blocked_mask: Incomplete | None = None): ...
...
class BigBirdLayer(nn.Module):
    ...
    def __init__(self, config, seed: Incomplete | None = None) -> None: ...
    def set_attention_type(self, value: str): ...
    def forward(self, hidden_states, attention_mask: Incomplete | None = None, head_mask: Incomplete | None = None, encoder_hidden_states: Incomplete | None = None, encoder_attention_mask: Incomplete | None = None, band_mask: Incomplete | None = None, from_mask: Incomplete | None = None, to_mask: Incomplete | None = None, blocked_encoder_mask: Incomplete | None = None, past_key_value: Incomplete | None = None, output_attentions: bool = False): ...
...
class BigBirdEncoder(nn.Module):
    ...
    def __init__(self, config) -> None: ...
    def set_attention_type(self, value: str): ...
    def forward(self, hidden_states, attention_mask: Incomplete | None = None, head_mask: Incomplete | None = None, encoder_hidden_states: Incomplete | None = None, encoder_attention_mask: Incomplete | None = None, past_key_values: Incomplete | None = None, use_cache: Incomplete | None = None, output_attentions: bool = False, output_hidden_states: bool = False, band_mask: Incomplete | None = None, from_mask: Incomplete | None = None, to_mask: Incomplete | None = None, blocked_encoder_mask: Incomplete | None = None, return_dict: bool = True) -> Union[BaseModelOutputWithPastAndCrossAttentions, Tuple]: ...
...
class BigBirdForQuestionAnsweringModelOutput(ModelOutput):
    ...
    hidden_states: Optional[Tuple[torch.FloatTensor]] = ...
    attentions: Optional[Tuple[torch.FloatTensor]] = ...
    def __init__(self, loss, start_logits, end_logits, pooler_output, hidden_states, attentions) -> None: ...
...
class BigBirdForQuestionAnswering(BigBirdPreTrainedModel):
    ...
    def forward(self, input_ids: torch.LongTensor = None, attention_mask: Optional[torch.FloatTensor] = None, question_lengths: Incomplete | None = None, token_type_ids: Optional[torch.LongTensor] = None, position_ids: Optional[torch.LongTensor] = None, head_mask: Optional[torch.FloatTensor] = None, inputs_embeds: Optional[torch.FloatTensor] = None, start_positions: Optional[torch.LongTensor] = None, end_positions: Optional[torch.LongTensor] = None, output_attentions: Optional[bool] = None, output_hidden_states: Optional[bool] = None, return_dict: Optional[bool] = None) -> Union[BigBirdForQuestionAnsweringModelOutput, Tuple[torch.FloatTensor]]:
        '''
