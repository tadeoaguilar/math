...
logger: Incomplete
REALM_PRETRAINED_CONFIG_ARCHIVE_MAP: Incomplete
...
class RealmConfig(PretrainedConfig):
    ...
    retriever_proj_size: Incomplete
    ...
    span_hidden_size: Incomplete
    max_span_width: Incomplete
    reader_layer_norm_eps: Incomplete
    reader_beam_size: Incomplete
    reader_seq_len: Incomplete
    num_block_records: Incomplete
    searcher_beam_size: Incomplete
    def __init__(self, vocab_size: int = 30522, hidden_size: int = 768, retriever_proj_size: int = 128, num_hidden_layers: int = 12, num_attention_heads: int = 12, num_candidates: int = 8, intermediate_size: int = 3072, hidden_act: str = 'gelu_new', hidden_dropout_prob: float = 0.1, attention_probs_dropout_prob: float = 0.1, max_position_embeddings: int = 512, type_vocab_size: int = 2, initializer_range: float = 0.02, layer_norm_eps: float = 1e-12, span_hidden_size: int = 256, max_span_width: int = 10, reader_layer_norm_eps: float = 0.001, reader_beam_size: int = 5, reader_seq_len: int = 320, num_block_records: int = 13353718, searcher_beam_size: int = 5000, pad_token_id: int = 1, bos_token_id: int = 0, eos_token_id: int = 2, **kwargs) -> None: ...
