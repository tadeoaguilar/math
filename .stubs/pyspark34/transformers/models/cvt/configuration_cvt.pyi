...
logger: Incomplete
CVT_PRETRAINED_CONFIG_ARCHIVE_MAP: Incomplete
...
class CvtConfig(PretrainedConfig):
    ...
    patch_padding: Incomplete
    embed_dim: Incomplete
    num_heads: Incomplete
    depth: Incomplete
    mlp_ratio: Incomplete
    attention_drop_rate: Incomplete
    drop_rate: Incomplete
    drop_path_rate: Incomplete
    qkv_bias: Incomplete
    cls_token: Incomplete
    qkv_projection_method: Incomplete
    kernel_qkv: Incomplete
    padding_kv: Incomplete
    stride_kv: Incomplete
    padding_q: Incomplete
    stride_q: Incomplete
    initializer_range: Incomplete
    layer_norm_eps: Incomplete
    def __init__(self, num_channels: int = 3, patch_sizes=[7, 3, 3], patch_stride=[4, 2, 2], patch_padding=[2, 1, 1], embed_dim=[64, 192, 384], num_heads=[1, 3, 6], depth=[1, 2, 10], mlp_ratio=[4.0, 4.0, 4.0], attention_drop_rate=[0.0, 0.0, 0.0], drop_rate=[0.0, 0.0, 0.0], drop_path_rate=[0.0, 0.0, 0.1], qkv_bias=[True, True, True], cls_token=[False, False, True], qkv_projection_method=['dw_bn', 'dw_bn', 'dw_bn'], kernel_qkv=[3, 3, 3], padding_kv=[1, 1, 1], stride_kv=[2, 2, 2], padding_q=[1, 1, 1], stride_q=[1, 1, 1], initializer_range: float = 0.02, layer_norm_eps: float = 1e-12, **kwargs) -> None: ...
