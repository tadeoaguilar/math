...
from ...tokenization_utils_base import BatchEncoding as BatchEncoding, EncodedInput as EncodedInput
...
class LEDTokenizer(PreTrainedTokenizer):
    ...
    pat: Incomplete
    def __init__(self, vocab_file, merges_file, errors: str = 'replace', bos_token: str = '<s>', eos_token: str = '</s>', sep_token: str = '</s>', cls_token: str = '<s>', unk_token: str = '<unk>', pad_token: str = '<pad>', mask_token: str = '<mask>', add_prefix_space: bool = False, **kwargs) -> None: ...
    @property
    def vocab_size(self): ...
    def get_vocab(self): ...
    def bpe(self, token): ...
