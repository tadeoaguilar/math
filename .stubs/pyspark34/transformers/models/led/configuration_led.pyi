...
logger: Incomplete
LED_PRETRAINED_CONFIG_ARCHIVE_MAP: Incomplete
...
class LEDConfig(PretrainedConfig):
    ...
    max_encoder_position_embeddings: Incomplete
    max_decoder_position_embeddings: Incomplete
    d_model: Incomplete
    ...
    def __init__(self, vocab_size: int = 50265, max_encoder_position_embeddings: int = 16384, max_decoder_position_embeddings: int = 1024, encoder_layers: int = 12, encoder_ffn_dim: int = 4096, encoder_attention_heads: int = 16, decoder_layers: int = 12, decoder_ffn_dim: int = 4096, decoder_attention_heads: int = 16, encoder_layerdrop: float = 0.0, decoder_layerdrop: float = 0.0, use_cache: bool = True, is_encoder_decoder: bool = True, activation_function: str = 'gelu', d_model: int = 1024, dropout: float = 0.1, attention_dropout: float = 0.0, activation_dropout: float = 0.0, init_std: float = 0.02, decoder_start_token_id: int = 2, classifier_dropout: float = 0.0, pad_token_id: int = 1, bos_token_id: int = 0, eos_token_id: int = 2, attention_window: Union[List[int], int] = 512, **kwargs) -> None: ...
