...
BART_ENCODE_INPUTS_DOCSTRING: str
BART_DECODE_INPUTS_DOCSTRING: str
...
class FlaxBartPreTrainedModel(FlaxPreTrainedModel):
    ...
    def __init__(self, config: BartConfig, input_shape: Tuple[int] = (1, 1), seed: int = 0, dtype: jnp.dtype = ..., _do_init: bool = True, **kwargs) -> None: ...
...
FLAX_BART_CONDITIONAL_GENERATION_DOCSTRING: str
