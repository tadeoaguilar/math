import pandas as pd
from ...file_utils import ExplicitEnum as ExplicitEnum, PaddingStrategy as PaddingStrategy, TensorType as TensorType, add_end_docstrings as add_end_docstrings, is_pandas_available as is_pandas_available
from ...tokenization_utils import AddedToken as AddedToken, PreTrainedTokenizer as PreTrainedTokenizer
from ...tokenization_utils_base import BatchEncoding as BatchEncoding, ENCODE_KWARGS_DOCSTRING as ENCODE_KWARGS_DOCSTRING, TextInput as TextInput, TruncationStrategy as TruncationStrategy
...
TAPEX_ENCODE_PLUS_ADDITIONAL_KWARGS_DOCSTRING: str
...
class TapexTokenizer(PreTrainedTokenizer):
    ...
    pat: Incomplete
    max_cell_length: Incomplete
    table_linearize: Incomplete
    def __init__(self, vocab_file, merges_file, do_lower_case: bool = True, errors: str = 'replace', bos_token: str = '<s>', eos_token: str = '</s>', sep_token: str = '</s>', cls_token: str = '<s>', unk_token: str = '<unk>', pad_token: str = '<pad>', mask_token: str = '<mask>', add_prefix_space: bool = False, max_cell_length: int = 15, **kwargs) -> None: ...
    ...
    def target_encode_plus(self, answer: str, add_special_tokens: bool = True, padding: Union[bool, str, PaddingStrategy] = False, truncation: Union[bool, str] = None, max_length: Optional[int] = None, pad_to_multiple_of: Optional[int] = None, return_tensors: Optional[Union[str, TensorType]] = None, return_token_type_ids: Optional[bool] = None, return_attention_mask: Optional[bool] = None, return_special_tokens_mask: bool = False, return_offsets_mapping: bool = False, return_length: bool = False, verbose: bool = True, **kwargs) -> BatchEncoding:
        ...
        Args:
            answer `str`:
                Corresponding answer supervision to the queries for training the model.
        """
    def prepare_table_query(self, table, query, answer: Incomplete | None = None, truncation_strategy=..., max_length: Incomplete | None = None):
        """
    ...
    def truncate_table_rows(self, table_content: Dict, question: str, answer: Optional[Union[str, List[str]]] = None, max_length: Incomplete | None = None):
        '''
        Args:
        table_content:
        ...
        '''
    def estimate_delete_ratio(self, table_content: Dict, question: str, max_length: Incomplete | None = None): ...
