...
from .configuration_pegasus_x import PegasusXConfig as PegasusXConfig
...
class DimensionInfo:
    ...
    global_len: int
    padded_seq_len: int
    def __init__(self, batch_size, seq_len, block_size, num_heads, hidden_dim, dim_per_head, num_blocks, global_len, padded_seq_len) -> None: ...
...
class PegasusXSinusoidalPositionalEmbedding(nn.Module):
    ...
    def __init__(self, embed_dim, max_scale: int = 10000.0) -> None: ...
...
class PegasusXGlobalLocalAttention(nn.Module):
    ...
    q_proj: Incomplete
    out_proj: Incomplete
    def __init__(self, embed_dim: int, num_heads: int, block_size: int, dropout: float = 0.0, is_decoder: bool = False) -> None: ...
...
class PegasusXEncoderLayer(nn.Module):
    ...
    global_self_attn_layer_norm: Incomplete
    dropout: Incomplete
    ...
    stagger_blocks_this_layer: Incomplete
    block_size: Incomplete
...
PEGASUS_X_START_DOCSTRING: str
PEGASUS_X_GENERATION_EXAMPLE: str
PEGASUS_X_INPUTS_DOCSTRING: str
...
class PegasusXEncoder(PegasusXPreTrainedModel):
    ...
    embed_global: Incomplete
    embed_positions: Incomplete
    layers: Incomplete
    layer_norm: Incomplete
    gradient_checkpointing: bool
    def __init__(self, config: PegasusXConfig, embed_tokens: Optional[nn.Embedding] = None) -> None: ...
    ...
    def get_position_embeddings(self) -> nn.Embedding:
        ...
        """
    def forward(self, input_ids: Incomplete | None = None, attention_mask: Incomplete | None = None, inputs_embeds: Incomplete | None = None, output_attentions: Incomplete | None = None, output_hidden_states: Incomplete | None = None, return_dict: Incomplete | None = None):
        """
        Args:
...
class PegasusXDecoder(PegasusXPreTrainedModel):
    ...
    def get_position_embeddings(self) -> nn.Embedding:
        ...
        Returns the position embeddings matrix
        """
    def forward(self, input_ids: Incomplete | None = None, attention_mask: Incomplete | None = None, encoder_hidden_states: Incomplete | None = None, encoder_attention_mask: Incomplete | None = None, past_key_values: Incomplete | None = None, inputs_embeds: Incomplete | None = None, use_cache: Incomplete | None = None, output_attentions: Incomplete | None = None, output_hidden_states: Incomplete | None = None, return_dict: Incomplete | None = None):
        """
        Args:
            input_ids (`torch.LongTensor` of shape `(batch_size, sequence_length)`):
                Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you
...
class PegasusXForConditionalGeneration(PegasusXPreTrainedModel):
    ...
    def forward(self, input_ids: Optional[torch.Tensor] = None, attention_mask: Optional[torch.Tensor] = None, decoder_input_ids: Optional[torch.Tensor] = None, decoder_attention_mask: Optional[torch.Tensor] = None, encoder_outputs: Optional[Tuple[torch.FloatTensor]] = None, past_key_values: Optional[Tuple[torch.FloatTensor]] = None, inputs_embeds: Optional[torch.Tensor] = None, decoder_inputs_embeds: Optional[torch.Tensor] = None, labels: Optional[torch.Tensor] = None, use_cache: Optional[bool] = None, output_attentions: Optional[bool] = None, output_hidden_states: Optional[bool] = None, return_dict: Optional[bool] = None) -> Union[Tuple, Seq2SeqLMOutput]:
        ...
        """
    def prepare_inputs_for_generation(self, decoder_input_ids, past_key_values: Incomplete | None = None, attention_mask: Incomplete | None = None, use_cache: Incomplete | None = None, encoder_outputs: Incomplete | None = None, **kwargs): ...
