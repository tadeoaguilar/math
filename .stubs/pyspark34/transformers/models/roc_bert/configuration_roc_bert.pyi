...
logger: Incomplete
ROC_BERT_PRETRAINED_CONFIG_ARCHIVE_MAP: Incomplete
...
class RoCBertConfig(PretrainedConfig):
    ...
    pronunciation_embed_dim: Incomplete
    pronunciation_vocab_size: Incomplete
    shape_embed_dim: Incomplete
    shape_vocab_size: Incomplete
    concat_input: Incomplete
    position_embedding_type: Incomplete
    classifier_dropout: Incomplete
    def __init__(self, vocab_size: int = 30522, hidden_size: int = 768, num_hidden_layers: int = 12, num_attention_heads: int = 12, intermediate_size: int = 3072, hidden_act: str = 'gelu', hidden_dropout_prob: float = 0.1, attention_probs_dropout_prob: float = 0.1, max_position_embeddings: int = 512, type_vocab_size: int = 2, initializer_range: float = 0.02, layer_norm_eps: float = 1e-12, use_cache: bool = True, pad_token_id: int = 0, position_embedding_type: str = 'absolute', classifier_dropout: Incomplete | None = None, enable_pronunciation: bool = True, enable_shape: bool = True, pronunciation_embed_dim: int = 768, pronunciation_vocab_size: int = 910, shape_embed_dim: int = 512, shape_vocab_size: int = 24858, concat_input: bool = True, **kwargs) -> None: ...
