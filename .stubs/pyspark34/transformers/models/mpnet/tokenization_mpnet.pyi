...
class MPNetTokenizer(PreTrainedTokenizer):
    ...
    def __init__(self, vocab_file, do_lower_case: bool = True, do_basic_tokenize: bool = True, never_split: Incomplete | None = None, bos_token: str = '<s>', eos_token: str = '</s>', sep_token: str = '</s>', cls_token: str = '<s>', unk_token: str = '[UNK]', pad_token: str = '<pad>', mask_token: str = '<mask>', tokenize_chinese_chars: bool = True, strip_accents: Incomplete | None = None, **kwargs) -> None: ...
    @property
