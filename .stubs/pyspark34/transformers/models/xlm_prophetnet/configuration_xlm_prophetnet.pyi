...
logger: Incomplete
XLM_PROPHETNET_PRETRAINED_CONFIG_ARCHIVE_MAP: Incomplete
...
class XLMProphetNetConfig(PretrainedConfig):
    ...
    num_encoder_layers: Incomplete
    num_encoder_attention_heads: Incomplete
    decoder_ffn_dim: Incomplete
    num_decoder_layers: Incomplete
    num_decoder_attention_heads: Incomplete
