...
class XLMProphetNetTokenizer(PreTrainedTokenizer):
    ...
    def __init__(self, vocab_file, bos_token: str = '[SEP]', eos_token: str = '[SEP]', sep_token: str = '[SEP]', unk_token: str = '[UNK]', pad_token: str = '[PAD]', cls_token: str = '[CLS]', mask_token: str = '[MASK]', sp_model_kwargs: Optional[Dict[str, Any]] = None, **kwargs) -> None: ...
