...
from ...tokenization_utils import PreTrainedTokenizerBase as PreTrainedTokenizerBase
from ...utils import ModelOutput as ModelOutput, logging as logging, requires_backends as requires_backends
...
class Wav2Vec2DecoderWithLMOutput(ModelOutput):
    ...
    logit_score: Union[List[float], float] = ...
    lm_score: Union[List[float], float] = ...
    word_offsets: Union[List[ListOfDict], ListOfDict] = ...
    def __init__(self, text, logit_score, lm_score, word_offsets) -> None: ...
...
class Wav2Vec2ProcessorWithLM(ProcessorMixin):
    ...
    def pad(self, *args, **kwargs):
        ...
        """
    def batch_decode(self, logits: np.ndarray, pool: Optional[Pool] = None, num_processes: Optional[int] = None, beam_width: Optional[int] = None, beam_prune_logp: Optional[float] = None, token_min_logp: Optional[float] = None, hotwords: Optional[Iterable[str]] = None, hotword_weight: Optional[float] = None, alpha: Optional[float] = None, beta: Optional[float] = None, unk_score_offset: Optional[float] = None, lm_score_boundary: Optional[bool] = None, output_word_offsets: bool = False):
        """
