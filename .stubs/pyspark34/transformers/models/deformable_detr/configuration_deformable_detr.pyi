...
logger: Incomplete
DEFORMABLE_DETR_PRETRAINED_CONFIG_ARCHIVE_MAP: Incomplete
...
class DeformableDetrConfig(PretrainedConfig):
    ...
    dilation: Incomplete
    num_feature_levels: Incomplete
    encoder_n_points: Incomplete
    decoder_n_points: Incomplete
    two_stage: Incomplete
    two_stage_num_proposals: Incomplete
    with_box_refine: Incomplete
