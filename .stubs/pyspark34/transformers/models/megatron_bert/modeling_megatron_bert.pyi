...
from .configuration_megatron_bert import MegatronBertConfig as MegatronBertConfig
...
MEGATRON_BERT_START_DOCSTRING: str
MEGATRON_BERT_INPUTS_DOCSTRING: str
...
class MegatronBertForPreTraining(MegatronBertPreTrainedModel):
    bert: Incomplete
    cls: Incomplete
    def __init__(self, config, add_binary_head: bool = True) -> None: ...
