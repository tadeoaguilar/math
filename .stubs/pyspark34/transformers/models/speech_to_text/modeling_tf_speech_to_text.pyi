...
from ...activations_tf import get_tf_activation as get_tf_activation, glu as glu
...
from ...modeling_tf_utils import TFCausalLanguageModelingLoss as TFCausalLanguageModelingLoss, TFModelInputType as TFModelInputType, TFPreTrainedModel as TFPreTrainedModel, TFSharedEmbeddings as TFSharedEmbeddings, keras_serializable as keras_serializable, unpack_inputs as unpack_inputs
...
from .configuration_speech_to_text import Speech2TextConfig as Speech2TextConfig
...
SPEECH_TO_TEXT_START_DOCSTRING: str
SPEECH_TO_TEXT_INPUTS_DOCSTRING: str
...
class TFSpeech2TextEncoder(tf.keras.layers.Layer):
    ...
    def __init__(self, config: Speech2TextConfig, **kwargs) -> None: ...
    def call(self, input_features: Incomplete | None = None, attention_mask: Incomplete | None = None, head_mask: Incomplete | None = None, output_attentions: Incomplete | None = None, output_hidden_states: Incomplete | None = None, return_dict: Incomplete | None = None, training: bool = False):
        """
        Args:
...
class TFSpeech2TextDecoder(tf.keras.layers.Layer):
    ...
    def call(self, input_ids: Incomplete | None = None, inputs_embeds: Incomplete | None = None, attention_mask: Incomplete | None = None, encoder_hidden_states: Incomplete | None = None, encoder_attention_mask: Incomplete | None = None, head_mask: Incomplete | None = None, cross_attn_head_mask: Incomplete | None = None, past_key_values: Incomplete | None = None, use_cache: Incomplete | None = None, output_attentions: Incomplete | None = None, output_hidden_states: Incomplete | None = None, return_dict: Incomplete | None = None, training: bool = False):
        """
        Args:
...
class TFSpeech2TextMainLayer(tf.keras.layers.Layer):
    ...
    def call(self, input_features: Incomplete | None = None, attention_mask: Incomplete | None = None, decoder_input_ids: Incomplete | None = None, decoder_attention_mask: Incomplete | None = None, head_mask: Incomplete | None = None, decoder_head_mask: Incomplete | None = None, cross_attn_head_mask: Incomplete | None = None, encoder_outputs: Incomplete | None = None, past_key_values: Incomplete | None = None, decoder_inputs_embeds: Incomplete | None = None, use_cache: Incomplete | None = None, output_attentions: Incomplete | None = None, output_hidden_states: Incomplete | None = None, return_dict: Incomplete | None = None, training: bool = False, **kwargs): ...
