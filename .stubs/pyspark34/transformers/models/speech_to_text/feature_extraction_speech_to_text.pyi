...
from ...utils import PaddingStrategy as PaddingStrategy, TensorType as TensorType, logging as logging
...
class Speech2TextFeatureExtractor(SequenceFeatureExtractor):
    ...
    do_ceptral_normalize: Incomplete
    normalize_means: Incomplete
    normalize_vars: Incomplete
    return_attention_mask: bool
    def __init__(self, feature_size: int = 80, sampling_rate: int = 16000, num_mel_bins: int = 80, padding_value: float = 0.0, do_ceptral_normalize: bool = True, normalize_means: bool = True, normalize_vars: bool = True, **kwargs) -> None: ...
    @staticmethod
