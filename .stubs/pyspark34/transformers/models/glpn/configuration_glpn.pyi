...
logger: Incomplete
GLPN_PRETRAINED_CONFIG_ARCHIVE_MAP: Incomplete
...
class GLPNConfig(PretrainedConfig):
    ...
    def __init__(self, num_channels: int = 3, num_encoder_blocks: int = 4, depths=[2, 2, 2, 2], sr_ratios=[8, 4, 2, 1], hidden_sizes=[32, 64, 160, 256], patch_sizes=[7, 3, 3, 3], strides=[4, 2, 2, 2], num_attention_heads=[1, 2, 5, 8], mlp_ratios=[4, 4, 4, 4], hidden_act: str = 'gelu', hidden_dropout_prob: float = 0.0, attention_probs_dropout_prob: float = 0.0, initializer_range: float = 0.02, drop_path_rate: float = 0.1, layer_norm_eps: float = 1e-06, decoder_hidden_size: int = 64, max_depth: int = 10, head_in_index: int = -1, **kwargs) -> None: ...
