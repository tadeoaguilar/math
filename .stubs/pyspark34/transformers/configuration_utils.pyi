...
from .utils import CONFIG_NAME as CONFIG_NAME, PushToHubMixin as PushToHubMixin, cached_file as cached_file, copy_func as copy_func, download_url as download_url, extract_commit_hash as extract_commit_hash, is_remote_url as is_remote_url, is_torch_available as is_torch_available, logging as logging
...
class PretrainedConfig(PushToHubMixin):
    ...
    task_specific_params: Incomplete
    ...
    def dict_torch_dtype_to_str(self, d: Dict[str, Any]) -> None:
        ...
        '''
    @classmethod
    def register_for_auto_class(cls, auto_class: str = 'AutoConfig') -> None:
        '''
