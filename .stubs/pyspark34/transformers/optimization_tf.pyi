...
class WarmUp(tf.keras.optimizers.schedules.LearningRateSchedule):
    ...
    power: Incomplete
    decay_schedule_fn: Incomplete
    name: Incomplete
    def __init__(self, initial_learning_rate: float, decay_schedule_fn: Callable, warmup_steps: int, power: float = 1.0, name: str = None) -> None: ...
