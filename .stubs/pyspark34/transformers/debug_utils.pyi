from .utils import ExplicitEnum as ExplicitEnum, is_torch_available as is_torch_available, logging as logging
...
class DebugUnderflowOverflow:
    ...
    **Performance**:
    ...
    """
    model: Incomplete
    trace_batch_nums: Incomplete
    abort_after_batch_num: Incomplete
    frames: Incomplete
    frame: Incomplete
    batch_number: int
    total_calls: int
    ...
    prefix: str
    def __init__(self, model, max_frames_to_save: int = 21, trace_batch_nums=[], abort_after_batch_num: Incomplete | None = None) -> None: ...
    def save_frame(self, frame: Incomplete | None = None) -> None: ...
...
class DebugOption(ExplicitEnum):
    UNDERFLOW_OVERFLOW: str
    TPU_METRICS_DEBUG: str
