...
class TFBaseModelOutputWithPoolingAndCrossAttentions(ModelOutput):
    ...
    def __init__(self, last_hidden_state, pooler_output, past_key_values, hidden_states, attentions, cross_attentions) -> None: ...
...
class TFSeq2SeqQuestionAnsweringModelOutput(ModelOutput):
    ...
    encoder_hidden_states: Optional[Tuple[tf.Tensor]] = ...
    encoder_attentions: Optional[Tuple[tf.Tensor]] = ...
    def __init__(self, loss, start_logits, end_logits, past_key_values, decoder_hidden_states, decoder_attentions, encoder_last_hidden_state, encoder_hidden_states, encoder_attentions) -> None: ...
