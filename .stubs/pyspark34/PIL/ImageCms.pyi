...
class ImageCmsTransform(Image.ImagePointHandler):
    ...
    def __init__(self, input, output, input_mode, output_mode, intent=..., proof: Incomplete | None = None, proof_intent=..., flags: int = 0) -> None: ...
    def point(self, im): ...
...
def profileToProfile(im, inputProfile, outputProfile, renderingIntent=..., outputMode: Incomplete | None = None, inPlace: bool = False, flags: int = 0):
    '''
