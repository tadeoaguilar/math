...
class SList(list):
    ...
    * .p (or .paths): list of path objects (requires path.py package)
    ...
    p: Incomplete
    paths: Incomplete
    def grep(self, pattern, prune: bool = False, field: Incomplete | None = None):
    ...
    def fields(self, *fields):
        ...
        * ``a.fields(-1)`` is ``['ChangeLog', 'IPython']``
        ...
        """
    def sort(self, field: Incomplete | None = None, nums: bool = False):
...
def indent(instr, nspaces: int = 4, ntabs: int = 0, flatten: bool = False):
...
def list_strings(arg):
    ...
    """
def marquee(txt: str = '', width: int = 78, mark: str = '*'):
...
def dedent(text):
    ...
    """
def wrap_paragraphs(text, ncols: int = 80):
...
class DollarFormatter(FullEvalFormatter):
    ...
    ::
        ...
        Out[4]: '1 or 2'
    """
    def parse(self, fmt_string) -> Generator[Incomplete, None, None]: ...

def compute_item_matrix(items, row_first: bool = False, empty: Incomplete | None = None, *args, **kwargs):
    ...
    ::
        ...
        Out[5]: True
    """
def columnize(items, row_first: bool = False, separator: str = '  ', displaywidth: int = 80, spread: bool = False):
    ...
    """
def get_text_list(list_, last_sep: str = ' and ', sep: str = ', ', wrap_item_with: str = ''):
    '''
