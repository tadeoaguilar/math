...
class ColorScheme:
    ...
    name: Incomplete
    colors: Incomplete
    def __init__(self, __scheme_name_, colordict: Incomplete | None = None, **colormap) -> None: ...
    def copy(self, name: Incomplete | None = None):
...
class ColorSchemeTable(dict):
    ...
    active_colors: Incomplete
    def __init__(self, scheme_list: Incomplete | None = None, default_scheme: str = '') -> None:
    ...
    def set_active_scheme(self, scheme, case_sensitive: int = 0) -> None:
