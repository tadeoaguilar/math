...
from IPython.utils.encoding import get_stream_enc as get_stream_enc
from _typeshed import Incomplete

line_split: Incomplete

def split_user_input(line, pattern: Incomplete | None = None):
...
class LineInfo:
    ...
    '''
    line: Incomplete
    continue_prompt: Incomplete
    pre_char: Incomplete
    pre_whitespace: str
    def __init__(self, line, continue_prompt: bool = False) -> None: ...
