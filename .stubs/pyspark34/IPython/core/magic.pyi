from . import oinspect as oinspect
from ..utils.ipstruct import Struct as Struct
from ..utils.process import arg_split as arg_split
from ..utils.text import dedent as dedent
from .error import UsageError as UsageError
from .inputtransformer2 import ESC_MAGIC as ESC_MAGIC, ESC_MAGIC2 as ESC_MAGIC2
from _typeshed import Incomplete
from traitlets.config.configurable import Configurable

magics: Incomplete
magic_kinds: Incomplete
magic_spec: Incomplete
magic_escapes: Incomplete
...
MAGIC_NO_VAR_EXPAND_ATTR: str
MAGIC_OUTPUT_CAN_BE_SILENCED: str
...
line_magic: Incomplete
cell_magic: Incomplete
line_cell_magic: Incomplete
register_line_magic: Incomplete
register_cell_magic: Incomplete
register_line_cell_magic: Incomplete

class MagicsManager(Configurable):
    """Object that handles all magic-related functionality for IPython.
    """
    magics: Incomplete
    lazy_magics: Incomplete
    registry: Incomplete
    shell: Incomplete
    auto_magic: Incomplete
    user_magics: Incomplete
    def __init__(self, shell: Incomplete | None = None, config: Incomplete | None = None, user_magics: Incomplete | None = None, **traits) -> None: ...
    ...
    def lsmagic(self):
        ...
        """
    def lsmagic_docs(self, brief: bool = False, missing: str = ''):
    ...
    def register(self, *magic_objects) -> None:
        ...
        *magic_objects : one or more classes or instances
        """
    def register_function(self, func, magic_kind: str = 'line', magic_name: Incomplete | None = None) -> None:
        ...
        * For a function that does both: `def f(line, cell=None)`
        ...
        """
    def register_alias(self, alias_name, magic_name, magic_kind: str = 'line', magic_params: Incomplete | None = None) -> None:
...
class MagicAlias:
    ...
    """
    shell: Incomplete
    magic_name: Incomplete
    magic_params: Incomplete
    magic_kind: Incomplete
    pretty_target: Incomplete
    __doc__: Incomplete
    def __init__(self, shell, magic_name, magic_kind, magic_params: Incomplete | None = None) -> None: ...
