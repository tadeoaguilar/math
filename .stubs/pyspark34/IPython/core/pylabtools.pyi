from IPython.utils.decorators import flag_calls as flag_calls
from _typeshed import Incomplete

backends: Incomplete
backend2gui: Incomplete
...
def figsize(sizex, sizey) -> None:
    ...
    """
def print_figure(fig, fmt: str = 'png', bbox_inches: str = 'tight', base64: bool = False, **kwargs):
...
def select_figure_formats(shell, formats, **kwargs) -> None:
    ...
    **kwargs : any
    ...
    """
def find_gui_and_backend(gui: Incomplete | None = None, gui_select: Incomplete | None = None):
...
def import_pylab(user_ns, import_all: bool = True) -> None:
