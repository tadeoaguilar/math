import abc
from ..lib import pretty as pretty
from ..utils.dir2 import get_real_method as get_real_method
from ..utils.sentinel import Sentinel as Sentinel
from .getipython import get_ipython as get_ipython
from _typeshed import Incomplete
from traitlets.config.configurable import Configurable

class DisplayFormatter(Configurable):
    active_types: Incomplete
    ipython_display_formatter: Incomplete
    mimebundle_formatter: Incomplete
    formatters: Incomplete
    def format(self, obj, include: Incomplete | None = None, exclude: Incomplete | None = None):
...
class BaseFormatter(Configurable):
    ...
    singleton_printers: Incomplete
    type_printers: Incomplete
    deferred_printers: Incomplete
    def __call__(self, obj):
    ...
    def lookup_by_type(self, typ):
        ...
        KeyError if the type has not been registered.
        """
    def for_type(self, typ, func: Incomplete | None = None):
        ...
        """
    def for_type_by_name(self, type_module, type_name, func: Incomplete | None = None):
...
class MimeBundleFormatter(BaseFormatter):
    ...
    """
    print_method: Incomplete
    def __call__(self, obj, include: Incomplete | None = None, exclude: Incomplete | None = None):
        """Compute the format for an object.
...
def format_display_data(obj, include: Incomplete | None = None, exclude: Incomplete | None = None):
    """Return a format data dict for an object.
