from IPython.core import magic_arguments as magic_arguments, oinspect as oinspect, page as page
from IPython.core.alias import Alias as Alias, AliasError as AliasError
from IPython.core.error import UsageError as UsageError
from IPython.core.magic import Magics as Magics, cell_magic as cell_magic, compress_dhist as compress_dhist, line_cell_magic as line_cell_magic, line_magic as line_magic, magics_class as magics_class
from IPython.testing.skipdoctest import skip_doctest as skip_doctest
from IPython.utils.openpy import source_to_unicode as source_to_unicode
from IPython.utils.process import abbrev_cwd as abbrev_cwd
from IPython.utils.terminal import set_term_title as set_term_title
from _typeshed import Incomplete

class OSMagics(Magics):
    """Magics to interact with the underlying OS (shell-type functionality).
    """
    cd_force_quiet: Incomplete
    is_posix: bool
    execre: Incomplete
    ...
    def isexec(self, file):
        ...
        """
    def alias(self, parameter_s: str = ''):
    ...
    def unalias(self, parameter_s: str = '') -> None:
        """Remove an alias"""
    def rehashx(self, parameter_s: str = '') -> None:
    ...
    def pwd(self, parameter_s: str = ''):
        ...
        """
    def cd(self, parameter_s: str = '') -> None:
    ...
    def set_env(self, parameter_s) -> None:
        ...
        '''
    def pushd(self, parameter_s: str = ''):
        """Place the current dir on stack and change directory.

        Usage:\\\n          %pushd ['dirname']
        """
    def popd(self, parameter_s: str = '') -> None:
        """Change to directory popped off the top of the stack.
        """
    def dirs(self, parameter_s: str = ''):
        """Return the current directory stack."""
    def dhist(self, parameter_s: str = '') -> None:
    ...
    def sc(self, parameter_s: str = ''):
        ...
        '''
    def sx(self, line: str = '', cell: Incomplete | None = None):
    ...
    system: Incomplete
    bang: Incomplete
    def bookmark(self, parameter_s: str = '') -> None:
    ...
    def pycat(self, parameter_s: str = '') -> None:
