from IPython.core.error import StdinNotImplementedError as StdinNotImplementedError, TryNext as TryNext, UsageError as UsageError
...
from IPython.core.oinspect import find_file as find_file, find_source_lines as find_source_lines
from IPython.core.release import version as version
...
from IPython.utils.text import get_text_list as get_text_list
from _typeshed import Incomplete
from collections.abc import Generator

class MacroToEdit(ValueError): ...

ipython_input_pat: Incomplete
range_re: Incomplete

def extract_code_ranges(ranges_str) -> Generator[Incomplete, None, None]:
...
def extract_symbols(code, symbols):
    ...
    For example::
        ...
        Out[2]: (['class A: pass\\n', 'def b(): return 42\\n'], ['z'])
    """
def strip_initial_indent(lines) -> Generator[Incomplete, None, None]:
...
class CodeMagics(Magics):
    ...
    def save(self, parameter_s: str = '') -> None:
        ...
        """
    def pastebin(self, parameter_s: str = ''):
    ...
    def load(self, arg_s) -> None:
        ...
        """
    def edit(self, parameter_s: str = '', last_call=['', '']):
