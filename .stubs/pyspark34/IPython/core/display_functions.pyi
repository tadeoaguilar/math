...
def publish_display_data(data, metadata: Incomplete | None = None, source=..., *, transient: Incomplete | None = None, **kwargs) -> None:
    ...
    """
def display(*objs, include: Incomplete | None = None, exclude: Incomplete | None = None, metadata: Incomplete | None = None, transient: Incomplete | None = None, display_id: Incomplete | None = None, raw: bool = False, clear: bool = False, **kwargs):
...
class DisplayHandle:
    ...
    def __init__(self, display_id: Incomplete | None = None) -> None: ...
