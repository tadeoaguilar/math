...
class PromptStripper:
    ...
    """
    prompt_re: Incomplete
    initial_re: Incomplete
    def __init__(self, prompt_re, initial_re: Incomplete | None = None) -> None: ...
    def __call__(self, lines): ...

classic_prompt: Incomplete
ipython_prompt: Incomplete
...
ESC_QUOTE2: str
ESC_PAREN: str
ESCAPE_SINGLES: Incomplete
ESCAPE_DOUBLES: Incomplete
tr: Incomplete
...
class TransformerManager:
    ...
    and ``check_complete()``.
    """
    cleanup_transforms: Incomplete
    line_transforms: Incomplete
    token_transformers: Incomplete
...
class MaybeAsyncCompile(Compile):
    def __init__(self, extra_flags: int = 0) -> None: ...

class MaybeAsyncCommandCompiler(CommandCompiler):
    compiler: Incomplete
    def __init__(self, extra_flags: int = 0) -> None: ...

compile_command: Incomplete
