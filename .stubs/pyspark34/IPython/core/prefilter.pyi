from .autocall import IPyAutocall as IPyAutocall
from .inputtransformer2 import ESC_MAGIC as ESC_MAGIC, ESC_PAREN as ESC_PAREN, ESC_QUOTE as ESC_QUOTE, ESC_QUOTE2 as ESC_QUOTE2
from .macro import Macro as Macro
from .splitinput import LineInfo as LineInfo
from _typeshed import Incomplete
from traitlets.config.configurable import Configurable

class PrefilterError(Exception): ...

re_fun_name: Incomplete
re_exclude_auto: Incomplete
...
class PrefilterManager(Configurable):
    ...
    """
    multi_line_specials: Incomplete
    shell: Incomplete
    ...
    def prefilter_line(self, line, continue_prompt: bool = False):
        """Prefilter a single input line as text.

        This method prefilters a single line of text by calling the
        transformers and then the checkers/handlers.
        """
    def prefilter_lines(self, lines, continue_prompt: bool = False):
...
class PrefilterTransformer(Configurable):
    ...
    enabled: Incomplete
    def __init__(self, shell: Incomplete | None = None, prefilter_manager: Incomplete | None = None, **kwargs) -> None: ...
...
class AutocallChecker(PrefilterChecker):
    priority: Incomplete
    function_name_regexp: Incomplete
    exclude_regexp: Incomplete
    def check(self, line_info):
        """Check if the initial word/function is callable and autocall is on."""

class PrefilterHandler(Configurable):
    handler_name: Incomplete
    esc_strings: Incomplete
    shell: Incomplete
    prefilter_manager: Incomplete
    def __init__(self, shell: Incomplete | None = None, prefilter_manager: Incomplete | None = None, **kwargs) -> None: ...
