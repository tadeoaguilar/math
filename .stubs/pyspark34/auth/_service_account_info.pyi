...
def from_dict(data, require: Incomplete | None = None, use_rsa_signer: bool = True):
    ...
    """
def from_filename(filename, require: Incomplete | None = None, use_rsa_signer: bool = True):
