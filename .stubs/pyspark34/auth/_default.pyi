...
def load_credentials_from_file(filename, scopes: Incomplete | None = None, default_scopes: Incomplete | None = None, quota_project_id: Incomplete | None = None, request: Incomplete | None = None):
    ...
    """
def load_credentials_from_dict(info, scopes: Incomplete | None = None, default_scopes: Incomplete | None = None, quota_project_id: Incomplete | None = None, request: Incomplete | None = None):
...
def default(scopes: Incomplete | None = None, request: Incomplete | None = None, quota_project_id: Incomplete | None = None, default_scopes: Incomplete | None = None):
