...
class ReplacedPatterns:
    ...
    def __init__(self, anchor, nodes_map, replacements) -> None: ...
...
def replace_pattern(gm: GraphModule, pattern: Callable | GraphModule, replacement: Callable | GraphModule) -> List[Match]:
    ...
    .. code-block:: python
        ...
        def forward(self, x, w1, w2):
            ...
            return add_2
    '''
def replace_pattern_with_filters(gm: GraphModule, pattern: Callable | GraphModule, replacement: Callable | GraphModule, match_filters: List[Callable[[InternalMatch, Graph, Graph], bool]]) -> List[ReplacedPatterns]:
    """
