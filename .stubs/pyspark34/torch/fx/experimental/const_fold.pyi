...
class FoldedGraphModule(torch.fx.GraphModule):
    ...
    def __init__(self, root: torch.nn.Module, graph: torch.fx.Graph, const_subgraph: torch.fx.Graph | None = None, fx_const_folded_attrs_name: str = None, device_for_folded_attrs: str = 'cuda') -> None: ...
