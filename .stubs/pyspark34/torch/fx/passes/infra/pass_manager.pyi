...
class PassManager:
    ...
    def __init__(self, passes: Incomplete | None = None, constraints: Incomplete | None = None, steps: Incomplete | None = None, run_checks_after_each_pass: bool = False, suppress_check_failures: bool = False) -> None: ...
