...
class _SplitterSettingBase:
    ...
    def __init__(self, min_acc_module_size=..., skip_fusion=..., allow_non_tensor=...) -> None: ...
...
class _SplitterBase:
    ...
    def __init__(self, module: torch.fx.GraphModule, sample_input: Sequence[Any], operator_support: OperatorSupportBase, settings: _SplitterSettingBase, non_acc_submodule_name: str = '_run_on_cpu_') -> None:
        """
