...
class FxNetAccFusionsFinder:
    ...
    class FusionGroup:
        ...
        def add_node(self, node) -> None:
            ...
            """
        def __init__(self, top_node_idx, nodes, inputs, nodes_need_process) -> None: ...
    def recursive_add_node(self, fusion_group: FxNetAccFusionsFinder.FusionGroup, inputs: NodeSet | NodeList):
        """
