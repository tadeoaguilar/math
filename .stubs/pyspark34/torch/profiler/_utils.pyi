...
class EventMetrics:
    ...
    def __init__(self, duration_time_ns, self_time_ns, idle_time_ns, queue_depth) -> None: ...
...
class Interval:
    ...
    queue_depth: int = ...
    def __init__(self, start, end, queue_depth) -> None: ...
...
def index_of_first_match(seq, predicate, start: int = 0, end: Incomplete | None = None): ...
def argmax(seq, key=..., start: int = 0, end: Incomplete | None = None): ...
