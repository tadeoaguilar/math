...
class Pattern:
    ...
    def eventTreeTraversal(self) -> Generator[Incomplete, Incomplete, None]:
        """
...
def report_all_anti_patterns(prof, should_benchmark: bool = False, print_enable: bool = True, json_report_dir: str = None): ...
