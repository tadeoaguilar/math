...
def functional_call(module: torch.nn.Module, parameters_and_buffers: Dict[str, Tensor], args: Any | Tuple, kwargs: Dict[str, Any] = None, *, tie_weights: bool = True, strict: bool = False):
