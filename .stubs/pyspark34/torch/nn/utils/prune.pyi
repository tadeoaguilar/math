...
class BasePruningMethod(ABC, metaclass=abc.ABCMeta):
    ...
    def apply_mask(self, module):
        ...
        """
    @classmethod
    def apply(cls, module, name, *args, importance_scores: Incomplete | None = None, **kwargs):
        ...
        Args:
            ...
            kwargs: keyword arguments passed on to a subclass of a
                :class:`BasePruningMethod`
        """
    def prune(self, t, default_mask: Incomplete | None = None, importance_scores: Incomplete | None = None):
...
class L1Unstructured(BasePruningMethod):
    ...
    def compute_mask(self, t, default_mask): ...
    @classmethod
    def apply(cls, module, name, amount, importance_scores: Incomplete | None = None):
        """Adds the forward pre-hook that enables pruning on the fly and
        the reparametrization of a tensor in terms of the original tensor
        and the pruning mask.
...
class LnStructured(BasePruningMethod):
    ...
    def compute_mask(self, t, default_mask):
        ...
        """
    @classmethod
    def apply(cls, module, name, amount, n, dim, importance_scores: Incomplete | None = None):
        """Adds the forward pre-hook that enables pruning on the fly and
        the reparametrization of a tensor in terms of the original tensor
        and the pruning mask.
...
def random_unstructured(module, name, amount):
    ...
    """
def l1_unstructured(module, name, amount, importance_scores: Incomplete | None = None):
    """Prunes tensor corresponding to parameter called ``name`` in ``module``
...
def random_structured(module, name, amount, dim):
    ...
    Examples:
        ...
        3
    """
def ln_structured(module, name, amount, n, dim, importance_scores: Incomplete | None = None):
    """Prunes tensor corresponding to parameter called ``name`` in ``module``
    by removing the specified ``amount`` of (currently unpruned) channels
    ...
    Examples:
        ...
        ... )
    """
def global_unstructured(parameters, pruning_method, importance_scores: Incomplete | None = None, **kwargs) -> None:
    """
