...
class Transformer(Module):
    ...
    def __init__(self, d_model: int = 512, nhead: int = 8, num_encoder_layers: int = 6, num_decoder_layers: int = 6, dim_feedforward: int = 2048, dropout: float = 0.1, activation: str | Callable[[Tensor], Tensor] = ..., custom_encoder: Any | None = None, custom_decoder: Any | None = None, layer_norm_eps: float = 1e-05, batch_first: bool = False, norm_first: bool = False, device: Incomplete | None = None, dtype: Incomplete | None = None) -> None: ...
    def forward(self, src: Tensor, tgt: Tensor, src_mask: Tensor | None = None, tgt_mask: Tensor | None = None, memory_mask: Tensor | None = None, src_key_padding_mask: Tensor | None = None, tgt_key_padding_mask: Tensor | None = None, memory_key_padding_mask: Tensor | None = None) -> Tensor:
        ...
        """
    @staticmethod
    def generate_square_subsequent_mask(sz: int, device: str = 'cpu') -> Tensor:
...
class TransformerEncoder(Module):
    ...
    def __init__(self, encoder_layer, num_layers, norm: Incomplete | None = None, enable_nested_tensor: bool = True, mask_check: bool = True) -> None: ...
...
class TransformerDecoder(Module):
    ...
    def forward(self, tgt: Tensor, memory: Tensor, tgt_mask: Tensor | None = None, memory_mask: Tensor | None = None, tgt_key_padding_mask: Tensor | None = None, memory_key_padding_mask: Tensor | None = None) -> Tensor:
...
class TransformerEncoderLayer(Module):
    ...
    def __init__(self, d_model: int, nhead: int, dim_feedforward: int = 2048, dropout: float = 0.1, activation: str | Callable[[Tensor], Tensor] = ..., layer_norm_eps: float = 1e-05, batch_first: bool = False, norm_first: bool = False, device: Incomplete | None = None, dtype: Incomplete | None = None) -> None: ...
