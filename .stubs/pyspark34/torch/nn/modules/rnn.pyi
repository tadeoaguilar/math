...
class RNNBase(Module):
    ...
    bidirectional: bool
    proj_size: int
    def __init__(self, mode: str, input_size: int, hidden_size: int, num_layers: int = 1, bias: bool = True, batch_first: bool = False, dropout: float = 0.0, bidirectional: bool = False, proj_size: int = 0, device: Incomplete | None = None, dtype: Incomplete | None = None) -> None: ...
...
class RNNCellBase(Module):
    ...
    bias_ih: Incomplete
    bias_hh: Incomplete
    def __init__(self, input_size: int, hidden_size: int, bias: bool, num_chunks: int, device: Incomplete | None = None, dtype: Incomplete | None = None) -> None: ...
    def extra_repr(self) -> str: ...
    def reset_parameters(self) -> None: ...
...
class RNNCell(RNNCellBase):
    ...
    __constants__: Incomplete
    nonlinearity: str
    def __init__(self, input_size: int, hidden_size: int, bias: bool = True, nonlinearity: str = 'tanh', device: Incomplete | None = None, dtype: Incomplete | None = None) -> None: ...
...
class LSTMCell(RNNCellBase):
    ...
    """
    def __init__(self, input_size: int, hidden_size: int, bias: bool = True, device: Incomplete | None = None, dtype: Incomplete | None = None) -> None: ...
