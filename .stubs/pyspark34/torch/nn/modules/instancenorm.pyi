...
class _InstanceNorm(_NormBase):
    def __init__(self, num_features: int, eps: float = 1e-05, momentum: float = 0.1, affine: bool = False, track_running_stats: bool = False, device: Incomplete | None = None, dtype: Incomplete | None = None) -> None: ...
...
class LazyInstanceNorm1d(_LazyNormBase, _InstanceNorm):
    """A :class:`torch.nn.InstanceNorm1d` module with lazy initialization of
...
class LazyInstanceNorm2d(_LazyNormBase, _InstanceNorm):
    """A :class:`torch.nn.InstanceNorm2d` module with lazy initialization of
...
class LazyInstanceNorm3d(_LazyNormBase, _InstanceNorm):
    """A :class:`torch.nn.InstanceNorm3d` module with lazy initialization of
