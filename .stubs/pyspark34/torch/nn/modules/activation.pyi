...
class ELU(Module):
    """Applies the Exponential Linear Unit (ELU) function, element-wise, as described
...
class MultiheadAttention(Module):
    ...
    def __init__(self, embed_dim, num_heads, dropout: float = 0.0, bias: bool = True, add_bias_kv: bool = False, add_zero_attn: bool = False, kdim: Incomplete | None = None, vdim: Incomplete | None = None, batch_first: bool = False, device: Incomplete | None = None, dtype: Incomplete | None = None) -> None: ...
...
class PReLU(Module):
    ...
    num_parameters: int
    weight: Incomplete
    def __init__(self, num_parameters: int = 1, init: float = 0.25, device: Incomplete | None = None, dtype: Incomplete | None = None) -> None: ...
    def forward(self, input: Tensor) -> Tensor: ...
    def extra_repr(self) -> str: ...
