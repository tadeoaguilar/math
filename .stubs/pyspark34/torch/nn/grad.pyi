def conv1d_input(input_size, weight, grad_output, stride: int = 1, padding: int = 0, dilation: int = 1, groups: int = 1):
    """
    ...
    """
def conv1d_weight(input, weight_size, grad_output, stride: int = 1, padding: int = 0, dilation: int = 1, groups: int = 1):
    """
    ...
    """
def conv2d_input(input_size, weight, grad_output, stride: int = 1, padding: int = 0, dilation: int = 1, groups: int = 1):
    """
    ...
    """
def conv2d_weight(input, weight_size, grad_output, stride: int = 1, padding: int = 0, dilation: int = 1, groups: int = 1):
    """
    ...
    """
def conv3d_input(input_size, weight, grad_output, stride: int = 1, padding: int = 0, dilation: int = 1, groups: int = 1):
    """
    ...
    """
def conv3d_weight(input, weight_size, grad_output, stride: int = 1, padding: int = 0, dilation: int = 1, groups: int = 1):
    """
