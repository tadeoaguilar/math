...
__all__ = ['ParallelStyle', 'RowwiseParallel', 'ColwiseParallel', 'PairwiseParallel', 'make_input_replicate_1d', 'make_input_shard_1d', 'make_input_shard_1d_last_dim', 'make_output_replicate_1d', 'make_output_tensor', 'make_output_shard_1d']
...
def make_input_shard_1d(input: torch.Tensor | DTensor, device_mesh: DeviceMesh | None = None, dim: int = 0) -> DTensor:
    """
    ...
    """
def make_input_shard_1d_last_dim(input: torch.Tensor | DTensor, device_mesh: DeviceMesh | None = None) -> DTensor:
    """
    ...
    Returns:
        A :class:`DTensor` sharded on dimension ``dim`` over ``device_mesh``.
    """
def make_input_replicate_1d(input: torch.Tensor | DTensor, device_mesh: DeviceMesh | None = None) -> DTensor:
    """
    ...
    """
def make_output_shard_1d(output: DTensor, device_mesh: DeviceMesh | None = None, dim: int = 0) -> DTensor:
    """
    ...
    """
def make_output_replicate_1d(output: DTensor, device_mesh: DeviceMesh | None = None) -> DTensor:
    """
    ...
    """
def make_output_tensor(output: DTensor, device_mesh: DeviceMesh | None = None) -> torch.Tensor:
    """
