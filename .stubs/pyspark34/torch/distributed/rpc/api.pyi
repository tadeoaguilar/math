...
def shutdown(graceful: bool = True, timeout=...) -> None:
    ...
    Example::
        ...
        >>> rpc.shutdown()
    '''
def get_worker_info(worker_name: Incomplete | None = None):
    """
...
def remote(to, func, args: Incomplete | None = None, kwargs: Incomplete | None = None, timeout=...):
    '''
    ...
    Example::
        ...
        >>> rpc.shutdown()
    '''
def rpc_sync(to, func, args: Incomplete | None = None, kwargs: Incomplete | None = None, timeout=...):
    '''
    ...
    '''
def rpc_async(to, func, args: Incomplete | None = None, kwargs: Incomplete | None = None, timeout=...):
    '''
