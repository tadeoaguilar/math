...
from .api import ShardedOptimizer as ShardedOptimizer
from torch.distributed._shard.sharded_tensor import ShardedTensor as ShardedTensor
from typing import Iterator, Tuple

def named_params_with_sharded_tensor(module: nn.Module, prefix: str = '', recurse: bool = True) -> Iterator[Tuple[str, nn.Parameter | ShardedTensor]]:
