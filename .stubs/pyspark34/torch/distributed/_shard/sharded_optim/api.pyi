...
class ShardedOptimizer(optim.Optimizer):
    named_params: Incomplete
    param_groups: Incomplete
    state: Incomplete
    def __init__(self, named_params: Mapping[str, Tensor | ShardedTensor], optimizer_class, *optimizer_args, **optimizer_kwargs) -> None:
        """
    ...
    def load_state_dict(self, state_dict: Mapping[str, Any]):
        """Loads the ShardedOptimizer state.
