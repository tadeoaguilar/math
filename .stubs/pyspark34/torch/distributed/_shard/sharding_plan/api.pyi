...
from torch.distributed._shard.sharder import Sharder as Sharder
...
class ShardingPlan:
    ...
    def __init__(self, plan, output_plan, return_local_tensor) -> None: ...

class ShardingPlanner(abc.ABC, metaclass=abc.ABCMeta):
    """
