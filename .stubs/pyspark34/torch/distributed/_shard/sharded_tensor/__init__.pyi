...
from .api import Shard as Shard, ShardedTensor as ShardedTensor, ShardedTensorBase as ShardedTensorBase, ShardedTensorMetadata as ShardedTensorMetadata, TensorProperties as TensorProperties
from .metadata import ShardMetadata as ShardMetadata
from _typeshed import Incomplete
from typing import List

def empty(sharding_spec: shard_spec.ShardingSpec, *size, dtype: Incomplete | None = None, layout=..., requires_grad: bool = False, pin_memory: bool = False, memory_format=..., process_group: Incomplete | None = None, init_rrefs: bool = False) -> ShardedTensor:
    """
    ...
    """
def ones(sharding_spec: shard_spec.ShardingSpec, *size, dtype: Incomplete | None = None, layout=..., requires_grad: bool = False, pin_memory: bool = False, memory_format=..., process_group: Incomplete | None = None, init_rrefs: bool = False) -> ShardedTensor:
    """
    ...
    Returns:
        A :class:`ShardedTensor` object on each rank
    """
def zeros(sharding_spec: shard_spec.ShardingSpec, *size, dtype: Incomplete | None = None, layout=..., requires_grad: bool = False, pin_memory: bool = False, memory_format=..., process_group: Incomplete | None = None, init_rrefs: bool = False) -> ShardedTensor:
    """
    ...
    Returns:
        A :class:`ShardedTensor` object on each rank
    """
def full(sharding_spec: shard_spec.ShardingSpec, size, fill_value, *, dtype: Incomplete | None = None, layout=..., requires_grad: bool = False, pin_memory: bool = False, memory_format=..., process_group: Incomplete | None = None, init_rrefs: bool = False) -> ShardedTensor:
    """
    ...
    Returns:
        A :class:`ShardedTensor` object on each rank
    """
def rand(sharding_spec: shard_spec.ShardingSpec, *size, dtype: Incomplete | None = None, layout=..., requires_grad: bool = False, pin_memory: bool = False, memory_format=..., process_group: Incomplete | None = None, init_rrefs: bool = False) -> ShardedTensor:
    """
    ...
    Returns:
        A :class:`ShardedTensor` object on each rank
    """
def randn(sharding_spec: shard_spec.ShardingSpec, *size, dtype: Incomplete | None = None, layout=..., requires_grad: bool = False, pin_memory: bool = False, memory_format=..., process_group: Incomplete | None = None, init_rrefs: bool = False) -> ShardedTensor:
    """
    Creates a :class:`ShardedTensor` filled with random numbers from a uniform distribution
    ...
    Returns:
        A :class:`ShardedTensor` object on each rank
    """
def init_from_local_shards(local_shards: List[Shard], *global_size, process_group: Incomplete | None = None, init_rrefs: bool = False) -> ShardedTensor:
    '''
