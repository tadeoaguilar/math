...
from typing import Any, Callable, Dict, Iterator, List, Mapping, Set, Tuple, Type, TypeVar
...
class _RemoteModule(nn.Module):
    ...
    def __init__(self, remote_device: str, module_cls: Type[nn.Module], args: Tuple = None, kwargs: Dict[str, Any] = None, _module_interface_cls: Any = None) -> None:
        '''
...
class RemoteModule(_RemoteModule):
    ...
    '''
    def __init__(self, remote_device: str, module_cls: Type[nn.Module], args: Tuple = None, kwargs: Dict[str, Any] = None) -> None: ...
