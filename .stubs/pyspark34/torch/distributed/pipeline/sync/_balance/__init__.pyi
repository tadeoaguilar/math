...
def balance_by_time(partitions: int, module: nn.Sequential, sample: List[Any] | Tensor, *, timeout: float = 1.0, device: Device = ...) -> List[int]:
    ...
    """
def balance_by_size(partitions: int, module: nn.Sequential, input: List[Any] | Tensor, *, chunks: int = 1, param_scale: float = 2.0, device: Device = ...) -> List[int]:
