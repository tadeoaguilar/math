...
class Backend:
    ...
    @classmethod
    def register_backend(cls, name, func, extended_api: bool = False) -> None:
        """
...
class _World:
    ...
    @property
    def pg_map(self) -> Dict[ProcessGroup, Tuple[str, Store | None]]:
        """
...
def get_backend(group: ProcessGroup | None = None) -> str:
    ...
    """
def init_process_group(backend: str | Backend = None, init_method: str | None = None, timeout: timedelta = ..., world_size: int = -1, rank: int = -1, store: Store | None = None, group_name: str = '', pg_options: Any | None = None):
    '''
...
def get_world_size(group: ProcessGroup | None = None) -> int:
    ...
    """
def isend(tensor: torch.Tensor, dst: int, group: ProcessGroup | None = None, tag: int = 0) -> Work:
    """
    ...
    """
def irecv(tensor: torch.Tensor, src: int | None = None, group: ProcessGroup | None = None, tag: int = 0) -> Work:
    """
    ...
    """
def send(tensor: torch.Tensor, dst: int, group: ProcessGroup | None = None, tag: int = 0) -> None:
    """
    ...
    """
def recv(tensor: torch.Tensor, src: int | None = None, group: ProcessGroup | None = None, tag: int = 0) -> int:
    """
...
class P2POp:
    ...
    group: Incomplete
    tag: Incomplete
    def __init__(self, op, tensor, peer, group: Incomplete | None = None, tag: int = 0) -> None: ...
    def __new__(cls, op, tensor, peer, group: Incomplete | None = None, tag: int = 0): ...
...
def broadcast_multigpu(tensor_list, src, group: Incomplete | None = None, async_op: bool = False, src_tensor: int = 0):
    """
    ...
    """
def broadcast(tensor, src, group: Incomplete | None = None, async_op: bool = False):
    """
    ...
    """
def all_reduce_multigpu(tensor_list, op=..., group: Incomplete | None = None, async_op: bool = False):
    """
    ...
    """
def all_reduce(tensor, op=..., group: Incomplete | None = None, async_op: bool = False):
    '''
    Reduces the tensor data across all machines in such a way that all get
    the final result.
    ...
    '''
def all_reduce_coalesced(tensors, op=..., group: Incomplete | None = None, async_op: bool = False):
    """
    ...
    """
def reduce_multigpu(tensor_list, dst, op=..., group: Incomplete | None = None, async_op: bool = False, dst_tensor: int = 0):
    """
    ...
    """
def reduce(tensor, dst, op=..., group: Incomplete | None = None, async_op: bool = False):
    """
    ...
    """
def all_gather_multigpu(output_tensor_lists, input_tensor_list, group: Incomplete | None = None, async_op: bool = False):
    """
...
def all_gather_object(object_list, obj, group: Incomplete | None = None) -> None:
    ...
    Example::
        ...
        [\'foo\', 12, {1: 2}]
    '''
def gather_object(obj, object_gather_list: Incomplete | None = None, dst: int = 0, group: Incomplete | None = None) -> None:
    '''
    ...
    Example::
        ...
        [\'foo\', 12, {1: 2}]
    '''
def broadcast_object_list(object_list, src: int = 0, group: Incomplete | None = None, device: Incomplete | None = None) -> None:
    '''
    ...
    Example::
        ...
        [\'foo\', 12, {1: 2}]
    '''
def scatter_object_list(scatter_object_output_list, scatter_object_input_list, src: int = 0, group: Incomplete | None = None) -> None:
    '''
    ...
    Example::
        ...
        [{1: 2}]
    '''
def all_gather(tensor_list, tensor, group: Incomplete | None = None, async_op: bool = False):
    '''
    Gathers tensors from the whole group in a list.
    ...
    '''
def all_gather_into_tensor(output_tensor, input_tensor, group: Incomplete | None = None, async_op: bool = False):
    '''
    ...
    '''
def all_gather_coalesced(output_tensor_lists, input_tensor_list, group: Incomplete | None = None, async_op: bool = False):
    """
    ...
    """
def gather(tensor, gather_list: Incomplete | None = None, dst: int = 0, group: Incomplete | None = None, async_op: bool = False):
    """
    ...
    """
def scatter(tensor, scatter_list: Incomplete | None = None, src: int = 0, group: Incomplete | None = None, async_op: bool = False):
    '''
    ...
    '''
def reduce_scatter_multigpu(output_tensor_list, input_tensor_lists, op=..., group: Incomplete | None = None, async_op: bool = False):
    """
    ...
    """
def reduce_scatter(output, input_list, op=..., group: Incomplete | None = None, async_op: bool = False):
    """
    ...
    """
def reduce_scatter_tensor(output, input, op=..., group: Incomplete | None = None, async_op: bool = False):
    '''
    ...
    '''
def all_to_all_single(output, input, output_split_sizes: Incomplete | None = None, input_split_sizes: Incomplete | None = None, group: Incomplete | None = None, async_op: bool = False):
    '''
    ...
    '''
def all_to_all(output_tensor_list, input_tensor_list, group: Incomplete | None = None, async_op: bool = False):
    '''
    ...
    '''
def barrier(group=..., async_op: bool = False, device_ids: Incomplete | None = None):
    """
    ...
    Returns:
        ...
        None, if not async_op or if not part of the group
    """
def monitored_barrier(group=..., timeout: Incomplete | None = None, wait_all_ranks: bool = False):
    '''
    ...
    Example::
        ...
        >>> # monitored_barrier.
    '''
def new_group(ranks: Incomplete | None = None, timeout=..., backend: Incomplete | None = None, pg_options: Incomplete | None = None):
    '''
    ...
    '''
def new_subgroups(group_size: Incomplete | None = None, group: Incomplete | None = None, timeout=..., backend: Incomplete | None = None, pg_options: Incomplete | None = None):
    '''
    ...
    '''
def new_subgroups_by_enumeration(ranks_per_subgroup_list, timeout=..., backend: Incomplete | None = None, pg_options: Incomplete | None = None):
    '''
