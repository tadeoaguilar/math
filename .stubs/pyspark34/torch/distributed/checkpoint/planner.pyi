...
class TensorWriteData:
    ...
    size: torch.Size
    def __init__(self, chunk, properties, size) -> None: ...
...
class WriteItem:
    ...
    def __init__(self, index, type, tensor_data) -> None: ...
...
class ReadItem:
    ...
    lengths: torch.Size
    def __init__(self, type, dest_index, dest_offsets, storage_index, storage_offsets, lengths) -> None: ...
...
class SavePlan:
    ...
    storage_data: Any = ...
    planner_data: Any = ...
    def __init__(self, items, storage_data, planner_data) -> None: ...
...
class SavePlanner(abc.ABC, metaclass=abc.ABCMeta):
    '''
...
class LoadPlanner(metaclass=abc.ABCMeta):
    '''
