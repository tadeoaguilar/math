...
class WriteResult:
    ...
    size_in_bytes: int
    storage_data: Any
    def __init__(self, index, size_in_bytes, storage_data) -> None: ...

class StorageWriter(abc.ABC, metaclass=abc.ABCMeta):
    """
...
class StorageReader(abc.ABC, metaclass=abc.ABCMeta):
    """
