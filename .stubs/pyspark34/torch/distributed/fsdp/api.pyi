...
class MixedPrecision:
    ...
    def __init__(self, param_dtype, reduce_dtype, buffer_dtype, keep_low_precision_grads, cast_forward_inputs, cast_root_forward_inputs) -> None: ...
...
class CPUOffload:
    ...
    """
    offload_params: bool = ...
    def __init__(self, offload_params) -> None: ...
...
class StateDictType(Enum):
    ...
    '''
    FULL_STATE_DICT: Incomplete
    LOCAL_STATE_DICT: Incomplete
    SHARDED_STATE_DICT: Incomplete
...
class StateDictConfig:
    ...
    """
    offload_to_cpu: bool = ...
    def __init__(self, offload_to_cpu) -> None: ...
...
class FullStateDictConfig(StateDictConfig):
    ...
    '''
    rank0_only: bool = ...
    def __init__(self, offload_to_cpu, rank0_only) -> None: ...
...
class StateDictSettings:
    ...
    def __init__(self, state_dict_type, state_dict_config, optim_state_dict_config) -> None: ...
