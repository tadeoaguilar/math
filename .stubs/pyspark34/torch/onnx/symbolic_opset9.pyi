...
__all__ = ['abs', 'acos', 'add', 'addcmul', 'addmm', 'alias', 'amax', 'amin', 'aminmax', 'arange', 'argmax', 'argmin', 'as_strided', 'as_tensor', 'asin', 'atan', 'baddbmm', 'batch_norm', 'bernoulli', 'bitwise_not', 'bitwise_or', 'bmm', 'broadcast_tensors', 'bucketize', 'cat', 'cdist', 'ceil', 'clamp_max', 'clamp_min', 'clamp', 'clone', 'constant_pad_nd', 'contiguous', 'conv_tbc', 'conv_transpose1d', 'conv_transpose2d', 'conv_transpose3d', 'conv1d', 'conv2d', 'conv3d', 'convert_element_type', 'convolution', 'cos', 'cosine_similarity', 'cross', 'cumsum', 'detach', 'dim', 'div', 'dot', 'dropout', 'elu', 'embedding_bag', 'embedding', 'empty_like', 'empty', 'eq', 'erf', 'exp', 'expand_as', 'expand', 'eye', 'fill', 'flatten', 'floor_divide', 'floor', 'floordiv', 'frobenius_norm', 'full_like', 'full', 'gather', 'ge', 'gelu', 'get_pool_ceil_padding', 'glu', 'group_norm', 'gt', 'hann_window', 'hardshrink', 'hardsigmoid', 'hardswish', 'hardtanh', 'index_add', 'index_copy', 'index_fill', 'index_put', 'index_select', 'index', 'instance_norm', 'is_floating_point', 'is_pinned', 'isnan', 'item', 'kl_div', 'layer_norm', 'le', 'leaky_relu', 'lerp', 'lift', 'linalg_cross', 'linalg_matrix_norm', 'linalg_norm', 'linalg_vector_norm', 'linear', 'linspace', 'log_sigmoid', 'log_softmax', 'log', 'log10', 'log1p', 'log2', 'logical_and', 'logical_or', 'logical_xor', 'logsumexp', 'lstm_cell', 'lstm', 'lt', 'masked_fill', 'masked_fill_', 'matmul', 'max_pool1d_with_indices', 'max_pool2d_with_indices', 'max_pool3d_with_indices', 'max', 'maximum', 'meshgrid', 'min', 'minimum', 'mish', 'mm', 'movedim', 'mse_loss', 'mul', 'multinomial', 'mv', 'narrow', 'native_layer_norm', 'ne', 'neg', 'new_empty', 'new_full', 'new_ones', 'new_zeros', 'nonzero_numpy', 'nonzero', 'norm', 'numel', 'numpy_T', 'one_hot', 'ones_like', 'ones', 'onnx_placeholder', 'overload_by_arg_count', 'pad', 'pairwise_distance', 'permute', 'pixel_shuffle', 'pixel_unshuffle', 'pow', 'prelu', 'prim_constant_chunk', 'prim_constant_split', 'prim_constant', 'prim_data', 'prim_device', 'prim_dtype', 'prim_if', 'prim_layout', 'prim_list_construct', 'prim_list_unpack', 'prim_loop', 'prim_max', 'prim_min', 'prim_shape', 'prim_tolist', 'prim_tuple_construct', 'prim_type', 'prim_unchecked_cast', 'prim_uninitialized', 'rand_like', 'rand', 'randn_like', 'randn', 'reciprocal', 'reflection_pad', 'relu', 'relu6', 'remainder', 'repeat_interleave', 'repeat', 'replication_pad', 'reshape_as', 'reshape', 'roll', 'rrelu', 'rsqrt', 'rsub', 'scalar_tensor', 'scatter_add', 'scatter', 'select', 'selu', 'sigmoid', 'sign', 'silu', 'sin', 'size', 'slice', 'softmax', 'softplus', 'softshrink', 'sort', 'split_with_sizes', 'split', 'sqrt', 'square', 'squeeze', 'stack', 'std_mean', 'std', 'sub', 't', 'take', 'tan', 'tanh', 'tanhshrink', 'tensor', 'threshold', 'to', 'topk', 'transpose', 'true_divide', 'type_as', 'unbind', 'unfold', 'unsafe_chunk', 'unsafe_split_with_sizes', 'unsafe_split', 'unsqueeze', 'unsupported_complex_operators', 'noop_complex_operators', 'unused', 'var_mean', 'var', 'view_as', 'view', 'where', 'wrap_logical_op_with_cast_to', 'wrap_logical_op_with_negation', 'zeros_like', 'zeros', 'zero']
...
def add(g: jit_utils.GraphContext, self, other, alpha: Incomplete | None = None): ...
def sub(g: jit_utils.GraphContext, self, other, alpha: Incomplete | None = None): ...
def rsub(g: jit_utils.GraphContext, self, other, alpha: Incomplete | None = None): ...
...
def size(g: jit_utils.GraphContext, self, dim: Incomplete | None = None): ...
...
def squeeze(g: jit_utils.GraphContext, self, dim: Incomplete | None = None): ...
...
def empty(g: jit_utils.GraphContext, sizes, dtype, layout, device, pin_memory: bool = False, memory_format: Incomplete | None = None): ...
def empty_like(g: jit_utils.GraphContext, input, dtype: Incomplete | None = None, layout: Incomplete | None = None, device: Incomplete | None = None, pin_memory: bool = False, memory_format: Incomplete | None = None): ...
...
def tensor(g: jit_utils.GraphContext, data, dtype: Incomplete | None = None, device: Incomplete | None = None, requires_grad: bool = False): ...
def as_tensor(g: jit_utils.GraphContext, data, dtype: Incomplete | None = None, device: Incomplete | None = None): ...
def zeros(g: jit_utils.GraphContext, sizes, dtype, layout, device, pin_memory: bool = False): ...
def zeros_like(g: jit_utils.GraphContext, input, dtype: Incomplete | None = None, layout: Incomplete | None = None, device: Incomplete | None = None, pin_memory: bool = False, memory_format: Incomplete | None = None): ...
...
def ones_like(g: jit_utils.GraphContext, input, dtype: Incomplete | None = None, layout: Incomplete | None = None, device: Incomplete | None = None, pin_memory: bool = False, memory_format: Incomplete | None = None): ...
...
def full_like(g: jit_utils.GraphContext, input, fill_value, dtype: Incomplete | None = None, layout: Incomplete | None = None, device: Incomplete | None = None, pin_memory: bool = False, memory_format: Incomplete | None = None): ...
...
def sort(g: jit_utils.GraphContext, self, dim, decending, out: Incomplete | None = None): ...
def numel(g: jit_utils.GraphContext, self): ...
def topk(g: jit_utils.GraphContext, self, k, dim, largest, sorted, out: Incomplete | None = None): ...
...
def randn_like(g: jit_utils.GraphContext, self, dtype, layout: Incomplete | None = None, device: Incomplete | None = None, pin_memory: bool = False, memory_format: Incomplete | None = None): ...
def rand_like(g: jit_utils.GraphContext, self, dtype, layout: Incomplete | None = None, device: Incomplete | None = None, pin_memory: bool = False, memory_format: Incomplete | None = None): ...
...
def multinomial(g: jit_utils.GraphContext, input, num_samples, replacement: bool = False, generator: Incomplete | None = None): ...
...
def as_strided(g: jit_utils.GraphContext, self, sizes, strides, offset: Incomplete | None = None): ...
def linear(g: jit_utils.GraphContext, input, weight, bias): ...
def hann_window(g: jit_utils.GraphContext, window_length, periodic: bool = True, dtype: int | None = None, layout: Incomplete | None = None, device: Incomplete | None = None, pin_memory: Incomplete | None = None, requires_grad: bool = False): ...
...
def index_add(g: jit_utils.GraphContext, self, dim, index, other, alpha: Incomplete | None = None): ...
def roll(g: jit_utils.GraphContext, self, shifts, dims): ...
def cross(g: jit_utils.GraphContext, input, other, dim: Incomplete | None = None): ...
...
def is_pinned(g: jit_utils.GraphContext, self, device: Incomplete | None = None): ...
...
def prim_min(g: jit_utils.GraphContext, self, other: Incomplete | None = None): ...
