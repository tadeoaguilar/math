...
from typing import Any, Callable, Collection, List, Mapping, Sequence, Tuple, Type

__all__ = ['is_in_onnx_export', 'select_model_mode_for_export', 'disable_apex_o2_state_dict_hook', 'setup_onnx_logging', 'exporter_context', 'export', 'warn_on_static_input_change', 'unpack_quantized_tensor', 'export_to_pretty_string', 'unconvertible_ops', 'register_custom_op_symbolic', 'unregister_custom_op_symbolic']
...
def export(model: torch.nn.Module | torch.jit.ScriptModule | torch.jit.ScriptFunction, args: Tuple[Any, ...] | torch.Tensor, f: str | io.BytesIO, export_params: bool = True, verbose: bool = False, training: _C_onnx.TrainingMode = ..., input_names: Sequence[str] | None = None, output_names: Sequence[str] | None = None, operator_export_type: _C_onnx.OperatorExportTypes = ..., opset_version: int | None = None, do_constant_folding: bool = True, dynamic_axes: Mapping[str, Mapping[int, str]] | Mapping[str, Sequence[int]] | None = None, keep_initializers_as_inputs: bool | None = None, custom_opsets: Mapping[str, int] | None = None, export_modules_as_functions: bool | Collection[Type[torch.nn.Module]] = False) -> None:
...
def export_to_pretty_string(model, args, export_params: bool = True, verbose: bool = False, training=..., input_names: Incomplete | None = None, output_names: Incomplete | None = None, operator_export_type=..., export_type: Incomplete | None = None, google_printer: bool = False, opset_version: Incomplete | None = None, keep_initializers_as_inputs: Incomplete | None = None, custom_opsets: Incomplete | None = None, add_node_names: bool = True, do_constant_folding: bool = True, dynamic_axes: Incomplete | None = None):
    """
