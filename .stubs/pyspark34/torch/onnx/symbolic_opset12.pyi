...
def einsum(g: jit_utils.GraphContext, equation, tensor_list, path: Incomplete | None = None): ...
...
def tensordot(g: jit_utils.GraphContext, input_a, input_b, dims_a, dims_b, out: Incomplete | None = None): ...
