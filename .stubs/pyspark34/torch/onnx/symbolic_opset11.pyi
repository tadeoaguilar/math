...
def cumsum(g: jit_utils.GraphContext, self, dim, dtype: Incomplete | None = None): ...
...
def argsort(g: jit_utils.GraphContext, self, dim, decending, out: Incomplete | None = None): ...
...
def constant_pad_nd(g: jit_utils.GraphContext, input, padding, value: Incomplete | None = None): ...
...
def normal(g: jit_utils.GraphContext, mean, std, sizes: Incomplete | None = None, generator: Incomplete | None = None, dtype: Incomplete | None = None, layout: Incomplete | None = None, device: Incomplete | None = None, pin_memory: Incomplete | None = None): ...
