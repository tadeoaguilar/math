...
__all__ = ['Constraint', 'boolean', 'cat', 'corr_cholesky', 'dependent', 'dependent_property', 'greater_than', 'greater_than_eq', 'independent', 'integer_interval', 'interval', 'half_open_interval', 'is_dependent', 'less_than', 'lower_cholesky', 'lower_triangular', 'multinomial', 'nonnegative_integer', 'positive', 'positive_semidefinite', 'positive_definite', 'positive_integer', 'real', 'real_vector', 'simplex', 'square', 'stack', 'symmetric', 'unit_interval']
...
class _DependentProperty(property, _Dependent):
    ...
    Args:
        ...
        event_dim (int): Optional value of ``.event_dim`` in case this
            ...
            ``.event_dim`` attribute will raise a NotImplementedError.
    """
    def __init__(self, fn: Incomplete | None = None, *, is_discrete=..., event_dim=...) -> None: ...
...
class _Cat(Constraint):
    ...
    lengths: Incomplete
    dim: Incomplete
    def __init__(self, cseq, dim: int = 0, lengths: Incomplete | None = None) -> None: ...
    @property
    def is_discrete(self): ...
    @property
    def event_dim(self): ...
