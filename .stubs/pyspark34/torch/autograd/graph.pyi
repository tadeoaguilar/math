...
__all__ = ['saved_tensors_hooks', 'save_on_cpu', 'disable_saved_tensors_hooks', 'register_multi_grad_hook', 'allow_mutation_on_saved_tensors', 'Node']
...
class save_on_cpu(saved_tensors_hooks):
    ...
    '''
    def __init__(self, pin_memory: bool = False) -> None: ...

def disable_saved_tensors_hooks(error_message) -> Generator[None, None, None]:
    ...
    '''
def register_multi_grad_hook(tensors: Sequence[torch.Tensor], fn: Callable[[Sequence[torch.Tensor | None]], None]):
...
class _AllowMutationOnSavedContext:
    cloned: Incomplete
    original: Incomplete
    tid_to_weakhandle: Incomplete
    sid_to_tid: Incomplete
    def __init__(self) -> None: ...
    def clear(self) -> None: ...

def allow_mutation_on_saved_tensors() -> Generator[Incomplete, None, None]:
