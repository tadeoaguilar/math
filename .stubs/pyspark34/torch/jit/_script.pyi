...
from torch.jit._recursive import ScriptMethodStub as ScriptMethodStub, infer_methods_to_compile as infer_methods_to_compile, wrap_cpp_module as wrap_cpp_module
...
class ScriptModule(torch.nn.Module):
    def __init__(self, arg: Incomplete | None = None) -> None: ...
...
def create_script_dict(obj):
    ...
    Returns:
        ...
        zero copy overhead.
    """
def create_script_list(obj, type_hint: Incomplete | None = None):
    """
    ...
    Returns:
        ...
        zero copy overhead.
    """
def script(obj, optimize: Incomplete | None = None, _frames_up: int = 0, _rcb: Incomplete | None = None, example_inputs: List[Tuple] | Dict[Callable, List[Tuple]] | None = None):
    """
