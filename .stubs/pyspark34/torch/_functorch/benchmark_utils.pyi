...
def dump_chrome_trace(f, input, trace_filename, optimize_ctx, activities, num_runs: int = 1, devices: Incomplete | None = None, kwargs_for_f: Incomplete | None = None, kwargs_for_profiler: Incomplete | None = None):
    """
...
def compute_utilization(filename: str, total_length: float):
    ...
    """
def benchmark_utilization(f, input, trace_folder, optimize_ctx: Incomplete | None = None, trace_file_name: str = 'tmp_chrome_trace', num_runs: int = 1):
    '''
