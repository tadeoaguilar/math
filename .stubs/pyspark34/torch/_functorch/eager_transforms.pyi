import torch
from .pytree_hacks import tree_map_ as tree_map_, treespec_pprint as treespec_pprint
from .vmap import doesnt_support_saved_tensors_hooks as doesnt_support_saved_tensors_hooks, get_chunk_sizes as get_chunk_sizes, vmap as vmap
from collections.abc import Generator
from torch._C._functorch import get_inplace_requires_grad_allowed as get_inplace_requires_grad_allowed, set_inplace_requires_grad_allowed as set_inplace_requires_grad_allowed
...
from torch.utils._pytree import tree_flatten as tree_flatten, tree_map as tree_map, tree_map_only as tree_map_only, tree_unflatten as tree_unflatten
from typing import Any, Callable, List, Tuple

argnums_t = int | Tuple[int, ...]

def enable_inplace_requires_grad(enabled: bool = True) -> Generator[None, None, None]: ...
