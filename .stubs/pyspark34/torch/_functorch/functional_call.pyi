...
def functional_call(module: torch.nn.Module, parameter_and_buffer_dicts: Dict[str, Tensor] | Sequence[Dict[str, Tensor]], args: Any | Tuple, kwargs: Dict[str, Any] = None, *, tie_weights: bool = True, strict: bool = False):
