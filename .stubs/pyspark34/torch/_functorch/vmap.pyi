from .pytree_hacks import tree_map_ as tree_map_
from _typeshed import Incomplete
from torch import Tensor as Tensor
from torch._C._functorch import is_batchedtensor as is_batchedtensor
...
def vmap(func: Callable, in_dims: in_dims_t = 0, out_dims: out_dims_t = 0, randomness: str = 'error', *, chunk_size: Incomplete | None = None) -> Callable:
    '''
...
def chunk_vmap(func: Callable, in_dims: in_dims_t = 0, out_dims: out_dims_t = 0, randomness: str = 'error', chunks: int = 2) -> Callable:
    '''
