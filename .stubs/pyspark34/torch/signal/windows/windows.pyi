...
def hamming(M: int, *, sym: bool = True, dtype: torch.dtype = None, layout: torch.layout = ..., device: torch.device = None, requires_grad: bool = False) -> Tensor: ...
def hann(M: int, *, sym: bool = True, dtype: torch.dtype = None, layout: torch.layout = ..., device: torch.device = None, requires_grad: bool = False) -> Tensor: ...
def blackman(M: int, *, sym: bool = True, dtype: torch.dtype = None, layout: torch.layout = ..., device: torch.device = None, requires_grad: bool = False) -> Tensor: ...
def bartlett(M: int, *, sym: bool = True, dtype: torch.dtype = None, layout: torch.layout = ..., device: torch.device = None, requires_grad: bool = False) -> Tensor: ...
def general_cosine(M, *, a: Iterable, sym: bool = True, dtype: torch.dtype = None, layout: torch.layout = ..., device: torch.device = None, requires_grad: bool = False) -> Tensor: ...
def general_hamming(M, *, alpha: float = 0.54, sym: bool = True, dtype: torch.dtype = None, layout: torch.layout = ..., device: torch.device = None, requires_grad: bool = False) -> Tensor: ...
