...
class Capture:
    ctx: Incomplete
    def __init__(self, schema_df: Incomplete | None = None) -> None: ...
...
class CaptureF(Capture):
    ctx: Incomplete
    kwargs: Incomplete
    def __init__(self, ctx: Incomplete | None = None, **kwargs) -> None: ...
...
class CaptureCall(Capture):
    ...
    kwargs: Incomplete
    callable: Incomplete
    def __init__(self, callable, ctx: Incomplete | None = None, **kwargs) -> None: ...
    def execute(self): ...
...
class CaptureDataFrameWithDataPipeOps(CaptureDataFrame):
    ...
    def groupby(self, group_key_fn, *, buffer_size: int = 10000, group_size: Incomplete | None = None, guaranteed_group_size: Incomplete | None = None, drop_remaining: bool = False): ...
...
class DataFrameTracer(CaptureDataFrameWithDataPipeOps, IterDataPipe):
    ...
    def __init__(self, source_datapipe, schema_df: Incomplete | None = None) -> None: ...
