...
class BatcherIterDataPipe(IterDataPipe[DataChunk]):
    ...
    def __init__(self, datapipe: IterDataPipe, batch_size: int, drop_last: bool = False, wrapper_class=...) -> None: ...
...
class GrouperIterDataPipe(IterDataPipe[DataChunk]):
    ...
    wrapper_class: Incomplete
    def __init__(self, datapipe: IterDataPipe[T_co], group_key_fn: Callable[[T_co], Any], *, keep_key: bool = False, buffer_size: int = 10000, group_size: int | None = None, guaranteed_group_size: int | None = None, drop_remaining: bool = False) -> None: ...
    def __iter__(self): ...
    def reset(self) -> None: ...
