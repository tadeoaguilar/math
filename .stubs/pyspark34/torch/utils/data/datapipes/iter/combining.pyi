...
class _ForkerIterDataPipe(IterDataPipe, _ContainerTemplate):
    ...
    leading_ptr: int
    end_ptr: Incomplete
    def __init__(self, datapipe: IterDataPipe, num_instances: int, buffer_size: int = 1000) -> None: ...
    def __len__(self) -> int: ...
    def get_next_element_by_instance(self, instance_id: int): ...
    def is_every_instance_exhausted(self) -> bool: ...
...
class DemultiplexerIterDataPipe(IterDataPipe):
    ...
    Examples:
        ...
        [1, 3]
    """
    def __new__(cls, datapipe: IterDataPipe, num_instances: int, classifier_fn: Callable[[T_co], int | None], drop_none: bool = False, buffer_size: int = 1000): ...
...
class _DemultiplexerIterDataPipe(IterDataPipe, _ContainerTemplate):
    ...
    def __init__(self, datapipe: IterDataPipe[T_co], num_instances: int, classifier_fn: Callable[[T_co], int | None], drop_none: bool, buffer_size: int) -> None: ...
    def get_next_element_by_instance(self, instance_id: int): ...
    def is_every_instance_exhausted(self) -> bool: ...
    def get_length_by_instance(self, instance_id: int) -> int: ...
    def reset(self) -> None: ...
