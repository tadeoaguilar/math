...
__all__ = ['Dataset', 'IterableDataset', 'TensorDataset', 'ConcatDataset', 'ChainDataset', 'Subset', 'random_split']
...
def random_split(dataset: Dataset[T], lengths: Sequence[int | float], generator: Generator | None = ...) -> List[Subset[T]]:
    """
