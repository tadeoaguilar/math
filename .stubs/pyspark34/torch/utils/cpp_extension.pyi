...
__all__ = ['get_default_build_root', 'check_compiler_ok_for_platform', 'get_compiler_abi_compatibility_and_version', 'BuildExtension', 'CppExtension', 'CUDAExtension', 'include_paths', 'library_paths', 'load', 'load_inline', 'is_ninja_available', 'verify_ninja_availability']
...
def library_paths(cuda: bool = False) -> List[str]:
    ...
    """
def load(name, sources: str | List[str], extra_cflags: Incomplete | None = None, extra_cuda_cflags: Incomplete | None = None, extra_ldflags: Incomplete | None = None, extra_include_paths: Incomplete | None = None, build_directory: Incomplete | None = None, verbose: bool = False, with_cuda: bool | None = None, is_python_module: bool = True, is_standalone: bool = False, keep_intermediates: bool = True):
    """
    ...
    Example:
        ...
        ...     verbose=True)
    """
def load_inline(name, cpp_sources, cuda_sources: Incomplete | None = None, functions: Incomplete | None = None, extra_cflags: Incomplete | None = None, extra_cuda_cflags: Incomplete | None = None, extra_ldflags: Incomplete | None = None, extra_include_paths: Incomplete | None = None, build_directory: Incomplete | None = None, verbose: bool = False, with_cuda: Incomplete | None = None, is_python_module: bool = True, with_pytorch_error_handling: bool = True, keep_intermediates: bool = True):
    '''
