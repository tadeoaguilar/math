...
class LeakyReLU(torch.nn.LeakyReLU):
    ...
    """
    def __init__(self, scale: float, zero_point: int, negative_slope: float = 0.01, inplace: bool = False, device: Incomplete | None = None, dtype: Incomplete | None = None) -> None: ...
    def forward(self, input): ...
    @classmethod
...
class Softmax(torch.nn.Softmax):
    ...
    scale: Incomplete
    zero_point: Incomplete
    def __init__(self, dim: Incomplete | None = None, scale: float = 1.0, zero_point: int = 0) -> None: ...
    def forward(self, input): ...
    @staticmethod
    def from_float(mod): ...
    @classmethod
