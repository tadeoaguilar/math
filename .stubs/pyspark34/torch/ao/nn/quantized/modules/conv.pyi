...
class _ConvNd(WeightedQuantizedModule):
    ...
    def __copy__(self): ...
    @classmethod
    def get_qconv(cls, mod, activation_post_process, weight_post_process: Incomplete | None = None):
...
class Conv1d(_ConvNd):
    ...
    """
    def __init__(self, in_channels: int, out_channels: int, kernel_size: _size_1_t, stride: _size_1_t = 1, padding: _size_1_t = 0, dilation: _size_1_t = 1, groups: int = 1, bias: bool = True, padding_mode: str = 'zeros', device: Incomplete | None = None, dtype: Incomplete | None = None) -> None: ...
...
class ConvTranspose1d(_ConvTransposeNd):
    ...
    Examples::
        ...
        torch.Size([1, 16, 12])
    '''
    def __init__(self, in_channels, out_channels, kernel_size, stride: int = 1, padding: int = 0, output_padding: int = 0, groups: int = 1, bias: bool = True, dilation: int = 1, padding_mode: str = 'zeros', device: Incomplete | None = None, dtype: Incomplete | None = None) -> None: ...
    def set_weight_bias(self, w: torch.Tensor, b: torch.Tensor | None) -> None: ...
    def weight(self): ...
    def bias(self): ...
    def forward(self, input): ...
