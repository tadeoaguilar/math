...
class Conv1d(nnq.Conv1d):
    ...
    """
    def __init__(self, in_channels: int, out_channels: int, kernel_size: _size_1_t, stride: _size_1_t = 1, padding: _size_1_t = 0, dilation: _size_1_t = 1, groups: int = 1, bias: bool = True, padding_mode: str = 'zeros', device: Incomplete | None = None, dtype: Incomplete | None = None, reduce_range: bool = True) -> None: ...
