...
class Conv1d(_ConvNd, nn.Conv1d):
    def __init__(self, in_channels: int, out_channels: int, kernel_size: _size_1_t, stride: _size_1_t = 1, padding: _size_1_t = 0, dilation: _size_1_t = 1, groups: int = 1, bias: bool = True, padding_mode: str = 'zeros', device: Incomplete | None = None, dtype: Incomplete | None = None, weight_qparams: Dict[str, Any] | None = None) -> None: ...
...
class Conv2d(_ConvNd, nn.Conv2d):
    def __init__(self, in_channels, out_channels, kernel_size, stride: int = 1, padding: int = 0, dilation: int = 1, groups: int = 1, bias: bool = True, padding_mode: str = 'zeros', device: Incomplete | None = None, dtype: Incomplete | None = None, weight_qparams: Dict[str, Any] | None = None) -> None: ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        """
        we have:
...
class ConvTranspose1d(_ConvTransposeNd, nn.ConvTranspose1d):
    def __init__(self, in_channels: int, out_channels: int, kernel_size: _size_1_t, stride: _size_1_t = 1, padding: _size_1_t = 0, output_padding: _size_1_t = 0, groups: int = 1, bias: bool = True, dilation: _size_1_t = 1, padding_mode: str = 'zeros', device: Incomplete | None = None, dtype: Incomplete | None = None, weight_qparams: Dict[str, Any] | None = None) -> None: ...
...
class ConvTranspose2d(_ConvTransposeNd, nn.ConvTranspose2d):
    def __init__(self, in_channels, out_channels, kernel_size, stride: int = 1, padding: int = 0, output_padding: int = 0, groups: int = 1, bias: bool = True, dilation: int = 1, padding_mode: str = 'zeros', device: Incomplete | None = None, dtype: Incomplete | None = None, weight_qparams: Dict[str, Any] | None = None) -> None: ...
    def forward(self, x: torch.Tensor, output_size: List[int] | None = None) -> torch.Tensor:
        """
        we have:
