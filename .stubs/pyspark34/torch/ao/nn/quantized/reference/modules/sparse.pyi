...
class Embedding(nn.Embedding, ReferenceQuantizedModule):
    ...
    embedding operator.
    """
    def __init__(self, num_embeddings: int, embedding_dim: int, padding_idx: int | None = None, max_norm: float | None = None, norm_type: float = 2.0, scale_grad_by_freq: bool = False, sparse: bool = False, _weight: Tensor | None = None, device: Incomplete | None = None, dtype: Incomplete | None = None, weight_qparams: Dict[str, Any] | None = None) -> None: ...
