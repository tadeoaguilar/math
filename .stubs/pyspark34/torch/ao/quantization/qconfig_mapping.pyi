...
class QConfigMapping:
    ...
    '''
    global_qconfig: Incomplete
    object_type_qconfigs: Incomplete
    module_name_regex_qconfigs: Incomplete
    module_name_qconfigs: Incomplete
    module_name_object_type_order_qconfigs: Incomplete
