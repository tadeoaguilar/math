...
def fuse_known_modules(mod_list, is_qat, additional_fuser_method_mapping: Incomplete | None = None):
    ...
    """
def fuse_modules(model, modules_to_fuse, inplace: bool = False, fuser_func=..., fuse_custom_config_dict: Incomplete | None = None):
    ...
    '''
def fuse_modules_qat(model, modules_to_fuse, inplace: bool = False, fuser_func=..., fuse_custom_config_dict: Incomplete | None = None):
