...
def get_default_custom_config_dict():
    ...
    """
def propagate_qconfig_(module, qconfig_dict: Incomplete | None = None, prepare_custom_config_dict: Incomplete | None = None) -> None:
...
def add_quant_dequant(module):
    ...
    """
def prepare(model, inplace: bool = False, allow_list: Incomplete | None = None, observer_non_leaf_module_list: Incomplete | None = None, prepare_custom_config_dict: Incomplete | None = None):
    ...
    '''
def quantize(model, run_fn, run_args, mapping: Incomplete | None = None, inplace: bool = False):
    ...
    Return:
        Quantized model.
    """
def quantize_dynamic(model, qconfig_spec: Incomplete | None = None, dtype=..., mapping: Incomplete | None = None, inplace: bool = False):
    ...
    """
def prepare_qat(model, mapping: Incomplete | None = None, inplace: bool = False):
    """
...
def quantize_qat(model, run_fn, run_args, inplace: bool = False):
    ...
    Return:
        Quantized model.
    """
def convert(module, mapping: Incomplete | None = None, inplace: bool = False, remove_qconfig: bool = True, is_reference: bool = False, convert_custom_config_dict: Incomplete | None = None):
