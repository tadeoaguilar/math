...
class DTypeWithConstraints:
    ...
    * `scale_exact_match` and `zero_point_exact_match`: Exact match requirements
    ...
    def __init__(self, dtype, quant_min_lower_bound, quant_max_upper_bound, scale_min_lower_bound, scale_max_upper_bound, scale_exact_match, zero_point_exact_match) -> None: ...
...
class BackendPatternConfig:
    ...
    dtype_configs: Incomplete
    root_module: Incomplete
    qat_module: Incomplete
    reference_quantized_module: Incomplete
    fused_module: Incomplete
    fuser_method: Incomplete
