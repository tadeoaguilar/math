...
class StandaloneModuleConfigEntry:
    ...
    def __init__(self, qconfig_mapping, example_inputs, prepare_custom_config, backend_config) -> None: ...
...
class PrepareCustomConfig:
    ...
    '''
    standalone_module_names: Incomplete
    standalone_module_classes: Incomplete
    float_to_observed_mapping: Incomplete
    non_traceable_module_names: Incomplete
    non_traceable_module_classes: Incomplete
    input_quantized_indexes: Incomplete
    output_quantized_indexes: Incomplete
    preserved_attributes: Incomplete
...
class ConvertCustomConfig:
    ...
    '''
    observed_to_quantized_mapping: Incomplete
    preserved_attributes: Incomplete
    def __init__(self) -> None: ...
