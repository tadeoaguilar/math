...
from .fx import fuse as fuse, prepare as prepare
...
def attach_preserved_attrs_to_model(model: GraphModule | torch.nn.Module, preserved_attrs: Dict[str, Any]):
...
def prepare_qat_fx(model: torch.nn.Module, qconfig_mapping: QConfigMapping | Dict[str, Any], example_inputs: Tuple[Any, ...], prepare_custom_config: PrepareCustomConfig | Dict[str, Any] | None = None, backend_config: BackendConfig | Dict[str, Any] | None = None) -> GraphModule:
    ...
    '''
def convert_fx(graph_module: GraphModule, convert_custom_config: ConvertCustomConfig | Dict[str, Any] | None = None, _remove_qconfig: bool = True, qconfig_mapping: QConfigMapping | Dict[str, Any] | None = None, backend_config: BackendConfig | Dict[str, Any] | None = None) -> torch.nn.Module:
    ...
    '''
def convert_to_reference_fx(graph_module: GraphModule, convert_custom_config: ConvertCustomConfig | Dict[str, Any] | None = None, _remove_qconfig: bool = True, qconfig_mapping: QConfigMapping | Dict[str, Any] | None = None, backend_config: BackendConfig | Dict[str, Any] | None = None) -> torch.nn.Module:
