...
def get_matching_activations(float_module: nn.Module, q_module: nn.Module) -> Dict[str, Dict[str, torch.Tensor]]:
    ...
    """
def prepare_model_outputs(float_module: nn.Module, q_module: nn.Module, logger_cls=..., allow_list: Incomplete | None = None) -> None:
    ...
    """
def compare_model_outputs(float_model: nn.Module, q_model: nn.Module, *data, logger_cls=..., allow_list: Incomplete | None = None) -> Dict[str, Dict[str, torch.Tensor]]:
