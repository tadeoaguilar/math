from .downloaders import DOIDownloader as DOIDownloader, choose_downloader as choose_downloader, doi_to_repository as doi_to_repository
from .hashes import file_hash as file_hash, hash_matches as hash_matches
from .utils import cache_location as cache_location, check_version as check_version, get_logger as get_logger, make_local_storage as make_local_storage, os_cache as os_cache, temporary_file as temporary_file, unique_file_name as unique_file_name
from _typeshed import Incomplete

def retrieve(url, known_hash, fname: Incomplete | None = None, path: Incomplete | None = None, processor: Incomplete | None = None, downloader: Incomplete | None = None, progressbar: bool = False):
    '''
    ...
    *known_hash*. If they are not the same, this is interpreted as the file
    ...
    '''
def create(path, base_url, version: Incomplete | None = None, version_dev: str = 'master', env: Incomplete | None = None, registry: Incomplete | None = None, urls: Incomplete | None = None, retry_if_failed: int = 0, allow_updates: bool = True):
    '''
...
class Pooch:
    ...
    registry: Incomplete
    urls: Incomplete
    retry_if_failed: Incomplete
    allow_updates: Incomplete
    def __init__(self, path, base_url, registry: Incomplete | None = None, urls: Incomplete | None = None, retry_if_failed: int = 0, allow_updates: bool = True) -> None: ...
    @property
    def abspath(self):
    ...
    def fetch(self, fname, processor: Incomplete | None = None, downloader: Incomplete | None = None, progressbar: bool = False):
        """
    ...
    def get_url(self, fname):
        ...
        """
    def load_registry(self, fname) -> None:
        '''
    ...
    def load_registry_from_doi(self):
        ...
        .. important::
            ...
            a DOI.
        """
    def is_available(self, fname, downloader: Incomplete | None = None):
        """
...
def download_action(path, known_hash):
    ...
    """
def stream_download(url, fname, known_hash, downloader, pooch: Incomplete | None = None, retry_if_failed: int = 0) -> None:
    """
