...
class PythonAPI:
    ...
    def err_push(self, keep_new: bool = False) -> Generator[None, None, None]:
        """
    ...
    def set_iterate(self, set) -> Generator[Incomplete, None, None]: ...
    def gil_ensure(self):
        """
    ...
    def alloca_buffer(self):
        ...
        """
    def if_object_ok(self, obj) -> Generator[None, None, None]: ...
