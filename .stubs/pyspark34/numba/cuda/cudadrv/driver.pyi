...
from numba.cuda.cudadrv import drvapi as drvapi, enums as enums
...
class HostOnlyCUDAMemoryManager(BaseCUDAMemoryManager, metaclass=abc.ABCMeta):
    ...
    def defer_cleanup(self) -> Generator[None, None, None]:
...
class Stream:
    ...
    def synchronize(self) -> None:
        ...
        """
    def auto_synchronize(self) -> Generator[Incomplete, None, None]:
        """
...
class CtypesLinker(Linker):
    ...
    def add_cu(self, path, name) -> None: ...
    def complete(self): ...
...
def profile_stop() -> None:
    ...
    """
def profiling() -> Generator[None, None, None]:
    """
