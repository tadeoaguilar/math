...
class OrthoForestDMLModel(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaModel):
    ...
    def __init__(self, java_obj: Incomplete | None = None, confidenceLevel: float = 0.975, confounderVecCol: str = 'XW', featuresCol: Incomplete | None = None, forest: Incomplete | None = None, heterogeneityVecCol: str = 'X', maxDepth: int = 5, maxIter: int = 1, minSamplesLeaf: int = 10, numTrees: int = 20, outcomeCol: Incomplete | None = None, outcomeModel: Incomplete | None = None, outcomeResidualCol: str = 'OutcomeResidual', outputCol: str = 'EffectAverage', outputHighCol: str = 'EffectUpperBound', outputLowCol: str = 'EffectLowerBound', parallelism: int = 10, sampleSplitRatio=[0.5, 0.5], treatmentCol: Incomplete | None = None, treatmentModel: Incomplete | None = None, treatmentResidualCol: str = 'TreatmentResidual', weightCol: Incomplete | None = None) -> None: ...
    def setParams(self, confidenceLevel: float = 0.975, confounderVecCol: str = 'XW', featuresCol: Incomplete | None = None, forest: Incomplete | None = None, heterogeneityVecCol: str = 'X', maxDepth: int = 5, maxIter: int = 1, minSamplesLeaf: int = 10, numTrees: int = 20, outcomeCol: Incomplete | None = None, outcomeModel: Incomplete | None = None, outcomeResidualCol: str = 'OutcomeResidual', outputCol: str = 'EffectAverage', outputHighCol: str = 'EffectUpperBound', outputLowCol: str = 'EffectLowerBound', parallelism: int = 10, sampleSplitRatio=[0.5, 0.5], treatmentCol: Incomplete | None = None, treatmentModel: Incomplete | None = None, treatmentResidualCol: str = 'TreatmentResidual', weightCol: Incomplete | None = None):
        """
