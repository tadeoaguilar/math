from . import constants as constants, normalization as normalization, types as types
...
def name_to_hex(name: str, spec: str = ...) -> str:
    ...
    '''
def name_to_rgb(name: str, spec: str = ...) -> types.IntegerRGB:
    '''
    ...
    '''
def name_to_rgb_percent(name: str, spec: str = ...) -> types.PercentRGB:
    '''
...
def hex_to_rgb_percent(hex_value: str) -> types.PercentRGB:
    ...
    '''
def rgb_to_name(rgb_triplet: types.IntTuple, spec: str = ...) -> str:
    '''
...
def rgb_to_rgb_percent(rgb_triplet: types.IntTuple) -> types.PercentRGB:
    ...
    '''
def rgb_percent_to_name(rgb_percent_triplet: types.PercentTuple, spec: str = ...) -> str:
    '''
