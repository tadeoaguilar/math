...
from optuna.visualization._plotly_imports import Contour as Contour, Scatter as Scatter, go as go, make_subplots as make_subplots, plotly as plotly
from typing import Callable, List

def plot_contour(study: Study, params: List[str] | None = None, *, target: Callable[[FrozenTrial], float] | None = None, target_name: str = 'Objective Value') -> go.Figure:
