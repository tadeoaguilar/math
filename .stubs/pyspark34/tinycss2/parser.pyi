from .ast import AtRule as AtRule, Declaration as Declaration, ParseError as ParseError, QualifiedRule as QualifiedRule
from .tokenizer import parse_component_value_list as parse_component_value_list

def parse_one_component_value(input, skip_comments: bool = False):
    ...
    """
def parse_one_declaration(input, skip_comments: bool = False):
    ...
    """
def parse_declaration_list(input, skip_comments: bool = False, skip_whitespace: bool = False):
    ...
    """
def parse_one_rule(input, skip_comments: bool = False):
    ...
    """
def parse_rule_list(input, skip_comments: bool = False, skip_whitespace: bool = False):
    ...
    """
def parse_stylesheet(input, skip_comments: bool = False, skip_whitespace: bool = False):
