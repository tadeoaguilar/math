...
def decode_stylesheet_bytes(css_bytes, protocol_encoding: Incomplete | None = None, environment_encoding: Incomplete | None = None):
    ...
    """
def parse_stylesheet_bytes(css_bytes, protocol_encoding: Incomplete | None = None, environment_encoding: Incomplete | None = None, skip_comments: bool = False, skip_whitespace: bool = False):
