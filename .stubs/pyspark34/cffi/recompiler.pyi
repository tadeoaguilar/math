...
def recompile(ffi, module_name, preamble, tmpdir: str = '.', call_c_compiler: bool = True, c_file: Incomplete | None = None, source_extension: str = '.c', extradir: Incomplete | None = None, compiler_verbose: int = 1, target: Incomplete | None = None, debug: Incomplete | None = None, **kwds): ...
