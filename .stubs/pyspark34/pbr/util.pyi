...
from pbr import extra_files as extra_files

CFG_TO_PY_SETUP_ARGS: Incomplete
MULTI_FIELDS: Incomplete
MAP_FIELDS: Incomplete
BOOL_FIELDS: Incomplete
CSV_FIELDS: Incomplete
...
def resolve_name(name):
    ...
    """
def cfg_to_args(path: str = 'setup.cfg', script_args=()):
...
def setup_cfg_to_setup_kwargs(config, script_args=()):
    ...
    """
def register_custom_compilers(config) -> None:
