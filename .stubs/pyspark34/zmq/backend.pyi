...
class Frame:
    ...
    more: bool
    tracker: Any
    def __init__(self, data: Any = None, track: bool = False, copy: bool | None = None, copy_threshold: int | None = None) -> None: ...
    def copy_fast(self) -> T: ...
...
class Socket:
    ...
    copy_threshold: int
    FD: int
    def __init__(self, context: Context | None = None, socket_type: int = 0, shadow: int = 0, copy_threshold: int | None = ...) -> None: ...
    ...
    def send(self, data: Any, flags: int = ..., copy: bool = ..., track: bool = ...) -> zmq.MessageTracker | None: ...
    @overload
    def recv(self, flags: int = ..., *, copy: Literal[False], track: bool = ...) -> zmq.Frame: ...
    @overload
    def recv(self, flags: int = ..., *, copy: Literal[True], track: bool = ...) -> bytes: ...
    @overload
    def recv(self, flags: int = ..., track: bool = False) -> bytes: ...
    @overload
    def recv(self, flags: int | None = ..., copy: bool = ..., track: bool | None = False) -> zmq.Frame | bytes: ...
...
def zmq_poll(sockets: List[Any], timeout: int | None = ...) -> List[Tuple[Socket, int]]: ...
...
def proxy_steerable(frontend: Socket, backend: Socket, capture: Socket | None = ..., control: Socket | None = ...) -> int: ...
