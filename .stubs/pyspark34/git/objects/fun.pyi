...
EntryTupOrNone = EntryTup | None

def tree_to_stream(entries: Sequence[EntryTup], write: Callable[[ReadableBuffer], int | None]) -> None:
...
def traverse_trees_recursive(odb: GitCmdObjectDB, tree_shas: Sequence[bytes | None], path_prefix: str) -> List[Tuple[EntryTupOrNone, ...]]:
    """
