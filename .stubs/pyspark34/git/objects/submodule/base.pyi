...
class Submodule(IndexObject, TraversableIterableObj):
    ...
    size: int
    def __init__(self, repo: Repo, binsha: bytes, mode: int | None = None, path: PathLike | None = None, name: str | None = None, parent_commit: Commit_ish | None = None, url: str | None = None, branch_path: PathLike | None = None) -> None:
    ...
    @classmethod
    def add(cls, repo: Repo, name: str, path: PathLike, url: str | None = None, branch: str | None = None, no_checkout: bool = False, depth: int | None = None, env: Mapping[str, str] | None = None, clone_multi_options: Sequence[TBD] | None = None, allow_unsafe_options: bool = False, allow_unsafe_protocols: bool = False) -> Submodule:
    ...
    def update(self, recursive: bool = False, init: bool = True, to_latest_revision: bool = False, progress: UpdateProgress | None = None, dry_run: bool = False, force: bool = False, keep_going: bool = False, env: Mapping[str, str] | None = None, clone_multi_options: Sequence[TBD] | None = None, allow_unsafe_options: bool = False, allow_unsafe_protocols: bool = False) -> Submodule:
    ...
    def move(self, module_path: PathLike, configuration: bool = True, module: bool = True) -> Submodule:
        ...
        """
    def remove(self, module: bool = True, force: bool = False, configuration: bool = True, dry_run: bool = False) -> Submodule:
    ...
    binsha: Incomplete
    def set_parent_commit(self, commit: Commit_ish | None, check: bool = True) -> Submodule:
        ...
        :return: self"""
    def config_writer(self, index: IndexFile | None = None, write: bool = True) -> SectionConstraint['SubmoduleConfigParser']:
    ...
    @classmethod
    def iter_items(cls, repo: Repo, parent_commit: Commit_ish | str = 'HEAD', *Args: Any, **kwargs: Any) -> Iterator['Submodule']:
