...
from git.types import CallableProgress, Commit_ish, ConfigLevels_Tup, Lit_config_levels, PathLike, TBD, Tree_ish
from git.util import IterableList
from gitdb.db.loose import LooseObjectDB
from typing import Any, BinaryIO, Dict, Iterator, List, Mapping, NamedTuple, Sequence, TextIO, Type
...
class Repo:
    ...
    odb: Incomplete
    def __init__(self, path: PathLike | None = None, odbt: Type[LooseObjectDB] = ..., search_parent_directories: bool = False, expand_vars: bool = True) -> None:
    ...
    def create_head(self, path: PathLike, commit: SymbolicReference | str = 'HEAD', force: bool = False, logmsg: str | None = None) -> Head:
    ...
    def create_tag(self, path: PathLike, ref: str | SymbolicReference = 'HEAD', message: str | None = None, force: bool = False, **kwargs: Any) -> TagReference:
    ...
    def iter_commits(self, rev: str | Commit | SymbolicReference | None = None, paths: PathLike | Sequence[PathLike] = '', **kwargs: Any) -> Iterator[Commit]:
    ...
    def is_dirty(self, index: bool = True, working_tree: bool = True, untracked_files: bool = False, submodules: bool = True, path: PathLike | None = None) -> bool:
        """
        :return:
    ...
    def blame_incremental(self, rev: str | HEAD, file: str, **kwargs: Any) -> Iterator['BlameEntry']:
        ...
        """
    def blame(self, rev: str | HEAD, file: str, incremental: bool = False, rev_opts: List[str] | None = None, **kwargs: Any) -> List[List[Commit | List[str | bytes] | None]] | Iterator[BlameEntry] | None:
        ...
        :return:
            ...
            of appearance."""
    @classmethod
    def init(cls, path: PathLike | None = None, mkdir: bool = True, odbt: Type[GitCmdObjectDB] = ..., expand_vars: bool = True, **kwargs: Any) -> Repo:
    ...
    def clone(self, path: PathLike, progress: CallableProgress | None = None, multi_options: List[str] | None = None, allow_unsafe_protocols: bool = False, allow_unsafe_options: bool = False, **kwargs: Any) -> Repo:
    ...
    @classmethod
    def clone_from(cls, url: PathLike, to_path: PathLike, progress: CallableProgress = None, env: Mapping[str, str] | None = None, multi_options: List[str] | None = None, allow_unsafe_protocols: bool = False, allow_unsafe_options: bool = False, **kwargs: Any) -> Repo:
    ...
    def archive(self, ostream: TextIO | BinaryIO, treeish: str | None = None, prefix: str | None = None, **kwargs: Any) -> Repo:
