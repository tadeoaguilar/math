...
def is_git_dir(d: PathLike) -> bool:
    ...
    @throws WorkTreeRepositoryUnsupported if it sees a worktree directory. It's quite hacky to do that here,
            ...
            but are none."""
def find_worktree_git_dir(dotgit: PathLike) -> str | None:
    """Search for a gitdir for this worktree."""
def find_submodule_git_dir(d: PathLike) -> PathLike | None:
    """Search for a submodule repo."""
def short_to_long(odb: GitCmdObjectDB, hexsha: str) -> bytes | None:
    """:return: long hexadecimal sha1 from the given less-than-40 byte hexsha
        or None if no candidate could be found.
    :param hexsha: hexsha with less than 40 byte"""
def name_to_object(repo: Repo, name: str, return_ref: bool = False) -> SymbolicReference | Commit | TagObject | Blob | Tree:
    """
...
def to_commit(obj: Object) -> Commit | TagObject:
    """Convert the given object to a commit if possible and return it"""
def rev_parse(repo: Repo, rev: str) -> Commit | Tag | Tree | Blob:
    """
