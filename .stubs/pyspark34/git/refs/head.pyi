...
class HEAD(SymbolicReference):
    ...
    def reset(self, commit: Commit_ish | SymbolicReference | str = 'HEAD', index: bool = True, working_tree: bool = False, paths: PathLike | Sequence[PathLike] | None = None, **kwargs: Any) -> HEAD:
...
class Head(Reference):
    ...
    @classmethod
    def delete(cls, repo: Repo, *heads: Head | str, force: bool = False, **kwargs: Any) -> None:
        ...
        :param force:
            ...
            Default False"""
    def set_tracking_branch(self, remote_reference: RemoteReference | None) -> Head:
        """
    ...
    def checkout(self, force: bool = False, **kwargs: Any) -> HEAD | Head:
