...
class RefLog(List[RefLogEntry], Serializable):
    ...
    def __new__(cls, filepath: PathLike | None = None) -> RefLog: ...
    ...
    @classmethod
    def iter_entries(cls, stream: str | BytesIO | mmap) -> Iterator[RefLogEntry]:
        """
    ...
    @classmethod
    def append_entry(cls, config_reader: Actor | GitConfigParser | SectionConstraint | None, filepath: PathLike, oldbinsha: bytes, newbinsha: bytes, message: str, write: bool = True) -> RefLogEntry:
