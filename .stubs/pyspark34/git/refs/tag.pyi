...
class TagReference(Reference):
    ...
    @classmethod
    def create(cls, repo: Repo, path: PathLike, reference: str | SymbolicReference = 'HEAD', logmsg: str | None = None, force: bool = False, **kwargs: Any) -> TagReference:
