...
from typing import Dict, IO, List, Sequence, Tuple, Type
...
def stat_mode_to_index_mode(mode: int) -> int:
    ...
    and return it"""
def write_cache(entries: Sequence[BaseIndexEntry | IndexEntry], stream: IO[bytes], extension_data: None | bytes = None, ShaStreamCls: Type[IndexFileSHA1Writer] = ...) -> None:
...
def entry_key(*entry: BaseIndexEntry | PathLike | int) -> Tuple[PathLike, int]:
