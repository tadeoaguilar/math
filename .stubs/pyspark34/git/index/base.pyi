...
from .typ import BaseIndexEntry, StageType as StageType
...
class IndexFile(LazyMixin, git_diff.Diffable, Serializable):
    ...
    repo: Incomplete
    version: Incomplete
    def __init__(self, repo: Repo, file_path: PathLike | None = None) -> None:
    ...
    def write(self, file_path: None | PathLike = None, ignore_extension_data: bool = False) -> None:
    ...
    def merge_tree(self, rhs: Treeish, base: None | Treeish = None) -> IndexFile:
    ...
    @classmethod
    def new(cls, repo: Repo, *tree_sha: str | Tree) -> IndexFile:
    ...
    def from_tree(cls, repo: Repo, *treeish: Treeish, **kwargs: Any) -> IndexFile:
        ...
        :note:
            ...
            interferences."""
    def iter_blobs(self, predicate: Callable[[Tuple[StageType, Blob]], bool] = ...) -> Iterator[Tuple[StageType, Blob]]:
        """
    ...
    def unmerged_blobs(self) -> Dict[PathLike, List[Tuple[StageType, Blob]]]:
        ...
        """
    @classmethod
    def entry_key(cls, *entry: BaseIndexEntry | PathLike | StageType) -> Tuple[PathLike, StageType]: ...
    ...
    def add(self, items: Sequence[PathLike | Blob | BaseIndexEntry | Submodule], force: bool = True, fprogress: Callable = ..., path_rewriter: Callable[..., PathLike] | None = None, write: bool = True, write_extension_data: bool = False) -> List[BaseIndexEntry]:
        ...
        :raise OSError:
            ...
            do not exist.
        """
    def remove(self, items: Sequence[PathLike | Blob | BaseIndexEntry | Submodule], working_tree: bool = False, **kwargs: Any) -> List[str]:
    ...
    def move(self, items: Sequence[PathLike | Blob | BaseIndexEntry | Submodule], skip_errors: bool = False, **kwargs: Any) -> List[Tuple[str, str]]:
    ...
    def commit(self, message: str, parent_commits: Commit_ish | None = None, head: bool = True, author: None | Actor = None, committer: None | Actor = None, author_date: datetime.datetime | str | None = None, commit_date: datetime.datetime | str | None = None, skip_hooks: bool = False) -> Commit:
    ...
    def checkout(self, paths: None | Iterable[PathLike] = None, force: bool = False, fprogress: Callable = ..., **kwargs: Any) -> None | Iterator[PathLike] | Sequence[PathLike]:
        ...
        """
    entries: Incomplete
    def reset(self, commit: Commit | Reference | str = 'HEAD', working_tree: bool = False, paths: None | Iterable[PathLike] = None, head: bool = False, **kwargs: Any) -> IndexFile:
        ...
        :return: self"""
    def diff(self, other: Type['git_diff.Diffable.Index'] | Tree | Commit | str | None = ..., paths: PathLike | List[PathLike] | Tuple[PathLike, ...] | None = None, create_patch: bool = False, **kwargs: Any) -> git_diff.DiffIndex:
