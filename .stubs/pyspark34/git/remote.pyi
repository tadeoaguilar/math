...
from git.util import IterableList, IterableObj, LazyMixin, RemoteProgress as RemoteProgress
from typing import Any, Callable, Iterator, List, NoReturn, overload
...
class PushInfo(IterableObj):
    ...
    summary: Incomplete
    def __init__(self, flags: int, local_ref: SymbolicReference | None, remote_ref_string: str, remote: Remote, old_commit: str | None = None, summary: str = '') -> None:
        """Initialize a new instance
        local_ref: HEAD | Head | RemoteReference | TagReference | Reference | SymbolicReference | None"""
    @property
    def old_commit(self) -> str | SymbolicReference | Commit_ish | None: ...
    @property
    def remote_ref(self) -> RemoteReference | TagReference:
        """
        :return:
...
class FetchInfo(IterableObj):
    ...
    def __init__(self, ref: SymbolicReference, flags: int, note: str = '', old_commit: Commit_ish | None = None, remote_ref_path: PathLike | None = None) -> None:
        """
        Initialize a new instance
        """
    @property
...
class Remote(LazyMixin, IterableObj):
    ...
    def set_url(self, new_url: str, old_url: str | None = None, allow_unsafe_protocols: bool = False, **kwargs: Any) -> Remote:
    ...
    def update(self, **kwargs: Any) -> Remote:
        ...
        :return: self"""
    def fetch(self, refspec: str | List[str] | None = None, progress: RemoteProgress | None | UpdateProgress = None, verbose: bool = True, kill_after_timeout: None | float = None, allow_unsafe_protocols: bool = False, allow_unsafe_options: bool = False, **kwargs: Any) -> IterableList[FetchInfo]:
    ...
    def pull(self, refspec: str | List[str] | None = None, progress: RemoteProgress | UpdateProgress | None = None, kill_after_timeout: None | float = None, allow_unsafe_protocols: bool = False, allow_unsafe_options: bool = False, **kwargs: Any) -> IterableList[FetchInfo]:
    ...
    def push(self, refspec: str | List[str] | None = None, progress: RemoteProgress | UpdateProgress | Callable[..., RemoteProgress] | None = None, kill_after_timeout: None | float = None, allow_unsafe_protocols: bool = False, allow_unsafe_options: bool = False, **kwargs: Any) -> PushInfoList:
