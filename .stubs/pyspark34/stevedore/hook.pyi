...
class HookManager(NamedExtensionManager):
    ...
    """
    def __init__(self, namespace, name, invoke_on_load: bool = False, invoke_args=(), invoke_kwds={}, on_load_failure_callback: Incomplete | None = None, verify_requirements: bool = False, on_missing_entrypoints_callback: Incomplete | None = None, warn_on_missing_entrypoint: bool = False) -> None: ...
