...
class BllipParser(ParserI):
    ...
    """
    rrp: Incomplete
    def __init__(self, parser_model: Incomplete | None = None, reranker_features: Incomplete | None = None, reranker_weights: Incomplete | None = None, parser_options: Incomplete | None = None, reranker_options: Incomplete | None = None) -> None:
        """
        ...
        """
    def parse(self, sentence) -> Generator[Incomplete, None, None]:
        """
        ...
        :rtype: iter(Tree)
        """
    def tagged_parse(self, word_and_tag_pairs) -> Generator[Incomplete, None, None]:
        """
        ...
        """
    @classmethod
    def from_unified_model_dir(cls, model_dir, parser_options: Incomplete | None = None, reranker_options: Incomplete | None = None):
        """
