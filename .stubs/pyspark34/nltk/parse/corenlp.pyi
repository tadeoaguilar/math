...
from nltk.internals import config_java as config_java, find_jar_iter as find_jar_iter, java as java
...
class CoreNLPServer:
    ...
    def __init__(self, path_to_jar: Incomplete | None = None, path_to_models_jar: Incomplete | None = None, verbose: bool = False, java_options: Incomplete | None = None, corenlp_options: Incomplete | None = None, port: Incomplete | None = None) -> None: ...
    popen: Incomplete
    def start(self, stdout: str = 'devnull', stderr: str = 'devnull') -> None:
...
class GenericCoreNLPParser(ParserI, TokenizerI, TaggerI):
    ...
    session: Incomplete
    def __init__(self, url: str = 'http://localhost:9000', encoding: str = 'utf8', tagtype: Incomplete | None = None, strict_json: bool = True) -> None: ...
    def parse_sents(self, sentences, *args, **kwargs):
        ...
        """
    def raw_parse(self, sentence, properties: Incomplete | None = None, *args, **kwargs):
        """Parse a sentence.
        ...
        :rtype: iter(Tree)
        """
    def api_call(self, data, properties: Incomplete | None = None, timeout: int = 60): ...
    def raw_parse_sents(self, sentences, verbose: bool = False, properties: Incomplete | None = None, *args, **kwargs) -> Generator[Incomplete, None, None]:
        """Parse multiple sentences.
        ...
        """
    def parse_text(self, text, *args, **kwargs) -> Generator[Incomplete, None, None]:
        ...
        """
    def tokenize(self, text, properties: Incomplete | None = None) -> Generator[Incomplete, None, None]:
    ...
    def tag(self, sentence: str) -> List[Tuple[str, str]]:
        ...
        >>> server.stop()
        '''
    def raw_tag_sents(self, sentences) -> Generator[Incomplete, None, None]:
        """
        Tag multiple sentences.
...
def transform(sentence) -> Generator[Incomplete, None, None]: ...
