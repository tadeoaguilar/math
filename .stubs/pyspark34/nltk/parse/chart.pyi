...
from nltk.grammar import PCFG as PCFG, is_nonterminal as is_nonterminal, is_terminal as is_terminal
...
class TreeEdge(EdgeI):
    ...
    """
    def __init__(self, span, lhs, rhs, dot: int = 0) -> None:
        """
...
class Chart:
    ...
    def insert(self, edge, *child_pointer_lists):
        ...
        :rtype: bool
        """
    def parses(self, root, tree_class=...) -> Generator[Incomplete, Incomplete, None]:
        """
        Return an iterator of the complete tree structures that span
        the entire chart, and whose root node is ``root``.
        """
    def trees(self, edge, tree_class=..., complete: bool = False):
        """
    ...
    def child_pointer_lists(self, edge):
        ...
        """
    def pretty_format_edge(self, edge, width: Incomplete | None = None):
        """
        ...
        """
    def pretty_format_leaves(self, width: Incomplete | None = None):
        """
        Return a pretty-printed string representation of this
        chart's leaves.  This string can be used as a header
        for calls to ``pretty_format_edge``.
        """
    def pretty_format(self, width: Incomplete | None = None):
        """
...
class ChartRuleI:
    ...
    :cvar NUM_EDGES: The number of existing edges that this rule uses
        ...
        to two.
    """
    def apply(self, chart, grammar, *edges) -> None:
        """
        ...
        :rtype: iter(EdgeI)
        """
    def apply_everywhere(self, chart, grammar) -> None:
        """
...
class AbstractChartRule(ChartRuleI):
    ...
    """
    def apply(self, chart, grammar, *edges) -> None: ...
    def apply_everywhere(self, chart, grammar) -> Generator[Incomplete, Incomplete, None]: ...
...
class ChartParser(ParserI):
    ...
    '''
    def __init__(self, grammar, strategy=..., trace: int = 0, trace_chart_width: int = 50, use_agenda: bool = True, chart_class=...) -> None:
        """
...
class SteppingChartParser(ChartParser):
    ...
    """
    def __init__(self, grammar, strategy=[], trace: int = 0) -> None: ...
...
def demo_grammar(): ...
def demo(choice: Incomplete | None = None, print_times: bool = True, print_grammar: bool = False, print_trees: bool = True, trace: int = 2, sent: str = 'I saw John with a dog with my cookie', numparses: int = 5):
    """
