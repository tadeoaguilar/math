...
from nltk.grammar import DependencyGrammar as DependencyGrammar, DependencyProduction as DependencyProduction, ProbabilisticDependencyGrammar as ProbabilisticDependencyGrammar
...
class ProjectiveDependencyParser:
    ...
    def __init__(self, dependency_grammar) -> None:
        ...
        """
    def parse(self, tokens) -> Generator[Incomplete, None, None]:
        """
