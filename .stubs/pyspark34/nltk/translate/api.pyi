...
class AlignedSent:
    ...
    def __init__(self, words, mots, alignment: Incomplete | None = None) -> None: ...
    @property
    def words(self): ...
    @property
    def mots(self): ...
...
class Alignment(frozenset):
    ...
    def invert(self):
        ...
        """
    def range(self, positions: Incomplete | None = None):
        """
...
class PhraseTableEntry(NamedTuple):
