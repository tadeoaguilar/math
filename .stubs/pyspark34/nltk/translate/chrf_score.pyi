...
def sentence_chrf(reference, hypothesis, min_len: int = 1, max_len: int = 6, beta: float = 3.0, ignore_whitespace: bool = True):
    '''
    ...
    :rtype: float
    '''
def chrf_precision_recall_fscore_support(reference, hypothesis, n, beta: float = 3.0, epsilon: float = 1e-16):
    """
    ...
    :rtype: tuple(float)
    """
def corpus_chrf(references, hypotheses, min_len: int = 1, max_len: int = 6, beta: float = 3.0, ignore_whitespace: bool = True):
    """
