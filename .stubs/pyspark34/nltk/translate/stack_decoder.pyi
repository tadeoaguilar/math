...
class _Hypothesis:
    ...
    """
    raw_score: Incomplete
    src_phrase_span: Incomplete
    trg_phrase: Incomplete
    previous: Incomplete
    future_score: Incomplete
    def __init__(self, raw_score: float = 0.0, src_phrase_span=(), trg_phrase=(), previous: Incomplete | None = None, future_score: float = 0.0) -> None:
        """
...
class _Stack:
    ...
    max_size: Incomplete
    items: Incomplete
    def __init__(self, max_size: int = 100, beam_threshold: float = 0.0) -> None:
        """
