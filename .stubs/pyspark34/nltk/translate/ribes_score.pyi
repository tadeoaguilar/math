...
from nltk.util import choose as choose, ngrams as ngrams

def sentence_ribes(references, hypothesis, alpha: float = 0.25, beta: float = 0.1):
    '''
    ...
    :rtype: float
    '''
def corpus_ribes(list_of_references, hypotheses, alpha: float = 0.25, beta: float = 0.1):
    '''
...
def position_of_ngram(ngram, sentence):
    ...
    """
def word_rank_alignment(reference, hypothesis, character_based: bool = False):
    """
    ...
    :type hypothesis: list(str)
    """
def find_increasing_sequences(worder) -> Generator[Incomplete, None, None]:
    """
    ...
    :param type: list(int)
    """
def kendall_tau(worder, normalize: bool = True):
    """
    ...
    :rtype: float
    """
def spearman_rho(worder, normalize: bool = True):
    """
