from nltk.util import everygrams as everygrams, ngrams as ngrams

def sentence_gleu(references, hypothesis, min_len: int = 1, max_len: int = 4):
    '''
    ...
    :rtype: float
    '''
def corpus_gleu(list_of_references, hypotheses, min_len: int = 1, max_len: int = 4):
    '''
