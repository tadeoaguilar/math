...
class MultiListbox(Frame):
    ...
    def __init__(self, master, columns, column_weights: Incomplete | None = None, cnf={}, **kw) -> None:
        '''
    ...
    def listboxes(self):
        ...
        """
    def select(self, index: Incomplete | None = None, delta: Incomplete | None = None, see: bool = True) -> None:
        """
    ...
    def columnconfigure(self, col_index, cnf={}, **kw) -> None:
        ...
        ``selectbackground``, ``selectforeground``.
        """
    def itemconfigure(self, row_index, col_index, cnf: Incomplete | None = None, **kw):
        """
    ...
    def insert(self, index, *rows) -> None:
        ...
        ``Tkinter.Listbox``.
        """
    def get(self, first, last: Incomplete | None = None):
        """
    ...
    def show_column(self, col_index) -> None:
        ...
        """
    def bind_to_labels(self, sequence: Incomplete | None = None, func: Incomplete | None = None, add: Incomplete | None = None):
        """
        ...
        """
    def bind_to_listboxes(self, sequence: Incomplete | None = None, func: Incomplete | None = None, add: Incomplete | None = None) -> None:
        """
        ...
        :return: A list of the identifiers of replaced binding
            ...
            prevent a memory leak).
        """
    def bind_to_columns(self, sequence: Incomplete | None = None, func: Incomplete | None = None, add: Incomplete | None = None):
        """
...
class Table:
    ...
    :ivar _rows: A list-of-lists used to hold the cell values of this
        ...
        cell values, one for each column in the row.
    """
    def __init__(self, master, column_names, rows: Incomplete | None = None, column_weights: Incomplete | None = None, scrollbar: bool = True, click_to_sort: bool = True, reprfunc: Incomplete | None = None, cnf={}, **kw) -> None:
        """
    ...
    def bind(self, sequence: Incomplete | None = None, func: Incomplete | None = None, add: Incomplete | None = None) -> None:
    ...
    def bind_to_listboxes(self, sequence: Incomplete | None = None, func: Incomplete | None = None, add: Incomplete | None = None):
    ...
    def sort_by(self, column_index, order: str = 'toggle') -> None:
        """
