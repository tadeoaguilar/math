...
class CanvasWidget(metaclass=ABCMeta):
    ...
    :ivar __callbacks: Registered callbacks.  Currently, four keys are
        ...
        callback.
    '''
    def __init__(self, canvas, parent: Incomplete | None = None, **attribs) -> None:
        '''
    ...
    def move(self, dx, dy) -> None:
        ...
        :rtype: None
        """
    def moveto(self, x, y, anchor: str = 'NW') -> None:
        """
    ...
    def hidden(self):
        ...
        :rtype: bool
        """
    def bind_click(self, callback, button: int = 1) -> None:
        """
...
class AbstractContainerWidget(CanvasWidget, metaclass=abc.ABCMeta):
    """
...
class CanvasFrame:
    ...
    button.
    '''
    def __init__(self, parent: Incomplete | None = None, **kw) -> None:
        """
    ...
    def canvas(self):
        ...
        :rtype: Tkinter.Canvas
        """
    def add_widget(self, canvaswidget, x: Incomplete | None = None, y: Incomplete | None = None) -> None:
        """
...
class ShowText:
    ...
    information.
    """
    def __init__(self, root, title, text, width: Incomplete | None = None, height: Incomplete | None = None, **textbox_options) -> None: ...
...
class EntryDialog:
    ...
    """
    def __init__(self, parent, original_text: str = '', instructions: str = '', set_callback: Incomplete | None = None, title: Incomplete | None = None) -> None: ...

class ColorizedList(metaclass=abc.ABCMeta):
    """
    ...
    def __init__(self, parent, items=[], **options) -> None:
        ...
        :param options:
        """
    def get(self, index: Incomplete | None = None):
        """
