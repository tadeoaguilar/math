from nltk.draw.util import BoxWidget as BoxWidget, CanvasFrame as CanvasFrame, CanvasWidget as CanvasWidget, OvalWidget as OvalWidget, ParenWidget as ParenWidget, TextWidget as TextWidget
...
class TreeWidget(CanvasWidget):
    ...
    def collapsed_tree(self, *path_to_tree):
        ...
        :param path_to_tree: A list of indices i1, i2, ..., in, where
            ...
            For the root, the path is ``()``.
        """
    def bind_click_trees(self, callback, button: int = 1) -> None:
        """
        Add a binding to all tree segments.
        """
    def bind_drag_trees(self, callback, button: int = 1) -> None:
        """
        Add a binding to all tree segments.
        """
    def bind_click_leaves(self, callback, button: int = 1) -> None:
        """
        Add a binding to all leaves.
        """
    def bind_drag_leaves(self, callback, button: int = 1) -> None:
        """
        Add a binding to all leaves.
        """
    def bind_click_nodes(self, callback, button: int = 1) -> None:
        """
        Add a binding to all nodes.
        """
    def bind_drag_nodes(self, callback, button: int = 1) -> None:
        """
        Add a binding to all nodes.
        """
    def __setitem__(self, attr, value) -> None: ...
