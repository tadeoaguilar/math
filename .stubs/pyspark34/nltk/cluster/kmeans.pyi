...
class KMeansClusterer(VectorSpaceClusterer):
    ...
    """
    def __init__(self, num_means, distance, repeats: int = 1, conv_test: float = 1e-06, initial_means: Incomplete | None = None, normalise: bool = False, svd_dimensions: Incomplete | None = None, rng: Incomplete | None = None, avoid_empty_clusters: bool = False) -> None:
        """
