...
def extract_fields(tweet, fields):
    ...
    :rtype: list(str)
    """
def json2csv(fp, outfile, fields, encoding: str = 'utf8', errors: str = 'replace', gzip_compress: bool = False) -> None:
    """
    ...
    """
def outf_writer_compat(outfile, encoding, errors, gzip_compress: bool = False):
    """Get a CSV writer with optional compression."""
def json2csv_entities(tweets_file, outfile, main_fields, entity_type, entity_fields, encoding: str = 'utf8', errors: str = 'replace', gzip_compress: bool = False) -> None:
    """
    Extract selected fields from a file of line-separated JSON tweets and
    write to a file in CSV format.
