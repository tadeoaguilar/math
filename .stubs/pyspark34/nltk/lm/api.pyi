...
class LanguageModel(metaclass=ABCMeta):
    ...
    vocab: Incomplete
    counts: Incomplete
    def __init__(self, order, vocabulary: Incomplete | None = None, counter: Incomplete | None = None) -> None:
        ...
        """
    def fit(self, text, vocabulary_text: Incomplete | None = None) -> None:
        """Trains the model on a text.

        :param text: Training text as a sequence of sentences.

        """
    def score(self, word, context: Incomplete | None = None):
    ...
    def unmasked_score(self, word, context: Incomplete | None = None):
        ...
        :rtype: float
        """
    def logscore(self, word, context: Incomplete | None = None):
    ...
    def perplexity(self, text_ngrams):
        ...
        """
    def generate(self, num_words: int = 1, text_seed: Incomplete | None = None, random_seed: Incomplete | None = None):
