def edit_distance(s1, s2, substitution_cost: int = 1, transpositions: bool = False):
    '''
    ...
    :rtype: int
    '''
def edit_distance_align(s1, s2, substitution_cost: int = 1):
    '''
...
def jaro_similarity(s1, s2):
    ...
    """
def jaro_winkler_similarity(s1, s2, p: float = 0.1, max_l: int = 4):
    '''
