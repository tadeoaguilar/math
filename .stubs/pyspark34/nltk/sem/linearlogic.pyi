...
from nltk.sem.logic import APP as APP, LogicParser as LogicParser
...
class Expression:
    ...
    def applyto(self, other, other_indices: Incomplete | None = None): ...
    def __call__(self, other): ...

class AtomicExpression(Expression):
    name: Incomplete
    dependencies: Incomplete
    def __init__(self, name, dependencies: Incomplete | None = None) -> None:
        """
        :param name: str for the constant name
        :param dependencies: list of int for the indices on which this atom is dependent
        """
    def simplify(self, bindings: Incomplete | None = None):
        """
...
class ApplicationExpression(Expression):
    ...
    argument: Incomplete
    bindings: Incomplete
    def __init__(self, function, argument, argument_indices: Incomplete | None = None) -> None:
        """
