...
from nltk.tbl import Feature as Feature, Template as Template
...
class BrillTagger(TaggerI):
    ...
    """
    json_tag: str
    def __init__(self, initial_tagger, rules, training_stats: Incomplete | None = None) -> None:
        """
    ...
    def rules(self):
        ...
        :rtype: list of Rules
        """
    def train_stats(self, statistic: Incomplete | None = None):
        """
        ...
        """
    def tag(self, tokens): ...
    def print_template_statistics(self, test_stats: Incomplete | None = None, printunused: bool = True):
        """
