...
from nltk.probability import ConditionalFreqDist as ConditionalFreqDist, ConditionalProbDist as ConditionalProbDist, DictionaryConditionalProbDist as DictionaryConditionalProbDist, DictionaryProbDist as DictionaryProbDist, FreqDist as FreqDist, LidstoneProbDist as LidstoneProbDist, MLEProbDist as MLEProbDist, MutableProbDist as MutableProbDist, RandomProbDist as RandomProbDist
from nltk.tag.api import TaggerI as TaggerI
from nltk.util import LazyMap as LazyMap, unique_list as unique_list
...
class HiddenMarkovModelTagger(TaggerI):
    ...
    @classmethod
    def train(cls, labeled_sequence, test_sequence: Incomplete | None = None, unlabeled_sequence: Incomplete | None = None, **kwargs):
        """
    ...
    def point_entropy(self, unlabeled_sequence):
        ...
        """
    def test(self, test_sequence, verbose: bool = False, **kwargs):
        """
...
class HiddenMarkovModelTrainer:
    ...
    """
    def __init__(self, states: Incomplete | None = None, symbols: Incomplete | None = None) -> None: ...
    def train(self, labeled_sequences: Incomplete | None = None, unlabeled_sequences: Incomplete | None = None, **kwargs):
        """
        ...
        """
    def train_unsupervised(self, unlabeled_sequences, update_outputs: bool = True, **kwargs):
        """
        ...
        :param convergence_logprob: the maximum change in log probability to
            allow convergence
        """
    def train_supervised(self, labelled_sequences, estimator: Incomplete | None = None):
        """
...
def demo_pos(): ...
def demo_pos_bw(test: int = 10, supervised: int = 20, unsupervised: int = 10, verbose: bool = True, max_iterations: int = 5): ...
def demo_bw() -> None: ...
