...
class AveragedPerceptron:
    ...
    def predict(self, features, return_conf: bool = False):
...
class PerceptronTagger(TaggerI):
    ...
    def __init__(self, load: bool = True) -> None:
        ...
        """
    def tag(self, tokens, return_conf: bool = False, use_tagdict: bool = True):
        """
        Tag tokenized sentences.
        :params tokens: list of word
        :type tokens: list(str)
        """
    def train(self, sentences, save_loc: Incomplete | None = None, nr_iter: int = 5) -> None:
