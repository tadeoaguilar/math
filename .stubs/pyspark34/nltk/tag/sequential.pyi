...
from nltk.tag.api import FeaturesetTaggerI as FeaturesetTaggerI, TaggerI as TaggerI
from typing import List, Tuple

class SequentialBackoffTagger(TaggerI, metaclass=abc.ABCMeta):
    """
...
class ContextTagger(SequentialBackoffTagger, metaclass=abc.ABCMeta):
    '''
    ...
    '''
    def __init__(self, context_to_tag, backoff: Incomplete | None = None) -> None:
        """
...
class NgramTagger(ContextTagger):
    ...
    """
    json_tag: str
    def __init__(self, n, train: Incomplete | None = None, model: Incomplete | None = None, backoff: Incomplete | None = None, cutoff: int = 0, verbose: bool = False) -> None: ...
    def encode_json_obj(self): ...
    @classmethod
    def decode_json_obj(cls, obj): ...
    def context(self, tokens, index, history): ...
...
class UnigramTagger(NgramTagger):
    ...
    '''
    json_tag: str
    def __init__(self, train: Incomplete | None = None, model: Incomplete | None = None, backoff: Incomplete | None = None, cutoff: int = 0, verbose: bool = False) -> None: ...
    def context(self, tokens, index, history): ...
...
class AffixTagger(ContextTagger):
    ...
    '''
    json_tag: str
    def __init__(self, train: Incomplete | None = None, model: Incomplete | None = None, affix_length: int = -3, min_stem_length: int = 2, backoff: Incomplete | None = None, cutoff: int = 0, verbose: bool = False) -> None: ...
    def encode_json_obj(self): ...
    @classmethod
    def decode_json_obj(cls, obj): ...
    def context(self, tokens, index, history): ...
...
class RegexpTagger(SequentialBackoffTagger):
    ...
    '''
    json_tag: str
    def __init__(self, regexps: List[Tuple[str, str]], backoff: TaggerI | None = None) -> None: ...
    def encode_json_obj(self): ...
    @classmethod
    def decode_json_obj(cls, obj): ...
    def choose_tag(self, tokens, index, history): ...
...
class ClassifierBasedTagger(SequentialBackoffTagger, FeaturesetTaggerI):
    ...
    """
    def __init__(self, feature_detector: Incomplete | None = None, train: Incomplete | None = None, classifier_builder=..., classifier: Incomplete | None = None, backoff: Incomplete | None = None, cutoff_prob: Incomplete | None = None, verbose: bool = False) -> None: ...
    def choose_tag(self, tokens, index, history): ...
