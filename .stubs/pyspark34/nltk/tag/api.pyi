...
from nltk.internals import deprecated as deprecated, overridden as overridden
from nltk.metrics import ConfusionMatrix as ConfusionMatrix, accuracy as accuracy
...
class TaggerI(metaclass=ABCMeta):
    ...
    def precision(self, gold):
        ...
        :rtype: Dict[str, float]
        """
    def f_measure(self, gold, alpha: float = 0.5):
        """
        ...
        :rtype: Dict[str, float]
        """
    def evaluate_per_tag(self, gold, alpha: float = 0.5, truncate: Incomplete | None = None, sort_by_count: bool = False):
...
class FeaturesetTaggerI(TaggerI, metaclass=abc.ABCMeta):
    """
