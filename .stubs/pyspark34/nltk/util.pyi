...
from nltk.internals import deprecated as deprecated, raise_unorderable_types as raise_unorderable_types, slice_bounds as slice_bounds
...
def in_idle():
    ...
    :rtype: bool
    """
def pr(data, start: int = 0, end: Incomplete | None = None) -> None:
    """
    ...
    :type end: int
    """
def print_string(s, width: int = 70) -> None:
    """
    ...
    :type width: int
    """
def tokenwrap(tokens, separator: str = ' ', width: int = 70):
    """
...
def re_show(regexp, string, left: str = '{', right: str = '}') -> None:
    """
    ...
    """
def filestring(f): ...
def breadth_first(tree, children=..., maxdepth: int = -1) -> Generator[Incomplete, None, None]:
    ...
    """
def edge_closure(tree, children=..., maxdepth: int = -1, verbose: bool = False) -> Generator[Incomplete, None, None]:
    ...
    [('A', 'B'), ('A', 'C'), ('B', 'C'), ('C', 'B')]
    """
def edges2dot(edges, shapes: Incomplete | None = None, attr: Incomplete | None = None):
    '''
    ...
    <BLANKLINE>
    '''
def unweighted_minimum_spanning_digraph(tree, children=..., shapes: Incomplete | None = None, attr: Incomplete | None = None):
    '''
    ...
    <BLANKLINE>
    '''
def acyclic_breadth_first(tree, children=..., maxdepth: int = -1) -> Generator[Incomplete, None, None]:
    """Traverse the nodes of a tree in breadth-first order,
    discarding eventual cycles.
    ...
    and returning an iterator of the node's children.
    """
def acyclic_depth_first(tree, children=..., depth: int = -1, cut_mark: Incomplete | None = None, traversed: Incomplete | None = None):
    ...
    '''
def acyclic_branches_depth_first(tree, children=..., depth: int = -1, cut_mark: Incomplete | None = None, traversed: Incomplete | None = None):
    '''Traverse the nodes of a tree in depth-first order,
...
def unweighted_minimum_spanning_dict(tree, children=...):
    """
...
def unique_list(xs): ...
def invert_dict(d): ...
def transitive_closure(graph, reflexive: bool = False):
    '''
...
def flatten(*args):
    ...
    :rtype: list
    """
def pad_sequence(sequence, n, pad_left: bool = False, pad_right: bool = False, left_pad_symbol: Incomplete | None = None, right_pad_symbol: Incomplete | None = None):
    """
...
def ngrams(sequence, n, **kwargs):
    ...
    :rtype: sequence or iter
    """
def bigrams(sequence, **kwargs) -> Generator[Incomplete, Incomplete, None]:
    """
    ...
    :rtype: iter(tuple)
    """
def trigrams(sequence, **kwargs) -> Generator[Incomplete, Incomplete, None]:
    """
    ...
    :rtype: iter(tuple)
    """
def everygrams(sequence, min_len: int = 1, max_len: int = -1, pad_left: bool = False, pad_right: bool = False, **kwargs) -> Generator[Incomplete, None, None]:
    """
    ...
    :rtype: iter(tuple)
    """
def skipgrams(sequence, n, k, **kwargs) -> Generator[Incomplete, None, None]:
    '''
    ...
    :rtype: iter(tuple)
    '''
def binary_search_file(file, key, cache: Incomplete | None = None, cacheDepth: int = -1):
    """
    ...
    """
def set_proxy(proxy, user: Incomplete | None = None, password: str = '') -> None:
    """
    ...
    """
def elementtree_indent(elem, level: int = 0) -> None:
    """
