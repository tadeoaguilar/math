...
from nltk.data import PathPointer as PathPointer, find as find

class StandardFormat:
    """
    Class for reading and processing standard format marker files and strings.
    """
    def __init__(self, filename: Incomplete | None = None, encoding: Incomplete | None = None) -> None: ...
    ...
    def raw_fields(self) -> Generator[Incomplete, None, None]:
        ...
        """
    def fields(self, strip: bool = True, unwrap: bool = True, encoding: Incomplete | None = None, errors: str = 'strict', unicode_fields: Incomplete | None = None) -> Generator[Incomplete, None, None]:
        """
        Return an iterator that returns the next field in a ``(marker, value)``
...
class ToolboxData(StandardFormat):
    def parse(self, grammar: Incomplete | None = None, **kwargs): ...

def to_sfm_string(tree, encoding: Incomplete | None = None, errors: str = 'strict', unicode_fields: Incomplete | None = None):
    """
...
class ToolboxSettings(StandardFormat):
    ...
    def parse(self, encoding: Incomplete | None = None, errors: str = 'strict', **kwargs):
        """
...
def to_settings_string(tree, encoding: Incomplete | None = None, errors: str = 'strict', unicode_fields: Incomplete | None = None): ...
