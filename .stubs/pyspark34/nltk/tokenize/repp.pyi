...
class ReppTokenizer(TokenizerI):
    ...
    encoding: Incomplete
    def __init__(self, repp_dir, encoding: str = 'utf8') -> None: ...
    def tokenize(self, sentence):
        ...
        :rtype: tuple(str)
        """
    def tokenize_sents(self, sentences, keep_token_positions: bool = False) -> Generator[Incomplete, None, None]:
        """
    ...
    def generate_repp_command(self, inputfilename):
        ...
        """
    @staticmethod
    def parse_repp_outputs(repp_output) -> Generator[Incomplete, None, None]:
        '''
