...
def string_span_tokenize(s, sep) -> Generator[Incomplete, None, None]:
    '''
    ...
    '''
def regexp_span_tokenize(s, regexp) -> Generator[Incomplete, None, None]:
    """
    Return the offsets of the tokens in *s*, as a sequence of ``(start, end)``
    ...
    :rtype: iter(tuple(int, int))
    """
def spans_to_relative(spans) -> Generator[Incomplete, None, None]:
    """
