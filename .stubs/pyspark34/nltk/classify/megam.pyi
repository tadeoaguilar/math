...
def config_megam(bin: Incomplete | None = None) -> None:
    """
    ...
    :type bin: str
    """
def write_megam_file(train_toks, encoding, stream, bernoulli: bool = True, explicit: bool = True) -> None:
    """
    ...
    """
def parse_megam_weights(s, features_count, explicit: bool = True):
    """
