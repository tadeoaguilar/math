...
from nltk.classify.megam import call_megam as call_megam, parse_megam_weights as parse_megam_weights, write_megam_file as write_megam_file
from nltk.classify.tadm import call_tadm as call_tadm, parse_tadm_weights as parse_tadm_weights, write_tadm_file as write_tadm_file
from nltk.classify.util import CutoffChecker as CutoffChecker, accuracy as accuracy, log_likelihood as log_likelihood
from nltk.data import gzip_open_unicode as gzip_open_unicode
...
class MaxentClassifier(ClassifierI):
    ...
    '''
    def __init__(self, encoding, weights, logarithmic: bool = True) -> None:
        """
    ...
    def explain(self, featureset, columns: int = 4):
        """
        ...
        """
    def most_informative_features(self, n: int = 10):
        """
        Generates the ranked list of informative features from most to least.
        """
    def show_most_informative_features(self, n: int = 10, show: str = 'all') -> None:
        """
    ...
    @classmethod
    def train(cls, train_toks, algorithm: Incomplete | None = None, trace: int = 3, encoding: Incomplete | None = None, labels: Incomplete | None = None, gaussian_prior_sigma: int = 0, **cutoffs):
        """
...
class MaxentFeatureEncodingI:
    ...
    corpus.
    """
    def encode(self, featureset, label) -> None:
        """
...
class BinaryMaxentFeatureEncoding(MaxentFeatureEncodingI):
    ...
    '''
    def __init__(self, labels, mapping, unseen_features: bool = False, alwayson_features: bool = False) -> None:
        '''
    ...
    def length(self): ...
    @classmethod
    def train(cls, train_toks, count_cutoff: int = 0, labels: Incomplete | None = None, **options):
        """
        Construct and return new feature encoding, based on a given
...
class GISEncoding(BinaryMaxentFeatureEncoding):
    ...
    training algorithm:
      ...
      - The feature vector must sum to a constant non-negative number
        for every token.
    """
    def __init__(self, labels, mapping, unseen_features: bool = False, alwayson_features: bool = False, C: Incomplete | None = None) -> None:
        """
...
def train_maxent_classifier_with_gis(train_toks, trace: int = 3, encoding: Incomplete | None = None, labels: Incomplete | None = None, **cutoffs):
    """
...
def train_maxent_classifier_with_iis(train_toks, trace: int = 3, encoding: Incomplete | None = None, labels: Incomplete | None = None, **cutoffs):
    """
    Train a new ``ConditionalExponentialClassifier``, using the given
...
def calculate_deltas(train_toks, classifier, unattested, ffreq_empirical, nfmap, nfarray, nftranspose, encoding):
    ...
    *delta[i]*.  In particular, it starts with a guess of
    ...
    """
def train_maxent_classifier_with_megam(train_toks, trace: int = 3, encoding: Incomplete | None = None, labels: Incomplete | None = None, gaussian_prior_sigma: int = 0, **kwargs):
    """
    Train a new ``ConditionalExponentialClassifier``, using the given
