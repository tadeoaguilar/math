...
class ChunkScore:
    ...
    def recall(self):
        ...
        :rtype: float
        """
    def f_measure(self, alpha: float = 0.5):
        """
...
def tagstr2tree(s, chunk_label: str = 'NP', root_label: str = 'S', sep: str = '/', source_tagset: Incomplete | None = None, target_tagset: Incomplete | None = None):
    """
    ...
    :rtype: Tree
    """
def conllstr2tree(s, chunk_types=('NP', 'PP', 'VP'), root_label: str = 'S'):
    """
...
def tree2conlltags(t):
    ...
    :rtype: list(tuple)
    """
def conlltags2tree(sentence, chunk_types=('NP', 'PP', 'VP'), root_label: str = 'S', strict: bool = False):
    """
...
def tree2conllstr(t):
    ...
    :rtype: str
    """
def ieerstr2tree(s, chunk_types=['LOCATION', 'ORGANIZATION', 'PERSON', 'DURATION', 'DATE', 'CARDINAL', 'PERCENT', 'MONEY', 'MEASURE'], root_label: str = 'S'):
    """
