...
class ChunkString:
    ...
    """
    CHUNK_TAG_CHAR: str
    CHUNK_TAG: Incomplete
    IN_CHUNK_PATTERN: str
    IN_STRIP_PATTERN: str
    def __init__(self, chunk_struct, debug_level: int = 1) -> None:
        """
        ...
        """
    def to_chunkstruct(self, chunk_label: str = 'CHUNK'):
        """
...
class RegexpChunkParser(ChunkParserI):
    ...
    '''
    def __init__(self, rules, chunk_label: str = 'NP', root_label: str = 'S', trace: int = 0) -> None:
        '''
        ...
        '''
    def parse(self, chunk_struct, trace: Incomplete | None = None):
        """
        :type chunk_struct: Tree
        :param chunk_struct: the chunk structure to be (further) chunked
        :type trace: int
...
class RegexpParser(ChunkParserI):
    ...
    """
    def __init__(self, grammar, root_label: str = 'S', loop: int = 1, trace: int = 0) -> None:
        """
