...
from nltk.data import SeekableUnicodeStreamReader as SeekableUnicodeStreamReader
...
class XMLCorpusReader(CorpusReader):
    ...
    def xml(self, fileid: Incomplete | None = None): ...
    def words(self, fileid: Incomplete | None = None):
        """
