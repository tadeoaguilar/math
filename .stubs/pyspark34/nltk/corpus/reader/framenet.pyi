...
from nltk.corpus.reader import XMLCorpusReader as XMLCorpusReader, XMLCorpusView as XMLCorpusView
from nltk.util import LazyConcatenation as LazyConcatenation, LazyIteratorList as LazyIteratorList, LazyMap as LazyMap
from operator import itemgetter as itemgetter

__docformat__: str

def mimic_wrap(lines, wrap_at: int = 65, **kwargs) -> Generator[Incomplete, None, None]:
    """
...
class FramenetCorpusReader(XMLCorpusReader):
    ...
    def help(self, attrname: Incomplete | None = None):
    ...
    def frame_by_id(self, fn_fid, ignorekeys=[]):
        ...
        '''
    def frame_by_name(self, fn_fname, ignorekeys=[], check_cache: bool = True):
        '''
    ...
    def lu_basic(self, fn_luid):
        ...
        :rtype: dict
        '''
    def lu(self, fn_luid, ignorekeys=[], luName: Incomplete | None = None, frameID: Incomplete | None = None, frameName: Incomplete | None = None):
        '''
    ...
    def frames(self, name: Incomplete | None = None):
        '''
        ...
        :rtype: list(AttrDict)
        '''
    def frame_ids_and_names(self, name: Incomplete | None = None):
        """
        Uses the frame index, which is much faster than looking up each frame definition
        if only the names and IDs are needed.
        """
    def fes(self, name: Incomplete | None = None, frame: Incomplete | None = None):
        """
        ...
        :rtype: list(AttrDict)
        """
    def lus(self, name: Incomplete | None = None, frame: Incomplete | None = None):
        '''
        ...
        '''
    def lu_ids_and_names(self, name: Incomplete | None = None):
        """
        Uses the LU index, which is much faster than looking up each LU definition
        if only the names and IDs are needed.
        """
    def docs_metadata(self, name: Incomplete | None = None):
        '''
        ...
        :rtype: list of dicts, where each dict object contains the following
                ...
                - \'filename\'
        '''
    def docs(self, name: Incomplete | None = None):
        """
        ...
        """
    def sents(self, exemplars: bool = True, full_text: bool = True):
        """
        Annotated sentences matching the specified criteria.
        """
    def annotations(self, luNamePattern: Incomplete | None = None, exemplars: bool = True, full_text: bool = True):
        """
        Frame annotation sets matching the specified criteria.
        """
    def exemplars(self, luNamePattern: Incomplete | None = None, frame: Incomplete | None = None, fe: Incomplete | None = None, fe2: Incomplete | None = None):
        """
        ...
        """
    def ft_sents(self, docNamePattern: Incomplete | None = None):
        """
    ...
    def frame_relation_types(self):
        ...
        :rtype: list(dict)
        """
    def frame_relations(self, frame: Incomplete | None = None, frame2: Incomplete | None = None, type: Incomplete | None = None):
        """
