...
from nltk.corpus.reader.util import StreamBackedCorpusView as StreamBackedCorpusView, ZipFilePathPointer as ZipFilePathPointer, concat as concat
...
class TwitterCorpusReader(CorpusReader):
    ...
    def __init__(self, root, fileids: Incomplete | None = None, word_tokenizer=..., encoding: str = 'utf8') -> None:
        """
    ...
    def docs(self, fileids: Incomplete | None = None):
        ...
        :rtype: list(dict)
        """
    def strings(self, fileids: Incomplete | None = None):
        """
        ...
        :rtype: list(str)
        """
    def tokenized(self, fileids: Incomplete | None = None):
        """
