...
class PropbankCorpusReader(CorpusReader):
    ...
    '''
    def __init__(self, root, propfile, framefiles: str = '', verbsfile: Incomplete | None = None, parse_fileid_xform: Incomplete | None = None, parse_corpus: Incomplete | None = None, encoding: str = 'utf8') -> None:
        """
        ...
        """
    def instances(self, baseform: Incomplete | None = None):
        """
    ...
    def roleset(self, roleset_id):
        ...
        """
    def rolesets(self, baseform: Incomplete | None = None):
        """
...
class PropbankInstance:
    ...
    def __init__(self, fileid, sentnum, wordnum, tagger, roleset, inflection, predicate, arguments, parse_corpus: Incomplete | None = None) -> None: ...
    @property
    def baseform(self):
    ...
    tree: Incomplete
    @staticmethod
    def parse(s, parse_fileid_xform: Incomplete | None = None, parse_corpus: Incomplete | None = None): ...
...
class PropbankInflection:
    ...
    person: Incomplete
    voice: Incomplete
    def __init__(self, form: str = '-', tense: str = '-', aspect: str = '-', person: str = '-', voice: str = '-') -> None: ...
    @staticmethod
    def parse(s): ...
