...
class LinThesaurusCorpusReader(CorpusReader):
    ...
    def __init__(self, root, badscore: float = 0.0) -> None:
        """
        ...
        """
    def similarity(self, ngram1, ngram2, fileid: Incomplete | None = None):
        """
        ...
        """
    def scored_synonyms(self, ngram, fileid: Incomplete | None = None):
        """
        ...
        :return: If fileid is specified, list of tuples of scores and synonyms; otherwise,
                 ...
                 scores and synonyms.
        """
    def synonyms(self, ngram, fileid: Incomplete | None = None):
        """
