...
from nltk.corpus.reader.xmldocs import ElementTree as ElementTree, XMLCorpusReader as XMLCorpusReader
from nltk.util import LazyConcatenation as LazyConcatenation, LazyMap as LazyMap, flatten as flatten
...
class CHILDESCorpusReader(XMLCorpusReader):
    ...
    """
    def __init__(self, root, fileids, lazy: bool = True) -> None: ...
    def words(self, fileids: Incomplete | None = None, speaker: str = 'ALL', stem: bool = False, relation: bool = False, strip_space: bool = True, replace: bool = False):
        """
        ...
        """
    def tagged_words(self, fileids: Incomplete | None = None, speaker: str = 'ALL', stem: bool = False, relation: bool = False, strip_space: bool = True, replace: bool = False):
        """
        ...
        :param replace: If true, then use the replaced (intended) word instead
            of the original word (e.g., 'wat' will be replaced with 'watch')
        """
    def sents(self, fileids: Incomplete | None = None, speaker: str = 'ALL', stem: bool = False, relation: Incomplete | None = None, strip_space: bool = True, replace: bool = False):
        """
        ...
        :param replace: If true, then use the replaced (intended) word instead
            of the original word (e.g., 'wat' will be replaced with 'watch')
        """
    def tagged_sents(self, fileids: Incomplete | None = None, speaker: str = 'ALL', stem: bool = False, relation: Incomplete | None = None, strip_space: bool = True, replace: bool = False):
        """
        ...
        :param replace: If true, then use the replaced (intended) word instead
            of the original word (e.g., 'wat' will be replaced with 'watch')
        """
    def corpus(self, fileids: Incomplete | None = None):
        """
        :return: the given file(s) as a dict of ``(corpus_property_key, value)``
        :rtype: list(dict)
        """
    def participants(self, fileids: Incomplete | None = None):
        """
        :return: the given file(s) as a dict of
            ``(participant_property_key, value)``
        :rtype: list(dict)
        """
    def age(self, fileids: Incomplete | None = None, speaker: str = 'CHI', month: bool = False):
        """
    ...
    def MLU(self, fileids: Incomplete | None = None, speaker: str = 'CHI'):
        """
        :return: the given file(s) as a floating number
        :rtype: list(float)
        """
    childes_url_base: str
    def webview_file(self, fileid, urlbase: Incomplete | None = None) -> None:
