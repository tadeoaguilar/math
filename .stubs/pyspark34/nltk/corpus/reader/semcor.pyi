...
class SemcorCorpusReader(XMLCorpusReader):
    ...
    """
    def __init__(self, root, fileids, wordnet, lazy: bool = True) -> None: ...
    def words(self, fileids: Incomplete | None = None):
        """
        :return: the given file(s) as a list of words and punctuation symbols.
        :rtype: list(str)
        """
    def chunks(self, fileids: Incomplete | None = None):
        """
        ...
        :rtype: list(list(str))
        """
    def tagged_chunks(self, fileids: Incomplete | None = None, tag=...):
        """
    ...
    def sents(self, fileids: Incomplete | None = None):
        ...
        :rtype: list(list(str))
        """
    def chunk_sents(self, fileids: Incomplete | None = None):
        """
        :return: the given file(s) as a list of sentences, each encoded
            as a list of chunks.
        :rtype: list(list(list(str)))
        """
    def tagged_sents(self, fileids: Incomplete | None = None, tag=...):
        """
