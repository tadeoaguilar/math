...
from nltk.corpus.reader import TaggedCorpusReader as TaggedCorpusReader, concat as concat
...
class MTECorpusView(XMLCorpusView):
    ...
    """
    def __init__(self, fileid, tagspec, elt_handler: Incomplete | None = None) -> None: ...
...
class MTECorpusReader(TaggedCorpusReader):
    ...
    """
    def __init__(self, root: Incomplete | None = None, fileids: Incomplete | None = None, encoding: str = 'utf8') -> None:
        """
    ...
    def paras(self, fileids: Incomplete | None = None):
        ...
        """
    def lemma_words(self, fileids: Incomplete | None = None):
        """
        :param fileids: A list specifying the fileids that should be used.
        ...
        """
    def tagged_words(self, fileids: Incomplete | None = None, tagset: str = 'msd', tags: str = ''):
        '''
        :param fileids: A list specifying the fileids that should be used.
        ...
        :rtype: list(tuple(str, str))
        '''
    def lemma_sents(self, fileids: Incomplete | None = None):
        """
        :param fileids: A list specifying the fileids that should be used.
        ...
        """
    def tagged_sents(self, fileids: Incomplete | None = None, tagset: str = 'msd', tags: str = ''):
        '''
        :param fileids: A list specifying the fileids that should be used.
        :param tagset: The tagset that should be used in the returned object,
                       either "universal" or "msd", "msd" is the default
        ...
        :rtype: list(list(tuple(str, str)))
        '''
    def lemma_paras(self, fileids: Incomplete | None = None):
        """
        :param fileids: A list specifying the fileids that should be used.
        ...
        """
    def tagged_paras(self, fileids: Incomplete | None = None, tagset: str = 'msd', tags: str = ''):
        '''
        :param fileids: A list specifying the fileids that should be used.
        :param tagset: The tagset that should be used in the returned object,
                       either "universal" or "msd", "msd" is the default
