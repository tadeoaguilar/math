...
class VerbnetCorpusReader(XMLCorpusReader):
    ...
    '''
    def __init__(self, root, fileids, wrap_etree: bool = False) -> None: ...
    def lemmas(self, vnclass: Incomplete | None = None):
        """
        Return a list of all verb lemmas that appear in any class, or
        in the ``classid`` if specified.
        """
    def wordnetids(self, vnclass: Incomplete | None = None):
        """
        Return a list of all wordnet identifiers that appear in any
        class, or in ``classid`` if specified.
        """
    def classids(self, lemma: Incomplete | None = None, wordnetid: Incomplete | None = None, fileid: Incomplete | None = None, classid: Incomplete | None = None):
        """
    ...
    def vnclass(self, fileid_or_classid):
        ...
        :param fileid_or_classid: An identifier specifying which class
            ...
            ``'9.1'``).
        """
    def fileids(self, vnclass_ids: Incomplete | None = None):
        """
    ...
    def pprint_members(self, vnclass, indent: str = ''):
        ...
        :param vnclass: A VerbNet class identifier; or an ElementTree
            containing the xml contents of a VerbNet class.
        """
    def pprint_themroles(self, vnclass, indent: str = ''):
        ...
        :param vnclass: A VerbNet class identifier; or an ElementTree
            containing the xml contents of a VerbNet class.
        """
    def pprint_frames(self, vnclass, indent: str = ''):
