...
class NombankCorpusReader(CorpusReader):
    ...
    '''
    def __init__(self, root, nomfile, framefiles: str = '', nounsfile: Incomplete | None = None, parse_fileid_xform: Incomplete | None = None, parse_corpus: Incomplete | None = None, encoding: str = 'utf8') -> None:
        """
...
class NombankInstance:
    ...
    wordnum: Incomplete
    baseform: Incomplete
    sensenumber: Incomplete
    predicate: Incomplete
    predid: Incomplete
    arguments: Incomplete
    parse_corpus: Incomplete
    def __init__(self, fileid, sentnum, wordnum, baseform, sensenumber, predicate, predid, arguments, parse_corpus: Incomplete | None = None) -> None: ...
    @property
    def roleset(self):
