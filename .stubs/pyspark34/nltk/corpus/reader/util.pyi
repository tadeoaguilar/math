...
from nltk.data import FileSystemPathPointer as FileSystemPathPointer, PathPointer as PathPointer, SeekableUnicodeStreamReader as SeekableUnicodeStreamReader, ZipFilePathPointer as ZipFilePathPointer
from nltk.internals import slice_bounds as slice_bounds
from nltk.tokenize import wordpunct_tokenize as wordpunct_tokenize
from nltk.util import AbstractLazySequence as AbstractLazySequence, LazyConcatenation as LazyConcatenation, LazySubsequence as LazySubsequence
...
class StreamBackedCorpusView(AbstractLazySequence):
    ...
    '''
    def __init__(self, fileid, block_reader: Incomplete | None = None, startpos: int = 0, encoding: str = 'utf8') -> None:
        """
        ...
        """
    fileid: Incomplete
    def read_block(self, stream) -> None:
        """
    ...
    def iterate_from(self, start_tok) -> Generator[Incomplete, None, None]: ...
...
class ConcatenatedCorpusView(AbstractLazySequence):
    ...
    def __len__(self) -> int: ...
    def close(self) -> None: ...
    def iterate_from(self, start_tok) -> Generator[Incomplete, Incomplete, None]: ...
...
class PickleCorpusView(StreamBackedCorpusView):
    ...
    BLOCK_SIZE: int
    PROTOCOL: int
    def __init__(self, fileid, delete_on_gc: bool = False) -> None:
        """
    ...
    def __del__(self) -> None:
        ...
        """
    @classmethod
    def write(cls, sequence, output_file) -> None: ...
    @classmethod
    def cache_to_tempfile(cls, sequence, delete_on_gc: bool = True):
        """
...
def read_regexp_block(stream, start_re, end_re: Incomplete | None = None):
    """
    ...
    """
def read_sexpr_block(stream, block_size: int = 16384, comment_char: Incomplete | None = None):
    """
