...
class WordListCorpusReader(CorpusReader):
    ...
    """
    def words(self, fileids: Incomplete | None = None, ignore_lines_startswith: str = '\n'): ...
...
class NonbreakingPrefixesCorpusReader(WordListCorpusReader):
    ...
    def words(self, lang: Incomplete | None = None, fileids: Incomplete | None = None, ignore_lines_startswith: str = '#'):
        """
...
class UnicharsCorpusReader(WordListCorpusReader):
    ...
    def chars(self, category: Incomplete | None = None, fileids: Incomplete | None = None):
        """
