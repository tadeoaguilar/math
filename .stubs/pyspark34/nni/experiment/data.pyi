...
class TrialResult:
    ...
    value: dict
    trialJobId: str
    def __init__(self, parameter: dict, value: str, trialJobId: str) -> None: ...
...
class TrialMetricData:
    ...
    sequence: int
    data: dict
    def __init__(self, timestamp: int, trialJobId: str, parameterId: int, type: str, sequence: int, data: str) -> None: ...
...
class TrialHyperParameters:
    ...
    parameters: dict
    parameter_index: int
    def __init__(self, parameter_id, parameter_source, parameters, parameter_index) -> None: ...
...
class TrialJob:
    ...
    sequenceId: int
    message: str
    def __init__(self, trialJobId: str, status: str, startTime: int, sequenceId: int, logPath: str = '', endTime: int = -1, stderrPath: str = '', hyperParameters: List = [], finalMetricData: List = [], message: str = '--') -> None: ...
