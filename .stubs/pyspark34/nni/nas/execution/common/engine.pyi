import abc
from .graph import MetricData as MetricData, Model
from abc import ABC, abstractmethod
from typing import Any, Iterable, List, Type

__all__ = ['GraphData', 'WorkerInfo', 'MetricData', 'AbstractGraphListener', 'AbstractExecutionEngine']

GraphData: Type[Any]
WorkerInfo: Type[Any]

class AbstractGraphListener(ABC, metaclass=abc.ABCMeta):
    """
...
class AbstractExecutionEngine(ABC, metaclass=abc.ABCMeta):
    '''
    ...
    def list_models(self) -> Iterable[Model]:
        ...
        """
    @abstractmethod
    def query_available_resource(self) -> List[WorkerInfo] | int:
        '''
