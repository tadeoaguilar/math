...
def write_context_name_to_docker_config(name: Incomplete | None = None): ...
def get_context_id(name): ...
def get_context_dir(): ...
def get_meta_dir(name: Incomplete | None = None): ...
def get_meta_file(name): ...
def get_tls_dir(name: Incomplete | None = None, endpoint: str = ''): ...
def get_context_host(path: Incomplete | None = None, tls: bool = False): ...
