    ...
    def attach_socket(self, container, params: Incomplete | None = None, ws: bool = False):
        ...
        Raises:
            :py:class:`docker.errors.APIError`
                If the server returns an error.
        """
    def commit(self, container, repository: Incomplete | None = None, tag: Incomplete | None = None, message: Incomplete | None = None, author: Incomplete | None = None, changes: Incomplete | None = None, conf: Incomplete | None = None):
        """
        ...
        Raises:
            :py:class:`docker.errors.APIError`
                If the server returns an error.
        """
    def containers(self, quiet: bool = False, all: bool = False, trunc: bool = False, latest: bool = False, since: Incomplete | None = None, before: Incomplete | None = None, limit: int = -1, size: bool = False, filters: Incomplete | None = None):
        '''
        ...
        Raises:
            :py:class:`docker.errors.APIError`
                If the server returns an error.
        '''
    def create_container(self, image, command: Incomplete | None = None, hostname: Incomplete | None = None, user: Incomplete | None = None, detach: bool = False, stdin_open: bool = False, tty: bool = False, ports: Incomplete | None = None, environment: Incomplete | None = None, volumes: Incomplete | None = None, network_disabled: bool = False, name: Incomplete | None = None, entrypoint: Incomplete | None = None, working_dir: Incomplete | None = None, domainname: Incomplete | None = None, host_config: Incomplete | None = None, mac_address: Incomplete | None = None, labels: Incomplete | None = None, stop_signal: Incomplete | None = None, networking_config: Incomplete | None = None, healthcheck: Incomplete | None = None, stop_timeout: Incomplete | None = None, runtime: Incomplete | None = None, use_config_proxy: bool = True, platform: Incomplete | None = None):
        '''
...
'''
    ...
    def kill(self, container, signal: Incomplete | None = None) -> None:
        ...
        Raises:
            :py:class:`docker.errors.APIError`
                If the server returns an error.
        """
    def logs(self, container, stdout: bool = True, stderr: bool = True, stream: bool = False, timestamps: bool = False, tail: str = 'all', since: Incomplete | None = None, follow: Incomplete | None = None, until: Incomplete | None = None):
        """
    ...
    def unpause(self, container) -> None:
        ...
        """
    def update_container(self, container, blkio_weight: Incomplete | None = None, cpu_period: Incomplete | None = None, cpu_quota: Incomplete | None = None, cpu_shares: Incomplete | None = None, cpuset_cpus: Incomplete | None = None, cpuset_mems: Incomplete | None = None, mem_limit: Incomplete | None = None, mem_reservation: Incomplete | None = None, memswap_limit: Incomplete | None = None, kernel_memory: Incomplete | None = None, restart_policy: Incomplete | None = None):
        """
