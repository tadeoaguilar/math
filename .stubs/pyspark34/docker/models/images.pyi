...
class Image(Model):
    ...
    def save(self, chunk_size=..., named: bool = False):
        ...
        Example:
            ...
            >>> f.close()
        '''
    def tag(self, repository, tag: Incomplete | None = None, **kwargs):
        """
    ...
    def load(self, data):
        ...
        Raises:
            :py:class:`docker.errors.APIError`
                If the server returns an error.
        """
    def pull(self, repository, tag: Incomplete | None = None, all_tags: bool = False, **kwargs):
        """
        ...
        """
    def push(self, repository, tag: Incomplete | None = None, **kwargs): ...
