    ...
    def attach_socket(self, **kwargs):
        ...
        Raises:
            :py:class:`docker.errors.APIError`
                If the server returns an error.
        """
    def commit(self, repository: Incomplete | None = None, tag: Incomplete | None = None, **kwargs):
        """
    ...
    def diff(self):
        ...
        Raises:
            :py:class:`docker.errors.APIError`
                If the server returns an error.
        """
    def exec_run(self, cmd, stdout: bool = True, stderr: bool = True, stdin: bool = False, tty: bool = False, privileged: bool = False, user: str = '', detach: bool = False, stream: bool = False, socket: bool = False, environment: Incomplete | None = None, workdir: Incomplete | None = None, demux: bool = False):
        '''
...
class ContainerCollection(Collection):
    model = Container
    def run(self, image, command: Incomplete | None = None, stdout: bool = True, stderr: bool = False, remove: bool = False, **kwargs):
        '''
    ...
    def get(self, container_id):
        ...
        Raises:
            ...
            :py:class:`docker.errors.APIError`
                If the server returns an error.
        """
    def list(self, all: bool = False, before: Incomplete | None = None, filters: Incomplete | None = None, limit: int = -1, since: Incomplete | None = None, sparse: bool = False, ignore_removed: bool = False):
        '''
