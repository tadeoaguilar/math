...
def tar(path, exclude: Incomplete | None = None, dockerfile: Incomplete | None = None, fileobj: Incomplete | None = None, gzip: bool = False): ...
...
def create_archive(root, files: Incomplete | None = None, fileobj: Incomplete | None = None, gzip: bool = False, extra_files: Incomplete | None = None): ...
