...
class EstimatorSettings:
    ...
    """
    efficient: Incomplete
    randomize: Incomplete
    n_res: Incomplete
    n_sub: Incomplete
    return_median: Incomplete
    return_only_bw: Incomplete
    n_jobs: Incomplete
    def __init__(self, efficient: bool = False, randomize: bool = False, n_res: int = 25, n_sub: int = 50, return_median: bool = True, return_only_bw: bool = False, n_jobs: int = -1) -> None: ...
...
def gpke(bw, data, data_predict, var_type, ckertype: str = 'gaussian', okertype: str = 'wangryzin', ukertype: str = 'aitchisonaitken', tosum: bool = True):
    """
