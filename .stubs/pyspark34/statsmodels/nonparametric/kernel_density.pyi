...
class KDEMultivariate(GenericKDE):
    ...
    bw: Incomplete
    def __init__(self, data, var_type, bw: Incomplete | None = None, defaults: Incomplete | None = None) -> None: ...
    def loo_likelihood(self, bw, func=...):
        ...
        """
    def pdf(self, data_predict: Incomplete | None = None):
        """
        ...
        .. math:: K_{h}(X_{i},X_{j}) =
            \\prod_{s=1}^{q}h_{s}^{-1}k\\left(\\frac{X_{is}-X_{js}}{h_{s}}\\right)
        """
    def cdf(self, data_predict: Incomplete | None = None):
        """
...
class KDEMultivariateConditional(GenericKDE):
    ...
    k_vars: Incomplete
    bw: Incomplete
    def __init__(self, endog, exog, dep_type, indep_type, bw, defaults: Incomplete | None = None) -> None: ...
    def loo_likelihood(self, bw, func=...):
        """
        ...
        for ``f(x)``.
        """
    def pdf(self, endog_predict: Incomplete | None = None, exog_predict: Incomplete | None = None):
        """
        Evaluate the probability density function.
        ...
        """
    def cdf(self, endog_predict: Incomplete | None = None, exog_predict: Incomplete | None = None):
        '''
