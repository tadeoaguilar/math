...
class KernelReg(GenericKDE):
    ...
    est: Incomplete
    bw: Incomplete
    def __init__(self, endog, exog, var_type, reg_type: str = 'll', bw: str = 'cv_ls', ckertype: str = 'gaussian', okertype: str = 'wangryzin', ukertype: str = 'aitchisonaitken', defaults: Incomplete | None = None) -> None: ...
    def aic_hurvich(self, bw, func: Incomplete | None = None):
        """
    ...
    def fit(self, data_predict: Incomplete | None = None):
        ...
        """
    def sig_test(self, var_pos, nboot: int = 50, nested_res: int = 25, pivot: bool = False):
        '''
...
class KernelCensoredReg(KernelReg):
    ...
    nobs: Incomplete
    est: Incomplete
    censor_val: Incomplete
    W_in: Incomplete
    bw: Incomplete
    def __init__(self, endog, exog, var_type, reg_type, bw: str = 'cv_ls', ckertype: str = 'gaussian', ukertype: str = 'aitchison_aitken_reg', okertype: str = 'wangryzin_reg', censor_val: int = 0, defaults: Incomplete | None = None) -> None: ...
    d: Incomplete
    sortix: Incomplete
    sortix_rev: Incomplete
...
class TestRegCoefC:
    ...
    gx: Incomplete
    pivot: Incomplete
    def __init__(self, model, test_vars, nboot: int = 400, nested_res: int = 400, pivot: bool = False) -> None: ...
    test_stat: Incomplete
    sig: Incomplete
    def run(self) -> None: ...
