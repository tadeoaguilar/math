...
from statsmodels.tsa.stl.mstl import MSTL as MSTL
...
def seasonal_mean(x, period):
    ...
    in the mean.
    """
def seasonal_decompose(x, model: str = 'additive', filt: Incomplete | None = None, period: Incomplete | None = None, two_sided: bool = True, extrapolate_trend: int = 0):
    '''
...
class DecomposeResult:
    ...
    """
    def __init__(self, observed, seasonal, trend, resid, weights: Incomplete | None = None) -> None: ...
    @property
    def observed(self):
        """Observed data"""
    @property
    ...
    def plot(self, observed: bool = True, seasonal: bool = True, trend: bool = True, resid: bool = True, weights: bool = False):
        """
