...
class SARIMAXSpecification:
    ...
    ar_lags: Incomplete
    ma_lags: Incomplete
    seasonal_ar_lags: Incomplete
    seasonal_ma_lags: Incomplete
    max_ar_order: Incomplete
    max_ma_order: Incomplete
    max_seasonal_ar_order: Incomplete
    max_seasonal_ma_order: Incomplete
    max_reduced_ar_order: Incomplete
    max_reduced_ma_order: Incomplete
    trend: Incomplete
    trend_terms: Incomplete
    k_trend: Incomplete
    trend_order: Incomplete
    trend_degree: Incomplete
    endog: Incomplete
    exog: Incomplete
    def __init__(self, endog: Incomplete | None = None, exog: Incomplete | None = None, order: Incomplete | None = None, seasonal_order: Incomplete | None = None, ar_order: Incomplete | None = None, diff: Incomplete | None = None, ma_order: Incomplete | None = None, seasonal_ar_order: Incomplete | None = None, seasonal_diff: Incomplete | None = None, seasonal_ma_order: Incomplete | None = None, seasonal_periods: Incomplete | None = None, trend: Incomplete | None = None, enforce_stationarity: Incomplete | None = None, enforce_invertibility: Incomplete | None = None, concentrate_scale: Incomplete | None = None, trend_offset: int = 1, dates: Incomplete | None = None, freq: Incomplete | None = None, missing: str = 'none', validate_specification: bool = True) -> None: ...
    @property
    ...
    def validate_estimator(self, estimator) -> None:
        ...
        '''
    def split_params(self, params, allow_infnan: bool = False):
        """
        ...
        {'exog_params': array([], dtype=float64),
         ...
         'sigma2': 4.0}
        """
    def join_params(self, exog_params: Incomplete | None = None, ar_params: Incomplete | None = None, ma_params: Incomplete | None = None, seasonal_ar_params: Incomplete | None = None, seasonal_ma_params: Incomplete | None = None, sigma2: Incomplete | None = None):
        """
    ...
    def unconstrain_params(self, constrained):
        ...
        array([0.57735, 2.     ])
        """
    def construct_trend_data(self, nobs, offset: int = 1): ...
