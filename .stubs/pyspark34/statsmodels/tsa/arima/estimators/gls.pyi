...
def gls(endog, exog: Incomplete | None = None, order=(0, 0, 0), seasonal_order=(0, 0, 0, 0), include_constant: Incomplete | None = None, n_iter: Incomplete | None = None, max_iter: int = 50, tolerance: float = 1e-08, arma_estimator: str = 'innovations_mle', arma_estimator_kwargs: Incomplete | None = None):
    """
