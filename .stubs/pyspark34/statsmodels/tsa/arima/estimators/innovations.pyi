...
def innovations(endog, ma_order: int = 0, demean: bool = True):
    """
    ...
    """
def innovations_mle(endog, order=(0, 0, 0), seasonal_order=(0, 0, 0, 0), demean: bool = True, enforce_invertibility: bool = True, start_params: Incomplete | None = None, minimize_kwargs: Incomplete | None = None):
    """
