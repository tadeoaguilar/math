...
def hannan_rissanen(endog, ar_order: int = 0, ma_order: int = 0, demean: bool = True, initial_ar_order: Incomplete | None = None, unbiased: Incomplete | None = None, fixed_params: Incomplete | None = None):
    '''
