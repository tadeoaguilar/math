...
class MarkovRegression(markov_switching.MarkovSwitching):
    ...
    '''
    trend: Incomplete
    switching_trend: Incomplete
    switching_exog: Incomplete
    switching_variance: Incomplete
    k_trend: int
    switching_coeffs: Incomplete
    def __init__(self, endog, k_regimes, trend: str = 'c', exog: Incomplete | None = None, order: int = 0, exog_tvtp: Incomplete | None = None, switching_trend: bool = True, switching_exog: bool = True, switching_variance: bool = False, dates: Incomplete | None = None, freq: Incomplete | None = None, missing: str = 'none') -> None: ...
