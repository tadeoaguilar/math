...
class MarkovAutoregression(markov_regression.MarkovRegression):
    ...
    '''
    switching_ar: Incomplete
    exog_ar: Incomplete
    orig_endog: Incomplete
    endog: Incomplete
    orig_exog: Incomplete
    exog: Incomplete
    def __init__(self, endog, k_regimes, order, trend: str = 'c', exog: Incomplete | None = None, exog_tvtp: Incomplete | None = None, switching_ar: bool = True, switching_trend: bool = True, switching_exog: bool = False, switching_variance: bool = False, dates: Incomplete | None = None, freq: Incomplete | None = None, missing: str = 'none') -> None: ...
