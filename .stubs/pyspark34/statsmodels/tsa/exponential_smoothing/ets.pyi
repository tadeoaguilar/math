...
class ETSModel(base.StateSpaceMLEModel):
    ...
    def __init__(self, endog, error: str = 'add', trend: Incomplete | None = None, damped_trend: bool = False, seasonal: Incomplete | None = None, seasonal_periods: Incomplete | None = None, initialization_method: str = 'estimated', initial_level: Incomplete | None = None, initial_trend: Incomplete | None = None, initial_seasonal: Incomplete | None = None, bounds: Incomplete | None = None, dates: Incomplete | None = None, freq: Incomplete | None = None, missing: str = 'none') -> None: ...
    initialization_method: Incomplete
    initial_level: Incomplete
    initial_trend: Incomplete
    initial_seasonal: Incomplete
    def set_initialization_method(self, initialization_method, initial_level: Incomplete | None = None, initial_trend: Incomplete | None = None, initial_seasonal: Incomplete | None = None) -> None:
        """
    ...
    @property
    def k_params(self): ...
    def fit(self, start_params: Incomplete | None = None, maxiter: int = 1000, full_output: bool = True, disp: bool = True, callback: Incomplete | None = None, return_params: bool = False, **kwargs):
        """
        ...
        **kwargs
        ...
        results : ETSResults
        """
    def use_internal_loglike(self) -> Generator[None, None, None]: ...
    def loglike(self, params, **kwargs):
        ...
        .. [1] J. K. Ord, A. B. Koehler R. D. and Snyder (1997). Estimation and
           ...
           *Journal of the American Statistical Association*, 92(440),
           1621-1629
        """
    def smooth(self, params, return_raw: bool = False):
        """
        ...
        """
    def hessian(self, params, approx_centered: bool = False, approx_complex_step: bool = True, **kwargs):
        """
        ...
        """
    def score(self, params, approx_centered: bool = False, approx_complex_step: bool = True, **kwargs): ...
...
class ETSResults(base.StateSpaceMLEResults):
    ...
    initial_level: Incomplete
    alpha: Incomplete
    smoothing_level: Incomplete
    slope: Incomplete
    initial_trend: Incomplete
    beta: Incomplete
    smoothing_trend: Incomplete
    season: Incomplete
    initial_seasonal: Incomplete
    gamma: Incomplete
    smoothing_seasonal: Incomplete
    phi: Incomplete
    damping_trend: Incomplete
    df_model: Incomplete
    mean_resid: Incomplete
    scale_resid: Incomplete
    ...
    def llf(self):
        ...
        """
    def simulate(self, nsimulations, anchor: Incomplete | None = None, repetitions: int = 1, random_errors: Incomplete | None = None, random_state: Incomplete | None = None):
        '''
    ...
    def forecast(self, steps: int = 1):
        ...
        """
    def predict(self, start: Incomplete | None = None, end: Incomplete | None = None, dynamic: bool = False, index: Incomplete | None = None):
        """
        ...
        """
    def get_prediction(self, start: Incomplete | None = None, end: Incomplete | None = None, dynamic: bool = False, index: Incomplete | None = None, method: Incomplete | None = None, simulate_repetitions: int = 1000, **simulate_kwargs):
        """
...
class PredictionResults:
    ...
    **simulate_kwargs :
    ...
    method: Incomplete
    predicted_mean: Incomplete
    row_labels: Incomplete
    endog: Incomplete
    model: Incomplete
    simulation_results: Incomplete
    forecast_variance: Incomplete
    def __init__(self, results, start: Incomplete | None = None, end: Incomplete | None = None, dynamic: bool = False, index: Incomplete | None = None, method: Incomplete | None = None, simulate_repetitions: int = 1000, **simulate_kwargs) -> None: ...
    @property
    def var_pred_mean(self):
        """The variance of the predicted mean"""
    def pred_int(self, alpha: float = 0.05):
        """
