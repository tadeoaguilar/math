...
class HoltWintersResults(Results):
    ...
    """
    data: Incomplete
    def __init__(self, model, params, sse, aic, aicc, bic, optimized, level, trend, season, params_formatted, resid, k, fittedvalues, fittedfcast, fcastvalues, mle_retvals: Incomplete | None = None) -> None: ...
    @property
    def aic(self):
        """
        The Akaike information criterion.
    ...
    def predict(self, start: Incomplete | None = None, end: Incomplete | None = None):
        """
    ...
    def summary(self):
        ...
        """
    def simulate(self, nsimulations, anchor: Incomplete | None = None, repetitions: int = 1, error: str = 'add', random_errors: Incomplete | None = None, random_state: Incomplete | None = None):
        '''
