...
def arma_innovations(endog, ar_params: Incomplete | None = None, ma_params: Incomplete | None = None, sigma2: int = 1, normalize: bool = False, prefix: Incomplete | None = None):
    '''
    ...
    '''
def arma_loglike(endog, ar_params: Incomplete | None = None, ma_params: Incomplete | None = None, sigma2: int = 1, prefix: Incomplete | None = None):
    """
    ...
    """
def arma_loglikeobs(endog, ar_params: Incomplete | None = None, ma_params: Incomplete | None = None, sigma2: int = 1, prefix: Incomplete | None = None):
    """
    ...
    """
def arma_score(endog, ar_params: Incomplete | None = None, ma_params: Incomplete | None = None, sigma2: int = 1, prefix: Incomplete | None = None):
    """
    ...
    """
def arma_scoreobs(endog, ar_params: Incomplete | None = None, ma_params: Incomplete | None = None, sigma2: int = 1, prefix: Incomplete | None = None):
    """
