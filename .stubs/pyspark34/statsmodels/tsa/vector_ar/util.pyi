...
from statsmodels.tools.validation import array_like as array_like, int_like as int_like

def get_var_endog(y, lags, trend: str = 'c', has_constant: str = 'skip'):
    """
    ...
    """
def get_trendorder(trend: str = 'c'): ...
def make_lag_names(names, lag_order, trendorder: int = 1, exog: Incomplete | None = None):
    """
...
def parse_lutkepohl_data(path):
    ...
    """
def norm_signif_level(alpha: float = 0.05): ...
def acf_to_acorr(acf): ...
def varsim(coefs, intercept, sig_u, steps: int = 100, initial_values: Incomplete | None = None, seed: Incomplete | None = None, nsimulations: Incomplete | None = None):
    """
...
def vech(A):
    ...
    """
def seasonal_dummies(n_seasons, len_endog, first_period: int = 0, centered: bool = False):
    """
