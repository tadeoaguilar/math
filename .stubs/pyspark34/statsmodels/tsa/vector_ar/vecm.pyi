...
from statsmodels.tsa.tsatools import duplication_matrix as duplication_matrix, lagmat as lagmat, vec as vec
...
def select_order(data, maxlags: int, deterministic: str = 'n', seasons: int = 0, exog: Incomplete | None = None, exog_coint: Incomplete | None = None):
    '''
...
class CointRankResults:
    ...
    neqs: Incomplete
    r_1: Incomplete
    test_stats: Incomplete
    crit_vals: Incomplete
    method: Incomplete
    signif: Incomplete
    def __init__(self, rank, neqs, test_stats, crit_vals, method: str = 'trace', signif: float = 0.05) -> None: ...
    def summary(self): ...

def select_coint_rank(endog, det_order, k_ar_diff, method: str = 'trace', signif: float = 0.05):
...
class VECM(tsbase.TimeSeriesModel):
    ...
    '''
    y: Incomplete
    exog_coint: Incomplete
    neqs: Incomplete
    k_ar: Incomplete
    k_ar_diff: Incomplete
    coint_rank: Incomplete
    deterministic: Incomplete
    seasons: Incomplete
    first_season: Incomplete
    load_coef_repr: str
    def __init__(self, endog, exog: Incomplete | None = None, exog_coint: Incomplete | None = None, dates: Incomplete | None = None, freq: Incomplete | None = None, missing: str = 'none', k_ar_diff: int = 1, coint_rank: int = 1, deterministic: str = 'n', seasons: int = 0, first_season: int = 0) -> None: ...
    def fit(self, method: str = 'ml'):
        '''
...
class VECMResults:
    ...
    coint_rank: Incomplete
    alpha: Incomplete
    const_coint: Incomplete
    lin_trend_coint: Incomplete
    exog_coint_coefs: Incomplete
    sigma_u: Incomplete
    nobs: Incomplete
    def __init__(self, endog, exog, exog_coint, k_ar, coint_rank, alpha, beta, gamma, sigma_u, deterministic: str = 'n', seasons: int = 0, first_season: int = 0, delta_y_1_T: Incomplete | None = None, y_lag1: Incomplete | None = None, delta_x: Incomplete | None = None, model: Incomplete | None = None, names: Incomplete | None = None, dates: Incomplete | None = None) -> None: ...
    def llf(self):
        """
    ...
    def conf_int_alpha(self, alpha: float = 0.05): ...
    def conf_int_beta(self, alpha: float = 0.05): ...
    def conf_int_det_coef_coint(self, alpha: float = 0.05): ...
    def conf_int_gamma(self, alpha: float = 0.05): ...
    def conf_int_det_coef(self, alpha: float = 0.05): ...
    def var_rep(self): ...
    ...
    def orth_ma_rep(self, maxn: int = 10, P: Incomplete | None = None):
        ...
        """
    def predict(self, steps: int = 5, alpha: Incomplete | None = None, exog_fc: Incomplete | None = None, exog_coint_fc: Incomplete | None = None):
        """
        ...
        forecast - ndarray (steps x neqs) or three ndarrays
            ...
            forecast.
        """
    def plot_forecast(self, steps, alpha: float = 0.05, plot_conf_int: bool = True, n_last_obs: Incomplete | None = None) -> None:
        """
        Plot the forecast.
        ...
        """
    def test_granger_causality(self, caused, causing: Incomplete | None = None, signif: float = 0.05):
        '''
    ...
    def test_whiteness(self, nlags: int = 10, signif: float = 0.05, adjusted: bool = False):
        ...
        .. [1] Lütkepohl, H. 2005. *New Introduction to Multiple Time Series Analysis*. Springer.
        """
    def plot_data(self, with_presample: bool = False) -> None:
        """
