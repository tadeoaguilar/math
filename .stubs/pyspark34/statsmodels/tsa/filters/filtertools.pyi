...
def fftconvolveinv(in1, in2, mode: str = 'full'):
    """
    ...
    """
def fftconvolve3(in1, in2: Incomplete | None = None, in3: Incomplete | None = None, mode: str = 'full'):
    """
    Convolve two N-dimensional arrays using FFT. See convolve.
    ...
    * note in2 and in3 need to have consistent dimension/shape
    ...
    original signal.fftconvolve also uses fftn
    """
def recursive_filter(x, ar_coeff, init: Incomplete | None = None):
    """
    ...
    """
def convolution_filter(x, filt, nsides: int = 2):
    """
    ...
    faster.
    """
def miso_lfilter(ar, ma, x, useic: bool = False):
    """
