...
class DynamicFactor(MLEModel):
    ...
    **kwargs
    ...
    error_order: Incomplete
    error_var: Incomplete
    error_cov_type: Incomplete
    mle_regression: Incomplete
    parameters: Incomplete
    k_params: Incomplete
    def __init__(self, endog, k_factors, factor_order, exog: Incomplete | None = None, error_order: int = 0, error_var: bool = False, error_cov_type: str = 'diagonal', enforce_stationarity: bool = True, **kwargs) -> None: ...
...
class DynamicFactorResults(MLEResults):
    ...
    coefficient_matrices_error: Incomplete
    ...
    def coefficients_of_determination(self):
        ...
        """
    def plot_coefficients_of_determination(self, endog_labels: Incomplete | None = None, fig: Incomplete | None = None, figsize: Incomplete | None = None):
        """
