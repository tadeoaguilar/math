...
class SARIMAX(MLEModel):
    ...
    **kwargs
    ...
    k_states: Incomplete
    k_posdef: Incomplete
    def __init__(self, endog, exog: Incomplete | None = None, order=(1, 0, 0), seasonal_order=(0, 0, 0, 0), trend: Incomplete | None = None, measurement_error: bool = False, time_varying_regression: bool = False, mle_regression: bool = True, simple_differencing: bool = False, enforce_stationarity: bool = True, enforce_invertibility: bool = True, hamilton_representation: bool = False, concentrate_scale: bool = False, trend_offset: int = 1, use_exact_diffuse: bool = False, dates: Incomplete | None = None, freq: Incomplete | None = None, missing: str = 'none', validate_specification: bool = True, **kwargs) -> None: ...
