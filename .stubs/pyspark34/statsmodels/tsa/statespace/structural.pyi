...
class UnobservedComponents(MLEModel):
    ...
    **Regression effects**
    ...
    seasonal: Incomplete
    freq_seasonal_periods: Incomplete
    freq_seasonal_harmonics: Incomplete
    freq_seasonal: Incomplete
    cycle: Incomplete
    ar_order: Incomplete
    autoregressive: Incomplete
    irregular: Incomplete
    stochastic_level: Incomplete
    stochastic_trend: Incomplete
    stochastic_seasonal: Incomplete
    stochastic_freq_seasonal: Incomplete
    stochastic_cycle: Incomplete
    damped_cycle: Incomplete
    mle_regression: Incomplete
    use_exact_diffuse: Incomplete
    trend_specification: Incomplete
    trend_mask: Incomplete
    regression: Incomplete
    cycle_frequency_bound: Incomplete
    def __init__(self, endog, level: bool = False, trend: bool = False, seasonal: Incomplete | None = None, freq_seasonal: Incomplete | None = None, cycle: bool = False, autoregressive: Incomplete | None = None, exog: Incomplete | None = None, irregular: bool = False, stochastic_level: bool = False, stochastic_trend: bool = False, stochastic_seasonal: bool = True, stochastic_freq_seasonal: Incomplete | None = None, stochastic_cycle: bool = False, damped_cycle: bool = False, cycle_period_bounds: Incomplete | None = None, mle_regression: bool = True, use_exact_diffuse: bool = False, **kwargs) -> None: ...
    parameters: Incomplete
    parameters_obs_intercept: Incomplete
    parameters_obs_cov: Incomplete
    parameters_transition: Incomplete
    parameters_state_cov: Incomplete
    k_obs_intercept: Incomplete
    k_obs_cov: Incomplete
    k_transition: Incomplete
    k_state_cov: Incomplete
    k_params: Incomplete
    def setup(self) -> None:
        """
    ...
    def initialize_default(self, approximate_diffuse_variance: Incomplete | None = None) -> None: ...
    ...
    def regression_coefficients(self):
        ...
        out: Bunch
            ...
            - `offset`: an integer giving the offset in the state vector where
                        this component begins
        """
    def plot_components(self, which: Incomplete | None = None, alpha: float = 0.05, observed: bool = True, level: bool = True, trend: bool = True, seasonal: bool = True, freq_seasonal: bool = True, cycle: bool = True, autoregressive: bool = True, legend_loc: str = 'upper right', fig: Incomplete | None = None, figsize: Incomplete | None = None):
        """
