...
class FactorBlock(dict):
    ...
    """
    factor_names: Incomplete
    k_factors: Incomplete
    factor_order: Incomplete
    endog_factor_map: Incomplete
    state_offset: Incomplete
    k_endog_Q: Incomplete
    k_states: Incomplete
...
class DynamicFactorMQStates(dict):
    ...
    '''
    k_endog_M: Incomplete
    k_endog_Q: Incomplete
    k_endog: Incomplete
    idiosyncratic_ar1: Incomplete
    factors: Incomplete
    factor_orders: Incomplete
    factor_multiplicities: Incomplete
    endog_factor_map: Incomplete
    k_factors: Incomplete
    loading_counts: Incomplete
    block_loading_counts: Incomplete
    factor_block_orders: Incomplete
    factor_names: Incomplete
    max_factor_order: Incomplete
    k_states_factors: int
    k_posdef_factors: int
    factor_blocks: Incomplete
    k_states_idio_M: Incomplete
    k_states_idio_Q: Incomplete
    k_states_idio: Incomplete
    k_posdef_idio_M: Incomplete
    k_posdef_idio_Q: Incomplete
    k_posdef_idio: Incomplete
    k_states: Incomplete
    k_posdef: Incomplete
...
class DynamicFactorMQ(mlemodel.MLEModel):
    ...
    *Impulse responses*
    ...
    factor_names: Incomplete
    k_factors: Incomplete
    k_factor_blocks: Incomplete
    max_factor_order: Incomplete
    idiosyncratic_ar1: Incomplete
    init_t0: Incomplete
    obs_cov_diag: Incomplete
    standardize: Incomplete
    params: Incomplete
    k_params: Incomplete
    def __init__(self, endog, k_endog_monthly: Incomplete | None = None, factors: int = 1, factor_orders: int = 1, factor_multiplicities: Incomplete | None = None, idiosyncratic_ar1: bool = True, standardize: bool = True, endog_quarterly: Incomplete | None = None, init_t0: bool = False, obs_cov_diag: bool = False, **kwargs) -> None: ...
    @classmethod
    def construct_endog(cls, endog_monthly, endog_quarterly):
        ...
        """
    def clone(self, endog, k_endog_monthly: Incomplete | None = None, endog_quarterly: Incomplete | None = None, retain_standardization: bool = False, **kwargs):
        """
        ...
        """
    model: Incomplete
    def summary(self, truncate_endog_names: Incomplete | None = None):
        """
    ...
    def loading_constraints(self, i):
        ...
        """
    def fit(self, start_params: Incomplete | None = None, transformed: bool = True, includes_fixed: bool = False, cov_type: str = 'none', cov_kwds: Incomplete | None = None, method: str = 'em', maxiter: int = 500, tolerance: float = 1e-06, em_initialization: bool = True, mstep_method: Incomplete | None = None, full_output: int = 1, disp: bool = False, callback: Incomplete | None = None, return_params: bool = False, optim_score: Incomplete | None = None, optim_complex_step: Incomplete | None = None, optim_hessian: Incomplete | None = None, flags: Incomplete | None = None, low_memory: bool = False, llf_decrease_action: str = 'revert', llf_decrease_tolerance: float = 0.0001, **kwargs):
        """
        ...
        **kwargs
        ...
        """
    def fit_em(self, start_params: Incomplete | None = None, transformed: bool = True, cov_type: str = 'none', cov_kwds: Incomplete | None = None, maxiter: int = 500, tolerance: float = 1e-06, disp: bool = False, em_initialization: bool = True, mstep_method: Incomplete | None = None, full_output: bool = True, return_params: bool = False, low_memory: bool = False, llf_decrease_action: str = 'revert', llf_decrease_tolerance: float = 0.0001):
        '''
        ...
        statsmodels.tsa.statespace.mlemodel.MLEResults
        '''
    def smooth(self, params, transformed: bool = True, includes_fixed: bool = False, complex_step: bool = False, cov_type: str = 'none', cov_kwds: Incomplete | None = None, return_ssm: bool = False, results_class: Incomplete | None = None, results_wrapper_class: Incomplete | None = None, **kwargs):
        """
        Kalman smoothing.
        ...
        **kwargs
        ...
        """
    def filter(self, params, transformed: bool = True, includes_fixed: bool = False, complex_step: bool = False, cov_type: str = 'none', cov_kwds: Incomplete | None = None, return_ssm: bool = False, results_class: Incomplete | None = None, results_wrapper_class: Incomplete | None = None, low_memory: bool = False, **kwargs):
        """
        Kalman filtering.
        ...
        **kwargs
            ...
            `KalmanFilter.filter` for more details.
        """
    def simulate(self, params, nsimulations, measurement_shocks: Incomplete | None = None, state_shocks: Incomplete | None = None, initial_state: Incomplete | None = None, anchor: Incomplete | None = None, repetitions: Incomplete | None = None, exog: Incomplete | None = None, extend_model: Incomplete | None = None, extend_kwargs: Incomplete | None = None, transformed: bool = True, includes_fixed: bool = False, original_scale: bool = True, **kwargs):
        '''
        ...
        '''
    def impulse_responses(self, params, steps: int = 1, impulse: int = 0, orthogonalized: bool = False, cumulative: bool = False, anchor: Incomplete | None = None, exog: Incomplete | None = None, extend_model: Incomplete | None = None, extend_kwargs: Incomplete | None = None, transformed: bool = True, includes_fixed: bool = False, original_scale: bool = True, **kwargs):
        '''
...
class DynamicFactorMQResults(mlemodel.MLEResults):
    ...
    def factors(self):
        ...
        """
    def get_coefficients_of_determination(self, method: str = 'individual', which: Incomplete | None = None):
        '''
    ...
    def coefficients_of_determination(self):
        ...
        plot_coefficients_of_determination
        """
    def plot_coefficients_of_determination(self, method: str = 'individual', which: Incomplete | None = None, endog_labels: Incomplete | None = None, fig: Incomplete | None = None, figsize: Incomplete | None = None):
        '''
        ...
        get_coefficients_of_determination
        '''
    def get_prediction(self, start: Incomplete | None = None, end: Incomplete | None = None, dynamic: bool = False, information_set: str = 'predicted', signal_only: bool = False, original_scale: bool = True, index: Incomplete | None = None, exog: Incomplete | None = None, extend_model: Incomplete | None = None, extend_kwargs: Incomplete | None = None, **kwargs):
        '''
        ...
        **kwargs
        ...
        '''
    def news(self, comparison, impact_date: Incomplete | None = None, impacted_variable: Incomplete | None = None, start: Incomplete | None = None, end: Incomplete | None = None, periods: Incomplete | None = None, exog: Incomplete | None = None, comparison_type: Incomplete | None = None, state_index: Incomplete | None = None, return_raw: bool = False, tolerance: float = 1e-10, endog_quarterly: Incomplete | None = None, original_scale: bool = True, **kwargs):
        '''
        ...
        .. [3] Bańbura, Marta, Domenico Giannone, Michele Modugno, and Lucrezia
               ...
               Elsevier, 2013.
        '''
    def get_smoothed_decomposition(self, decomposition_of: str = 'smoothed_state', state_index: Incomplete | None = None, original_scale: bool = True):
        '''
        ...
        '''
    def append(self, endog, endog_quarterly: Incomplete | None = None, refit: bool = False, fit_kwargs: Incomplete | None = None, copy_initialization: bool = True, retain_standardization: bool = True, **kwargs):
        """
        ...
        **kwargs
        ...
        apply
        """
    def extend(self, endog, endog_quarterly: Incomplete | None = None, fit_kwargs: Incomplete | None = None, retain_standardization: bool = True, **kwargs):
        """
        ...
        **kwargs
        ...
        """
    def apply(self, endog, k_endog_monthly: Incomplete | None = None, endog_quarterly: Incomplete | None = None, refit: bool = False, fit_kwargs: Incomplete | None = None, copy_initialization: bool = False, retain_standardization: bool = True, **kwargs):
        """
        ...
        **kwargs
        ...
        """
    def summary(self, alpha: float = 0.05, start: Incomplete | None = None, title: Incomplete | None = None, model_name: Incomplete | None = None, display_params: bool = True, display_diagnostics: bool = False, display_params_as_list: bool = False, truncate_endog_names: Incomplete | None = None, display_max_endog: int = 3):
        """
        Summarize the Model.
