...
class CFASimulationSmoother:
    ...
    **Not-yet-implemented**:
    ...
    def __init__(self, model, cfa_simulation_smoother_classes: Incomplete | None = None) -> None: ...
    @property
    ...
    def posterior_cov(self):
        ...
        **Warning**: the matrix computed when accessing this property can be
        ...
        """
    simulated_state: Incomplete
    def simulate(self, variates: Incomplete | None = None, update_posterior: bool = True) -> None:
        """
