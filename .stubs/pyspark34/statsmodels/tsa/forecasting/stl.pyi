...
%(stl_forecast_params)s
    ...
    * ``results`` may also exposes a method ``get_prediction`` that produces
    ...
    >>> forecasts = res.forecast(12)
    '''
    def __init__(self, endog, model, *, model_kwargs: Incomplete | None = None, period: Incomplete | None = None, seasonal: int = 7, trend: Incomplete | None = None, low_pass: Incomplete | None = None, seasonal_deg: int = 1, trend_deg: int = 1, low_pass_deg: int = 1, robust: bool = False, seasonal_jump: int = 1, trend_jump: int = 1, low_pass_jump: int = 1) -> None: ...
    def fit(self, *, inner_iter: Incomplete | None = None, outer_iter: Incomplete | None = None, fit_kwargs: Incomplete | None = None):
        """
...
class STLForecastResults:
    ...
    def summary(self) -> Summary:
        ...
        """
    def forecast(self, steps: int = 1, **kwargs: Dict[str, Any]) -> np.ndarray | pd.Series:
        """
        ...
        **kwargs
        ...
        forecast : {ndarray, Series}
            Out of sample forecasts
        """
    def get_prediction(self, start: DateLike | None = None, end: DateLike | None = None, dynamic: bool | DateLike = False, **kwargs: Dict[str, Any]):
        """
