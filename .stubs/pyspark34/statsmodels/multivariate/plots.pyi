...
def plot_scree(eigenvals, total_var, ncomp: Incomplete | None = None, x_label: str = 'factor'):
    """
    ...
    """
def plot_loadings(loadings, col_names: Incomplete | None = None, row_names: Incomplete | None = None, loading_pairs: Incomplete | None = None, percent_variance: Incomplete | None = None, title: str = 'Factor patterns'):
    """
