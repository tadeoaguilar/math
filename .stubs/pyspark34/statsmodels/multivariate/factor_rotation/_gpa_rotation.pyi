...
def GPA(A, ff: Incomplete | None = None, vgQ: Incomplete | None = None, T: Incomplete | None = None, max_tries: int = 501, rotation_method: str = 'orthogonal', tol: float = 1e-05):
    """
...
def Gf(T, ff):
    ...
    """
def rotateA(A, T, rotation_method: str = 'orthogonal'):
    """
    For orthogonal rotation methods :math:`L=AT`, where :math:`T` is an
    orthogonal matrix. For oblique rotation matrices :math:`L=A(T^*)^{-1}`,
    where :math:`T` is a normal matrix, i.e., :math:`TT^*=T^*T`. Oblique
    ...
    in the interpretation.
    """
def oblimin_objective(L: Incomplete | None = None, A: Incomplete | None = None, T: Incomplete | None = None, gamma: int = 0, rotation_method: str = 'orthogonal', return_gradient: bool = True):
    """
    ...
    * :math:`\\gamma=\\frac{1}{2}` corresponds to biquartimin.
    ...
    """
def orthomax_objective(L: Incomplete | None = None, A: Incomplete | None = None, T: Incomplete | None = None, gamma: int = 0, return_gradient: bool = True):
    """
    ...
    * :math:`\\gamma=\\frac{1}{p}` corresponds to equamax.
    ...
    return_gradient : bool (default True)
        toggles return of gradient
    """
def CF_objective(L: Incomplete | None = None, A: Incomplete | None = None, T: Incomplete | None = None, kappa: int = 0, rotation_method: str = 'orthogonal', return_gradient: bool = True):
    """
    ...
    * :math:`\\kappa=1` corresponds to factor parsimony.
    ...
    return_gradient : bool (default True)
        toggles return of gradient
    """
def vgQ_target(H, L: Incomplete | None = None, A: Incomplete | None = None, T: Incomplete | None = None, rotation_method: str = 'orthogonal'):
    """
    ...
    rotation_method : str
        should be one of {orthogonal, oblique}
    """
def ff_target(H, L: Incomplete | None = None, A: Incomplete | None = None, T: Incomplete | None = None, rotation_method: str = 'orthogonal'):
    """
    ...
    rotation_method : str
        should be one of {orthogonal, oblique}
    """
def vgQ_partial_target(H, W: Incomplete | None = None, L: Incomplete | None = None, A: Incomplete | None = None, T: Incomplete | None = None):
    """
    ...
    T : numpy matrix (default None)
        rotation matrix
    """
def ff_partial_target(H, W: Incomplete | None = None, L: Incomplete | None = None, A: Incomplete | None = None, T: Incomplete | None = None):
    """
    Subroutine for the value of vgQ using orthogonal rotation towards a partial
    target matrix, i.e., we minimize:
