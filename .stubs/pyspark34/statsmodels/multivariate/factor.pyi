...
class Factor(Model):
    ...
    **Experimental**
    ...
    n_factor: Incomplete
    loadings: Incomplete
    communality: Incomplete
    method: Incomplete
    smc: Incomplete
    nobs: Incomplete
    corr: Incomplete
    k_endog: Incomplete
    def __init__(self, endog: Incomplete | None = None, n_factor: int = 1, corr: Incomplete | None = None, method: str = 'pa', smc: bool = True, endog_names: Incomplete | None = None, nobs: Incomplete | None = None, missing: str = 'drop') -> None: ...
    @property
    def endog_names(self):
        """Names of endogenous variables"""
    @endog_names.setter
    def endog_names(self, value) -> None: ...
    def fit(self, maxiter: int = 50, tol: float = 1e-08, start: Incomplete | None = None, opt_method: str = 'BFGS', opt: Incomplete | None = None, em_iter: int = 3):
        """
...
class FactorResults:
    ...
    loadings_no_rot: Incomplete
    eigenvals: Incomplete
    communality: Incomplete
    uniqueness: Incomplete
    rotation_method: Incomplete
    fa_method: Incomplete
    n_comp: Incomplete
    nobs: Incomplete
    mle_retvals: Incomplete
    df: Incomplete
    loadings: Incomplete
    ...
    def rotate(self, method) -> None:
        ...
        """
    def factor_score_params(self, method: str = 'bartlett'):
        """
        ...
        """
    def factor_scoring(self, endog: Incomplete | None = None, method: str = 'bartlett', transform: bool = True):
        """
    ...
    def summary(self):
        """Summary"""
    def get_loadings_frame(self, style: str = 'display', sort_: bool = True, threshold: float = 0.3, highlight_max: bool = True, color_max: str = 'yellow', decimals: Incomplete | None = None):
        ...
        >>> print(lds.to_latex())
        """
    def plot_scree(self, ncomp: Incomplete | None = None):
        """
        ...
        """
    def plot_loadings(self, loading_pairs: Incomplete | None = None, plot_prerotated: bool = False):
        """
    ...
    def fitted_cov(self):
        ...
        """
    def uniq_stderr(self, kurt: int = 0):
        """
