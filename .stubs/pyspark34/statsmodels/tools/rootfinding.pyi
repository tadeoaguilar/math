...
def brentq_expanding(func, low: Incomplete | None = None, upp: Incomplete | None = None, args=(), xtol: float = 1e-05, start_low: Incomplete | None = None, start_upp: Incomplete | None = None, increasing: Incomplete | None = None, max_it: int = 100, maxiter_bq: int = 100, factor: int = 10, full_output: bool = False):
