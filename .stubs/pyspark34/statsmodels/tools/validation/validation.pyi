...
def array_like(obj, name, dtype=..., ndim: int = 1, maxdim: Incomplete | None = None, shape: Incomplete | None = None, order: Incomplete | None = None, contiguous: bool = False, optional: bool = False, writeable: bool = True):
    """
...
class PandasWrapper:
    ...
    def wrap(self, obj, columns: Incomplete | None = None, append: Incomplete | None = None, trim_start: int = 0, trim_end: int = 0):
        """
        Parameters
        ----------
        obj : {array_like}
...
def bool_like(value, name, optional: bool = False, strict: bool = False):
    """
    ...
    """
def int_like(value: Any, name: str, optional: bool = False, strict: bool = False) -> int | None:
    """
...
def required_int_like(value: Any, name: str, strict: bool = False) -> int:
    ...
    converted : int
        value converted to a int
    """
def float_like(value, name, optional: bool = False, strict: bool = False):
    """
    ...
    """
def string_like(value, name, optional: bool = False, options: Incomplete | None = None, lower: bool = True):
    """
    ...
    """
def dict_like(value, name, optional: bool = False, strict: bool = True):
    """
