...
def asstr2(s): ...
def drop_missing(Y, X: Incomplete | None = None, axis: int = 1):
    """
    ...
    """
def categorical(data, col: Incomplete | None = None, dictnames: bool = False, drop: bool = False) -> None:
    """
...
def isestimable(c, d):
    ...
    True
    """
def pinv_extended(x, rcond: float = 1e-15):
    """
...
def clean0(matrix):
    ...
    ndarray
        The cleaned array.
    """
def fullrank(x, r: Incomplete | None = None):
    """
...
def matrix_rank(m, tol: Incomplete | None = None, method: str = 'qr'):
    '''
