...
def fit_l1_cvxopt_cp(f, score, start_params, args, kwargs, disp: bool = False, maxiter: int = 100, callback: Incomplete | None = None, retall: bool = False, full_output: bool = False, hess: Incomplete | None = None):
    '''
