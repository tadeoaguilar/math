...
class Model:
    ...
    exog: Incomplete
    endog: Incomplete
    def __init__(self, endog, exog: Incomplete | None = None, **kwargs) -> None: ...
    @classmethod
    ...
    def fit(self) -> None:
        ...
        Fit a model to data.
        """
    def predict(self, params, exog: Incomplete | None = None, *args, **kwargs) -> None:
        """
...
class LikelihoodModel(Model):
    ...
    def hessian(self, params) -> None:
        ...
        """
    def fit(self, start_params: Incomplete | None = None, method: str = 'newton', maxiter: int = 100, full_output: bool = True, disp: bool = True, fargs=(), callback: Incomplete | None = None, retall: bool = False, skip_hessian: bool = False, **kwargs):
        '''
...
class GenericLikelihoodModel(LikelihoodModel):
    ...
    '''
    nparams: Incomplete
    def __init__(self, endog, exog: Incomplete | None = None, loglike: Incomplete | None = None, score: Incomplete | None = None, hessian: Incomplete | None = None, missing: str = 'none', extra_params_names: Incomplete | None = None, **kwds) -> None: ...
    df_model: Incomplete
    df_resid: Incomplete
    def initialize(self):
        """
    ...
    def hessian(self, params):
        ...
        """
    def hessian_factor(self, params, scale: Incomplete | None = None, observed: bool = True) -> None:
...
class LikelihoodModelResults(Results):
    ...
    cov_type: str
    cov_kwds: Incomplete
    def __init__(self, model, params, normalized_cov_params: Incomplete | None = None, scale: float = 1.0, **kwargs) -> None: ...
    ...
    def cov_params(self, r_matrix: Incomplete | None = None, column: Incomplete | None = None, scale: Incomplete | None = None, cov_p: Incomplete | None = None, other: Incomplete | None = None):
        """
        ...
        """
    def t_test(self, r_matrix, cov_p: Incomplete | None = None, use_t: Incomplete | None = None):
        """
        ...
        ==============================================================================
        """
    def f_test(self, r_matrix, cov_p: Incomplete | None = None, invcov: Incomplete | None = None):
        """
        ...
        """
    def wald_test(self, r_matrix, cov_p: Incomplete | None = None, invcov: Incomplete | None = None, use_f: Incomplete | None = None, df_constraints: Incomplete | None = None, scalar: Incomplete | None = None):
        """
        ...
        where the rank of the covariance of the noise is not full.
        """
    def wald_test_terms(self, skip_single: bool = False, extra_constraints: Incomplete | None = None, combine_terms: Incomplete | None = None, scalar: Incomplete | None = None):
        '''
        ...
        '''
    def t_test_pairwise(self, term_name, method: str = 'hs', alpha: float = 0.05, factor_labels: Incomplete | None = None):
        '''
...
class ResultMixin:
    ...
    def bsejac(self):
        ...
        """
    bootstrap_results: Incomplete
    def bootstrap(self, nrep: int = 100, method: str = 'nm', disp: int = 0, store: int = 1):
...
class _LLRMixin:
    ...
    """
    def pseudo_rsquared(self, kind: str = 'mcf'):
        """
...
class GenericLikelihoodModelResults(LikelihoodModelResults, ResultMixin):
    ...
    def get_prediction(self, exog: Incomplete | None = None, which: str = 'mean', transform: bool = True, row_labels: Incomplete | None = None, average: bool = False, agg_weights: Incomplete | None = None, **kwargs):
        '''
