...
def fit_l1_slsqp(f, score, start_params, args, kwargs, disp: bool = False, maxiter: int = 1000, callback: Incomplete | None = None, retall: bool = False, full_output: bool = False, hess: Incomplete | None = None):
    '''
