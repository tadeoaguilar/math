...
class LinearConstraints:
    ...
    """
    constraint_matrix: Incomplete
    constraint_values: Incomplete
...
class TransformRestriction:
    ...
    """
    k_unconstr: Incomplete
    evals: Incomplete
    evecs: Incomplete
    transf_mat: Incomplete
    constant: Incomplete
    def __init__(self, R, q: Incomplete | None = None) -> None: ...
...
def transform_params_constraint(params, Sinv, R, q):
    ...
    """
def fit_constrained(model, constraint_matrix, constraint_values, start_params: Incomplete | None = None, fit_kwds: Incomplete | None = None):
    ...
    **fit_kwds : keyword arguments
    ...
    """
def fit_constrained_wrap(model, constraints, start_params: Incomplete | None = None, **fit_kwds):
