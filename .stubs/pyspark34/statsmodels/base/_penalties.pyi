...
class PseudoHuber(Penalty):
    ...
    """
    dlt: Incomplete
    def __init__(self, dlt, weights: float = 1.0) -> None: ...
    def func(self, params): ...
    def deriv(self, params): ...
    def deriv2(self, params): ...
...
class SCAD(Penalty):
    ...
    tau: Incomplete
    c: Incomplete
    def __init__(self, tau, c: float = 3.7, weights: float = 1.0) -> None: ...
    def func(self, params): ...
    def deriv(self, params): ...
    def deriv2(self, params):
...
class SCADSmoothed(SCAD):
    ...
    def __init__(self, tau, c: float = 3.7, c0: Incomplete | None = None, weights: float = 1.0, restriction: Incomplete | None = None) -> None: ...
    def func(self, params): ...
    def deriv(self, params): ...
    def deriv2(self, params): ...
...
class ConstraintsPenalty:
    ...
    weights: float
    restriction: Incomplete
    def __init__(self, penalty, weights: Incomplete | None = None, restriction: Incomplete | None = None) -> None: ...
    def func(self, params):
...
class L2ConstraintsPenalty(ConstraintsPenalty):
    ...
    """
    def __init__(self, weights: Incomplete | None = None, restriction: Incomplete | None = None, sigma_prior: Incomplete | None = None) -> None: ...
