...
class CovStruct:
    ...
    """
    dep_params: Incomplete
    cov_adjust: Incomplete
    cov_nearest_method: Incomplete
    def __init__(self, cov_nearest_method: str = 'clipped') -> None: ...
    model: Incomplete
...
class Nested(CovStruct):
    ...
    """
    id_matrix: Incomplete
    designx: Incomplete
    ilabels: Incomplete
    designx_u: Incomplete
    designx_s: Incomplete
    designx_v: Incomplete
    def initialize(self, model) -> None:
        """
...
class Stationary(CovStruct):
    ...
    grid: Incomplete
    dep_params: Incomplete
    def __init__(self, max_lag: int = 1, grid: Incomplete | None = None) -> None: ...
    time: Incomplete
    def initialize(self, model) -> None: ...
    def update(self, params) -> None: ...
...
class Autoregressive(CovStruct):
    ...
    """
    dist_func: Incomplete
    grid: Incomplete
    designx: Incomplete
    dep_params: float
    def __init__(self, dist_func: Incomplete | None = None, grid: Incomplete | None = None) -> None: ...
    def update(self, params) -> None: ...
    def covariance_matrix(self, endog_expval, index): ...
    def covariance_matrix_solve(self, expval, index, stdev, rhs): ...
    def summary(self): ...
...
class Equivalence(CovStruct):
    ...
    pairs: Incomplete
    labels: Incomplete
    return_cov: Incomplete
    def __init__(self, pairs: Incomplete | None = None, labels: Incomplete | None = None, return_cov: bool = False) -> None: ...
    dep_params: Incomplete
