...
class Runs:
    ...
    runstart: Incomplete
    runs: Incomplete
    runs_sign: Incomplete
    runs_pos: Incomplete
    runs_neg: Incomplete
    runs_freqs: Incomplete
    n_runs: Incomplete
    n_pos: Incomplete
    def __init__(self, x) -> None: ...
    npo: Incomplete
    nne: Incomplete
    def runs_test(self, correction: bool = True):
...
def runstest_1samp(x, cutoff: str = 'mean', correction: bool = True):
    ...
    """
def runstest_2samp(x, y: Incomplete | None = None, groups: Incomplete | None = None, correction: bool = True):
...
def cochrans_q(x):
    ...
    """
def mcnemar(x, y: Incomplete | None = None, exact: bool = True, correction: bool = True):
    """McNemar test
