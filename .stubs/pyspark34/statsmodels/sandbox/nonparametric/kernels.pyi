...
class NdKernel:
    ...
    """
    weights: Incomplete
    def __init__(self, n, kernels: Incomplete | None = None, H: Incomplete | None = None) -> None: ...
    def getH(self):
...
class CustomKernel:
    ...
    domain: Incomplete
    weights: Incomplete
    def __init__(self, shape, h: float = 1.0, domain: Incomplete | None = None, norm: Incomplete | None = None) -> None:
        """
    ...
    def density_var(self, density, nobs):
        ...
        """
    def density_confint(self, density, nobs, alpha: float = 0.05):
    ...
    def smoothvar(self, xs, ys, x):
        ...
        """
    def smoothconf(self, xs, ys, x, alpha: float = 0.05):
