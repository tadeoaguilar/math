...
def mean_diff_plot(m1, m2, sd_limit: float = 1.96, ax: Incomplete | None = None, scatter_kwds: Incomplete | None = None, mean_line_kwds: Incomplete | None = None, limit_lines_kwds: Incomplete | None = None):
    '''
