...
def plot_corr(dcorr, xnames: Incomplete | None = None, ynames: Incomplete | None = None, title: Incomplete | None = None, normcolor: bool = False, ax: Incomplete | None = None, cmap: str = 'RdYlBu_r'):
    ...
    """
def plot_corr_grid(dcorrs, titles: Incomplete | None = None, ncols: Incomplete | None = None, normcolor: bool = False, xnames: Incomplete | None = None, ynames: Incomplete | None = None, fig: Incomplete | None = None, cmap: str = 'RdYlBu_r'):
    """
