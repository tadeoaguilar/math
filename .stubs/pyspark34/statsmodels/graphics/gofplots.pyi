...
class ProbPlot:
    ...
    def __init__(self, data, dist=..., fit: bool = False, distargs=(), a: int = 0, loc: int = 0, scale: int = 1) -> None: ...
    ...
    def sample_percentiles(self):
        """Sample percentiles"""
    def ppplot(self, xlabel: Incomplete | None = None, ylabel: Incomplete | None = None, line: Incomplete | None = None, other: Incomplete | None = None, ax: Incomplete | None = None, **plotkwargs):
        '''
        ...
        **plotkwargs
        ...
        Figure
            ...
            `ax` is connected.
        '''
    def qqplot(self, xlabel: Incomplete | None = None, ylabel: Incomplete | None = None, line: Incomplete | None = None, other: Incomplete | None = None, ax: Incomplete | None = None, swap: bool = False, **plotkwargs):
        '''
        ...
        **plotkwargs
        ...
        Figure
            ...
            `ax` is connected.
        '''
    def probplot(self, xlabel: Incomplete | None = None, ylabel: Incomplete | None = None, line: Incomplete | None = None, exceed: bool = False, ax: Incomplete | None = None, **plotkwargs):
        '''
...
def qqplot(data, dist=..., distargs=(), a: int = 0, loc: int = 0, scale: int = 1, fit: bool = False, line: Incomplete | None = None, ax: Incomplete | None = None, **plotkwargs):
    '''
    ...
    **plotkwargs
    ...
    .. plot:: plots/graphics_gofplots_qqplot.py
    '''
def qqplot_2samples(data1, data2, xlabel: Incomplete | None = None, ylabel: Incomplete | None = None, line: Incomplete | None = None, ax: Incomplete | None = None):
    '''
    ...
    ...                       line=None, ax=None)
    '''
def qqline(ax, line, x: Incomplete | None = None, y: Incomplete | None = None, dist: Incomplete | None = None, fmt: str = 'r-', **lineoptions) -> None:
    '''
