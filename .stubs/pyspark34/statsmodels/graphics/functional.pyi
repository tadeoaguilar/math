...
def hdrboxplot(data, ncomp: int = 2, alpha: Incomplete | None = None, threshold: float = 0.95, bw: Incomplete | None = None, xdata: Incomplete | None = None, labels: Incomplete | None = None, ax: Incomplete | None = None, use_brute: bool = False, seed: Incomplete | None = None):
    '''
    ...
    '''
def fboxplot(data, xdata: Incomplete | None = None, labels: Incomplete | None = None, depth: Incomplete | None = None, method: str = 'MBD', wfactor: float = 1.5, ax: Incomplete | None = None, plot_opts: Incomplete | None = None):
    '''
    ...
    '''
def rainbowplot(data, xdata: Incomplete | None = None, depth: Incomplete | None = None, method: str = 'MBD', ax: Incomplete | None = None, cmap: Incomplete | None = None):
    '''
    ...
    '''
def banddepth(data, method: str = 'MBD'):
    '''
