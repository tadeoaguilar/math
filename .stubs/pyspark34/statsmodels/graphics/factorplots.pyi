...
from statsmodels.graphics.plottools import rainbow as rainbow

def interaction_plot(x, trace, response, func=..., ax: Incomplete | None = None, plottype: str = 'b', xlabel: Incomplete | None = None, ylabel: Incomplete | None = None, colors: Incomplete | None = None, markers: Incomplete | None = None, linestyles: Incomplete | None = None, legendloc: str = 'best', legendtitle: Incomplete | None = None, **kwargs):
    """
