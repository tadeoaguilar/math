...
def violinplot(data, ax: Incomplete | None = None, labels: Incomplete | None = None, positions: Incomplete | None = None, side: str = 'both', show_boxplot: bool = True, plot_opts: Incomplete | None = None):
    '''
    ...
    '''
def beanplot(data, ax: Incomplete | None = None, labels: Incomplete | None = None, positions: Incomplete | None = None, side: str = 'both', jitter: bool = False, plot_opts={}):
    '''
