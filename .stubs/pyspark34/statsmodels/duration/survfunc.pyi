...
class CumIncidenceRight:
    ...
    cinc_se: Incomplete
    title: Incomplete
    def __init__(self, time, status, title: Incomplete | None = None, freq_weights: Incomplete | None = None, exog: Incomplete | None = None, bw_factor: float = 1.0, dimred: bool = True) -> None: ...
...
class SurvfuncRight:
    ...
    https://arxiv.org/pdf/math/0409180.pdf
    """
    surv_prob: Incomplete
    surv_times: Incomplete
    surv_prob_se: Incomplete
    n_risk: Incomplete
    n_events: Incomplete
    title: Incomplete
    def __init__(self, time, status, entry: Incomplete | None = None, title: Incomplete | None = None, freq_weights: Incomplete | None = None, exog: Incomplete | None = None, bw_factor: float = 1.0) -> None: ...
    ...
    def quantile(self, p):
        ...
        """
    def quantile_ci(self, p, alpha: float = 0.05, method: str = 'cloglog'):
        """
    ...
    def summary(self):
        ...
        """
    def simultaneous_cb(self, alpha: float = 0.05, method: str = 'hw', transform: str = 'log'):
        """
...
def survdiff(time, status, group, weight_type: Incomplete | None = None, strata: Incomplete | None = None, entry: Incomplete | None = None, **kwargs):
    """
    ...
    """
def plot_survfunc(survfuncs, ax: Incomplete | None = None):
    '''
