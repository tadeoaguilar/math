...
class Margins:
    ...
    results: Incomplete
    dist: Incomplete
    def __init__(self, results, get_margeff, derivative, dist: Incomplete | None = None, margeff_args=()) -> None: ...
    margeff: Incomplete
    ...
    def conf_int(self, alpha: float = 0.05) -> None: ...
...
class DiscreteMargins:
    ...
    dummy_idx: Incomplete
    count_idx: Incomplete
    margeff: Incomplete
