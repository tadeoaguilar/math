...
class GLMGamResults(GLMResults):
    ...
    def predict(self, exog: Incomplete | None = None, exog_smooth: Incomplete | None = None, transform: bool = True, **kwargs):
        '''"
        compute prediction
        ...
        prediction : ndarray, pandas.Series or pandas.DataFrame
            predicted values
        '''
    def get_prediction(self, exog: Incomplete | None = None, exog_smooth: Incomplete | None = None, transform: bool = True, **kwargs):
        ...
        prediction_results : generalized_linear_model.PredictionResults
            ...
            observations.
        """
    def partial_values(self, smooth_index, include_constant: bool = True):
        ...
        """
    def plot_partial(self, smooth_index, plot_se: bool = True, cpr: bool = False, include_constant: bool = True, ax: Incomplete | None = None):
    ...
    def test_significance(self, smooth_index):
        ...
        """
    def get_hat_matrix_diag(self, observed: bool = True, _axis: int = 1):
        """
...
class GLMGam(PenalizedMixin, GLM):
    ...
    **kwargs
    ...
    all results.)
    """
    design_info_linear: Incomplete
    data_linear: Incomplete
    k_exog_linear: Incomplete
    exog_linear: Incomplete
    smoother: Incomplete
    k_smooths: Incomplete
    alpha: Incomplete
    formula_linear: Incomplete
    formula: Incomplete
    def __init__(self, endog, exog: Incomplete | None = None, smoother: Incomplete | None = None, alpha: int = 0, family: Incomplete | None = None, offset: Incomplete | None = None, exposure: Incomplete | None = None, missing: str = 'none', **kwargs) -> None: ...
    def fit(self, start_params: Incomplete | None = None, maxiter: int = 1000, method: str = 'pirls', tol: float = 1e-08, scale: Incomplete | None = None, cov_type: str = 'nonrobust', cov_kwds: Incomplete | None = None, use_t: Incomplete | None = None, full_output: bool = True, disp: bool = False, max_start_irls: int = 3, **kwargs):
    ...
    def select_penweight(self, criterion: str = 'aic', start_params: Incomplete | None = None, start_model_params: Incomplete | None = None, method: str = 'basinhopping', **fit_kwds):
        ...
        might also change.
        """
    def select_penweight_kfold(self, alphas: Incomplete | None = None, cv_iterator: Incomplete | None = None, cost: Incomplete | None = None, k_folds: int = 5, k_grid: int = 11):
