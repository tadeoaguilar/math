...
class MixedLMParams:
    ...
    def from_packed(params, k_fe, k_re, use_sqrt, has_fe):
        ...
        """
    from_packed: Incomplete
    def from_components(fe_params: Incomplete | None = None, cov_re: Incomplete | None = None, cov_re_sqrt: Incomplete | None = None, vcomp: Incomplete | None = None):
        """
        ...
        A MixedLMParams object.
        """
    from_components: Incomplete
    def copy(self):
        """
        Returns a copy of the object.
        """
    def get_packed(self, use_sqrt, has_fe: bool = False):
        """
...
class MixedLM(base.LikelihoodModel):
    ...
    exog_re: Incomplete
    k_params: Incomplete
    row_indices: Incomplete
    group_labels: Incomplete
    n_groups: Incomplete
    endog_li: Incomplete
    exog_li: Incomplete
    exog_re_li: Incomplete
    exog_re2_li: Incomplete
    nobs: Incomplete
    n_totobs: Incomplete
    exog_names: Incomplete
    def __init__(self, endog, exog, groups, exog_re: Incomplete | None = None, exog_vc: Incomplete | None = None, use_sqrt: bool = True, missing: str = 'none', **kwargs) -> None: ...
    @classmethod
    def from_formula(cls, formula, data, re_formula: Incomplete | None = None, vc_formula: Incomplete | None = None, subset: Incomplete | None = None, use_sparse: bool = False, missing: str = 'none', *args, **kwargs):
        '''
    ...
    def group_list(self, array):
        ...
        grouping structure.
        """
    def fit_regularized(self, start_params: Incomplete | None = None, method: str = 'l1', alpha: int = 0, ceps: float = 0.0001, ptol: float = 1e-06, maxit: int = 200, **fit_kwargs):
        '''
        ...
        **fit_kwargs
        ...
        '''
    def get_fe_params(self, cov_re, vcomp, tol: float = 1e-10):
        """
        ...
        """
    def loglike(self, params, profile_fe: bool = True):
        """
        ...
        """
    def score(self, params, profile_fe: bool = True):
        """
    ...
    def score_full(self, params, calc_fe):
        ...
        """
    def score_sqrt(self, params, calc_fe: bool = True):
        """
    ...
    def get_scale(self, fe_params, cov_re, vcomp):
        ...
        """
    cov_pen: Incomplete
    def fit(self, start_params: Incomplete | None = None, reml: bool = True, niter_sa: int = 0, do_cg: bool = True, fe_pen: Incomplete | None = None, cov_pen: Incomplete | None = None, free: Incomplete | None = None, full_output: bool = False, method: Incomplete | None = None, **fit_kwargs):
        """
...
class _mixedlm_distribution:
    ...
    model: Incomplete
    exog: Incomplete
    fe_params: Incomplete
    cov_re: Incomplete
    vcomp: Incomplete
    scale: Incomplete
    group_idx: Incomplete
...
class MixedLMResults(base.LikelihoodModelResults, base.ResultMixin):
    ...
    def random_effects_cov(self):
        ...
        """
    def t_test(self, r_matrix, use_t: Incomplete | None = None):
        """
        ...
        res : ContrastResults instance
            ...
            in `summary()`.
        """
    def summary(self, yname: Incomplete | None = None, xname_fe: Incomplete | None = None, xname_re: Incomplete | None = None, title: Incomplete | None = None, alpha: float = 0.05):
        """
    ...
    def profile_re(self, re_ix, vtype, num_low: int = 5, dist_low: float = 1.0, num_high: int = 5, dist_high: float = 1.0, **fit_kwargs):
        """
