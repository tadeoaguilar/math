...
def forg(x, prec: int = 3): ...
def d_or_f(x, width: int = 6):
    ...
    """
def summary(self, yname: Incomplete | None = None, xname: Incomplete | None = None, title: int = 0, alpha: float = 0.05, returns: str = 'text', model_info: Incomplete | None = None):
    """
    Parameters
    ----------
    yname : str
    ...
    """
def summary_top(results, title: Incomplete | None = None, gleft: Incomplete | None = None, gright: Incomplete | None = None, yname: Incomplete | None = None, xname: Incomplete | None = None):
    ...
    """
def summary_params(results, yname: Incomplete | None = None, xname: Incomplete | None = None, alpha: float = 0.05, use_t: bool = True, skip_header: bool = False, title: Incomplete | None = None):
    ...
    '''
def summary_params_frame(results, yname: Incomplete | None = None, xname: Incomplete | None = None, alpha: float = 0.05, use_t: bool = True):
    '''create a summary table for the parameters
    ...
    params_table : SimpleTable instance
    '''
def summary_params_2d(result, extras: Incomplete | None = None, endog_names: Incomplete | None = None, exog_names: Incomplete | None = None, title: Incomplete | None = None):
    ...
    """
def summary_params_2dflat(result, endog_names: Incomplete | None = None, exog_names: Incomplete | None = None, alpha: float = 0.05, use_t: bool = True, keep_headers: bool = True, endog_cols: bool = False):
    ...
    """
def table_extend(tables, keep_headers: bool = True):
    ...
    """
def summary_return(tables, return_fmt: str = 'text'): ...
...
class Summary:
    ...
    def add_table_2cols(self, res, title: Incomplete | None = None, gleft: Incomplete | None = None, gright: Incomplete | None = None, yname: Incomplete | None = None, xname: Incomplete | None = None) -> None:
        '''
        ...
        '''
    def add_table_params(self, res, yname: Incomplete | None = None, xname: Incomplete | None = None, alpha: float = 0.05, use_t: bool = True) -> None:
