...
def durbin_watson(resids, axis: int = 0):
    """
    ...
    """
def omni_normtest(resids, axis: int = 0):
    """
    ...
    """
def jarque_bera(resids, axis: int = 0):
    """
    ...
    """
def robust_skewness(y, axis: int = 0):
    '''
...
def expected_robust_kurtosis(ab=(5.0, 50.0), dg=(2.5, 25.0)):
    ...
    """
def robust_kurtosis(y, axis: int = 0, ab=(5.0, 50.0), dg=(2.5, 25.0), excess: bool = True):
    '''
