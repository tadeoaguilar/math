...
FLOAT_INFO: Incomplete

def proportion_confint(count, nobs, alpha: float = 0.05, method: str = 'normal'):
    '''
    ...
    '''
def multinomial_proportions_confint(counts, alpha: float = 0.05, method: str = 'goodman'):
    '''
    ...
    '''
def samplesize_confint_proportion(proportion, half_length, alpha: float = 0.05, method: str = 'normal'):
    """
    ...
    """
def proportion_effectsize(prop1, prop2, method: str = 'normal'):
    """
...
def binom_tost(count, nobs, low, upp):
    ...
    """
def binom_tost_reject_interval(low, upp, nobs, alpha: float = 0.05):
    """
    ...
    """
def binom_test_reject_interval(value, nobs, alpha: float = 0.05, alternative: str = 'two-sided'):
    """
    ...
    x_low, x_upp : int
        lower and upper bound of rejection region
    """
def binom_test(count, nobs, prop: float = 0.5, alternative: str = 'two-sided'):
    """
    ...
    """
def power_binom_tost(low, upp, nobs, p_alt: Incomplete | None = None, alpha: float = 0.05): ...
def power_ztost_prop(low, upp, nobs, p_alt, alpha: float = 0.05, dist: str = 'norm', variance_prop: Incomplete | None = None, discrete: bool = True, continuity: int = 0, critval_continuity: int = 0):
    '''
    ...
    **verification:**
    ...
    '''
def proportions_ztest(count, nobs, value: Incomplete | None = None, alternative: str = 'two-sided', prop_var: bool = False):
    """
    ...
    distribution.
    """
def proportions_ztost(count, nobs, low, upp, prop_var: str = 'sample'):
    """
    ...
    """
def proportions_chisquare(count, nobs, value: Incomplete | None = None):
    """
    ...
    """
def proportions_chisquare_allpairs(count, nobs, multitest_method: str = 'hs'):
    """
    ...
    """
def proportions_chisquare_pairscontrol(count, nobs, value: Incomplete | None = None, multitest_method: str = 'hs', alternative: str = 'two-sided'):
    """
    ...
    """
def confint_proportions_2indep(count1, nobs1, count2, nobs2, method: Incomplete | None = None, compare: str = 'diff', alpha: float = 0.05, correction: bool = True):
    '''
    ...
    '''
def score_test_proportions_2indep(count1, nobs1, count2, nobs2, value: Incomplete | None = None, compare: str = 'diff', alternative: str = 'two-sided', correction: bool = True, return_results: bool = True):
    """
    ...
    """
def test_proportions_2indep(count1, nobs1, count2, nobs2, value: Incomplete | None = None, method: Incomplete | None = None, compare: str = 'diff', alternative: str = 'two-sided', correction: bool = True, return_results: bool = True):
    """
    ...
    """
def tost_proportions_2indep(count1, nobs1, count2, nobs2, low, upp, method: Incomplete | None = None, compare: str = 'diff', correction: bool = True):
    """
    ...
    """
def power_proportions_2indep(diff, prop2, nobs1, ratio: int = 1, alpha: float = 0.05, value: int = 0, alternative: str = 'two-sided', return_results: bool = True):
    """
    ...
    results : results instance or float
        ...
        std_alt
            ...
            (without sqrt(nobs1))
    """
def samplesize_proportions_2indep_onetail(diff, prop2, power, ratio: int = 1, alpha: float = 0.05, value: int = 0, alternative: str = 'two-sided'):
    """
