...
from statsmodels.stats.power import ncf_cdf as ncf_cdf, ncf_ppf as ncf_ppf
...
def effectsize_oneway(means, vars_, nobs, use_var: str = 'unequal', ddof_between: int = 0):
    '''
    ...
    '''
def convert_effectsize_fsqu(f2: Incomplete | None = None, eta2: Incomplete | None = None):
...
def fstat_to_wellek(f_stat, n_groups, nobs_mean):
    ...
    """
def confint_noncentrality(f_stat, df, alpha: float = 0.05, alternative: str = 'two-sided'):
    '''
    ...
    '''
def confint_effectsize_oneway(f_stat, df, alpha: float = 0.05, nobs: Incomplete | None = None):
    """
    ...
    """
def anova_generic(means, variances, nobs, use_var: str = 'unequal', welch_correction: bool = True, info: Incomplete | None = None):
    '''
    ...
    '''
def anova_oneway(data, groups: Incomplete | None = None, use_var: str = 'unequal', welch_correction: bool = True, trim_frac: int = 0):
    '''Oneway Anova
    ...
    '''
def equivalence_oneway_generic(f_stat, n_groups, nobs, equiv_margin, df, alpha: float = 0.05, margin_type: str = 'f2'):
    ...
    '''
def equivalence_oneway(data, equiv_margin, groups: Incomplete | None = None, use_var: str = 'unequal', welch_correction: bool = True, trim_frac: int = 0, margin_type: str = 'f2'):
    ...
    '''
def power_equivalence_oneway(f2_alt, equiv_margin, nobs_t, n_groups: Incomplete | None = None, df: Incomplete | None = None, alpha: float = 0.05, margin_type: str = 'f2'):
    '''
    ...
    pow_alt : float
        ...
        the alternative.
    '''
def simulate_power_equivalence_oneway(means, nobs, equiv_margin, vars_: Incomplete | None = None, k_mc: int = 1000, trim_frac: int = 0, options_var: Incomplete | None = None, margin_type: str = 'f2'):
    ...
    """
def test_scale_oneway(data, method: str = 'bf', center: str = 'median', transform: str = 'abs', trim_frac_mean: float = 0.1, trim_frac_anova: float = 0.0):
    ...
    scale_transform
    '''
def equivalence_scale_oneway(data, equiv_margin, method: str = 'bf', center: str = 'median', transform: str = 'abs', trim_frac_mean: float = 0.0, trim_frac_anova: float = 0.0):
