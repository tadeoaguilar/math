...
def clip_evals(x, value: int = 0): ...
def corr_nearest(corr, threshold: float = 1e-15, n_fact: int = 100):
    """
    ...
    """
def corr_clipped(corr, threshold: float = 1e-15):
    """
    ...
    """
def cov_nearest(cov, method: str = 'clipped', threshold: float = 1e-15, n_fact: int = 100, return_all: bool = False):
    '''
...
def corr_nearest_factor(corr, rank, ctol: float = 1e-06, lam_min: float = 1e-30, lam_max: float = 1e+30, maxiter: int = 1000):
    """
...
def cov_nearest_factor_homog(cov, rank):
    ...
    """
def corr_thresholded(data, minabs: Incomplete | None = None, max_elt: float = 10000000.0):
    """
...
class MultivariateKernel:
    ...
    def set_bandwidth(self, bw) -> None:
        ...
        """
    def set_default_bw(self, loc, bwm: Incomplete | None = None) -> None:
        """
...
def kernel_covariance(exog, loc, groups, kernel: Incomplete | None = None, bw: Incomplete | None = None):
    """
