...
class AnovaRM:
    ...
    between: Incomplete
    subject: Incomplete
    aggregate_func: Incomplete
    def __init__(self, data, depvar, subject, within: Incomplete | None = None, between: Incomplete | None = None, aggregate_func: Incomplete | None = None) -> None: ...
    def fit(self):
