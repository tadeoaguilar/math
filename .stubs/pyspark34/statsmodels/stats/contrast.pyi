...
class ContrastResults:
    ...
    sd: Incomplete
    c_names: Incomplete
    def __init__(self, t: Incomplete | None = None, F: Incomplete | None = None, sd: Incomplete | None = None, effect: Incomplete | None = None, df_denom: Incomplete | None = None, df_num: Incomplete | None = None, alpha: float = 0.05, **kwds) -> None: ...
    def conf_int(self, alpha: float = 0.05):
        ...
        """
    def summary(self, xname: Incomplete | None = None, alpha: float = 0.05, title: Incomplete | None = None):
        ...
        """
    def summary_frame(self, xname: Incomplete | None = None, alpha: float = 0.05):
...
def contrastfromcols(L, D, pseudo: Incomplete | None = None):
    """
...
class WaldTestResults:
    ...
    dist_args: Incomplete
    pvalues: Incomplete
    df_constraints: Incomplete
    df_denom: Incomplete
    dist: Incomplete
    def __init__(self, statistic, distribution, dist_args, table: Incomplete | None = None, pvalues: Incomplete | None = None) -> None: ...
    @property
    def col_names(self):
...
def t_test_multi(result, contrasts, method: str = 'hs', alpha: float = 0.05, ci_method: Incomplete | None = None, contrast_names: Incomplete | None = None):
...
def t_test_pairwise(result, term_name, method: str = 'hs', alpha: float = 0.05, factor_labels: Incomplete | None = None, ignore: bool = False):
    """
    ...
    available.
    """
def wald_test_noncent(params, r_matrix, value, results, diff: Incomplete | None = None, joint: bool = True):
    ...
    """
def wald_test_noncent_generic(params, r_matrix, value, cov_params, diff: Incomplete | None = None, joint: bool = True):
