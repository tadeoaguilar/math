...
class TableDist:
    ...
    alpha: Incomplete
    size: Incomplete
    crit_table: Incomplete
    n_alpha: Incomplete
    signcrit: Incomplete
    critv_bounds: Incomplete
    asymptotic: Incomplete
    min_nobs: Incomplete
    max_nobs: Incomplete
    def __init__(self, alpha, size, crit_table, asymptotic: Incomplete | None = None, min_nobs: Incomplete | None = None, max_nobs: Incomplete | None = None) -> None: ...
    def polyn(self): ...
    def poly2d(self): ...
    def polyrbf(self): ...
    def prob(self, x, n):
