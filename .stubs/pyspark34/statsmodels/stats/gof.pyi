...
def powerdiscrepancy(observed, expected, lambd: float = 0.0, axis: int = 0, ddof: int = 0):
...
def gof_chisquare_discrete(distfn, arg, rvs, alpha, msg):
    ...
    refactor: maybe a class, check returns, or separate binning from
        test results
    """
def gof_binning_discrete(rvs, distfn, arg, nsupp: int = 20):
    ...
    """
def chisquare(f_obs, f_exp: Incomplete | None = None, value: int = 0, ddof: int = 0, return_basic: bool = True):
    ...
    '''
def chisquare_power(effect_size, nobs, n_bins, alpha: float = 0.05, ddof: int = 0):
    ...
    """
def chisquare_effectsize(probs0, probs1, correction: Incomplete | None = None, cohen: bool = True, axis: int = 0):
