...
class OriginResults(RegressionResults):
    ...
    def el_test(self, b0_vals, param_nums, method: str = 'nm', stochastic_exog: int = 1, return_weights: int = 0):
        """
        ...
        """
    def conf_int_el(self, param_num, upper_bound: Incomplete | None = None, lower_bound: Incomplete | None = None, sig: float = 0.05, method: str = 'nm', stochastic_exog: int = 1):
        """
