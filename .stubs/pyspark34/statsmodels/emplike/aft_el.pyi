...
class emplikeAFT:
    ...
    censors: Incomplete
    nvar: Incomplete
    uncens_nobs: Incomplete
    uncens_endog: Incomplete
    uncens_exog: Incomplete
    ...
    def fit(self):
        ...
        """
    def predict(self, params, endog: Incomplete | None = None): ...
...
class AFTResults(OptAFT):
    ...
    def params(self):
        ...
        To avoid dividing by zero, max(endog) is assumed to be uncensored.
        """
    def test_beta(self, b0_vals, param_nums, ftol=..., maxiter: int = 30, print_weights: int = 1):
        """
        ...
        """
    r0: Incomplete
    def ci_beta(self, param_num, beta_high, beta_low, sig: float = 0.05):
        """
