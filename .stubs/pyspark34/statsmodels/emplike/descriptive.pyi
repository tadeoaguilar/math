...
class DescStatUV(_OptFuncts):
    ...
    def __init__(self, endog) -> None: ...
    mu0: Incomplete
    def test_mean(self, mu0, return_weights: bool = False):
        """
        ...
        """
    r0: Incomplete
    def ci_mean(self, sig: float = 0.05, method: str = 'gamma', epsilon=..., gamma_low=..., gamma_high=...):
        """
        ...
        """
    sig2_0: Incomplete
    def test_var(self, sig2_0, return_weights: bool = False):
        """
        ...
        """
    def ci_var(self, lower_bound: Incomplete | None = None, upper_bound: Incomplete | None = None, sig: float = 0.05):
        """
    ...
    def plot_contour(self, mu_low, mu_high, var_low, var_high, mu_step, var_step, levs=[0.2, 0.1, 0.05, 0.01, 0.001]):
        ...
        """
    skew0: Incomplete
    def test_skew(self, skew0, return_weights: bool = False):
        """
        ...
        """
    kurt0: Incomplete
    def test_kurt(self, kurt0, return_weights: bool = False):
        """
        ...
        """
    def test_joint_skew_kurt(self, skew0, kurt0, return_weights: bool = False):
        """
        ...
        """
    def ci_skew(self, sig: float = 0.05, upper_bound: Incomplete | None = None, lower_bound: Incomplete | None = None):
        """
        ...
        """
    def ci_kurt(self, sig: float = 0.05, upper_bound: Incomplete | None = None, lower_bound: Incomplete | None = None):
        """
...
class DescStatMV(_OptFuncts):
    ...
    nobs: Incomplete
    def __init__(self, endog) -> None: ...
    new_weights: Incomplete
    def mv_test_mean(self, mu_array, return_weights: bool = False):
        """
        ...
        """
    def mv_mean_contour(self, mu1_low, mu1_upp, mu2_low, mu2_upp, step1, step2, levs=(0.001, 0.01, 0.05, 0.1, 0.2), var1_name: Incomplete | None = None, var2_name: Incomplete | None = None, plot_dta: bool = False):
        """
        ...
        >>> contourp.show()
        """
    def test_corr(self, corr0, return_weights: int = 0):
        """
        ...
        """
    r0: Incomplete
    def ci_corr(self, sig: float = 0.05, upper_bound: Incomplete | None = None, lower_bound: Incomplete | None = None):
        """
