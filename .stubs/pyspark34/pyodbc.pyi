from typing import Any, Callable, Dict, Final, Generator, Iterable, Iterator, List, Sequence, Tuple
...
class Connection:
    ...
    def setencoding(self, encoding: str | None = None, ctype: int | None = None) -> None:
...
class Cursor:
    ...
    def tables(self, table: str | None = None, catalog: str | None = None, schema: str | None = None, tableType: str | None = None) -> Cursor:
        ...
        '''
    def columns(self, table: str | None = None, catalog: str | None = None, schema: str | None = None, column: str | None = None) -> Cursor:
        ...
        """
    def statistics(self, table: str, catalog: str | None = None, schema: str | None = None, unique: bool = False, quick: bool = True) -> Cursor:
        ...
        """
    def rowIdColumns(self, table: str, catalog: str | None = None, schema: str | None = None, nullable: bool = True) -> Cursor:
        ...
        """
    def rowVerColumns(self, table: str, catalog: str | None = None, schema: str | None = None, nullable: bool = True) -> Cursor:
        ...
        Returns:
            The cursor object, containing the relevant column information in the result set.
        """
    def primaryKeys(self, table: str, catalog: str | None = None, schema: str | None = None) -> Cursor:
        ...
        """
    def foreignKeys(self, table: str | None = None, catalog: str | None = None, schema: str | None = None, foreignTable: str | None = None, foreignCatalog: str | None = None, foreignSchema: str | None = None) -> Cursor:
        ...
        """
    def procedures(self, procedure: str | None = None, catalog: str | None = None, schema: str | None = None) -> Cursor:
        ...
        """
    def procedureColumns(self, procedure: str | None = None, catalog: str | None = None, schema: str | None = None) -> Cursor:
...
def setDecimalSeparator(sep: str) -> None:
    ...
    '''
def connect(connstring: str | None = None, *, autocommit: bool = False, encoding: str = 'utf-16le', ansi: bool = False, readonly: bool = False, timeout: int = 0, attrs_before: Dict[int, Any] = {}, **kwargs: Any) -> Connection:
