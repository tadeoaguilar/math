...
from openpyxl.descriptors import Alias as Alias, Bool as Bool, Descriptor as Descriptor, Integer as Integer, NoneSet as NoneSet, Sequence as Sequence, String as String, Typed as Typed
...
class TableStyleInfo(Serialisable):
    ...
    def __init__(self, name: Incomplete | None = None, showFirstColumn: Incomplete | None = None, showLastColumn: Incomplete | None = None, showRowStripes: Incomplete | None = None, showColumnStripes: Incomplete | None = None) -> None: ...
...
class XMLColumnProps(Serialisable):
    ...
    def __init__(self, mapId: Incomplete | None = None, xpath: Incomplete | None = None, denormalized: Incomplete | None = None, xmlDataType: Incomplete | None = None, extLst: Incomplete | None = None) -> None: ...
...
class Table(Serialisable):
    ...
    extLst: Incomplete
    __elements__: Incomplete
    def __init__(self, id: int = 1, displayName: Incomplete | None = None, ref: Incomplete | None = None, name: Incomplete | None = None, comment: Incomplete | None = None, tableType: Incomplete | None = None, headerRowCount: int = 1, insertRow: Incomplete | None = None, insertRowShift: Incomplete | None = None, totalsRowCount: Incomplete | None = None, totalsRowShown: Incomplete | None = None, published: Incomplete | None = None, headerRowDxfId: Incomplete | None = None, dataDxfId: Incomplete | None = None, totalsRowDxfId: Incomplete | None = None, headerRowBorderDxfId: Incomplete | None = None, tableBorderDxfId: Incomplete | None = None, totalsRowBorderDxfId: Incomplete | None = None, headerRowCellStyle: Incomplete | None = None, dataCellStyle: Incomplete | None = None, totalsRowCellStyle: Incomplete | None = None, connectionId: Incomplete | None = None, autoFilter: Incomplete | None = None, sortState: Incomplete | None = None, tableColumns=(), tableStyleInfo: Incomplete | None = None, extLst: Incomplete | None = None) -> None: ...
    def to_tree(self): ...
    @property
    def path(self):
        """
