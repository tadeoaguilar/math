...
class IgnoredError(Serialisable):
    ...
    def __init__(self, sqref: Incomplete | None = None, evalError: bool = False, twoDigitTextYear: bool = False, numberStoredAsText: bool = False, formula: bool = False, formulaRange: bool = False, unlockedFormula: bool = False, emptyCellReference: bool = False, listDataValidation: bool = False, calculatedColumn: bool = False) -> None: ...
