...
class Hyperlink(Serialisable):
    ...
    def __init__(self, ref: Incomplete | None = None, location: Incomplete | None = None, tooltip: Incomplete | None = None, display: Incomplete | None = None, id: Incomplete | None = None, target: Incomplete | None = None) -> None: ...
