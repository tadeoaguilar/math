...
class Outline(Serialisable):
    ...
    def __init__(self, applyStyles: Incomplete | None = None, summaryBelow: Incomplete | None = None, summaryRight: Incomplete | None = None, showOutlineSymbols: Incomplete | None = None) -> None: ...
