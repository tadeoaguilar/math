...
class Pane(Serialisable):
    ...
    state: Incomplete
    def __init__(self, xSplit: Incomplete | None = None, ySplit: Incomplete | None = None, topLeftCell: Incomplete | None = None, activePane: str = 'topLeft', state: str = 'split') -> None: ...
...
class Selection(Serialisable):
    ...
    sqref: Incomplete
    def __init__(self, pane: Incomplete | None = None, activeCell: str = 'A1', activeCellId: Incomplete | None = None, sqref: str = 'A1') -> None: ...
