...
from openpyxl.descriptors import Alias as Alias, Integer as Integer
...
class DrawingHF(Serialisable):
    ...
    def __init__(self, id: Incomplete | None = None, lho: Incomplete | None = None, lhe: Incomplete | None = None, lhf: Incomplete | None = None, cho: Incomplete | None = None, che: Incomplete | None = None, chf: Incomplete | None = None, rho: Incomplete | None = None, rhe: Incomplete | None = None, rhf: Incomplete | None = None, lfo: Incomplete | None = None, lfe: Incomplete | None = None, lff: Incomplete | None = None, cfo: Incomplete | None = None, cfe: Incomplete | None = None, cff: Incomplete | None = None, rfo: Incomplete | None = None, rfe: Incomplete | None = None, rff: Incomplete | None = None) -> None: ...
