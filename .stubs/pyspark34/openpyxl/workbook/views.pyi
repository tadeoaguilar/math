...
class BookView(Serialisable):
    ...
    def __init__(self, visibility: str = 'visible', minimized: bool = False, showHorizontalScroll: bool = True, showVerticalScroll: bool = True, showSheetTabs: bool = True, xWindow: Incomplete | None = None, yWindow: Incomplete | None = None, windowWidth: Incomplete | None = None, windowHeight: Incomplete | None = None, tabRatio: int = 600, firstSheet: int = 0, activeTab: int = 0, autoFilterDateGrouping: bool = True, extLst: Incomplete | None = None) -> None: ...
