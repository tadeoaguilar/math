...
from openpyxl.descriptors import Bool as Bool, Float as Float, Integer as Integer, NoneSet as NoneSet, Set as Set, String as String
...
class CalcProperties(Serialisable):
    ...
    def __init__(self, calcId: int = 124519, calcMode: Incomplete | None = None, fullCalcOnLoad: bool = True, refMode: Incomplete | None = None, iterate: Incomplete | None = None, iterateCount: Incomplete | None = None, iterateDelta: Incomplete | None = None, fullPrecision: Incomplete | None = None, calcCompleted: Incomplete | None = None, calcOnSave: Incomplete | None = None, concurrentCalc: Incomplete | None = None, concurrentManualCount: Incomplete | None = None, forceFullCalc: Incomplete | None = None) -> None: ...
...
class FileVersion(Serialisable):
    ...
    rupBuild: Incomplete
    codeName: Incomplete
    def __init__(self, appName: Incomplete | None = None, lastEdited: Incomplete | None = None, lowestEdited: Incomplete | None = None, rupBuild: Incomplete | None = None, codeName: Incomplete | None = None) -> None: ...
