...
from openpyxl.descriptors import Alias as Alias, Integer as Integer, MinMax as MinMax, Set as Set, Typed as Typed
from openpyxl.descriptors.excel import Percentage as Percentage
from openpyxl.descriptors.nested import EmptyTag as EmptyTag, NestedInteger as NestedInteger, NestedNoneSet as NestedNoneSet, NestedValue as NestedValue
from openpyxl.descriptors.serialisable import Serialisable as Serialisable
from openpyxl.styles.colors import RGB as RGB
...
class SystemColor(Serialisable):
    ...
    def __init__(self, val: str = 'windowText', lastClr: Incomplete | None = None, tint: Incomplete | None = None, shade: Incomplete | None = None, comp: Incomplete | None = None, inv: Incomplete | None = None, gray: Incomplete | None = None, alpha: Incomplete | None = None, alphaOff: Incomplete | None = None, alphaMod: Incomplete | None = None, hue: Incomplete | None = None, hueOff: Incomplete | None = None, hueMod: Incomplete | None = None, sat: Incomplete | None = None, satOff: Incomplete | None = None, satMod: Incomplete | None = None, lum: Incomplete | None = None, lumOff: Incomplete | None = None, lumMod: Incomplete | None = None, red: Incomplete | None = None, redOff: Incomplete | None = None, redMod: Incomplete | None = None, green: Incomplete | None = None, greenOff: Incomplete | None = None, greenMod: Incomplete | None = None, blue: Incomplete | None = None, blueOff: Incomplete | None = None, blueMod: Incomplete | None = None, gamma: Incomplete | None = None, invGamma: Incomplete | None = None) -> None: ...
...
class ColorMapping(Serialisable):
    ...
    folHlink: Incomplete
    extLst: Incomplete
    def __init__(self, bg1: str = 'lt1', tx1: str = 'dk1', bg2: str = 'lt2', tx2: str = 'dk2', accent1: str = 'accent1', accent2: str = 'accent2', accent3: str = 'accent3', accent4: str = 'accent4', accent5: str = 'accent5', accent6: str = 'accent6', hlink: str = 'hlink', folHlink: str = 'folHlink', extLst: Incomplete | None = None) -> None: ...
