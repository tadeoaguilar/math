from .colors import ColorChoice as ColorChoice
from _typeshed import Incomplete
from openpyxl.descriptors import Bool as Bool, Float as Float, Integer as Integer, Set as Set, String as String, Typed as Typed
...
class ColorChangeEffect(Serialisable):
    ...
    clrFrom: Incomplete
    clrTo: Incomplete
    def __init__(self, useA: Incomplete | None = None, clrFrom: Incomplete | None = None, clrTo: Incomplete | None = None) -> None: ...
...
class InnerShadowEffect(ColorChoice):
    ...
    prstClr: Incomplete
    __elements__: Incomplete
    def __init__(self, blurRad: Incomplete | None = None, dist: Incomplete | None = None, dir: Incomplete | None = None, **kw) -> None: ...
...
class OuterShadow(ColorChoice):
    ...
    prstClr: Incomplete
    __elements__: Incomplete
    def __init__(self, blurRad: Incomplete | None = None, dist: Incomplete | None = None, dir: Incomplete | None = None, sx: Incomplete | None = None, sy: Incomplete | None = None, kx: Incomplete | None = None, ky: Incomplete | None = None, algn: Incomplete | None = None, rotWithShape: Incomplete | None = None, **kw) -> None: ...
...
class PresetShadowEffect(ColorChoice):
    ...
    prstClr: Incomplete
    __elements__: Incomplete
    def __init__(self, prst: Incomplete | None = None, dist: Incomplete | None = None, dir: Incomplete | None = None, **kw) -> None: ...
...
class EffectList(Serialisable):
    ...
    softEdge: Incomplete
    __elements__: Incomplete
    def __init__(self, blur: Incomplete | None = None, fillOverlay: Incomplete | None = None, glow: Incomplete | None = None, innerShdw: Incomplete | None = None, outerShdw: Incomplete | None = None, prstShdw: Incomplete | None = None, reflection: Incomplete | None = None, softEdge: Incomplete | None = None) -> None: ...
