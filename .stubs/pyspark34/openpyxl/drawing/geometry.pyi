from .line import LineProperties as LineProperties
...
from openpyxl.descriptors.excel import Coordinate as Coordinate, Percentage as Percentage
from openpyxl.descriptors.serialisable import Serialisable as Serialisable
from openpyxl.styles.colors import Color as Color
...
class Transform2D(Serialisable):
    ...
    def __init__(self, rot: Incomplete | None = None, flipH: Incomplete | None = None, flipV: Incomplete | None = None, off: Incomplete | None = None, ext: Incomplete | None = None, chOff: Incomplete | None = None, chExt: Incomplete | None = None) -> None: ...
...
class GroupTransform2D(Serialisable):
    ...
    chExt: Incomplete
    __elements__: Incomplete
    def __init__(self, rot: int = 0, flipH: Incomplete | None = None, flipV: Incomplete | None = None, off: Incomplete | None = None, ext: Incomplete | None = None, chOff: Incomplete | None = None, chExt: Incomplete | None = None) -> None: ...
...
class Camera(Serialisable):
    ...
    zoom: Incomplete
    rot: Incomplete
    def __init__(self, prst: Incomplete | None = None, fov: Incomplete | None = None, zoom: Incomplete | None = None, rot: Incomplete | None = None) -> None: ...
...
class Backdrop(Serialisable):
    ...
    up: Incomplete
    extLst: Incomplete
    def __init__(self, anchor: Incomplete | None = None, norm: Incomplete | None = None, up: Incomplete | None = None, extLst: Incomplete | None = None) -> None: ...
...
class Scene3D(Serialisable):
    ...
    backdrop: Incomplete
    extLst: Incomplete
    def __init__(self, camera: Incomplete | None = None, lightRig: Incomplete | None = None, backdrop: Incomplete | None = None, extLst: Incomplete | None = None) -> None: ...
...
class Shape3D(Serialisable):
    ...
    extLst: Incomplete
    def __init__(self, z: Incomplete | None = None, extrusionH: Incomplete | None = None, contourW: Incomplete | None = None, prstMaterial: Incomplete | None = None, bevelT: Incomplete | None = None, bevelB: Incomplete | None = None, extrusionClr: Incomplete | None = None, contourClr: Incomplete | None = None, extLst: Incomplete | None = None) -> None: ...
...
class Path2D(Serialisable):
    ...
    def __init__(self, w: Incomplete | None = None, h: Incomplete | None = None, fill: Incomplete | None = None, stroke: Incomplete | None = None, extrusionOk: Incomplete | None = None) -> None: ...
...
class CustomGeometry2D(Serialisable):
    ...
    pathLst: Incomplete
    rect: Incomplete
    def __init__(self, avLst: Incomplete | None = None, gdLst: Incomplete | None = None, ahLst: Incomplete | None = None, cxnLst: Incomplete | None = None, rect: Incomplete | None = None, pathLst: Incomplete | None = None) -> None: ...
...
class ShapeStyle(Serialisable):
    ...
    fontRef: Incomplete
    def __init__(self, lnRef: Incomplete | None = None, fillRef: Incomplete | None = None, effectRef: Incomplete | None = None, fontRef: Incomplete | None = None) -> None: ...
