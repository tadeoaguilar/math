...
from .pivot import PivotFormat as PivotFormat, PivotSource as PivotSource
from .plotarea import PlotArea as PlotArea
...
from openpyxl.descriptors.nested import NestedBool as NestedBool, NestedMinMax as NestedMinMax, NestedNoneSet as NestedNoneSet, NestedString as NestedString
from openpyxl.descriptors.sequence import NestedSequence as NestedSequence
from openpyxl.descriptors.serialisable import Serialisable as Serialisable
from openpyxl.drawing.colors import ColorMapping as ColorMapping
...
class ChartContainer(Serialisable):
    ...
    def __init__(self, title: Incomplete | None = None, autoTitleDeleted: Incomplete | None = None, pivotFmts=(), view3D: Incomplete | None = None, floor: Incomplete | None = None, sideWall: Incomplete | None = None, backWall: Incomplete | None = None, plotArea: Incomplete | None = None, legend: Incomplete | None = None, plotVisOnly: bool = True, dispBlanksAs: str = 'gap', showDLblsOverMax: Incomplete | None = None, extLst: Incomplete | None = None) -> None: ...
...
class Protection(Serialisable):
    ...
    __elements__: Incomplete
    def __init__(self, chartObject: Incomplete | None = None, data: Incomplete | None = None, formatting: Incomplete | None = None, selection: Incomplete | None = None, userInterface: Incomplete | None = None) -> None: ...
...
class ChartSpace(Serialisable):
    ...
    extLst: Incomplete
    __elements__: Incomplete
    def __init__(self, date1904: Incomplete | None = None, lang: Incomplete | None = None, roundedCorners: Incomplete | None = None, style: Incomplete | None = None, clrMapOvr: Incomplete | None = None, pivotSource: Incomplete | None = None, protection: Incomplete | None = None, chart: Incomplete | None = None, spPr: Incomplete | None = None, txPr: Incomplete | None = None, externalData: Incomplete | None = None, printSettings: Incomplete | None = None, userShapes: Incomplete | None = None, extLst: Incomplete | None = None) -> None: ...
