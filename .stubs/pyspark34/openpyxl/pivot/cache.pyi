from .fields import Boolean as Boolean, DateTimeField as DateTimeField, Error as Error, Missing as Missing, Number as Number, Text as Text, TupleList as TupleList
from .table import PivotArea as PivotArea, Reference as Reference
from _typeshed import Incomplete
from openpyxl.descriptors import Bool as Bool, DateTime as DateTime, Float as Float, Integer as Integer, NoneSet as NoneSet, Sequence as Sequence, Set as Set, String as String, Typed as Typed
from openpyxl.descriptors.excel import ExtensionList as ExtensionList, HexBinary as HexBinary, Relation as Relation
from openpyxl.descriptors.nested import NestedInteger as NestedInteger
from openpyxl.descriptors.sequence import MultiSequence as MultiSequence, MultiSequencePart as MultiSequencePart, NestedSequence as NestedSequence
...
class PivotDimension(Serialisable):
    ...
    caption: Incomplete
    def __init__(self, measure: Incomplete | None = None, name: Incomplete | None = None, uniqueName: Incomplete | None = None, caption: Incomplete | None = None) -> None: ...
...
class CalculatedMember(Serialisable):
    ...
    def __init__(self, name: Incomplete | None = None, mdx: Incomplete | None = None, memberName: Incomplete | None = None, hierarchy: Incomplete | None = None, parent: Incomplete | None = None, solveOrder: Incomplete | None = None, set: Incomplete | None = None, extLst: Incomplete | None = None) -> None: ...
...
class CalculatedItem(Serialisable):
    ...
    extLst: Incomplete
    __elements__: Incomplete
    def __init__(self, field: Incomplete | None = None, formula: Incomplete | None = None, pivotArea: Incomplete | None = None, extLst: Incomplete | None = None) -> None: ...
...
class OLAPSet(Serialisable):
    ...
    __elements__: Incomplete
    def __init__(self, count: Incomplete | None = None, maxRank: Incomplete | None = None, setDefinition: Incomplete | None = None, sortType: Incomplete | None = None, queryFailed: Incomplete | None = None, tpls: Incomplete | None = None, sortByTuple: Incomplete | None = None) -> None: ...
...
class PCDSDTCEntries(Serialisable):
    ...
    s: Incomplete
    __elements__: Incomplete
    def __init__(self, count: Incomplete | None = None, m: Incomplete | None = None, n: Incomplete | None = None, e: Incomplete | None = None, s: Incomplete | None = None) -> None: ...
...
class TupleCache(Serialisable):
    ...
    extLst: Incomplete
    __elements__: Incomplete
    def __init__(self, entries: Incomplete | None = None, sets: Incomplete | None = None, queryCache: Incomplete | None = None, serverFormats: Incomplete | None = None, extLst: Incomplete | None = None) -> None: ...
...
class PCDKPI(Serialisable):
    ...
    weight: Incomplete
    time: Incomplete
    def __init__(self, uniqueName: Incomplete | None = None, caption: Incomplete | None = None, displayFolder: Incomplete | None = None, measureGroup: Incomplete | None = None, parent: Incomplete | None = None, value: Incomplete | None = None, goal: Incomplete | None = None, status: Incomplete | None = None, trend: Incomplete | None = None, weight: Incomplete | None = None, time: Incomplete | None = None) -> None: ...
...
class LevelGroup(Serialisable):
    ...
    __elements__: Incomplete
    def __init__(self, name: Incomplete | None = None, uniqueName: Incomplete | None = None, caption: Incomplete | None = None, uniqueParent: Incomplete | None = None, id: Incomplete | None = None, groupMembers: Incomplete | None = None) -> None: ...
...
class GroupLevel(Serialisable):
    ...
    extLst: Incomplete
    __elements__: Incomplete
    def __init__(self, uniqueName: Incomplete | None = None, caption: Incomplete | None = None, user: Incomplete | None = None, customRollUp: Incomplete | None = None, groups: Incomplete | None = None, extLst: Incomplete | None = None) -> None: ...
...
class RangePr(Serialisable):
    ...
    def __init__(self, autoStart: bool = True, autoEnd: bool = True, groupBy: str = 'range', startNum: Incomplete | None = None, endNum: Incomplete | None = None, startDate: Incomplete | None = None, endDate: Incomplete | None = None, groupInterval: int = 1) -> None: ...
...
class FieldGroup(Serialisable):
    ...
    __elements__: Incomplete
    def __init__(self, par: Incomplete | None = None, base: Incomplete | None = None, rangePr: Incomplete | None = None, discretePr: Incomplete | None = None, groupItems: Incomplete | None = None) -> None: ...
...
class SharedItems(Serialisable):
    ...
    longText: Incomplete
    __attrs__: Incomplete
    def __init__(self, _fields=(), containsSemiMixedTypes: Incomplete | None = None, containsNonDate: Incomplete | None = None, containsDate: Incomplete | None = None, containsString: Incomplete | None = None, containsBlank: Incomplete | None = None, containsMixedTypes: Incomplete | None = None, containsNumber: Incomplete | None = None, containsInteger: Incomplete | None = None, minValue: Incomplete | None = None, maxValue: Incomplete | None = None, minDate: Incomplete | None = None, maxDate: Incomplete | None = None, count: Incomplete | None = None, longText: Incomplete | None = None) -> None: ...
    @property
    def count(self): ...
...
class CacheField(Serialisable):
    ...
    __elements__: Incomplete
    def __init__(self, sharedItems: Incomplete | None = None, fieldGroup: Incomplete | None = None, mpMap: Incomplete | None = None, extLst: Incomplete | None = None, name: Incomplete | None = None, caption: Incomplete | None = None, propertyName: Incomplete | None = None, serverField: Incomplete | None = None, uniqueList: bool = True, numFmtId: Incomplete | None = None, formula: Incomplete | None = None, sqlType: int = 0, hierarchy: int = 0, level: int = 0, databaseField: bool = True, mappingCount: Incomplete | None = None, memberPropertyField: Incomplete | None = None) -> None: ...
...
class RangeSet(Serialisable):
    ...
    name: Incomplete
    sheet: Incomplete
    def __init__(self, i1: Incomplete | None = None, i2: Incomplete | None = None, i3: Incomplete | None = None, i4: Incomplete | None = None, ref: Incomplete | None = None, name: Incomplete | None = None, sheet: Incomplete | None = None) -> None: ...
...
class WorksheetSource(Serialisable):
    ...
    name: Incomplete
    sheet: Incomplete
    def __init__(self, ref: Incomplete | None = None, name: Incomplete | None = None, sheet: Incomplete | None = None) -> None: ...
...
class CacheSource(Serialisable):
    ...
    extLst: Incomplete
    __elements__: Incomplete
    def __init__(self, type: Incomplete | None = None, connectionId: Incomplete | None = None, worksheetSource: Incomplete | None = None, consolidation: Incomplete | None = None, extLst: Incomplete | None = None) -> None: ...
...
class CacheDefinition(Serialisable):
    ...
    id: Incomplete
    __elements__: Incomplete
    def __init__(self, invalid: Incomplete | None = None, saveData: Incomplete | None = None, refreshOnLoad: Incomplete | None = None, optimizeMemory: Incomplete | None = None, enableRefresh: Incomplete | None = None, refreshedBy: Incomplete | None = None, refreshedDate: Incomplete | None = None, refreshedDateIso: Incomplete | None = None, backgroundQuery: Incomplete | None = None, missingItemsLimit: Incomplete | None = None, createdVersion: Incomplete | None = None, refreshedVersion: Incomplete | None = None, minRefreshableVersion: Incomplete | None = None, recordCount: Incomplete | None = None, upgradeOnRefresh: Incomplete | None = None, tupleCache: Incomplete | None = None, supportSubquery: Incomplete | None = None, supportAdvancedDrill: Incomplete | None = None, cacheSource: Incomplete | None = None, cacheFields=(), cacheHierarchies=(), kpis=(), calculatedItems=(), calculatedMembers=(), dimensions=(), measureGroups=(), maps=(), extLst: Incomplete | None = None, id: Incomplete | None = None) -> None: ...
    def to_tree(self): ...
    @property
    def path(self): ...
