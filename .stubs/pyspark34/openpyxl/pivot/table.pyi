from .fields import Index as Index
from _typeshed import Incomplete
from openpyxl.descriptors import Bool as Bool, Integer as Integer, NoneSet as NoneSet, Sequence as Sequence, Set as Set, String as String, Typed as Typed
...
from openpyxl.worksheet.filters import AutoFilter as AutoFilter
...
class PivotFilter(Serialisable):
    ...
    extLst: Incomplete
    __elements__: Incomplete
    def __init__(self, fld: Incomplete | None = None, mpFld: Incomplete | None = None, type: Incomplete | None = None, evalOrder: Incomplete | None = None, id: Incomplete | None = None, iMeasureHier: Incomplete | None = None, iMeasureFld: Incomplete | None = None, name: Incomplete | None = None, description: Incomplete | None = None, stringValue1: Incomplete | None = None, stringValue2: Incomplete | None = None, autoFilter: Incomplete | None = None, extLst: Incomplete | None = None) -> None: ...
...
class PivotTableStyle(Serialisable):
    ...
    def __init__(self, name: Incomplete | None = None, showRowHeaders: Incomplete | None = None, showColHeaders: Incomplete | None = None, showRowStripes: Incomplete | None = None, showColStripes: Incomplete | None = None, showLastColumn: Incomplete | None = None) -> None: ...
...
class MemberProperty(Serialisable):
    ...
    level: Incomplete
    field: Incomplete
    def __init__(self, name: Incomplete | None = None, showCell: Incomplete | None = None, showTip: Incomplete | None = None, showAsCaption: Incomplete | None = None, nameLen: Incomplete | None = None, pPos: Incomplete | None = None, pLen: Incomplete | None = None, level: Incomplete | None = None, field: Incomplete | None = None) -> None: ...
...
class ChartFormat(Serialisable):
    ...
    __elements__: Incomplete
    def __init__(self, chart: Incomplete | None = None, format: Incomplete | None = None, series: Incomplete | None = None, pivotArea: Incomplete | None = None) -> None: ...
...
class ConditionalFormat(Serialisable):
    ...
    extLst: Incomplete
    __elements__: Incomplete
    def __init__(self, scope: str = 'selection', type: Incomplete | None = None, priority: Incomplete | None = None, pivotAreas=(), extLst: Incomplete | None = None) -> None: ...

class ConditionalFormatList(Serialisable):
    tagname: str
    conditionalFormat: Incomplete
    __attrs__: Incomplete
    def __init__(self, conditionalFormat=(), count: Incomplete | None = None) -> None: ...
...
class Format(Serialisable):
    ...
    extLst: Incomplete
    __elements__: Incomplete
    def __init__(self, action: str = 'formatting', dxfId: Incomplete | None = None, pivotArea: Incomplete | None = None, extLst: Incomplete | None = None) -> None: ...
...
class DataField(Serialisable):
    ...
    extLst: Incomplete
    __elements__: Incomplete
    def __init__(self, name: Incomplete | None = None, fld: Incomplete | None = None, subtotal: str = 'sum', showDataAs: str = 'normal', baseField: int = -1, baseItem: int = 1048832, numFmtId: Incomplete | None = None, extLst: Incomplete | None = None) -> None: ...
...
class PageField(Serialisable):
    ...
    extLst: Incomplete
    __elements__: Incomplete
    def __init__(self, fld: Incomplete | None = None, item: Incomplete | None = None, hier: Incomplete | None = None, name: Incomplete | None = None, cap: Incomplete | None = None, extLst: Incomplete | None = None) -> None: ...
...
class FieldItem(Serialisable):
    ...
    d: Incomplete
    e: Incomplete
    def __init__(self, n: Incomplete | None = None, t: str = 'data', h: Incomplete | None = None, s: Incomplete | None = None, sd: bool = True, f: Incomplete | None = None, m: Incomplete | None = None, c: Incomplete | None = None, x: Incomplete | None = None, d: Incomplete | None = None, e: Incomplete | None = None) -> None: ...
...
class Location(Serialisable):
    ...
    def __init__(self, ref: Incomplete | None = None, firstHeaderRow: Incomplete | None = None, firstDataRow: Incomplete | None = None, firstDataCol: Incomplete | None = None, rowPageCount: Incomplete | None = None, colPageCount: Incomplete | None = None) -> None: ...
