...
class Figure(FigureBase):
    ...
    def set_canvas(self, canvas) -> None:
        ...
        canvas : FigureCanvas
        """
    def figimage(self, X, xo: int = 0, yo: int = 0, alpha: Incomplete | None = None, norm: Incomplete | None = None, cmap: Incomplete | None = None, vmin: Incomplete | None = None, vmax: Incomplete | None = None, origin: Incomplete | None = None, resize: bool = False, **kwargs):
        """
    ...
    def waitforbuttonpress(self, timeout: int = -1):
        ...
        *timeout* seconds.  Negative values deactivate *timeout*.
        """
    def execute_constrained_layout(self, renderer: Incomplete | None = None):
        """
