...
class Text(Artist):
    ...
    zorder: int
    def __init__(self, x: int = 0, y: int = 0, text: str = '', color: Incomplete | None = None, verticalalignment: str = 'baseline', horizontalalignment: str = 'left', multialignment: Incomplete | None = None, fontproperties: Incomplete | None = None, rotation: Incomplete | None = None, linespacing: Incomplete | None = None, rotation_mode: Incomplete | None = None, usetex: Incomplete | None = None, wrap: bool = False, transform_rotates_text: bool = False, *, parse_math: Incomplete | None = None, **kwargs) -> None:
        """
