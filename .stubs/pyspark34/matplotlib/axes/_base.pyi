...
class _process_plot_var_args:
    ...
    axes: Incomplete
    command: Incomplete
    def __init__(self, axes, command: str = 'plot') -> None: ...
    prop_cycler: Incomplete
    def set_prop_cycle(self, cycler) -> None: ...
    def __call__(self, *args, data: Incomplete | None = None, **kwargs) -> Generator[Incomplete, Incomplete, None]: ...
...
class _AxesBase(martist.Artist):
    ...
    def __init__(self, fig, *args, facecolor: Incomplete | None = None, frameon: bool = True, sharex: Incomplete | None = None, sharey: Incomplete | None = None, label: str = '', xscale: Incomplete | None = None, yscale: Incomplete | None = None, box_aspect: Incomplete | None = None, **kwargs) -> None:
        """
    ...
    def get_window_extent(self, renderer: Incomplete | None = None, *args, **kwargs):
        """
    ...
    def grid(self, visible: Incomplete | None = None, which: str = 'major', axis: str = 'both', **kwargs) -> None:
        ...
        **kwargs : `~matplotlib.lines.Line2D` properties
        ...
        """
    def ticklabel_format(self, *, axis: str = 'both', style: str = '', scilimits: Incomplete | None = None, useOffset: Incomplete | None = None, useLocale: Incomplete | None = None, useMathText: Incomplete | None = None) -> None:
        """
