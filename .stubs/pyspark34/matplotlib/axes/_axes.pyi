...
class Axes(_AxesBase):
    ...
    def inset_axes(self, bounds, *, transform: Incomplete | None = None, zorder: int = 5, **kwargs):
        ...
        **kwargs
        ...
        """
    def indicate_inset(self, bounds, inset_ax: Incomplete | None = None, *, transform: Incomplete | None = None, facecolor: str = 'none', edgecolor: str = '0.5', alpha: float = 0.5, zorder: float = 4.99, **kwargs):
        """
    ...
    def indicate_inset_zoom(self, inset_ax, **kwargs):
        ...
        **kwargs
        ...
        connector_lines : 4-tuple of `.patches.ConnectionPatch`
            ...
            correct.
        """
    def secondary_xaxis(self, location, *, functions: Incomplete | None = None, **kwargs):
        """
        ...
        .. plot::
            ...
            plt.show()
        """
    def secondary_yaxis(self, location, *, functions: Incomplete | None = None, **kwargs):
        """
    ...
    def broken_barh(self, xranges, yrange, **kwargs):
        ...
        **kwargs : `.PolyCollection` properties
        ...
        """
    def stem(self, *args, linefmt: Incomplete | None = None, markerfmt: Incomplete | None = None, basefmt: Incomplete | None = None, bottom: int = 0, label: Incomplete | None = None, use_line_collection: bool = True, orientation: str = 'vertical'):
        """
        Create a stem plot.
    ...
    def boxplot(self, x, notch: Incomplete | None = None, sym: Incomplete | None = None, vert: Incomplete | None = None, whis: Incomplete | None = None, positions: Incomplete | None = None, widths: Incomplete | None = None, patch_artist: Incomplete | None = None, bootstrap: Incomplete | None = None, usermedians: Incomplete | None = None, conf_intervals: Incomplete | None = None, meanline: Incomplete | None = None, showmeans: Incomplete | None = None, showcaps: Incomplete | None = None, showbox: Incomplete | None = None, showfliers: Incomplete | None = None, boxprops: Incomplete | None = None, labels: Incomplete | None = None, flierprops: Incomplete | None = None, medianprops: Incomplete | None = None, meanprops: Incomplete | None = None, capprops: Incomplete | None = None, whiskerprops: Incomplete | None = None, manage_ticks: bool = True, autorange: bool = False, zorder: Incomplete | None = None, capwidths: Incomplete | None = None):
        ...
        '''
    def bxp(self, bxpstats, positions: Incomplete | None = None, widths: Incomplete | None = None, vert: bool = True, patch_artist: bool = False, shownotches: bool = False, showmeans: bool = False, showcaps: bool = True, showbox: bool = True, showfliers: bool = True, boxprops: Incomplete | None = None, whiskerprops: Incomplete | None = None, flierprops: Incomplete | None = None, medianprops: Incomplete | None = None, capprops: Incomplete | None = None, meanprops: Incomplete | None = None, meanline: bool = False, manage_ticks: bool = True, zorder: Incomplete | None = None, capwidths: Incomplete | None = None):
        """
        ...
        """
    def scatter(self, x, y, s: Incomplete | None = None, c: Incomplete | None = None, marker: Incomplete | None = None, cmap: Incomplete | None = None, norm: Incomplete | None = None, vmin: Incomplete | None = None, vmax: Incomplete | None = None, alpha: Incomplete | None = None, linewidths: Incomplete | None = None, *, edgecolors: Incomplete | None = None, plotnonfinite: bool = False, **kwargs):
        '''
        ...
        * Fundamentally, scatter works with 1D arrays; *x*, *y*, *s*, and *c*
        ...
        '''
    def hexbin(self, x, y, C: Incomplete | None = None, gridsize: int = 100, bins: Incomplete | None = None, xscale: str = 'linear', yscale: str = 'linear', extent: Incomplete | None = None, cmap: Incomplete | None = None, norm: Incomplete | None = None, vmin: Incomplete | None = None, vmax: Incomplete | None = None, alpha: Incomplete | None = None, linewidths: Incomplete | None = None, edgecolors: str = 'face', reduce_C_function=..., mincnt: Incomplete | None = None, marginals: bool = False, **kwargs):
        """
    ...
    def imshow(self, X, cmap: Incomplete | None = None, norm: Incomplete | None = None, *, aspect: Incomplete | None = None, interpolation: Incomplete | None = None, alpha: Incomplete | None = None, vmin: Incomplete | None = None, vmax: Incomplete | None = None, origin: Incomplete | None = None, extent: Incomplete | None = None, interpolation_stage: Incomplete | None = None, filternorm: bool = True, filterrad: float = 4.0, resample: Incomplete | None = None, url: Incomplete | None = None, **kwargs):
        """
        ...
        **kwargs : `~matplotlib.artist.Artist` properties
        ...
        """
    def pcolor(self, *args, shading: Incomplete | None = None, alpha: Incomplete | None = None, norm: Incomplete | None = None, cmap: Incomplete | None = None, vmin: Incomplete | None = None, vmax: Incomplete | None = None, **kwargs):
        '''
        ...
        *X* and the row number as *Y*.
        '''
    def pcolormesh(self, *args, alpha: Incomplete | None = None, norm: Incomplete | None = None, cmap: Incomplete | None = None, vmin: Incomplete | None = None, vmax: Incomplete | None = None, shading: Incomplete | None = None, antialiased: bool = False, **kwargs):
        """
        Create a pseudocolor plot with a non-regular rectangular grid.
        ...
        **Differences between pcolor() and pcolormesh()**
        ...
        """
    def pcolorfast(self, *args, alpha: Incomplete | None = None, norm: Incomplete | None = None, cmap: Incomplete | None = None, vmin: Incomplete | None = None, vmax: Incomplete | None = None, **kwargs):
        """
        Create a pseudocolor plot with a non-regular rectangular grid.
    ...
    def matshow(self, Z, **kwargs):
        ...
        **kwargs : `~matplotlib.axes.Axes.imshow` arguments
        ...
        """
    def violinplot(self, dataset, positions: Incomplete | None = None, vert: bool = True, widths: float = 0.5, showmeans: bool = False, showextrema: bool = True, showmedians: bool = False, quantiles: Incomplete | None = None, points: int = 100, bw_method: Incomplete | None = None):
        """
        Make a violin plot.
        ...
        """
    def violin(self, vpstats, positions: Incomplete | None = None, vert: bool = True, widths: float = 0.5, showmeans: bool = False, showextrema: bool = True, showmedians: bool = False):
        """
