...
class _SelectorWidget(AxesWidget):
    ...
    def __init__(self, ax, onselect, useblit: bool = False, button: Incomplete | None = None, state_modifier_keys: Incomplete | None = None, use_data_coordinates: bool = False) -> None: ...
...
class LassoSelector(_SelectorWidget):
    ...
    """
    verts: Incomplete
    def __init__(self, ax, onselect, useblit: bool = True, props: Incomplete | None = None, button: Incomplete | None = None) -> None: ...
...
class PolygonSelector(_SelectorWidget):
    ...
    """
    grab_range: Incomplete
    def __init__(self, ax, onselect, useblit: bool = False, props: Incomplete | None = None, handle_props: Incomplete | None = None, grab_range: int = 10, *, draw_bounding_box: bool = False, box_handle_props: Incomplete | None = None, box_props: Incomplete | None = None) -> None: ...
    def onmove(self, event):
        """Cursor move event handler and validator."""
    @property
    def verts(self):
