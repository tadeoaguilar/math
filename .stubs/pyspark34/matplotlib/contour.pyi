...
class ContourLabeler:
    ...
    def locate_label(self, linecontour, labelwidth):
        ...
        """
    def calc_label_rot_and_inline(self, slc, ind, lw, lc: Incomplete | None = None, spacing: int = 5):
        """
