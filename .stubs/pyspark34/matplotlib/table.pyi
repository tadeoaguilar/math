...
class Cell(Rectangle):
    ...
    """
    PAD: float
    def __init__(self, xy, width, height, edgecolor: str = 'k', facecolor: str = 'w', fill: bool = True, text: str = '', loc: Incomplete | None = None, fontproperties: Incomplete | None = None, *, visible_edges: str = 'closed') -> None:
        """
        Parameters
        ----------
        xy : 2-tuple
