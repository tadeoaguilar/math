...
class Path:
    ...
    def iter_segments(self, transform: Incomplete | None = None, remove_nans: bool = True, clip: Incomplete | None = None, snap: bool = False, stroke_width: float = 1.0, simplify: Incomplete | None = None, curves: bool = True, sketch: Incomplete | None = None) -> Generator[Incomplete, None, None]:
        """
