...
def pipe(engine: str, format: str, data: bytes, renderer: str | None = None, formatter: str | None = None, neato_no_op: bool | int | None = None, quiet: bool = False) -> bytes:
    ...
    """
def pipe_string(engine: str, format: str, input_string: str, *, encoding: str, renderer: str | None = None, formatter: str | None = None, neato_no_op: bool | int | None = None, quiet: bool = False) -> str:
    ...
    Note:
        The layout command is started from the current directory.
    """
def pipe_lines(engine: str, format: str, input_lines: typing.Iterator[str], *, input_encoding: str, renderer: str | None = None, formatter: str | None = None, neato_no_op: bool | int | None = None, quiet: bool = False) -> bytes:
    ...
    Note:
        The layout command is started from the current directory.
    """
def pipe_lines_string(engine: str, format: str, input_lines: typing.Iterator[str], *, encoding: str, renderer: str | None = None, formatter: str | None = None, neato_no_op: bool | int | None = None, quiet: bool = False) -> str:
