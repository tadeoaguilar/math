...
class _VowpalWabbitGeneric(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaEstimator):
    ...
    def __init__(self, java_obj: Incomplete | None = None, hashSeed: int = 0, ignoreNamespaces: Incomplete | None = None, initialModel: Incomplete | None = None, inputCol: str = 'value', interactions: Incomplete | None = None, l1: Incomplete | None = None, l2: Incomplete | None = None, learningRate: Incomplete | None = None, numBits: int = 18, numPasses: int = 1, numSyncsPerPass: int = 0, passThroughArgs: str = '', powerT: Incomplete | None = None, predictionIdCol: Incomplete | None = None, splitCol: Incomplete | None = None, splitColValues: Incomplete | None = None, useBarrierExecutionMode: bool = True) -> None: ...
    def setParams(self, hashSeed: int = 0, ignoreNamespaces: Incomplete | None = None, initialModel: Incomplete | None = None, inputCol: str = 'value', interactions: Incomplete | None = None, l1: Incomplete | None = None, l2: Incomplete | None = None, learningRate: Incomplete | None = None, numBits: int = 18, numPasses: int = 1, numSyncsPerPass: int = 0, passThroughArgs: str = '', powerT: Incomplete | None = None, predictionIdCol: Incomplete | None = None, splitCol: Incomplete | None = None, splitColValues: Incomplete | None = None, useBarrierExecutionMode: bool = True):
        """
