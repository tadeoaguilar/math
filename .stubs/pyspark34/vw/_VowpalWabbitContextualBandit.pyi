...
class _VowpalWabbitContextualBandit(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaEstimator):
    ...
    def __init__(self, java_obj: Incomplete | None = None, additionalFeatures=[], additionalSharedFeatures=[], chosenActionCol: str = 'chosenAction', epsilon: float = 0.05, featuresCol: str = 'features', hashSeed: int = 0, ignoreNamespaces: Incomplete | None = None, initialModel: Incomplete | None = None, interactions: Incomplete | None = None, l1: Incomplete | None = None, l2: Incomplete | None = None, labelCol: str = 'label', learningRate: Incomplete | None = None, numBits: int = 18, numPasses: int = 1, numSyncsPerPass: int = 0, parallelism: int = 1, passThroughArgs: str = '', powerT: Incomplete | None = None, predictionCol: str = 'prediction', predictionIdCol: Incomplete | None = None, probabilityCol: str = 'probability', sharedCol: str = 'shared', splitCol: Incomplete | None = None, splitColValues: Incomplete | None = None, useBarrierExecutionMode: bool = True, weightCol: Incomplete | None = None) -> None: ...
    def setParams(self, additionalFeatures=[], additionalSharedFeatures=[], chosenActionCol: str = 'chosenAction', epsilon: float = 0.05, featuresCol: str = 'features', hashSeed: int = 0, ignoreNamespaces: Incomplete | None = None, initialModel: Incomplete | None = None, interactions: Incomplete | None = None, l1: Incomplete | None = None, l2: Incomplete | None = None, labelCol: str = 'label', learningRate: Incomplete | None = None, numBits: int = 18, numPasses: int = 1, numSyncsPerPass: int = 0, parallelism: int = 1, passThroughArgs: str = '', powerT: Incomplete | None = None, predictionCol: str = 'prediction', predictionIdCol: Incomplete | None = None, probabilityCol: str = 'probability', sharedCol: str = 'shared', splitCol: Incomplete | None = None, splitColValues: Incomplete | None = None, useBarrierExecutionMode: bool = True, weightCol: Incomplete | None = None):
        """
