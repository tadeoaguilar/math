...
class _IsolationForestModel(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaModel):
    """
    Args:
    ...
    scoreCol: Incomplete
    def __init__(self, java_obj: Incomplete | None = None, bootstrap: bool = False, contamination: float = 0.0, contaminationError: float = 0.0, featuresCol: str = 'features', innerModel: Incomplete | None = None, maxFeatures: float = 1.0, maxSamples: float = 256.0, numEstimators: int = 100, predictionCol: str = 'predictedLabel', randomSeed: int = 1, scoreCol: str = 'outlierScore') -> None: ...
    def setParams(self, bootstrap: bool = False, contamination: float = 0.0, contaminationError: float = 0.0, featuresCol: str = 'features', innerModel: Incomplete | None = None, maxFeatures: float = 1.0, maxSamples: float = 256.0, numEstimators: int = 100, predictionCol: str = 'predictedLabel', randomSeed: int = 1, scoreCol: str = 'outlierScore'):
        """
