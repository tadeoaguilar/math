...
from gevent._compat import imp_acquire_lock as imp_acquire_lock, imp_release_lock as imp_release_lock, iteritems as iteritems

MAPPING: Incomplete
OPTIONAL_STDLIB_MODULES: Incomplete

class _SysModulesPatcher:
    extra_all: Incomplete
...
def import_patched(module_name, extra_all=..., after_import_hook=...):
    """
