...
__all__ = ['ILoop', 'IWatcher', 'ICallback']

class _Field(Attribute):
    __allowed_kw__: Incomplete
    def __init__(self, description, required: bool = False, **kwargs) -> None: ...
...
class ILoop(Interface):
    ...
    """
    default: Incomplete
    approx_timer_resolution: Incomplete
    def run(nowait: bool = False, once: bool = False) -> None:
        """
        Run the event loop.
    ...
    def destroy() -> None:
        ...
        """
    def io(fd, events, ref: bool = True, priority: Incomplete | None = None) -> None:
        """
    ...
    def closing_fd(fd) -> None:
        ...
        """
    def timer(after, repeat: float = 0.0, ref: bool = True, priority: Incomplete | None = None) -> None:
        """
        ...
        """
    def signal(signum, ref: bool = True, priority: Incomplete | None = None) -> None:
        """
        ...
        """
    def idle(ref: bool = True, priority: Incomplete | None = None) -> None:
        """
        Create and return a watcher that fires when the event loop is idle.
        """
    def prepare(ref: bool = True, priority: Incomplete | None = None) -> None:
        """
        ...
        """
    def check(ref: bool = True, priority: Incomplete | None = None) -> None:
        """
        Create and return a watcher that fires after the event loop
        polls for IO.
        """
    def fork(ref: bool = True, priority: Incomplete | None = None) -> None:
        """
        Create a watcher that fires when the process forks.

        Availability: Unix.
        """
    def async_(ref: bool = True, priority: Incomplete | None = None) -> None:
        """
        ...
        """
    def child(pid, trace: int = 0, ref: bool = True) -> None:
        """
            ...
            Availability: Unix.
            """
    def stat(path, interval: float = 0.0, ref: bool = True, priority: Incomplete | None = None) -> None:
        """
        ...
        """
    def run_callback(func, *args) -> None:
        """
        ...
        """
    def run_callback_threadsafe(func, *args) -> None:
        """
...
class IWatcher(Interface):
    ...
    """
    def start(callback, *args, **kwargs) -> None:
        """
