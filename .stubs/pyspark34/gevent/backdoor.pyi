...
class _Greenlet_stdreplace(Greenlet):
    stdin: Incomplete
    stdout: Incomplete
    prev_stdin: Incomplete
    prev_stdout: Incomplete
    prev_stderr: Incomplete
...
class BackdoorServer(StreamServer):
    ...
    banner: Incomplete
    stderr: Incomplete
    def __init__(self, listener, locals: Incomplete | None = None, banner: Incomplete | None = None, **server_args) -> None:
        '''
