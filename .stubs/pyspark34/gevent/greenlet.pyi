...
class Greenlet(greenlet):
    ...
    """
    spawning_stack_limit: int
    args: Incomplete
    kwargs: Incomplete
    value: Incomplete
    spawning_greenlet: Incomplete
    spawn_tree_locals: Incomplete
    spawning_stack: Incomplete
    def __init__(self, run: Incomplete | None = None, *args, **kwargs) -> None:
        """
...
def joinall(greenlets, timeout: Incomplete | None = None, raise_error: bool = False, count: Incomplete | None = None):
    """
    ...
    :return: A sequence of the greenlets that finished before the timeout (if any)
        expired.
    """
def killall(greenlets, exception=..., block: bool = True, timeout: Incomplete | None = None) -> None:
    """
