...
class Script(Component):
    ...
    def __init__(self, children: Incomplete | None = None, id=..., n_clicks=..., n_clicks_timestamp=..., disable_n_clicks=..., key=..., crossOrigin=..., defer=..., integrity=..., referrerPolicy=..., src=..., type=..., accessKey=..., className=..., contentEditable=..., dir=..., draggable=..., hidden=..., lang=..., role=..., spellCheck=..., style=..., tabIndex=..., title=..., loading_state=..., **kwargs) -> None: ...
