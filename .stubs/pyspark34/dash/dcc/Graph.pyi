...
class Graph(Component):
    ...
    def __init__(self, id=..., responsive=..., clickData=..., clickAnnotationData=..., hoverData=..., clear_on_unhover=..., selectedData=..., relayoutData=..., extendData=..., prependData=..., restyleData=..., figure=..., style=..., className=..., mathjax=..., animate=..., animation_options=..., config=..., loading_state=..., **kwargs) -> None: ...
