...
class RadioItems(Component):
    ...
    def __init__(self, options=..., value=..., inline=..., style=..., className=..., inputStyle=..., inputClassName=..., labelStyle=..., labelClassName=..., id=..., loading_state=..., persistence=..., persisted_props=..., persistence_type=..., **kwargs) -> None: ...
