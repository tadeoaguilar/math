...
class DatePickerRange(Component):
    ...
    def __init__(self, start_date=..., end_date=..., min_date_allowed=..., max_date_allowed=..., disabled_days=..., minimum_nights=..., updatemode=..., start_date_placeholder_text=..., end_date_placeholder_text=..., initial_visible_month=..., clearable=..., reopen_calendar_on_clear=..., display_format=..., month_format=..., first_day_of_week=..., show_outside_days=..., stay_open_on_select=..., calendar_orientation=..., number_of_months_shown=..., with_portal=..., with_full_screen_portal=..., day_size=..., is_RTL=..., disabled=..., start_date_id=..., end_date_id=..., style=..., className=..., id=..., loading_state=..., persistence=..., persisted_props=..., persistence_type=..., **kwargs) -> None: ...
