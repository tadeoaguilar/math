...
class Input(Component):
    ...
    def __init__(self, value=..., type=..., debounce=..., placeholder=..., n_submit=..., n_submit_timestamp=..., inputMode=..., autoComplete=..., readOnly=..., required=..., autoFocus=..., disabled=..., list=..., multiple=..., spellCheck=..., name=..., min=..., max=..., step=..., minLength=..., maxLength=..., pattern=..., selectionStart=..., selectionEnd=..., selectionDirection=..., n_blur=..., n_blur_timestamp=..., size=..., style=..., className=..., id=..., loading_state=..., persistence=..., persisted_props=..., persistence_type=..., **kwargs) -> None: ...
