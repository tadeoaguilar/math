...
class DatePickerSingle(Component):
    ...
    def __init__(self, date=..., min_date_allowed=..., max_date_allowed=..., disabled_days=..., placeholder=..., initial_visible_month=..., clearable=..., reopen_calendar_on_clear=..., display_format=..., month_format=..., first_day_of_week=..., show_outside_days=..., stay_open_on_select=..., calendar_orientation=..., number_of_months_shown=..., with_portal=..., with_full_screen_portal=..., day_size=..., is_RTL=..., disabled=..., style=..., className=..., id=..., loading_state=..., persistence=..., persisted_props=..., persistence_type=..., **kwargs) -> None: ...
