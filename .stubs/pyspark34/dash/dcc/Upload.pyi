...
class Upload(Component):
    ...
    def __init__(self, children: Incomplete | None = None, id=..., contents=..., filename=..., last_modified=..., accept=..., disabled=..., disable_click=..., max_size=..., min_size=..., multiple=..., className=..., className_active=..., className_reject=..., className_disabled=..., style=..., style_active=..., style_reject=..., style_disabled=..., loading_state=..., **kwargs) -> None: ...
