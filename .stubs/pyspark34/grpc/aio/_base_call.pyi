...
class UnaryUnaryCall(Call, Generic[RequestType, ResponseType], metaclass=ABCMeta):
...
class UnaryStreamCall(Call, Generic[RequestType, ResponseType], metaclass=ABCMeta):
    @abstractmethod
    def __aiter__(self) -> AsyncIterable[ResponseType]:
        ...
        '''
    @abstractmethod
    async def read(self) -> EOFType | ResponseType:
...
class StreamUnaryCall(Call, Generic[RequestType, ResponseType], metaclass=ABCMeta):
    @abstractmethod
...
class StreamStreamCall(Call, Generic[RequestType, ResponseType], metaclass=ABCMeta):
    @abstractmethod
    def __aiter__(self) -> AsyncIterable[ResponseType]:
        '''Returns the async iterable representation that yields messages.
