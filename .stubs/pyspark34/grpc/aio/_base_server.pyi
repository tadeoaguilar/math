...
from ._typing import DoneCallbackType as DoneCallbackType, MetadataType as MetadataType, RequestType as RequestType, ResponseType as ResponseType
from typing import Generic, Iterable, Mapping, NoReturn, Sequence
...
class ServicerContext(abc.ABC, Generic[RequestType, ResponseType], metaclass=abc.ABCMeta):
    ...
    async def send_initial_metadata(self, initial_metadata: MetadataType) -> None:
        ...
        """
    @abc.abstractmethod
    async def abort(self, code: grpc.StatusCode, details: str = '', trailing_metadata: MetadataType = ...) -> NoReturn:
