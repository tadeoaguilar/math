...
class GRPCCallOptions:
  ...
  other functions.
  """
    disable_compression: Incomplete
    subcall_of: Incomplete
    credentials: Incomplete
    def __init__(self, disable_compression, subcall_of, credentials) -> None: ...

def grpc_call_options(disable_compression: bool = False, credentials: Incomplete | None = None):
...
class GRPCServicerContext(abc.ABC, metaclass=abc.ABCMeta):
...
class GRPCInvocationContext(abc.ABC, metaclass=abc.ABCMeta):
