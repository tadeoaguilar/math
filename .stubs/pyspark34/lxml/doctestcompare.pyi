...
class LXMLOutputChecker(OutputChecker):
    ...
    def html_empty_tag(self, el, html: bool = True): ...
    def format_doc(self, doc, html, indent, prefix: str = ''): ...
    def format_text(self, text, strip: bool = True): ...
    ...
    def collect_diff_text(self, want, got, strip: bool = True): ...

class LHTMLOutputChecker(LXMLOutputChecker):
    def get_default_parser(self): ...

def install(html: bool = False) -> None:
    """
    ...
    """
def temp_install(html: bool = False, del_module: Incomplete | None = None) -> None:
    """
