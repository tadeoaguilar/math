...
class Schematron(_etree._Validator):
    ...
    def __init__(self, etree: Incomplete | None = None, file: Incomplete | None = None, include: bool = True, expand: bool = True, include_params={}, expand_params={}, compile_params={}, store_schematron: bool = False, store_xslt: bool = False, store_report: bool = False, phase: Incomplete | None = None, error_finder=...) -> None: ...
