...
class HtmlMixin:
    ...
    def text_content(self):
        ...
        """
    def cssselect(self, expr, translator: str = 'html'):
        """
        ...
        speedup.
        """
    def make_links_absolute(self, base_url: Incomplete | None = None, resolve_base_href: bool = True, handle_failures: Incomplete | None = None):
        """
        ...
        """
    def resolve_base_href(self, handle_failures: Incomplete | None = None) -> None:
        """
    ...
    def iterlinks(self) -> Generator[Incomplete, None, None]:
        ...
        """
    def rewrite_links(self, link_repl_func, resolve_base_href: bool = True, base_href: Incomplete | None = None) -> None:
        """
...
class _MethodFunc:
    ...
    copy: Incomplete
    __doc__: Incomplete
    def __init__(self, name, copy: bool = False, source_class=...) -> None: ...
...
class HtmlElementClassLookup(etree.CustomElementClassLookup):
    ...
    Element classes.
    """
    def __init__(self, classes: Incomplete | None = None, mixins: Incomplete | None = None) -> None: ...
    def lookup(self, node_type, document, namespace, name): ...

def document_fromstring(html, parser: Incomplete | None = None, ensure_head_body: bool = False, **kw): ...
def fragments_fromstring(html, no_leading_text: bool = False, base_url: Incomplete | None = None, parser: Incomplete | None = None, **kw):
    ...
    """
def fragment_fromstring(html, create_parent: bool = False, base_url: Incomplete | None = None, parser: Incomplete | None = None, **kw):
    """
    ...
    (and the tree's docinfo.URL).
    """
def fromstring(html, base_url: Incomplete | None = None, parser: Incomplete | None = None, **kw):
    """
    ...
    """
def parse(filename_or_url, parser: Incomplete | None = None, base_url: Incomplete | None = None, **kw):
    """
...
def submit_form(form, extra_values: Incomplete | None = None, open_http: Incomplete | None = None):
    """
...
def tostring(doc, pretty_print: bool = False, include_meta_content_type: bool = False, encoding: Incomplete | None = None, method: str = 'html', with_tail: bool = True, doctype: Incomplete | None = None):
    ...
    '''
def open_in_browser(doc, encoding: Incomplete | None = None) -> None:
    """
