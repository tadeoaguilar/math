...
class UserProxyAgent(ConversableAgent):
    ...
    """
    def __init__(self, name: str, is_termination_msg: Callable[[Dict], bool] | None = None, max_consecutive_auto_reply: int | None = None, human_input_mode: str | None = 'ALWAYS', function_map: Dict[str, Callable] | None = None, code_execution_config: Dict | bool | None = None, default_auto_reply: str | Dict | None | None = '', llm_config: Dict | bool | None = False, system_message: str | None = '') -> None:
        '''
        Args:
