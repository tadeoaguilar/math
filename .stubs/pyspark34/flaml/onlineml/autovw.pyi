...
from flaml.onlineml import OnlineTrialRunner as OnlineTrialRunner
from flaml.onlineml.trial import get_ns_feature_dim_from_vw_example as get_ns_feature_dim_from_vw_example
from flaml.tune import Categorical as Categorical, Float as Float, PolynomialExpansionSet as PolynomialExpansionSet, Trial as Trial, polynomial_expansion_set as polynomial_expansion_set
from flaml.tune.scheduler import ChaChaScheduler as ChaChaScheduler
from flaml.tune.searcher import ChampionFrontierSearcher as ChampionFrontierSearcher
...
class AutoVW:
    ...
    WARMSTART_NUM: int
    AUTOMATIC: str
    VW_INTERACTION_ARG_NAME: str
    def __init__(self, max_live_model_num: int, search_space: dict, init_config: dict | None = {}, min_resource_lease: str | float | None = 'auto', automl_runner_args: dict | None = {}, scheduler_args: dict | None = {}, model_select_policy: str | None = 'threshold_loss_ucb', metric: str | None = 'mae_clipped', random_seed: int | None = None, model_selection_mode: str | None = 'min', cb_coef: float | None = None) -> None:
        '''Constructor.
    ...
    def predict(self, data_sample):
        ...
        """
    def learn(self, data_sample) -> None:
