...
class IfRange:
    etag: str | None
    date: datetime | None
    def __init__(self, etag: str | None = None, date: datetime | None = None) -> None: ...
...
class ContentRange:
    ...
    def __init__(self, units: str | None, start: int | None, stop: int | None, length: int | None = None, on_update: Callable[[ContentRange], None] | None = None) -> None: ...
    @property
    ...
    def set(self, start: int | None, stop: int | None, length: int | None = None, units: str | None = 'bytes') -> None: ...
    def unset(self) -> None: ...
    def to_header(self) -> str: ...
