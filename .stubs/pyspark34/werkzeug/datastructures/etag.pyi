...
class ETags(Collection[str]):
    star_tag: bool
    def __init__(self, strong_etags: Iterable[str] | None = None, weak_etags: Iterable[str] | None = None, star_tag: bool = False) -> None: ...
    ...
    def __call__(self, etag: str | None = None, data: bytes | None = None, include_weak: bool = False) -> bool: ...
