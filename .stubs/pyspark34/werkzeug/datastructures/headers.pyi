...
class Headers(dict[str, str]):
    def __init__(self, defaults: Mapping[str, str | Iterable[str]] | Iterable[tuple[str, str]] | None = None) -> None: ...
    @overload
    ...
    @overload
    def get(self, key: str, default: T | None = None, type: Callable[[str], T] = ...) -> T | None: ...
    @overload
    ...
    def extend(self, *args: Mapping[str, str | Iterable[str]] | Iterable[tuple[str, str]], **kwargs: str | Iterable[str]) -> None: ...
    @overload
    ...
    @overload
    def pop(self, key: int | None = None, default: tuple[str, str] | None = None) -> tuple[str, str]: ...
    ...
    @overload
    def update(self, __m: SupportsKeysAndGetItem[str, str], **kwargs: str | Iterable[str]) -> None: ...
    @overload
    def update(self, __m: Iterable[tuple[str, str]], **kwargs: str | Iterable[str]) -> None: ...
    @overload
...
class EnvironHeaders(ImmutableHeadersMixin, Headers):
    ...
    def __eq__(self, other: object) -> bool: ...
    def __getitem__(self, key: str, _get_mode: Literal[False] = False) -> str: ...
    def __iter__(self) -> Iterator[tuple[str, str]]: ...
