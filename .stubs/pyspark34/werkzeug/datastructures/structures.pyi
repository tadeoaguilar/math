from .mixins import ImmutableDictMixin as ImmutableDictMixin, ImmutableListMixin as ImmutableListMixin, ImmutableMultiDictMixin as ImmutableMultiDictMixin, UpdateDictMixin as UpdateDictMixin
...
def iter_multi_items(mapping: Mapping[K, V | Iterable[V]] | Iterable[tuple[K, V]]) -> Iterator[tuple[K, V]]: ...
...
class MultiDict(TypeConversionDict[K, V]):
    def __init__(self, mapping: Mapping[K, Iterable[V] | V] | Iterable[tuple[K, V]] | None = None) -> None: ...
    ...
    def setlistdefault(self, key: K, default_list: Iterable[V] | None = None) -> list[V]: ...
    def items(self, multi: bool = False) -> Iterator[tuple[K, V]]: ...
    ...
    def update(self, mapping: Mapping[K, Iterable[V] | V] | Iterable[tuple[K, V]]) -> None: ...
    @overload
...
class OrderedMultiDict(MultiDict[K, V]):
    ...
    def setlist(self, key: K, new_list: Iterable[V]) -> None: ...
    def setlistdefault(self, key: K, default_list: Iterable[V] | None = None) -> list[V]: ...
    def update(self, mapping: Mapping[K, V] | Iterable[tuple[K, V]]) -> None: ...
    def poplist(self, key: K) -> list[V]: ...
    @overload
    def pop(self, key: K) -> V: ...
    @overload
...
class CombinedMultiDict(ImmutableMultiDictMixin[K, V], MultiDict[K, V]):
    ...
    @overload
    def get(self, key: K, default: T | None = None, type: Callable[[V], T] = ...) -> T | None: ...
    @overload
    def getlist(self, key: K) -> list[V]: ...
    @overload
    def getlist(self, key: K, type: Callable[[V], T] = ...) -> list[T]: ...
...
class CallbackDict(UpdateDictMixin[K, V], dict[K, V]):
    def __init__(self, initial: Mapping[K, V] | Iterable[tuple[K, V]] | None = None, on_update: Callable[[_CD], None] | None = None) -> None: ...

class HeaderSet(set[str]):
    on_update: Callable[[HeaderSet], None] | None
    def __init__(self, headers: Iterable[str] | None = None, on_update: Callable[[HeaderSet], None] | None = None) -> None: ...
