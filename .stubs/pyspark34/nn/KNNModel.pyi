...
class KNNModel(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaModel):
    ...
    def __init__(self, java_obj: Incomplete | None = None, ballTree: Incomplete | None = None, featuresCol: Incomplete | None = None, k: Incomplete | None = None, leafSize: Incomplete | None = None, outputCol: Incomplete | None = None, valuesCol: Incomplete | None = None) -> None: ...
    def setParams(self, ballTree: Incomplete | None = None, featuresCol: Incomplete | None = None, k: Incomplete | None = None, leafSize: Incomplete | None = None, outputCol: Incomplete | None = None, valuesCol: Incomplete | None = None):
        """
